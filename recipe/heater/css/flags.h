...
#define CF_EXPECT_COLOUR    0x0000000000000008
...
#define CF_FUNCTION         0x0000000000008000
...
#define CF_MEDIA_DEVICE     0x0000000080000000
#define CF_MEDIA_PROPERTY   0x0000000100000000
#define CF_MEDIA_LOGIC      0x0000000200000000
#define CF_MEDIA_UNIT       0x0000000400000000
#define CF_MEDIA_VALUE      0x0000000800000000
#define CF_MEDIA_FIRST      0x0000001000000000

#define CF_DEPRECATED       0x0000002000000000
#define CF_DEPRECATED_45    0x0000004000000000

#define CF_IMAGE            0x0000008000000000
...
#define CF_OFFSET_PATH      0x0000100000000000
#define CF_CONTENT          0x0000200000000000

#define CF_EXPECT_NUMBERS   0x0000400000000000
#define CF_WILDCARD         0x0000800000000000
#define CF_FADE             0x0001000000000000
#define CF_OR_LV_JAN25      0x0002000000000000

#define CF_ANCHOR           0x0004000000000000
#define CF_ANCHOR_SIZE      0x0008000000000000

#define CF_NO_PARAMS        0x0010000000000000
#define CF_MAYBE_NO_PARAMS  0x0020000000000000

#define CF_CORNER           0x0040000000000000
#define CF_CALC             0x0080000000000000
#define CF_IF               0x0100000000000000

#define TLD_EXAMPLE         0x0000000000000001
#define TLD_LOCAL           0x0000000000000002
#define TLD_INVALID         0x0000000000000004
#define TLD_TEST            0x0000000000000008
#define TLD_127001          0x0000000000000010
#define TLD_UNOFFICIAL      0x0000000000000020
#define TLD_ARCHAIC         0x0000000000000040

#define KEY_MODIFIER        0x0000000000000001
