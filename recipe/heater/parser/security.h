...
public:
    ...
    bool parse (::std::ostringstream& ss, mmac_t& mac, nitpick& nits, const ::std::string& site_path, const ::std::string& content, const directory* const d)
    ...
    void reset ();
    void review (::std::ostringstream& ss, mmac_t& mac, nitpick& nits);
    void swap (sec_txt& r); };
