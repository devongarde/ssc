...
typedef typed_property < t_css_border_wsc, ec_border > desc_border;
typedef typed_property < t_css_border_wsc, ec_border_bottom > desc_border_bottom;
...
typedef typed_property < t_css_border_wsc, ec_border_left > desc_border_left;
...
typedef typed_property < t_css_border_wsc, ec_border_right > desc_border_right;
...
typedef typed_property < t_css_border_wsc, ec_border_top > desc_border_top;
