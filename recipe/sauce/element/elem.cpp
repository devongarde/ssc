...
{   { { HTML_PLUS }, { HTML_UNDEF }, "!doctype", elem_faux_doctype, ns_default, EP_CLOSED | EP_TOP },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3 }, { HTML_UNDEF }, "bvar", elem_bvar, ns_default, 0, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3 }, { HTML_UNDEF }, "condition", elem_condition, ns_default, 0, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3 }, { HTML_UNDEF }, "declare", elem_declare, ns_default, 0, EF_M_CONTENT /*  | EF_M_CONTINPRES */ },
    ...
    { { XHTML_1_0, 0, MATH_2_3 }, { HTML_UNDEF }, "domainofapplication", elem_domainofapplication, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3 }, { HTML_UNDEF }, "lowlimit", elem_lowlimit, ns_default, 0, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, MATH_2_3 }, { HTML_UNDEF }, "mlabeledtr", elem_mlabeledtr, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_3 }, { HTML_UNDEF }, "mscarries", elem_mscarries, ns_default, 0, EF_M_PRESINCONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_3 }, { HTML_UNDEF }, "msline", elem_msline, ns_default, 0, EF_M_PRESINCONTENT },
    ...
    { { XHTML_1_0, 0, MATH_1_2 }, { HTML_UNDEF }, "reln", elem_reln, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3 }, { HTML_UNDEF }, "tendsto", elem_tendsto, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3 }, { HTML_UNDEF }, "uplimit", elem_uplimit, ns_default, 0, EF_M_CONTENT },
