...
{   { { HTML_4_0, HR_MF2 }, { HTML_UNDEF }, R_ABOUT, r_about },
    ...
    { { HTML_4_0, HR_ALL | HR_MF }, { HTML_UNDEF }, "alternate", r_alternative },
    { { HTML_4_0 }, { HTML_UNDEF }, R_AMPHTML, r_amphtml },
    { { HTML_4_0, HR_MF }, { HTML_UNDEF }, "appendix", r_appendix },
    ...
    { { HTML_4_0, HR_ALL | HR_MF }, { HTML_UNDEF }, "author", r_author },
    { { HTML_4_0 }, { HTML_UNDEF }, R_AUTHORISATION_ENDPOINT, r_authorisation_endpoint },
    { { HTML_3_0 }, { HTML_UNDEF }, "banner", r_banner },
    { { HTML_4_0 }, { HTML_UNDEF }, "begin", r_begin },
    { { HTML_4_0, HR_MF }, { HTML_UNDEF }, "biblioentry", r_biblioentry },
    ...
    { { HTML_JUL17, HR_A_AREA | HR_LINKHEAD | HV_WHATWG | HR_MF }, { HTML_UNDEF }, "canonical", r_canonical },
    ...
    { { HTML_4_0 }, { HTML_UNDEF }, "dcterms.conformsto", r_dcterms_conformsto },
    { { HTML_4_0 }, { HTML_UNDEF }, "dcterms.contributor", r_dcterms_contributor },
    { { HTML_4_0 }, { HTML_UNDEF }, "dcterms.creator", r_dcterms_creator },
    { { HTML_4_0 }, { HTML_UNDEF }, "dcterms.description", r_dcterms_description },
    { { HTML_4_0 }, { HTML_UNDEF }, "dcterms.hasformat", r_dcterms_hasformat },
    { { HTML_4_0 }, { HTML_UNDEF }, "dcterms.haspart", r_dcterms_haspart },
    { { HTML_4_0 }, { HTML_UNDEF }, "dcterms.hasversion", r_dcterms_hasversion },
    ...
    { { HTML_JUL16, HR_A_AREA | HR_LINK | HV_NOT50 | HV_NOT51 | HV_NOT52 }, { HTML_UNDEF }, "dns-prefetch", r_dnsprefetch },
    ...
    { { HTML_PLUS, HR_ALL | HR_MF }, { HTML_UNDEF }, "help", r_help },
    { { HTML_3_0, HR_MF }, { HTML_UNDEF }, "home", r_home },
    { { HTML_4_0 }, { HTML_UNDEF }, R_HOSTS, r_hosts },
    { { HTML_4_0 }, { HTML_UNDEF }, R_HUB, r_hub },
    { { HTML_4_0, HR_LINKHEAD | HR_EXTERNAL }, { HTML_UNDEF }, "icon", r_icon },
    ...
    { { HTML_4_0, HR_MF }, { HTML_UNDEF }, "its-rules", r_its_rules },
    ...
    { { HTML_4_0, HR_ALL | HR_MF }, { HTML_UNDEF }, "license", r_licence },
    ...
    { { HTML_JUL20, HR_LINKHEAD | HR_EXTERNAL | HV_WHATWG }, { HTML_UNDEF }, "manifest", r_manifest },
    ...
    { { HTML_4_0 }, { HTML_UNDEF }, "navigate", r_navigate },
    { { HTML_4_0, HR_MF }, { HTML_UNDEF }, R_NEIGHBOUR, r_neighbour },
    { { HTML_PLUS, HR_A_AREA | HR_LINK | HR_MF }, { HTML_UNDEF }, "next", r_next },
    { { HTML_4_0 }, { HTML_UNDEF }, R_NEXT_ARCHIVE, r_next_archive },
    { { HTML_4_0, HR_A_AREA | HR_FORM | HR_MF }, { HTML_UNDEF }, "nofollow", r_nofollow },
    { { HTML_JAN16, HR_A_AREA | HR_FORM | HV_NOT50 | HV_NOT51 }, { HTML_UNDEF }, "noopener", r_noopener },
    { { HTML_JAN08, HR_A_AREA | HR_FORM }, { HTML_UNDEF }, "noreferrer", r_noreferrer },
    ...
    { { HTML_JUL16, HR_LINK | HR_EXTERNAL | HV_NOT50 | HV_NOT51 | HV_NOT52 }, { HTML_UNDEF }, "preconnect", r_preconnect },
    { { HTML_4_0 }, { HTML_UNDEF }, R_PREDECESSOR_VERSION, r_predecessor_version },
    { { HTML_4_0, HR_EXTERNAL | HR_LINK | HV_NOT51 | HV_NOT52 }, { HTML_UNDEF }, "prefetch", r_prefetch },
    { { HTML_JUL16, HR_LINK | HR_EXTERNAL | HV_NOT50 | HV_NOT51 | HV_NOT52 }, { HTML_UNDEF }, "preload", r_preload },
    { { HTML_JUL16, HR_LINK | HR_EXTERNAL | HV_NOT50 | HV_NOT51 | HV_NOT52 }, { HTML_MAR23 }, R_PRERENDER, r_prerender },
    { { HTML_4_0, HR_A_AREA | HR_LINK | HR_MF }, { HTML_UNDEF }, "prev", r_prev },
    ...
    { { HTML_4_0 }, { HTML_UNDEF }, "privacy-policy", r_privacy_policy },
    ...
    { { HTML_4_0 }, { HTML_UNDEF }, R_SCHEMA_DCTERMS, r_ontology_dcterms },
    { { HTML_1_0, HR_ALL }, { HTML_UNDEF }, "search", r_search },
    ...
    { { HTML_3_0, HR_LINK | HR_EXTERNAL | HR_MF }, { HTML_UNDEF }, "stylesheet", r_stylesheet },
    ...
    { { HTML_4_0, HR_LINK | HR_A_AREA | HR_MF }, { HTML_UNDEF }, "tag", r_tag },
    { { HTML_4_0 }, { HTML_UNDEF }, "terms-of-service", r_terms_of_service },
    ...
    { { HTML_4_0, HR_MF }, { HTML_UNDEF }, "transformation", r_transformation },
