...
{   HTMLPLUS_ATTRIBUTES (elem_s),
    ...
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_semantics, a_cd },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_semantics, a_definitionurl },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_semantics, a_encoding },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_semantics, a_name },
    MATH3_DEFS_ATTRIBUTES (elem_semantics),

    { { HTML_MATH1, 0, MATH_1_2 }, { HTML_UNDEF }, elem_sep, a_xmlns },
    ...
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, elem_svg, a_allow_zoom_pan },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_svg, a_onabort },
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, elem_svg, a_onafterprint },
    { { HTML_SVG11, 0, HE_SVG_11_20 }, { HTML_UNDEF }, elem_svg, a_baseprofile },
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, elem_svg, a_onbeforeprint },
    { { HTML_SVG11, 0, HE_SVG_11_20 }, { HTML_UNDEF }, elem_svg, a_contentscripttype },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_svg, a_onerror },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_svg, a_onresize },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_svg, a_onscroll },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_svg, a_onunload },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_svg, a_onzoom },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_svg, a_phase },
    { { HTML_SVG12, 0, HE_SVG_12_20 }, { HTML_UNDEF }, elem_svg, a_playbackorder },
    ...
    { { HTML_SVG12, 0, HE_SVG_12_20 }, { HTML_UNDEF }, elem_svg, a_timelinebegin },
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, elem_svg, a_transform },
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_svg),
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_switch),
    SVGx_PRES_ATTRIBUTES (elem_switch),
    STANDARD_HTMLS_4_5_ATTRIBUTES (elem_switch),

    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_symbol, a_externalresourcesrequired },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_symbol, a_preserveaspectratio },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_symbol, a_viewbox },
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_text, a_externalresourcesrequired },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_text, a_lengthadjust },
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, elem_text, a_line_height },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_text, a_rotate },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_text, a_textlength },
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_text),
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_textarea),
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_textpath, a_externalresourcesrequired },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_textpath, a_lengthadjust },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_textpath, a_method },
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, elem_textpath, a_side },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_textpath, a_spacing },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_textpath, a_startoffset },
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_tref, a_externalresourcesrequired },
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, elem_tref, a_rotate },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_tref, a_textlength },
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_tspan, a_externalresourcesrequired },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_tspan, a_lengthadjust },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_tspan, a_rotate },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, elem_tspan, a_systemrequired },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_tspan, a_textlength },
    ...
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_video, a_audio_level },
    ...
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_video, a_syncbehaviour },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_video, a_syncmaster },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_video, a_synctolerance },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_video, a_transformbehaviour },
    { { HTML_JAN08 }, { HTML_UNDEF }, elem_video, a_width },
    SVG12_CONDGRAPH_ATTRIBUTES (elem_video),
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_view, a_viewbox },
