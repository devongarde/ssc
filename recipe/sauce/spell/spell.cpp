...
#pragma warning (pop)
                ...
                if (GSL_AT (word, x).dialect_)
                    nits.pick (nit_dialect, ed_dict, ref, es_info, ec_incorrectness, quote (sss), " is unrecognised. It contains ", quote (GSL_AT (word, x).spell_), " which is US English. Is standard English required?");
                else
                    nits.pick (nit_correct_spelling, ed_dict, ref, es_info, ec_incorrectness, quote (sss), " is unrecognised. It contains ", quote (GSL_AT (word, x).spell_), ", which is standard English. Is US English required?"); }
            else if (GSL_AT (word, x).dialect_)
                nits.pick (nit_dialect, es_info, ec_incorrectness, quote (sss), " is unrecognised. It contains ", quote (GSL_AT (word, x).spell_), ", which is US English. Is standard English required?");
            else
                nits.pick (nit_correct_spelling, es_info, ec_incorrectness, quote (sss), " is unrecognised. It contains ", quote (GSL_AT (word, x).spell_), ", which is standard English. Is US English required?");
            return true; }
    return false; }
