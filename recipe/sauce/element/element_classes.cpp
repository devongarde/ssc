...
{   { elem_undefined, { a_unknown } },
    ...
    { elem_csymbol, { a_type, MATH3DEFCOM, a_unknown } },
    ...
    { elem_math, {  a_altimg, a_altimg_height, a_altimg_width, a_alttext, a_baseline, a_box, a_cdgroup, a_display, a_macros, a_maxwidth, a_mode, a_name, a_overflow,
                    /* a_schemalocation, */ a_style, a_type, MATH3BREAK, MATH3INDENT, MATH3TOKEN, MATH3SHARED, MATH3UNIQUE, MATH3UNIPR, WIDEHIGH, LANGCLASS3, a_unknown } },
    ...
    { elem_mglyph, { a_alt, a_fontfamily, a_height, a_index, a_src, a_width, a_unknown } },
    ...
    { elem_mn, { MATH3BREAK, MATH3INDENT, MATH3FONT, MATH3PRES, a_unknown } },
    ...
    { elem_mover, { a_accent, MATH3PRES, a_unknown } },
    ...
    { elem_mspace, { MATH3BREAK, MATH3INDENT, MATHSIZE, MATH3TOKEN, MATH3PRES, a_unknown } },
    ...
    { elem_mstyle, {    a_accentunder, a_background, a_bevelled, a_close, a_columnspan, a_decimalpoint, a_depth, a_edge, a_height,
                        a_infixlinebreakstyle, a_linethickness, a_lquote, a_mediummathspace, a_rowspan, a_rquote, a_open, a_scriptlevel,
                        a_scriptminsize, a_scriptsizemultiplier, a_selection, a_separators, a_subscriptshift, a_superscriptshift,
                        a_thickmathspace, a_thinmathspace, a_verythickmathspace, a_verythinmathspace, a_veryverythickmathspace,
                        a_veryverythinmathspace, MATH3BREAK, MATH3INDENT, MATH3TABLE, MATH3FONT, MATHOPINFO, MATH3PRES, a_unknown } },
    ...
    { elem_munder, { a_accent, a_accentunder, MATH3PRES, a_unknown } },
    { elem_munderover, { a_accentunder, MATH3PRES, a_unknown } },
    ...
    { elem_semantics, { MATH3DEFCOM, a_unknown } },
