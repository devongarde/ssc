...
{   { { HTML_2_0, HV_RFC_2070 | HV_NOT3 }, { XHTML_2_0 }, elem_a, a_charset },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_area, a_download },
    { { HTML_2_0, HV_NOT30 | HV_RFC_1980 }, { HTML_UNDEF }, elem_area, a_href },
    { { HTML_JAN05 }, { HTML_5_3 }, elem_area, a_hreflang },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_audio, a_autoplay },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_audio, a_controls },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_audio, a_crossorigin },
    { { HTML_JAN05, 0, HE_MOZILLA }, { HTML_UNDEF }, elem_audio, a_currenttime },
    { { HTML_5_3, HV_W3, HE_EXPERIMENTAL }, { HTML_UNDEF }, elem_audio, a_disableremoteplayback },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_audio, a_loop },
    { { HTML_JAN05 }, { HTML_5_0 }, elem_audio, a_mediagroup },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_audio, a_muted },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_audio, a_preload },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_audio, a_src },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_embed, a_height },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_embed, a_src },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_embed, a_type },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_embed, a_width },
    { { HTML_JAN05, REJECT }, { HTML_UNDEF }, elem_embed, a_align },
    { { HTML_JAN05, REJECT }, { HTML_UNDEF }, elem_embed, a_hspace },
    { { HTML_JAN05, REJECT }, { HTML_UNDEF }, elem_embed, a_name },
    { { HTML_JAN05, REJECT }, { HTML_UNDEF }, elem_embed, a_vspace },
    ...
    { { HTML_JAN05, REQUIRED }, { HTML_UNDEF }, elem_img, a_alt },
    { { HTML_3_2, HV_DEPRECATED4 }, { XHTML_2_0 }, elem_img, a_border },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_img, a_crossorigin },
    ...
    { { HTML_JAN05 }, { HTML_5_2 }, elem_object, a_form },
    ...
    { { HTML_JAN05 }, { HTML_5_3 }, elem_object, a_typemustmatch },
    { { MAJOR_4_0, MINOR_4_0 }, { HTML_5_0 }, elem_object, a_usemap },
    ...
    { { HTML_JAN05, REQUIRED }, { HTML_5_0 }, elem_source, a_src },
    { { HTML_5_1 }, { HTML_UNDEF }, elem_source, a_src },
    { { HTML_5_1 }, { HTML_UNDEF }, elem_source, a_srcset },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_source, a_type },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_track, a_default },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_track, a_kind },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_track, a_label },
    { { HTML_JAN05, REQUIRED }, { HTML_UNDEF }, elem_track, a_src },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_track, a_srclang },
    ...
    { { HTML_JAN05, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, elem_video, a_autopictureinpicture },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_autoplay },
    { { HTML_JAN05, 0, HE_MOZILLA | HE_OPERA }, { HTML_UNDEF }, elem_video, a_buffered },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_controls },
    { { HTML_JAN05, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, elem_video, a_controlslist },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_crossorigin },
    { { HTML_JAN05, 0, HE_BESPOKE }, { HTML_UNDEF }, elem_video, a_currenttime },
    { { HTML_JAN05, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, elem_video, a_disablepictureinpicture },
    { { HTML_5_3 }, { HTML_5_3 }, elem_video, a_disableremoteplayback },
    { { HTML_JAN05, 0, HE_BESPOKE }, { HTML_UNDEF }, elem_video, a_duration },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_height },
    { { HTML_JAN05, 0, HE_CHROME | HE_OPERA }, { HTML_UNDEF }, elem_video, a_intrinsicsize },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_loop },
    { { HTML_JAN05 }, { HTML_5_0 }, elem_video, a_mediagroup },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_muted },
    { { HTML_JUL20, HV_WHATWG }, { HTML_UNDEF }, elem_video, a_playsinline },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_poster },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_preload },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_src },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_video, a_width },
