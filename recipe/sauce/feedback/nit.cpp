...
{   switch (doc)
    {   case ed_mishmash : return "(no reference)";
        ...
        case ed_jul10 : return "HTML 5 draft (July 2010)";
        case ed_jan12 : return "HTML 5 draft (Jan 2012)";
        case ed_jan13 : return "HTML 5 draft (Jan 2013)";
        case ed_jan14 : return "HTML 5 draft (Jan 2014)";
        case ed_jul17 : return "HTML 5 draft (July 2017)";
        case ed_may20 : return "HTML 5 draft (May 2020)";
        case ed_jul20 : return "HTML 5 draft (July 2020)";
        case ed_jan21 : return "HTML 5 draft (Jan 2021)";
