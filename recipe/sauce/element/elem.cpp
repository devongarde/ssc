...
{   { { HTML_PLUS }, { HTML_UNDEF }, "!doctype", elem_faux_doctype, ns_default, EP_CLOSED | EP_TOP },
    ...
    { { HTML_JAN06 }, { HTML_UNDEF }, "nav", elem_nav, ns_default, 0, EF_5_FLOW | EF_5_SECTION | EF_5_PALPABLE },
    { { HTML_JAN05 }, { HTML_DEC05 }, "navigation", elem_navigation, ns_default, 0, EF_5_FLOW | EF_5_SECTION | EF_5_PALPABLE },
