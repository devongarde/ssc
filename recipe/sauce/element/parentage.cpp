...
{   { { HTML_PLUS }, { HTML_PLUS }, elem_a, elem_em },
    ...
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_a, elem_undefined, 0, EF_SVG_DESC | EF_SVG_ANIM | EF_SVG_SHAPE | EF_SVG11_STR | EF_SVG_PSGRAD },
    ...
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_annotation_xml, elem_undefined },
    ...
    { { HTML_MATH3, 0, HE_MATH_3_4 }, { HTML_UNDEF }, elem_bvar, elem_degree },
    { { HTML_MATH3, 0, HE_MATH_3_4 }, { HTML_UNDEF }, elem_bvar, elem_semantics },
    { { HTML_MATH1, 0, HE_MATH_1_2 }, { HTML_UNDEF }, elem_bvar, elem_undefined, 0, EF_M_CONTENTEXPR },
    ...
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_ci, elem_mglyph },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_circle, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_PSGRAD },
    ...
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_ci, elem_mglyph },
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_ci, elem_undefined, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH3, 0, HE_MATH_3_4 }, { HTML_UNDEF }, elem_cn, elem_mglyph },
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_cn, elem_sep },
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_cn, elem_undefined, 0, EF_M_PRESINCONTENT },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_SVG20 }, elem_defs, elem_audio },
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_defs, elem_iframe, DENY },
    { { HTML_SVG21, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_defs, elem_iframe, DENY },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_SVG20 }, elem_defs, elem_video },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, elem_defs, elem_view },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_defs, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_SHAPE | EF_SVG_PSGRAD },
    { { HTML_SVG10, 0, HE_SVG_10_12 }, { HTML_UNDEF }, elem_defs, elem_undefined, 0, EF_SVG10_STR },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_defs, elem_undefined, 0, EF_SVG11_STR },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_defs, elem_undefined, 0, EF_SVG20_STR },
    ...
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_discard, elem_undefined, 0, EF_SVG_DESC },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_ellipse, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_PSGRAD },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_foreignobject, elem_undefined },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_SVG20 }, elem_g, elem_audio },
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_g, elem_iframe, DENY },
    { { HTML_SVG21, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_g, elem_iframe, DENY },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_SVG20 }, elem_g, elem_video },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, elem_g, elem_view },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_g, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_SHAPE | EF_SVG_PSGRAD },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_line, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_PSGRAD },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_lineargradient, elem_animate },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_lineargradient, elem_animatetransform },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_lineargradient, elem_set },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_lineargradient, elem_undefined, 0, EF_SVG_DESC },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_a },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_marker, elem_audio },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_clippath },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_filter },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_image },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_marker },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_mask },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_marker, elem_pattern },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_script },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_style },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_switch },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_text },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_marker, elem_video },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_marker, elem_view },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_marker, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG11_STR | EF_SVG_SHAPE | EF_SVG_PSGRAD },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_mask, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_SHAPE | EF_SVG_STR | EF_SVG_PSGRAD },
    ...
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_math, elem_declare },
    ...
    { { HTML_MATH3, 0, HE_MATH_3_4 }, { HTML_UNDEF }, elem_mlabeledtr, elem_mtd },
    { { HTML_MATH1, 0, HE_MATH_1_2 }, { HTML_UNDEF }, elem_mlabeledtr, elem_undefined, 0, EF_M_CONTENTEXPR },
    ...
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_mn, elem_mglyph },
    { { XHTML_1_0 }, { HTML_UNDEF }, elem_mo, elem_malignmark },
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_mo, elem_mglyph },
    ...
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_ms, elem_mglyph },
    ...
    { { HTML_MATH3, 0, HE_MATH_3_4 }, { HTML_UNDEF }, elem_mtable, elem_mlabeledtr },
    { { HTML_MATH3, 0, HE_MATH_3_4 }, { HTML_UNDEF }, elem_mtable, elem_mtr },
    { { HTML_MATH1, 0, HE_MATH_1_2 }, { HTML_UNDEF }, elem_mtable, elem_undefined, 0, EF_M_PRESEXPR },
    { { XHTML_1_0 }, { HTML_UNDEF }, elem_mtext, elem_malignmark },
    { { HTML_MATH2, 0, HE_MATH_2_3_4 }, { HTML_UNDEF }, elem_mtext, elem_mglyph },
    { { HTML_5_2 }, { HTML_UNDEF }, elem_mtext, elem_undefined },
    { { XHTML_1_0 }, { HTML_UNDEF }, elem_mtd, elem_undefined, 0, EF_M_PRESEXPR },
    { { HTML_MATH3, 0, HE_MATH_3_4 }, { HTML_UNDEF }, elem_mtr, elem_mtd },
    { { HTML_MATH1, 0, HE_MATH_1_2 }, { HTML_UNDEF }, elem_mtr, elem_undefined, 0, EF_M_CONTENTEXPR },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_a },
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, elem_pattern, elem_altglyphdef },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_pattern, elem_audio },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_pattern, elem_canvas },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_clippath },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_filter },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_image },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_marker },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_mask },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_pattern, elem_pattern },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_script },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_style },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_switch },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_text },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_pattern, elem_video },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_view },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, elem_pattern, elem_undefined, 0, EF_S_G },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_pattern, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_SHAPE | EF_SVG11_STR | EF_SVG_PSGRAD },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_path, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_PSGRAD },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_polyline, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_PSGRAD },
    ...
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_polygon, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_PSGRAD },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_radialgradient, elem_animate },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_radialgradient, elem_animatetransform },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_radialgradient, elem_set },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_radialgradient, elem_undefined, 0, EF_SVG_DESC },
    ...
    { { HTML_MATH1, 0, HE_MATH }, { HTML_UNDEF }, elem_set, elem_undefined, 0, EF_M_CONTENTEXPR },
    ...
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_solidcolour, elem_switch },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_stop, elem_animate },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_stop, elem_set },
    ...
    { { HTML_SVG12, 0, HE_SVG_12_2 }, { HTML_UNDEF }, elem_svg, elem_audio },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, elem_svg, elem_clippath },
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, elem_svg, elem_colourprofile },
...
//    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, elem_svg, elem_foreignobject, DENY },
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_svg, elem_iframe, DENY },
    { { HTML_SVG21, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_svg, elem_iframe, DENY },
    ...
    { { HTML_SVG12, 0, HE_SVG_12_2 }, { HTML_UNDEF }, elem_svg, elem_video },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_svg, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_SHAPE | EF_SVG_PSGRAD },
    { { HTML_SVG10, 0, HE_SVG_10_12 }, { HTML_UNDEF }, elem_svg, elem_undefined, 0, EF_SVG10_STR },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_svg, elem_undefined, 0, EF_SVG11_STR },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_svg, elem_undefined, 0, EF_SVG20_STR },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, elem_symbol, elem_colourprofile },
    ...
    { { HTML_SVG21, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_symbol, elem_iframe, DENY },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, elem_symbol, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_SHAPE | EF_SVG_PSGRAD },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, elem_symbol, elem_undefined, 0, EF_SVG10_STR },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_symbol, elem_undefined, 0, EF_SVG11_STR },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_symbol, elem_undefined, 0, EF_SVG20_STR },
    ...
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_12 | HE_SVG_2 }, { HTML_UNDEF }, elem_text, elem_a },
    ...
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_text, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_text, elem_undefined, 0, EF_SVG_ANIM | EF_SVG_DESC | EF_SVG_TEXT | EF_SVG_PSGRAD },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_textpath, elem_a },
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, elem_textpath, elem_altglyph },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_textpath, elem_animate },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_textpath, elem_set },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_textpath, elem_style },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_textpath, elem_tref },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_textpath, elem_tspan },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_textpath, elem_undefined, 0, EF_SVG_DESC },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_textpath, elem_undefined, 0, EF_SVG_DESC | EF_SVG_PSGRAD },
    ...
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_12 | HE_SVG_2 }, { HTML_UNDEF }, elem_tspan, elem_a },
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, elem_tspan, elem_altglyph },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_tspan, elem_animate },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_tspan, elem_animatecolour },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_tspan, elem_discard },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_tspan, elem_handler },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_tspan, elem_script },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_tspan, elem_set },
    { { HTML_SVG20, 0, HE_SVG_2 }, { HTML_UNDEF }, elem_tspan, elem_style },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_tspan, elem_switch },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_tspan, elem_tbreak },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_tspan, elem_tref },
    { { HTML_SVG11, 0, HE_SVG_11_2 }, { HTML_UNDEF }, elem_tspan, elem_tspan },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, elem_tspan, elem_undefined, 0, EF_SVG_DESC },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_tspan, elem_undefined, 0, EF_SVG_DESC | EF_SVG_ANIM },
