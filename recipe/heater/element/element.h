...
{   typedef ::std::array < int, 1000 > rowcount_t;
    ...
    void common_permits_prohibits (bool& geo, bool& usa, bool& use);
    e_rss_version find_rss_version ();
    void test_atom_text ();
    ...
    void examine_atom_category ();
    void examine_atom_content ();
    void examine_atom_email ();
    void examine_atom_feed ();
    void examine_atom_id ();
    void examine_atom_link ();
    void examine_atom_person ();
    void examine_atom_updated ();
    void examine_atom_uri ();
    ...
    void examine_itemprop (const itemscope_ptr& itemscope, itemscope_ptr& valuescope);
    ...
    void examine_rsl_content ();
    void examine_rsl_copyright ();
    void examine_rsl_legal ();
    void examine_rsl_licence ();
    void examine_rsl_payment ();
    void examine_rsl_permits ();
    void examine_rsl_prohibits ();
    void examine_rsl_standard ();
    void examine_rss ();
    void examine_rss_category ();
    void examine_rss_channel ();
    void examine_rss_cloud ();
    void examine_rss_date ();
    void examine_rss_day ();
    void examine_rss_docs ();
    void examine_rss_email ();
    void examine_rss_enclosure ();
    void examine_rss_height ();
    void examine_rss_hour ();
    void examine_rss_image ();
    void examine_rss_item ();
    void examine_rss_language ();
    void examine_rss_link ();
    void examine_rss_skipdays ();
    void examine_rss_skiphours ();
    void examine_rss_source ();
    void examine_rss_textinput ();
    void examine_rss_url ();
    void examine_rss_width ();
    void examine_ruby ();
