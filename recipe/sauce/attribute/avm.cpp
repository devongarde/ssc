...
{   { { HTML_2_0, HV_RFC_2070 | HV_NOT3 }, { XHTML_2_0 }, elem_a, a_charset },
    ...
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_button, a_formaction },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_button, a_formenctype },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_button, a_formmethod },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_button, a_formnovalidate },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_button, a_formtarget },
    ...
    { { MAJOR_3_0, MINOR_3_0, REQUIRED }, { HTML_DEC08 }, elem_form, a_action },
    ...
    { { HTML_JAN09 }, { HTML_UNDEF }, elem_input, a_action },
    ...
    { { HTML_JAN09 }, { HTML_5_3 }, elem_input, a_autofocus },
    ...
    { { HTML_JAN09 }, { HTML_UNDEF }, elem_input, a_dirname },
    { { HTML_PLUS, HV_NOT2 | HV_NOT32 }, { HTML_UNDEF }, elem_input, a_disabled },
    { { HTML_JAN09 }, { HTML_UNDEF }, elem_input, a_enctype },
    { { HTML_PLUS, HV_NOT2 }, { MAJOR_3_0, MINOR_3_0 }, elem_input, a_error },
    { { HTML_JAN09 }, { HTML_UNDEF }, elem_input, a_form },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_input, a_formaction },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_input, a_formenctype },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_input, a_formmethod },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_input, a_formnovalidate },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_input, a_formtarget },
    { { HTML_JAN09 }, { HTML_UNDEF }, elem_input, a_height },
    { { HTML_JAN09, 0, HE_SAFARI | HE_OPERA | HE_CHROME }, { HTML_UNDEF }, elem_input, a_incremental },
    { { HTML_JAN13, HV_NOT52 | HV_NOT53 }, { HTML_JUN18 }, elem_input, a_inputmode },
    ...
    { { HTML_JAN09 }, { HTML_UNDEF }, elem_input, a_method },
    { { HTML_PLUS, HV_NOT4 | HV_NOT32 }, { HTML_UNDEF }, elem_input, a_min },
    { { HTML_JAN12 }, { HTML_UNDEF }, elem_input, a_minlength },
    ...
    { { HTML_JAN09 }, { HTML_UNDEF }, elem_input, a_novalidate },
    ...
    { { HTML_JAN20, 0, HE_MOZILLA }, { HTML_UNDEF }, elem_input, a_orient },
    ...
    { { HTML_JAN09 }, { HTML_UNDEF }, elem_input, a_target },
    ...
    { { HTML_JAN13, HV_NOT50 | HV_NOT51 }, { HTML_UNDEF }, elem_select, a_autocomplete },
    ...
    { { MAJOR_4_0, MINOR_4_0 }, { XHTML_2_0 }, elem_td, a_headers },
    ...
    { { HTML_JAN05, HV_NOT52 | HV_NOT53 }, { HTML_JUN18 }, elem_textarea, a_inputmode },
    ...
    { { MAJOR_4_0, MINOR_4_0 }, { XHTML_2_0 }, elem_th, a_abbr },
