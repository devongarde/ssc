...
template < > struct type_master < t_css_filter > : type_either_or < t_css_filter, t_urifn, t_css_fn_trans_args >
{ using type_either_or < t_css_filter, t_urifn, t_css_fn_trans_args > :: type_either_or; };
