...
{   { { HTML_TAGS }, { HTML_UNDEF }, "0", math_none },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "4.20", math_4_20 },
    { { HTML_TAGS }, { HTML_UNDEF }, "4", math_4_22 },
...
{   { { HTML_TAGS }, { HTML_UNDEF }, "aaa", tld_aaa },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "corp", tld_corp, ns_default, TLD_LOCAL | TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "intranet", tld_intranet, ns_default, TLD_LOCAL | TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "private", tld_private, ns_default, TLD_LOCAL | TLD_UNOFFICIAL },
