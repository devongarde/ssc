...
#define MATH1COMMON a_class, a_id, a_other, a_style
...
#define MATH1SIZE   a_depth, WIDEHIGH
...
#define MATH2COMMON a_xlinkhref, a_xlinktype, a_xref, MATH1COMMON
#define MATH2STYLE  a_mathbackground, a_mathcolour, a_mathsize, a_mathvariant
#define MATH2FONT   MATH2STYLE, MATH1FONT
#define MATH2SIZE   a_linebreak, MATH1SIZE
#define MATH2TABLE  a_columnwidth, a_minilabelspacing, a_side, a_width, MATH1TABLE
#define MATH2DEFCOM a_definitionurl, a_encoding, MATH2COMMON
...
{   { elem_undefined, { a_unknown } },
    { elem_a, { a_actuate, a_charset, a_download, a_effect, a_externalresourcesrequired, a_md, a_methods, a_name, a_ping, a_print, a_referrerpolicy, a_show, a_size, a_transform, a_type,
                a_urn, a_xmllink, SVG11GREV, SVG11XLINK, SVG20COND, SVGPRES, COMMON54, a_unknown } },
    { elem_abbr, { a_full, COMMON54, a_unknown } },
    { elem_abbrev, { LC3PLUS, a_unknown } },
    { elem_above, { a_sym, LANGCLASS3, a_unknown } },
    { elem_abs, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_and, { MATH2DEFCOM, a_unknown } },
    { elem_animate, { a_externalresourcesrequired, a_from, a_to, SVG11ANAT, SVG11ANTIME, SVG11ANEV, SVG11ANVAL, SVG11ANADD, SVG11XLINK, SVG20COND, SVGPRES, COMMON54, a_unknown } },
    ...
    { elem_animatemotion, { a_externalresourcesrequired, a_fill, a_keypoints, a_origin, a_path, a_rotate, SVG11ANTIME, SVG11ANEV, SVG11ANVAL, SVG11ANADD, SVG11XLINK, SVG20COND, COMMON54, a_unknown } },
    { elem_animatetransform, { a_externalresourcesrequired, a_from, a_to, a_type, SVG11ANAT, SVG11ANTIME, SVG11ANEV, SVG11ANVAL, SVG11ANADD, SVG11XLINK, SVG20COND, SVGPRES, COMMON54, a_unknown } },
    { elem_animation, { COMMON54, a_unknown } },
    { elem_annotation, { a_encoding, MATH1COMMON, a_unknown } },
    { elem_annotation_xml, { a_encoding, MATH1COMMON, a_unknown } },
    { elem_applet, { a_align, a_alt, a_archive, a_code, a_codebase, a_hspace, a_name, a_object, a_vspace, WIDEHIGH, CLID, TIPSY, a_unknown } },
    { elem_approx, { MATH2DEFCOM, a_unknown } },
    { elem_apply, { MATH2COMMON, a_unknown } },
    { elem_arccos, { MATH2DEFCOM, a_unknown } },
    { elem_arcsin, { MATH2DEFCOM, a_unknown } },
    { elem_arctan, { MATH2DEFCOM, a_unknown } },
    { elem_arccosh, { MATH2DEFCOM, a_unknown } },
    { elem_arccot, { MATH2DEFCOM, a_unknown } },
    { elem_arccoth, { MATH2DEFCOM, a_unknown } },
    { elem_arccsc, { MATH2DEFCOM, a_unknown } },
    { elem_arccsch, { MATH2DEFCOM, a_unknown } },
    { elem_arcsinh, { MATH2DEFCOM, a_unknown } },
    { elem_arcsec, { MATH2DEFCOM, a_unknown } },
    { elem_arcsech, { MATH2DEFCOM, a_unknown } },
    { elem_arctanh, { MATH2DEFCOM, a_unknown } },
    { elem_area, { a_alt, a_download, a_nohref, a_name, a_ping, a_referrerpolicy, a_type, COMMON54, a_unknown } },
    { elem_arg, { a_index, a_lang, MATH2DEFCOM, a_unknown } },
    ...
    { elem_bvar, { MATH2COMMON, a_unknown } },
    ...
    { elem_card, { MATH2DEFCOM, a_unknown } },
    { elem_cartesianproduct, { MATH2DEFCOM, a_unknown } },
    { elem_cdata, { a_unknown } },
    { elem_ceiling, { MATH2DEFCOM, a_unknown } },
    { elem_centre, { a_unknown } },
    { elem_changed, { a_id, a_idref, a_unknown } },
    { elem_choose, { a_unknown } },
    { elem_ci, { a_type, MATH2DEFCOM, a_unknown } },
    ...
    { elem_cn, { a_base, a_type, MATH2COMMON, a_unknown } },
    ...
    { elem_complexes, { MATH2DEFCOM, a_unknown } },
    { elem_compose, { MATH2DEFCOM, a_unknown } },
    { elem_condition, { MATH2COMMON, a_unknown } },
    { elem_conjugate, { MATH2DEFCOM, a_unknown } },
    { elem_content, { a_select, COMMON54, a_unknown } },
    { elem_cos, { MATH2DEFCOM, a_unknown } },
    { elem_cosh, { MATH2DEFCOM, a_unknown } },
    { elem_cot, { MATH2DEFCOM, a_unknown } },
    { elem_coth, { MATH2DEFCOM, a_unknown } },
    { elem_credit, { LANGCLASS3, a_unknown } },
    { elem_csc, { MATH2DEFCOM, a_unknown } },
    { elem_csch, { MATH2DEFCOM, a_unknown } },
    { elem_csymbol, { MATH2DEFCOM, a_unknown } },
    { elem_curl, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_divergence, { MATH2DEFCOM, a_unknown } },
    { elem_divide, { MATH2DEFCOM, a_unknown } },
    { elem_dl, { a_compact, a_clear, COMMON54PLUS, a_unknown } },
    { elem_domain, { MATH2COMMON, a_unknown } },
    { elem_domainofapplication, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_emptyset, { MATH2DEFCOM, a_unknown } },
    { elem_eq, { MATH2DEFCOM, a_unknown } },
    { elem_equivalent, { MATH2DEFCOM, a_unknown } },
    { elem_eulergamma, { MATH2DEFCOM, a_unknown } },
    { elem_exists, { MATH2DEFCOM, a_unknown } },
    { elem_exp, { MATH2DEFCOM, a_unknown } },
    { elem_exponentiale, { MATH2DEFCOM, a_unknown } },
    { elem_extensiondefs, { COMMON54, a_unknown } },
    { elem_factorial, { MATH2DEFCOM, a_unknown } },
    { elem_factorof, { MATH2DEFCOM, a_unknown } },
    { elem_false, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_fespecularlighting, { a_kernelunitlength, a_lightcolour, a_specularconstant, a_specularexponent, a_surfacescale, SVG10FILTER, SVG11FILTER, SVGPRES, COMMON54, a_unknown } },
    ...
    { elem_floor, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_forall, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_gcd, { MATH2DEFCOM, a_unknown } },
    { elem_geq, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_grad, { MATH2DEFCOM, a_unknown } },
    { elem_gt, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_ident, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_image, { a_align, a_externalresourcesrequired, a_seethru, a_xlinkhref, SVG11GREV, SVGBOX, SVGG, SVGREPL, SVG20COND, SVGPRES, COMMON54, a_unknown } },
    { elem_imaginary, { MATH2DEFCOM, a_unknown } },
    { elem_imaginaryi, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_implies, { MATH2DEFCOM, a_unknown } },
    { elem_in, { MATH2DEFCOM, a_unknown } },
    { elem_infinity, { MATH2DEFCOM, a_unknown } },
    { elem_input, { a_accept, a_align, a_alt, a_autocorrect, a_autocomplete, a_capture, a_checked, a_dirname,
                    a_disabled, a_error, a_form, a_formaction, a_formenctype, a_formmethod, a_formnovalidate, a_formtarget, a_incremental, a_list, a_max,
                    a_maxlength, a_md, a_min, a_minlength, a_mozactionhint, a_multiple, a_name, a_orient, a_pattern, a_placeholder, a_readonly, a_required, a_results, a_size,
                    a_step, a_type, a_value, a_webkitdirectory, WIDEHIGH, RESERVED4, COMMON54, a_unknown } },
    { elem_ins, { a_datetime, COMMON54, a_unknown } },
    { elem_int, { MATH2DEFCOM, a_unknown } },
    { elem_interval, { a_closure, MATH2COMMON, a_unknown } },
    { elem_integers, { MATH2DEFCOM, a_unknown } },
    { elem_inverse, { MATH2DEFCOM, a_unknown } },
    { elem_intersect, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_lambda, { MATH2COMMON, a_unknown } },
    { elem_lang, { LANGCLASS3, a_unknown } },
    { elem_laplacian, { MATH2DEFCOM, a_unknown } },
    { elem_layer, { a_above, a_background, a_below, a_bgcolour, a_class, a_clip, a_height, a_id, a_left, a_name, a_pagex, a_pagey, a_src, a_style, a_top, a_visibility, a_zindex, a_unknown } },
    { elem_lcm, { MATH2DEFCOM, a_unknown } },
    { elem_left, { a_unknown } },
    { elem_legend, { a_align, COMMON54, a_unknown } },
    { elem_leq, { MATH2DEFCOM, a_unknown } },
    { elem_lh, { LANGCLASS3, a_unknown } },
    { elem_li, { a_clear, a_compact, a_dingbat, a_md, a_skip, a_type, a_value, COMMON54PLUS, a_unknown } },
    { elem_limit, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_list, { a_order, MATH2COMMON, a_unknown } },
    { elem_listing, { COMMON4, a_unknown } },
    { elem_lit, { HTMLPLUS, a_unknown } },
    { elem_ln, { MATH2DEFCOM, a_unknown } },
    { elem_loc, { COMMON54, a_unknown } },
    { elem_log, { MATH2DEFCOM, a_unknown } },
    { elem_logbase, { MATH2COMMON, a_unknown } },
    { elem_lowlimit, { MATH2COMMON, a_unknown } },
    { elem_lt, { MATH2DEFCOM, a_unknown } },
    { elem_maction, { a_actiontype, a_selection, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_main, { COMMON54, a_unknown } },
    { elem_map, { a_name, COMMON54, a_unknown } },
    { elem_malignmark, { a_edge, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_maligngroup, { a_groupalign, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_math, { a_altimg, a_alttext, a_baseline, a_box, a_macros, a_mode, a_name, a_other, a_overflow, a_style, a_type, a_xmlns, WIDEHIGH, LANGCLASS3, a_unknown } },
    { elem_margin, { HTMLPLUS, a_unknown } },
    { elem_mark, { COMMON54, a_unknown } },
    { elem_marker, { a_externalresourcesrequired, a_orient, a_markerheight, a_markerunits, a_markerwidth, a_viewbox, SVGPRES, SVGBOX, SVGFIT, SVGREF, COMMON54, a_unknown } },
    ...
    { elem_matrix, { MATH2COMMON, a_unknown } },
    { elem_matrixrow, { MATH2COMMON, a_unknown } },
    { elem_max, { MATH2DEFCOM, a_unknown } },
    { elem_mean, { MATH2DEFCOM, a_unknown } },
    { elem_median, { MATH2DEFCOM, a_unknown } },
    { elem_menclose, { a_notation, MATH2STYLE, MATH2COMMON, a_unknown } },
    ...
    { elem_merror, { MATH2STYLE, MATH2COMMON, a_unknown } },
    ...
    { elem_mfenced, { a_close, a_open, a_separators, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mfrac, { a_bevelled, a_denomalign, a_linethickness, a_numalign, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mglyph, { a_alt, a_fontfamily, a_index, MATH2COMMON, a_unknown } },
    { elem_mh, { a_action, a_hidden, a_method, HTMLPLUS, a_unknown } },
    { elem_mi, { MATH2FONT, MATH2COMMON, a_unknown } },
    { elem_min, { MATH2DEFCOM, a_unknown } },
    { elem_minus, { MATH2DEFCOM, a_unknown } },
    { elem_missingglyph, { a_d, a_horizadvx, a_vertadvy, a_vertoriginx, a_vertoriginy, SVGPRES, COMMON54, a_unknown } },
    { elem_mlabeledtr, { a_columnalign, a_groupalign, a_rowalign, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mn, { MATH2FONT, MATH2COMMON, a_unknown } },
    { elem_mmultiscripts, { a_subscriptshift, a_superscriptshift, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mo, { MATH2FONT, MATHOPINFO, MATH2COMMON, a_unknown } },
    { elem_mode, { MATH2DEFCOM, a_unknown } },
    { elem_moment, { MATH2DEFCOM, a_unknown } },
    { elem_momentabout, { MATH2DEFCOM, a_unknown } },
    { elem_mover, { a_accent, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mpadded, { a_lspace, MATH2SIZE, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mpath, { a_externalresourcesrequired, SVG11XLINK, COMMON54, a_unknown } },
    { elem_mphantom, { MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mprescripts, { MATH1COMMON, a_unknown } },
    { elem_mroot, { MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mrow, { MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_ms, { a_lquote, a_rquote, MATH2FONT, MATH2COMMON, a_unknown } },
    { elem_mspace, { MATH2SIZE, MATH2COMMON, a_unknown } },
    { elem_msqrt, { MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mstyle, {    a_accentunder, a_actiontype, a_background, a_close, a_columnspan, a_edge, a_linethickness, a_mediummathspace, a_rowspan, a_open,
                        a_scriptlevel, a_scriptminsize, a_scriptsizemultiplier, a_selection, a_separators, a_subscriptshift, a_superscriptshift,
                        a_thickmathspace, a_thinmathspace, a_verythickmathspace, a_verythinmathspace, a_veryverythickmathspace, a_veryverythinmathspace,
                        MATH2TABLE, MATH2FONT, MATHOPINFO, MATH2COMMON, a_unknown } },
    { elem_msub, { a_subscriptshift, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_msubsup, { a_subscriptshift, a_superscriptshift, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_msup, { a_superscriptshift, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mtable, { MATH2TABLE, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mtd, { a_columnalign, a_columnspan, a_groupalign, a_rowalign, a_rowspan, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mtr, { a_columnalign, a_groupalign, a_rowalign, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_mtext, { MATH2FONT, MATH2COMMON, a_unknown } },
    { elem_multicol, { a_class, a_cols, a_gutter, a_id, a_style, a_width, a_unknown } },
    { elem_munder, { a_accent, a_accentunder, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_munderover, { a_accentunder, MATH2STYLE, MATH2COMMON, a_unknown } },
    { elem_naturalnumbers, { MATH2DEFCOM, a_unknown } },
    { elem_nav, { COMMON54, a_unknown } },
    { elem_neq, { MATH2DEFCOM, a_unknown } },
    { elem_nextid, { a_n, a_unknown } },
    { elem_nl, { XHTML2, a_unknown } },
    { elem_nobr, { a_unknown } },
    { elem_noembed, { a_unknown } },
    { elem_noframes, { COMMON4, a_unknown } },
    { elem_none, { MATH1COMMON, a_unknown } },
    { elem_noscript, { COMMON54, a_unknown } },
    { elem_not, { MATH2DEFCOM, a_unknown } },
    { elem_notanumber, { MATH2DEFCOM, a_unknown } },
    { elem_note, { a_clear, a_md, a_role, a_src, LC3PLUS, a_unknown } },
    { elem_notin, { MATH2DEFCOM, a_unknown } },
    { elem_notprsubset, { MATH2DEFCOM, a_unknown } },
    { elem_notsubset, { MATH2DEFCOM, a_unknown } },
    { elem_object, {    a_align, a_archive, a_border, a_classid, a_codebase, a_codetype, a_contentlength, a_data, a_declare, a_form, a_hspace, a_name, a_standby,
                        a_type, a_typemustmatch, a_vspace, WIDEHIGH, RESERVED4, COMMON54, a_unknown } },
    { elem_of, { a_unknown } },
    ...
    { elem_or, { MATH2DEFCOM, a_unknown } },
    { elem_otherwise, { MATH2COMMON, a_unknown } },
    { elem_output, { a_for, a_form, a_name, COMMON54, a_unknown } },
    { elem_outerproduct, { MATH2DEFCOM, a_unknown } },
    { elem_over, { a_unknown } },
    ...
    { elem_partialdiff, { MATH2DEFCOM, a_unknown } },
    { elem_path, { a_d, a_externalresourcesrequired, a_flatness, a_nominallength, a_pathlength, SVG11GREV, SVGBOX, SVGG, SVG20COND, SVGPRES, COMMON54, a_unknown } },
    { elem_pattern, { a_externalresourcesrequired, a_patterncontentunits, a_patterntransform, a_patternunits, a_pattern_units, a_viewbox, SVG11XLINK, SVG20COND, SVGPRES, SVGFIT, SVGREF, SVGBOX, COMMON54, a_unknown } },
    { elem_person, { LC3PLUS, a_unknown } },
    { elem_pi, { MATH2DEFCOM, a_unknown } },
    { elem_picture, { COMMON54, a_unknown } },
    { elem_piece, { MATH2COMMON, a_unknown } },
    { elem_piecewise, { MATH2COMMON, a_unknown } },
    { elem_plaintext, { LANGCLASS, a_unknown } },
    { elem_plus, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_power, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_rationals, { MATH2DEFCOM, a_unknown } },
    { elem_rb, { COMMON54, a_unknown } },
    { elem_rbc, { COMMON54, a_unknown } },
    { elem_real, { MATH2DEFCOM, a_unknown } },
    { elem_reals, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_rem, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_root, { a_lang, MATH2DEFCOM, a_unknown } },
    { elem_row, { a_unknown } },
    ...
    { elem_scalarproduct, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_sdev, { MATH2DEFCOM, a_unknown } },
    { elem_sec, { MATH2DEFCOM, a_unknown } },
    { elem_sech, { MATH2DEFCOM, a_unknown } },
    { elem_section, { COMMON54, a_unknown } },
    { elem_select, { a_align, a_autocomplete, a_disabled, a_error, a_form, a_md, a_multiple, a_name, a_required, a_several, a_size, a_units, WIDEHIGH, RESERVED4, COMMON54, a_unknown } },
    { elem_selector, { MATH2DEFCOM, a_unknown } },
    { elem_semantics, { MATH2DEFCOM, a_unknown } },
    { elem_sep, { MATH1COMMON, a_unknown } },
    { elem_separator, { XHTML2, a_unknown } },
    { elem_set, { a_externalresourcesrequired, a_fill, a_to, SVG11ANAT, SVG11ANTIME, SVG11ANEV, SVG11XLINK, SVG20COND, COMMON54, a_unknown } },
    { elem_setdiff, { MATH2DEFCOM, a_unknown } },
    { elem_shadow, { COMMON54, a_unknown } },
    { elem_sin, { MATH2DEFCOM, a_unknown } },
    { elem_sinh, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_standby, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_subset, { MATH2DEFCOM , a_unknown } },
    { elem_sum, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_svg, {   a_allow_zoom_pan, a_baseprofile, a_contentscripttype, a_contentstyletype, a_externalresourcesrequired, a_onunload, a_onzoom, a_playbackorder,
                    a_systemrequired, a_snapshottime, a_timelinebegin, a_transform, a_version, a_viewbox, a_zoomandpan, SVG11GREV, SVGBOX, SVGFIT, SVGREF, SVG20COND, SVGPRES, COMMON54PLUS, a_unknown } },
    ...
    { elem_tan, { MATH2DEFCOM, a_unknown } },
    { elem_tanh, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_tendsto, { a_type, MATH2DEFCOM, a_unknown } },
    ...
    { elem_times, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_union, { MATH2DEFCOM, a_unknown } },
    { elem_uplimit, { MATH2COMMON, a_unknown } },
    ...
    { elem_variance, { MATH2DEFCOM, a_unknown } },
    { elem_veaffine, { COMMON54, a_unknown } },
    { elem_vec, { LANGCLASS3, a_unknown } },
    { elem_vector, { MATH2COMMON, a_unknown } },
    { elem_vectoreffect, { COMMON54, a_unknown } },
    { elem_vectorproduct, { MATH2DEFCOM, a_unknown } },
    ...
    { elem_xor, { MATH2DEFCOM, a_unknown } },
