...
#define ONTOLOGIES \
    ...
    s_daq, s_dbd, s_dbo, s_dbp, s_dbp_owl, s_dbr, s_dc, s_dcam, s_dcat, s_dcmi, s_dct, s_ddi, s_doap, \
        ...
        s_dpv_legal, s_dpv_legal_de, s_dpv_legal_eu, s_dpv_legal_gb, s_dpv_legal_ie, s_dpv_legal_in, s_dpv_legal_us, \
        s_dpv_loc, s_dpv_nace, s_dpv_pd, s_dpv_rights, s_dpv_risk, s_dpv_tech, \
...
{   ont_context,
    ...
    dpv_academicresearch, dpv_academicscientificorganisation, dpv_accent, dpv_access, dpv_accesscontrol, dpv_accesscontrolmethod, dpv_accountidentifier, dpv_accountmanagement, dpv_acquantaince,
        dpv_acquire, dpv_activelyinvolved, dpv_activeright, dpv_activitycompleted, dpv_activityhalted, dpv_activitymonitoring, dpv_activitynotcompleted, dpv_activityongoing, dpv_activityplanned,
        dpv_activityproposed, dpv_activitystatus, dpv_adapt, dpv_adult, dpv_advertising, dpv_age, dpv_ageverification, dpv_aggregate, dpv_ailiteracy, dpv_algorithmiclogic, dpv_align, dpv_alter,
        dpv_analyse, dpv_anonymisation, dpv_anonymise, dpv_anonymiseddata, dpv_anonymization, dpv_antiterrorismoperations, dpv_apartmentowned, dpv_applicability, dpv_applicant, dpv_assess,
        ...
        dpv_auditapproved, dpv_auditconditionallyapproved, dpv_auditnotrequired, dpv_auditrejected, dpv_auditrequested, dpv_auditrequired, dpv_auditstatus, dpv_authenticating, dpv_authenticationabc,
        dpv_authenticationhistory, dpv_authenticationpabc, dpv_authenticationprotocols, dpv_authorisationprocedure, dpv_authorisationprotocols, dpv_authority, dpv_authorityinformed,
        dpv_authorityuninformed, dpv_automateddecisionmaking, dpv_automatedprocessingwithhumaninput, dpv_automatedprocessingwithhumanoversight, dpv_automatedprocessingwithhumanreview,
        dpv_automatedprocessingwithhumanverification, dpv_automatedscoringofindividuals, dpv_automationlevel, dpv_automationofprocessing, dpv_autonomous,
    dpv_backgroundchecks, dpv_bankaccount, dpv_behavioural, dpv_beneficiary, dpv_benefit, dpv_biometric, dpv_biometricauthentication, dpv_bloodtype, dpv_browserfingerprint,
        dpv_browsingbehaviour, dpv_browsingreferral,
    dpv_calllog, dpv_cannotchallengeprocess, dpv_cannotchallengeprocessinput, dpv_cannotchallengeprocessoutput, dpv_cannotcorrectprocess, dpv_cannotcorrectprocessinput,
        dpv_cannotcorrectprocessoutput, dpv_cannotobjecttoprocess, dpv_cannotoptintoprocess, dpv_cannotoptoutfromprocess, dpv_cannotreverseprocesseffects, dpv_cannotreverseprocessinput,
        dpv_cannotreverseprocessoutput, dpv_cannotwithdrawfromprocess, dpv_carowned, dpv_certification, dpv_certificationseal, dpv_challengingprocess, dpv_challengingprocessinput,
        dpv_challengingprocessoutput, dpv_character, dpv_child, dpv_citizen, dpv_city, dpv_client, dpv_cloudlocation, dpv_codeofconduct, dpv_collect, dpv_collecteddata, dpv_collectedpersonaldata,
        dpv_combatclimatechange, dpv_combine, dpv_commercialinterest, dpv_commerciallyconfidentialdata, dpv_commercialpurpose, dpv_commercialresearch, dpv_communication,
        dpv_communicationforcustomercare, dpv_communicationmanagement, dpv_communicationsmetadata, dpv_completeanonymisation, dpv_completelymanualprocessing, dpv_complianceassessment,
        dpv_complianceindeterminate, dpv_compliancemonitoring, dpv_compliancestatus, dpv_complianceunknown, dpv_complianceviolation, dpv_compliant, dpv_concept, dpv_conditionalautomation,
        dpv_confidentialdata, dpv_confidentialityagreement, dpv_conformanceassessment, dpv_conformancestatus, dpv_conformant, dpv_connection, dpv_consent, dpv_consentcontrol, dpv_consentexpired,
        dpv_consentgiven, dpv_consentinvalidated, dpv_consentmanagement, dpv_consentnotice, dpv_consentreceipt, dpv_consentrecord, dpv_consentrefused, dpv_consentrequestdeferred,
        dpv_consentrequested, dpv_consentrevoked, dpv_consentstatus, dpv_consentstatusinvalidforprocessing, dpv_consentstatusvalidforprocessing, dpv_consentunknown, dpv_consentwithdrawn,
        dpv_consequence, dpv_consequenceassideeffect, dpv_consequenceoffailure, dpv_consequenceofsuccess, dpv_consult, dpv_consultation, dpv_consultationwithauthority,
        dpv_consultationwithdatasubject, dpv_consultationwithdatasubjectrepresentation, dpv_consultationwithdpo, dpv_consumer, dpv_contact, dpv_context, dpv_contextuallyanonymiseddata,
        dpv_continuousfrequency, dpv_contract, dpv_contractperformance, dpv_contractualterms, dpv_controllerinformed, dpv_controllerprocessoragreement, dpv_controlleruninformed, dpv_copy,
        dpv_correctingprocess, dpv_correctingprocessinput, dpv_correctingprocessoutput, dpv_countermoneylaundering, dpv_counterterrorism, dpv_country, dpv_createeventrecommendations,
        dpv_createpersonalisedrecommendations, dpv_createpersonalizedrecommendations, dpv_createproductrecommendations, dpv_credentialmanagement, dpv_credit, dpv_creditcapacity,
        dpv_creditcardnumber, dpv_creditchecking, dpv_creditrecord, dpv_creditscore, dpv_creditstanding, dpv_creditworthiness, dpv_criminal, dpv_criminalcharge, dpv_criminalconviction,
        dpv_criminalpardon, dpv_crossbordertransfer, dpv_cryptographicauthentication, dpv_cryptographickeymanagement, dpv_cryptographicmethods, dpv_customer, dpv_customercare,
        dpv_customerclaimsmanagement, dpv_customermanagement, dpv_customerordermanagement, dpv_customerrelationshipmanagement, dpv_customersolvencymonitoring, dpv_cybersecurityassessment,
        dpv_cybersecurityassessments, dpv_cybersecuritytraining,
    dpv_damage, dpv_data, dpv_dataaltruism, dpv_dataanonymisationtechnique, dpv_databackupprotocols, dpv_databreachimpactassessment, dpv_databreachnotice, dpv_databreachnotification,
        ...
        dpv_datagovernance, dpv_dataimporter, dpv_datainteroperabilityassessment, dpv_datainteroperabilityimprovement, dpv_datainteroperabilitymanagement, dpv_datainventorymanagement,
        dpv_datajurisdictionpolicy, dpv_dataprocessingagreement, dpv_dataprocessingpolicy, dpv_dataprocessingrecord, dpv_dataprocessingrecords, dpv_dataprocessor, dpv_dataprocessorcontract,
        ...
        dpv_derivedpersonaldata, dpv_designstandard, dpv_destruct, dpv_deterministicpseudonymisation, dpv_detriment, dpv_deviceapplications, dpv_devicebased, dpv_deviceoperatingsystem,
        ...
        dpv_distributedsystemsecurity, dpv_divorce, dpv_dnacode, dpv_documentrandomisedpseudonymisation, dpv_documentsecurity, dpv_download, dpv_dpia, dpv_drugtestresult, dpv_duration,
    dpv_economicunion, dpv_educationaltraining, dpv_effectivenessdeterminationprocedures, dpv_elderlydatasubject, dpv_emailaddress, dpv_emailcontent, dpv_employee, dpv_employmenthistory,
        dpv_encryption, dpv_encryptionatrest, dpv_encryptioninrest, dpv_encryptionintransfer, dpv_encryptioninuse, dpv_endlessduration, dpv_endtoendencryption, dpv_enforceaccesscontrol,
        dpv_enforcesecurity, dpv_enterintocontract, dpv_entity, dpv_entityactiveinvolvement, dpv_entitycontrol, dpv_entityinformed, dpv_entityinformedstatus, dpv_entityinvolvement,
        dpv_entitynoninvolvement, dpv_entitynonpermissiveinvolvement, dpv_entitypassiveinvolvement, dpv_entitypermissiveinvolvement, dpv_entityuninformed, dpv_environmentalprotection,
        dpv_erase, dpv_establishcontractualagreement, dpv_ethnicity, dpv_ethnicorigin, dpv_evaluationofindividuals, dpv_evaluationscoring, dpv_expectationstatus, dpv_expected,
        dpv_explicitlyexpressedconsent, dpv_export, dpv_expressedconsent, dpv_external,
    dpv_family, dpv_familyhealthhistory, dpv_familystructure, dpv_favourite, dpv_favouritecolour, dpv_favouritefood, dpv_favouritemusic, dpv_federatedlocations, dpv_fetish,
        dpv_filesystemsecurity, dpv_filter, dpv_financial, dpv_financialaccount, dpv_financialaccountnumber, dpv_fingerprint, dpv_fixedlocation, dpv_fixedmultiplelocations,
        dpv_fixedoccurencesduration, dpv_fixedsingularlocation, dpv_format, dpv_forprofitorganisation, dpv_fraudpreventiondetection, dpv_frequency, dpv_fria, dpv_friend,
        dpv_fulfilmentofcontractualobligation, dpv_fulfilmentofobligation, dpv_fullautomation, dpv_fullyautomatedprocessing, dpv_fullyrandomisedpseudonymisation,
    dpv_gender, dpv_generalreputation, dpv_generate, dpv_generateddata, dpv_generatedpersonaldata, dpv_geographic, dpv_geographiccoverage, dpv_globalscale, dpv_governanceprocedures,
        dpv_governmentalorganisation, dpv_gpscoordinate, dpv_groupmembership, dpv_guardianofdatasubject, dpv_guideline, dpv_guidelinesprinciple,
    dpv_haircolour, dpv_hardwaresecurityprotocols, dpv_harm, dpv_hashbasedmessageauthenticationcode, dpv_hashfunctions, dpv_health, dpv_healthdata, dpv_healthhistory, dpv_healthrecord,
        dpv_height, dpv_highautomation, dpv_historical, dpv_homomorphicencryption, dpv_houseowned, dpv_hugedatavolume, dpv_hugescaleofdatasubjects, dpv_humaninvolved, dpv_humaninvolvement,
        dpv_humaninvolvementforcontrol, dpv_humaninvolvementfordecision, dpv_humaninvolvementforinput, dpv_humaninvolvementforintervention, dpv_humaninvolvementforoversight,
        dpv_humaninvolvementforverification, dpv_humannotinvolved, dpv_humanresourcemanagement,
    dpv_identityauthentication, dpv_identifying, dpv_identifyingpersonaldata, dpv_identitymanagementmethod, dpv_identifyrectifyimpairments, dpv_identityverification, dpv_immigrant, dpv_impact, dpv_impactassessment,
        ...
        dpv_informationflowcontrol, dpv_informationsecuritypolicy, dpv_informedconsent, dpv_innovativeuseofexistingtechnology, dpv_innovativeuseofnewtechnologies,
    ...
    dpv_job, dpv_jobapplicant, dpv_jointdatacontrollers, dpv_jointdatacontrollersagreement, dpv_justification,
    dpv_knowledgebelief,
    dpv_language, dpv_largedatavolume, dpv_largescaleofdatasubjects, dpv_largescaleprocessing, dpv_law, dpv_lawful, dpv_lawfulness, dpv_lawfulnessunkown, dpv_legalagreement,
        dpv_legalbasis, dpv_legalcompliance, dpv_legalcomplianceassessment, dpv_legalentity, dpv_legalmeasure, dpv_legalobligation, dpv_legitimateinterest, dpv_legitimateinterestassessment,
        dpv_legitimateinterestofcontroller, dpv_legitimateinterestofdatasubject, dpv_legitimateinterestofthirdparty, dpv_licence, dpv_lifehistory, dpv_like, dpv_likelihood, dpv_linkclicked,
        dpv_loanrecord, dpv_localenvironmentscale, dpv_localityscale, dpv_locallocation, dpv_location, dpv_locationfixture, dpv_locationlocality, dpv_loggingpolicies, dpv_loggingpolicy,
    dpv_macaddress, dpv_maintaincreditcheckingdatabase, dpv_maintaincreditratingdatabase, dpv_maintainfrauddatabase, dpv_makeavailable, dpv_maritalstatus, dpv_marketing, dpv_marriage,
        dpv_match, dpv_matchingcombining, dpv_materialdamage, dpv_medicalhealth, dpv_mediumdatavolume, dpv_mediumscaleofdatasubjects, dpv_mediumscaleprocessing, dpv_member,
        dpv_memberpartnermanagement, dpv_mentalhealth, dpv_mentallyvulnerabledatasubject, dpv_messageauthenticationcodes, dpv_metadatamanagement, dpv_misusepreventionanddetection,
        dpv_mobileplatformsecurity, dpv_modify, dpv_monitor, dpv_monitoringpolicies, dpv_monitoringpolicy, dpv_monotoniccounterpseudoanonymisation, dpv_move, dpv_multifactorauthentication,
        dpv_multinationalscale,
    dpv_name, dpv_nationalauthority, dpv_nationalscale, dpv_naturalperson, dpv_nda, dpv_nearlyglobalscale, dpv_necessity, dpv_networkproxyrouting, dpv_networksecurityprotocols,
        dpv_noncitizen, dpv_noncommercialpurpose, dpv_noncommercialresearch, dpv_noncompliant, dpv_nonconformant, dpv_nongovernmentorganisation, dpv_nonmaterialdamage, dpv_nonpersonaldata,
        dpv_nonpersonaldataprocess, dpv_nonprofitorganisation, dpv_nonpublicdatasource, dpv_notapplicable, dpv_notautomated, dpv_notavailable, dpv_notcompliant, dpv_notice, dpv_notification,
        dpv_notificationcompleted, dpv_notificationfailed, dpv_notificationnotneeded, dpv_notificationongoing, dpv_notificationplanned, dpv_notificationstatus, dpv_notinvolved,
        dpv_notrequired,
    dpv_objectingtoprocess, dpv_obligation, dpv_observe, dpv_observeddata, dpv_observedpersonaldata, dpv_obtain, dpv_obtainconsent, dpv_officialauthorityofcontroller, dpv_officialid,
        dpv_offspring, dpv_oftenfrequency, dpv_operatingsystemsecurity, dpv_opinion, dpv_optimisationforconsumer, dpv_optimisationforcontroller, dpv_optimiseuserinterface,
        dpv_optingintoprocess, dpv_optingoutfromprocess, dpv_optional, dpv_organisation, dpv_organisationalmeasure, dpv_organisationalunit, dpv_organisationcompliancemanagement,
        dpv_organisationgovernance, dpv_organisationriskmanagement, dpv_organise, dpv_ownership, dpv_parent, dpv_parentlegalentity, dpv_parentofdatasubject, dpv_partialautomation,
    dpv_partiallyautomatedprocessing, dpv_partiallycompliant, dpv_participant, dpv_passivelyinvolved, dpv_passiveright, dpv_password, dpv_passwordauthentication, dpv_patient,
        dpv_payment, dpv_paymentcard, dpv_paymentcardexpiry, dpv_paymentcardnumber, dpv_paymentmanagement, dpv_penetrationtestingmethods, dpv_permission, dpv_permissionmanagement,
        dpv_personaldata, dpv_personaldatacategory, dpv_personaldatahandling, dpv_personaldataprocess, dpv_personalisation, dpv_personalisedadvertising, dpv_personalisedbenefits,
        dpv_personality, dpv_personalpossession, dpv_personnelhiring, dpv_personnelmanagement, dpv_personnelpayment, dpv_philosophicalbelief, dpv_physicalaccesscontrolmethod,
        dpv_physicaladdress, dpv_physicalauthentication, dpv_physicalauthorisation, dpv_physicalcharacteristic, dpv_physicaldevicesecurity, dpv_physicalhealth,
        dpv_physicalinterceptionprotection, dpv_physicalmeasure, dpv_physicalnetworksecurity, dpv_physicalsecurestorage, dpv_physicalsupplysecurity, dpv_physicalsurveillance,
        dpv_physicaltrait, dpv_pia, dpv_picture, dpv_piercing, dpv_pincode, dpv_policy, dpv_politicalaffiliation, dpv_postquantumcryptography, dpv_preference, dpv_prescription,
        dpv_primaryimportance, dpv_principle, dpv_privacybydefault, dpv_privacybydesign, dpv_privacynotice, dpv_privacypreference, dpv_privacypreservingprotocol,
        dpv_privateinformationretrieval, dpv_privatelocation, dpv_process, dpv_processing, dpv_processingcondition, dpv_processingcontext, dpv_processingduration, dpv_processinglocation,
        dpv_processingrecords, dpv_processingscale, dpv_proclivitie, dpv_professional, dpv_professionalcertification, dpv_professionalevaluation, dpv_professionalinterview,
        dpv_professionaltraining, dpv_profiling, dpv_prohibition, dpv_protectionofipr, dpv_protectionofnationalsecurity, dpv_protectionofpublicsecurity, dpv_provideconsent,
        dpv_providedata, dpv_providedpersonaldata, dpv_provideeventrecommendations, dpv_provideofficialstatistics, dpv_providepersonalisedrecommendations,
        dpv_provideproductrecommendations, dpv_pseudoanonymisation, dpv_pseudoanonymise, dpv_pseudoanonymiseddata, dpv_pseudoanonymization, dpv_pseudonymisation,
        dpv_pseudonymisationencryption, dpv_pseudonymise, dpv_pseudonymiseddata, dpv_publicbenefit, dpv_publicdatasource, dpv_publicinterest, dpv_publiclife, dpv_publiclocation,
        dpv_publiclylocation, dpv_publicpolicymaking, dpv_publicregisterofentities, dpv_publicrelations, dpv_purchase, dpv_purchasesandspendinghabit, dpv_purpose,
    ...
    dpv_race, dpv_randomlocation, dpv_reaffirmconsent, dpv_recertificationpolicy, dpv_recipient, dpv_recipientinformed, dpv_recipientuninformed, dpv_record, dpv_recordmanagement,
        dpv_recordsofactivities, dpv_reference, dpv_reformat, dpv_region, dpv_regionalauthority, dpv_regionalscale, dpv_registerofprocessingactivities, dpv_registrationauthentication,
        dpv_regularityofrecertification, dpv_regulatorysandbox, dpv_relation, dpv_relationship, dpv_religion, dpv_religiousbelief, dpv_remotelocation, dpv_remove, dpv_renewedconsentgiven,
        dpv_repairimpairments, dpv_representative, dpv_requestaccepted, dpv_requestacknowledged, dpv_requestactiondelayed, dpv_requestedserviceprovision, dpv_requestfulfilled,
        ...
        dpv_rightnotice, dpv_rightsfulfillment, dpv_rightsimpactassessment, dpv_rightsmanagement, dpv_risk, dpv_riskassessment, dpv_risklevel, dpv_riskmanagementplan,
    ...
    dpv_safeguard, dpv_safeguardfordatatransfer, dpv_salary, dpv_sale, dpv_scale, dpv_school, dpv_scientificresearch, dpv_scope, dpv_scoringofindividuals, dpv_screen, dpv_seal,
        ...
        dpv_security, dpv_securityassessment, dpv_securityassessments, dpv_securityincidentnotice, dpv_securityincidentnotification, dpv_securityincidentrecord,
        ...
        dpv_service, dpv_serviceconsumer, dpv_serviceconsumptionbehaviour, dpv_serviceoptimisation, dpv_serviceoptimization, dpv_servicepersonalisation, dpv_servicepersonalization,
        ...
        dpv_sibling, dpv_singlesignon, dpv_singulardatavolume, dpv_singularfrequency, dpv_singularscaleofdatasubjects, dpv_skintone, dpv_smalldatavolume, dpv_smallscaleofdatasubjects,
        ...
        dpv_sporadicdatavolume, dpv_sporadicfrequency, dpv_sporadicscaleofdatasubjects, dpv_stafftraining, dpv_standardsconformance, dpv_statisticalconfidentialityagreement,
        dpv_statisticallyconfidentialdata, dpv_status, dpv_storagecondition, dpv_storagedeletion, dpv_storageduration, dpv_storagelocation, dpv_storagerestoration, dpv_storagerestriction,
        dpv_store, dpv_structure, dpv_student, dpv_subprocessoragreement, dpv_subscriber, dpv_subsidiarylegalentity, dpv_supportcontractnegotiation, dpv_supportentitydecisionmaking,
        dpv_supportexchangeofviews, dpv_supportinformedconsentdecision, dpv_supranationalauthority, dpv_supranationalunion, dpv_symmetriccryptography, dpv_symmetricencryption,
        dpv_syntheticdata, dpv_systematicmonitoring, dpv_targetedadvertising,
    dpv_tattoo, dpv_tax, dpv_technicalmeasure, dpv_technicalorganisationalmeasure, dpv_technicalserviceprovision, dpv_technology, dpv_telephonenumber, dpv_temporalduration,
        dpv_thirdcountry, dpv_thirdparty, dpv_thirdpartyagreement, dpv_thirdpartycontract, dpv_thirdpartydatasource, dpv_thirdpartysecurityprocedures, dpv_thought, dpv_tourist,
        dpv_tracking, dpv_transaction, dpv_transactional, dpv_transfer, dpv_transform, dpv_transmit, dpv_trustedcomputing, dpv_trustedexecutionenvironments,
        dpv_trustedthirdpartyutilisation, dpv_tvviewingbehaviour,
    ...
    dpv_variablelocation, dpv_vendormanagement, dpv_vendorpayment, dpv_vendorrecordsmanagement, dpv_vendorselectionassessment, dpv_verification, dpv_verifieddata,
        dpv_violationofcompliance, dpv_virtualisationsecurity, dpv_visitor, dpv_vitalinterest, dpv_vitalinterestofdatasubject, dpv_vitalinterestofnaturalperson,
        dpv_voicecommunicationrecording, dpv_voicemail, dpv_vulnerabilitytestingmethods, dpv_vulnerabledatasubject,
    ...
    dpv_eu_aiact_aideployer, dpv_eu_aiact_aidistributor, dpv_eu_aiact_aiimporter, dpv_eu_aiact_ailiteracy, dpv_eu_aiact_aioffice,
        ...
        dpv_eu_aiact_aisystemperformance, dpv_eu_aiact_authorisedrepresentative, dpv_eu_aiact_availableoneumarket, dpv_eu_aiact_availableonmarket,
    ...
    dpv_eu_aiact_biometric, dpv_eu_aiact_biometriccategorisation, dpv_eu_aiact_biometriccategorisationsystem, dpv_eu_aiact_biometricidentification,
        dpv_eu_aiact_biometricidentityverification,
    dpv_eu_aiact_cemarking, dpv_eu_aiact_commonspecification, dpv_eu_aiact_conformityassessment, dpv_eu_aiact_conformityassessmentbody,
        dpv_eu_aiact_criticalinfrastructure,
    dpv_eu_aiact_deepfake, dpv_eu_aiact_downstreamaiprovider,
    dpv_eu_aiact_emotionrecognition, dpv_eu_aiact_emotionrecognitionsystem,
    dpv_eu_aiact_fria,
    ...
    dpv_eu_aiact_lawenforcement,
    dpv_eu_aiact_marketavailabilitystatus, dpv_eu_aiact_marketplacementstatus, dpv_eu_aiact_marketsurveillanceauthority,
    dpv_eu_aiact_nationalcompetentauthority, dpv_eu_aiact_notavailableonmarket, dpv_eu_aiact_notifiedbody, dpv_eu_aiact_notifyingauthority,
        dpv_eu_aiact_notputintoservice,
    dpv_eu_aiact_placedoneumarket, dpv_eu_aiact_placedonmarket, dpv_eu_aiact_postmarketmonitoringsystem, dpv_eu_aiact_postremotebiometricidentificationsystem,
        dpv_eu_aiact_publiclyaccessiblespace, dpv_eu_aiact_putintoservice, dpv_eu_aiact_putintoserviceineu,
    ...
    dpv_eu_aiact_safetycomponent, dpv_eu_aiact_sandboxplan, dpv_eu_aiact_seriousincident, dpv_eu_aiact_servicesupplystatus, dpv_eu_aiact_substantialmodification,
        dpv_eu_aiact_systemicriskatunionlevel,
    dpv_eu_aiact_technicaldocumentation, dpv_eu_aiact_testingdata, dpv_eu_aiact_testinginrealworldconditions, dpv_eu_aiact_trainingdata,
    dpv_eu_aiact_validationdata,
    dpv_eu_aiact_withdrawnfromservice,

    dpv_eu_dga_a12_e_exchange_approval, dpv_eu_dga_a2_6_permission, dpv_eu_dga_a31_2_transfer_agreement, dpv_eu_dga_a31_3_third_country_judgement,
        dpv_eu_dga_a5_11_mcc, dpv_eu_dga_a5_12_adequacy_decision, dpv_eu_dga_a5_9_transfer_permission,
    dpv_eu_dga_daoregister, dpv_eu_dga_daoregistereu, dpv_eu_dga_daoregisternational, dpv_eu_dga_dataaltruismannualreport, dpv_eu_dga_dataaltruismauthority,
        ...
        dpv_eu_dga_datareuseassistant, dpv_eu_dga_datareuserequest, dpv_eu_dga_datauser, dpv_eu_dga_disp, dpv_eu_dga_dispeuapproval, dpv_eu_dga_dispfordataholder,
        dpv_eu_dga_dispfordatasubject, dpv_eu_dga_dispnotice, dpv_eu_dga_dispregister,
    dpv_eu_dga_eudataaltruismconsentform, dpv_eu_dga_europeandatainnovationboard, dpv_eu_dga_eusipprovider,
    dpv_eu_dga_localsipprovider,
    dpv_eu_dga_nationaldataaltruismpolicy, dpv_eu_dga_nationalsipprovider,
    dpv_eu_dga_personaldatareusenotice,
    ...
    dpv_eu_gdpr_a13, dpv_eu_gdpr_a14, dpv_eu_gdpr_a15, dpv_eu_gdpr_a16, dpv_eu_gdpr_a17, dpv_eu_gdpr_a18, dpv_eu_gdpr_a19, dpv_eu_gdpr_a20,
        dpv_eu_gdpr_a21, dpv_eu_gdpr_a22,
    dpv_eu_gdpr_a453,
    ...
    dpv_eu_gdpr_a73, dpv_eu_gdpr_a77,
    ...
    dpv_eu_gdpr_bindingcorporaterules, dpv_eu_gdpr_breachnotificationnotneeded,
    dpv_eu_gdpr_certificationmechanismsfordatatransfers, dpv_eu_gdpr_codesofconductfordatatransfers, dpv_eu_gdpr_concernedsupervisoryauthority, dpv_eu_gdpr_confidentialitybreach,
        dpv_eu_gdpr_controllerbreachnotice, dpv_eu_gdpr_controllerbreachnotificationneeded, dpv_eu_gdpr_crossborderdatabreach,
    dpv_eu_gdpr_databreach, dpv_eu_gdpr_databreachconcludingreport, dpv_eu_gdpr_databreachdetectionreport, dpv_eu_gdpr_databreachnotice,
        ...
        dpv_eu_gdpr_datasubjectbreachnotificationneeded, dpv_eu_gdpr_datatransfertool, dpv_eu_gdpr_dbiaindicateshighrisk, dpv_eu_gdpr_dbiaindicateslowrisk,
    ...
    dpv_eu_gdpr_gdprcomplianceunknown, dpv_eu_gdpr_gdprcompliant, dpv_eu_gdpr_gdprlawfulness, dpv_eu_gdpr_gdprnoncompliant,
    dpv_eu_gdpr_indirectdatacollectionnotice, dpv_eu_gdpr_integritybreach, dpv_eu_gdpr_integrityconfidentialityprinciple,
    ...
    dpv_eu_gdpr_processorbreachnotice, dpv_eu_gdpr_processorbreachnotificationneeded, dpv_eu_gdpr_purposelimitationprinciple,
    dpv_eu_gdpr_rightsrecipientsnotice,
    ...
    dpv_eu_gdpr_transparencyprinciple,
    ...
    dpv_eu_nis2_earlywarningreport, dpv_eu_nis2_finalreport, dpv_eu_nis2_incidentassessmentreport, dpv_eu_nis2_initialfeedbackonincident, dpv_eu_nis2_intermediatereport,
        dpv_eu_nis2_progressreport, dpv_eu_nis2_riskmitigationadvice, dpv_eu_nis2_significantincidentnotice,

    dpv_eu_rights_a1_humandignity, dpv_eu_rights_a10_freedomofthoughtconsciencereligion, dpv_eu_rights_a11_freedomofexpressioninformation, dpv_eu_rights_a12_freedomofassemblyassociation,
        dpv_eu_rights_a13_freedomofartssciences, dpv_eu_rights_a14_righttoeducation, dpv_eu_rights_a15_freedomtochooseoccuprationengagework, dpv_eu_rights_a16_freedomtoconductbusiness,
        dpv_eu_rights_a17_righttoproperty, dpv_eu_rights_a18_righttoasylum, dpv_eu_rights_a19_protectionremovalexpulsionextradition,
    dpv_eu_rights_a2_righttolife, dpv_eu_rights_a20_equalitybeforelaw, dpv_eu_rights_a21_nondiscrimination, dpv_eu_rights_a22_culturalreligiouslinguisticdiversity,
        dpv_eu_rights_a23_equalitybetweenwomenmen, dpv_eu_rights_a24_rightsofchild, dpv_eu_rights_a25_rightsofelderly, dpv_eu_rights_a26_integrationofpersonswithdisabilities,
        dpv_eu_rights_a27_workersrighttoinformationconsultation, dpv_eu_rights_a28_rightofcollectivebargainingaction, dpv_eu_rights_a29_rightofaccesstoplacementservices,
    dpv_eu_rights_a3_righttointegrityofperson, dpv_eu_rights_a30_protectionunjustifieddismissal, dpv_eu_rights_a31_fairjustworkingconditions,
        dpv_eu_rights_a32_prohibitionofchildlabourprotectionofyoungatwork, dpv_eu_rights_a33_familyprofessionallife, dpv_eu_rights_a34_socialsecuritysocialassistance,
        dpv_eu_rights_a35_healthcare, dpv_eu_rights_a36_accesstoservicesofgeneraleconomicinterest, dpv_eu_rights_a37_environmentalprotection, dpv_eu_rights_a38_consumerprotection,
        dpv_eu_rights_a39_righttovotestandascanditateeuparliament,
    dpv_eu_rights_a4_prohibitionoftorturedegradationpunishment, dpv_eu_rights_a40_righttovotestandascandidatemunicipalelections, dpv_eu_rights_a41_righttogoodadministration,
        dpv_eu_rights_a42_righttoaccesstodocuments, dpv_eu_rights_a43_europeanombudsman, dpv_eu_rights_a44_righttopetition, dpv_eu_rights_a45_freedomofmovementandresidence,
        dpv_eu_rights_a46_diplomaticconsularprotection, dpv_eu_rights_a47_righttoeffectiveremedyfairtrial, dpv_eu_rights_a48_presumptionofinnocencerightofdefence,
        dpv_eu_rights_a49_principlesoflegalityproportionalitycriminaloffencespenalties,
    dpv_eu_rights_a5_prohibitionofslaveryforcedlabour, dpv_eu_rights_a50_rightnotbetriedpunishedtwiceforsamecriminaloffence, dpv_eu_rights_a51_fieldofapplication,
        dpv_eu_rights_a52_scopeinterpretationofrightsprinciples, dpv_eu_rights_a53_levelofprotection, dpv_eu_rights_a54_prohibitionofabuseofrights,
    dpv_eu_rights_a6_righttoliberysecurity,
    dpv_eu_rights_a7_respectprivatefamilylife,
    dpv_eu_rights_a8_protectionofpersonaldata,
    dpv_eu_rights_a9_righttomarryfoundfamily,
    dpv_eu_rights_eu_fundamentalrights,
    dpv_eu_rights_t1_dignity, dpv_eu_rights_t2_freedoms, dpv_eu_rights_t3_equality, dpv_eu_rights_t4_solidarity, dpv_eu_rights_t5_citizensrights, dpv_eu_rights_t6_justice,
        dpv_eu_rights_t7_interpretationandapplication,
    ...
    dpv_just_legalclaimdefenceimpaired, dpv_just_legalclaimestablishmentimpaired, dpv_just_legalclaimexerciseimpaired, dpv_just_legalitylackingobjection,
        dpv_just_legallyexempted, dpv_just_legalobligation, dpv_just_legalprocessimpaired, dpv_just_legitimateinterestoverride,
    ...
    dpv_just_rightsfreedomsimpactunlikely,
    ...
    dpv_legal_ie_dpa_ie, dpv_legal_ie_lawdpa,
    ...
    dpv_loc_ad, dpv_loc_ae, dpv_loc_af, dpv_loc_ag, dpv_loc_ai, dpv_loc_al, dpv_loc_am, dpv_loc_ao, dpv_loc_aq, dpv_loc_ar, dpv_loc_as, dpv_loc_at, dpv_loc_au,
        dpv_loc_aw, dpv_loc_ax, dpv_loc_az,
    dpv_loc_ba, dpv_loc_bb, dpv_loc_bd, dpv_loc_be, dpv_loc_bf, dpv_loc_bg, dpv_loc_bh, dpv_loc_bi, dpv_loc_bj, dpv_loc_bl, dpv_loc_bm, dpv_loc_bn, dpv_loc_bo,
        dpv_loc_bq, dpv_loc_br, dpv_loc_bs, dpv_loc_bt, dpv_loc_bv, dpv_loc_bw, dpv_loc_by, dpv_loc_bz,
    dpv_loc_ca, dpv_loc_cc, dpv_loc_cd, dpv_loc_cf, dpv_loc_cg, dpv_loc_ch, dpv_loc_ci, dpv_loc_ck, dpv_loc_cl, dpv_loc_cm, dpv_loc_cn, dpv_loc_co, dpv_loc_cr,
        dpv_loc_cu, dpv_loc_cv, dpv_loc_cw, dpv_loc_cx, dpv_loc_cy, dpv_loc_cz,
    dpv_loc_de, dpv_loc_de_bb, dpv_loc_de_be, dpv_loc_de_bw, dpv_loc_de_by, dpv_loc_de_hb, dpv_loc_de_he, dpv_loc_de_hh, dpv_loc_de_mv, dpv_loc_de_ni, dpv_loc_de_nw,
        dpv_loc_de_rp, dpv_loc_de_sh, dpv_loc_de_sl, dpv_loc_de_sn, dpv_loc_de_st, dpv_loc_de_th, dpv_loc_dj, dpv_loc_dk, dpv_loc_dm, dpv_loc_do, dpv_loc_dz,
    dpv_loc_ec, dpv_loc_ee, dpv_loc_eea, dpv_loc_eea30, dpv_loc_eea31, dpv_loc_eg, dpv_loc_eh, dpv_loc_er, dpv_loc_es, dpv_loc_et, dpv_loc_eu, dpv_loc_eu27, dpv_loc_eu28,
    dpv_loc_fi, dpv_loc_fj, dpv_loc_fk, dpv_loc_fm, dpv_loc_fo, dpv_loc_fr,
    dpv_loc_ga, dpv_loc_gb, dpv_loc_gd, dpv_loc_ge, dpv_loc_gf, dpv_loc_gg, dpv_loc_gh, dpv_loc_gi, dpv_loc_gl, dpv_loc_gm, dpv_loc_gn, dpv_loc_gp, dpv_loc_gq,
        dpv_loc_gr, dpv_loc_gs, dpv_loc_gt, dpv_loc_gu, dpv_loc_gw, dpv_loc_gy,
    ...
    dpv_loc_ma, dpv_loc_mc, dpv_loc_md, dpv_loc_me, dpv_loc_mf, dpv_loc_mg, dpv_loc_mh, dpv_loc_mk, dpv_loc_ml, dpv_loc_mm, dpv_loc_mn, dpv_loc_mo, dpv_loc_mp,
        dpv_loc_mq, dpv_loc_mr, dpv_loc_ms, dpv_loc_mt, dpv_loc_mu, dpv_loc_mv, dpv_loc_mw, dpv_loc_mx, dpv_loc_my, dpv_loc_mz,
    dpv_loc_na, dpv_loc_nc, dpv_loc_ne, dpv_loc_nf, dpv_loc_ng, dpv_loc_ni, dpv_loc_nl, dpv_loc_no, dpv_loc_np, dpv_loc_nr, dpv_loc_nu, dpv_loc_nz,
    dpv_loc_om,
    dpv_loc_pa, dpv_loc_pe, dpv_loc_pf, dpv_loc_pg, dpv_loc_ph, dpv_loc_pk, dpv_loc_pl, dpv_loc_pm, dpv_loc_pn, dpv_loc_pr, dpv_loc_ps, dpv_loc_pt, dpv_loc_pw,
        dpv_loc_py,
    dpv_loc_qa,
    dpv_loc_re, dpv_loc_ro, dpv_loc_rs, dpv_loc_ru, dpv_loc_rw,
    dpv_loc_sa, dpv_loc_sb, dpv_loc_sc, dpv_loc_sd, dpv_loc_se, dpv_loc_sg, dpv_loc_sh, dpv_loc_si, dpv_loc_sj, dpv_loc_sk, dpv_loc_sl, dpv_loc_sm, dpv_loc_sn,
        dpv_loc_so, dpv_loc_sr, dpv_loc_ss, dpv_loc_st, dpv_loc_sv, dpv_loc_sx, dpv_loc_sy, dpv_loc_sz,
    dpv_loc_tc, dpv_loc_td, dpv_loc_tf, dpv_loc_tg, dpv_loc_th, dpv_loc_tj, dpv_loc_tk, dpv_loc_tl, dpv_loc_tm, dpv_loc_tn, dpv_loc_to, dpv_loc_tr, dpv_loc_tt,
        dpv_loc_tv, dpv_loc_tw, dpv_loc_tz,
    dpv_loc_ua, dpv_loc_ug, dpv_loc_um, dpv_loc_us, dpv_loc_us_ak, dpv_loc_us_al, dpv_loc_us_ar, dpv_loc_us_as, dpv_loc_us_az, dpv_loc_us_ca, dpv_loc_us_co,
        dpv_loc_us_ct, dpv_loc_us_dc, dpv_loc_us_de, dpv_loc_us_fl, dpv_loc_us_ga, dpv_loc_us_gu, dpv_loc_us_hi, dpv_loc_us_ia, dpv_loc_us_id, dpv_loc_us_il,
        dpv_loc_us_in, dpv_loc_us_ks, dpv_loc_us_ky, dpv_loc_us_la, dpv_loc_us_ma, dpv_loc_us_md, dpv_loc_us_me, dpv_loc_us_mi, dpv_loc_us_mn, dpv_loc_us_mo,
        dpv_loc_us_mp, dpv_loc_us_ms, dpv_loc_us_mt, dpv_loc_us_nc, dpv_loc_us_nd, dpv_loc_us_ne, dpv_loc_us_nh, dpv_loc_us_nj, dpv_loc_us_nm, dpv_loc_us_nv,
        dpv_loc_us_ny, dpv_loc_us_oh, dpv_loc_us_ok, dpv_loc_us_or, dpv_loc_us_pa, dpv_loc_us_pr, dpv_loc_us_ri, dpv_loc_us_sc, dpv_loc_us_sd, dpv_loc_us_tn,
        dpv_loc_us_tx, dpv_loc_us_um, dpv_loc_us_ut, dpv_loc_us_va, dpv_loc_us_vc, dpv_loc_us_vi, dpv_loc_us_vt, dpv_loc_us_wa, dpv_loc_us_wi, dpv_loc_us_wv,
        dpv_loc_us_wy, dpv_loc_uy, dpv_loc_uz,
    ...
    dpv_pd_bankaccount, dpv_pd_behavioural, dpv_pd_birthdate, dpv_pd_birthplace, dpv_pd_biometric, dpv_pd_bloodtype, dpv_pd_browserfingerprint, dpv_pd_browserhistory,
    ...
    dpv_pd_education, dpv_pd_educationexperience, dpv_pd_educationqualification, dpv_pd_emailaddress, dpv_pd_emailaddresspersonal, dpv_pd_emailaddresswork,
        dpv_pd_emailcontent, dpv_pd_employmenthistory, dpv_pd_ethnicity, dpv_pd_ethnicorigin, dpv_pd_external,
    dpv_pd_facialprint, dpv_pd_family, dpv_pd_familyhealthhistory, dpv_pd_familystructure, dpv_pd_favourite, dpv_pd_favouritecolour, dpv_pd_favouritefood,
    ...
    dpv_risk_abusivecontentutilisation, dpv_risk_accidentalincident, dpv_risk_acscism, dpv_risk_alara, dpv_risk_alarp, dpv_risk_ansiisa62443322020,
        dpv_risk_attackonprivatelife, dpv_risk_authorisationfailure, dpv_risk_availabilityincident, dpv_risk_avoidsource,
    dpv_risk_bayesiananalysis, dpv_risk_bayesiannetworks, dpv_risk_benefit, dpv_risk_blackmail, dpv_risk_bowtieanalysis, dpv_risk_brainstorming,
    ...
    dpv_risk_casualmapping, dpv_risk_causeconsequenceanalysis, dpv_risk_ccracii, dpv_risk_changeconsequence, dpv_risk_changeimpact, dpv_risk_checklists,
        dpv_risk_childviolence, dpv_risk_cindynic, dpv_risk_citizensimpact, dpv_risk_classifications, dpv_risk_coercion, dpv_risk_compensation,
        dpv_risk_complianceimpact, dpv_risk_compromiseaccount, dpv_risk_compromiseaccountcredentials, dpv_risk_compromiseaccountsecurity,
        dpv_risk_confidentialitybreach, dpv_risk_confidentialityincident, dpv_risk_consequencecontrol, dpv_risk_consequencefordatasubject,
        dpv_risk_consequenceondatasecurity, dpv_risk_containmentcontrol, dpv_risk_controlconsequence, dpv_risk_controlmonitors, dpv_risk_controlrisksource,
        dpv_risk_copyrightviolation, dpv_risk_coras, dpv_risk_corruptionofdata, dpv_risk_costbenefitanalysis, dpv_risk_costacquisition, dpv_risk_costbackup,
        dpv_risk_costconfiguration, dpv_risk_costinstallation, dpv_risk_costjudicialpenalties, dpv_risk_costjudicialproceedings,
        dpv_risk_costoperationinterruption, dpv_risk_costsuspendedoperations, dpv_risk_cramm, dpv_risk_crossborderincident, dpv_risk_crossimpactanalysis,
        dpv_risk_cryptojacking, dpv_risk_cvar, dpv_risk_cyberspying, dpv_risk_cyberstalking,
    dpv_risk_damage, dpv_risk_damagebythirdparty, dpv_risk_dangertocustomers, dpv_risk_dangertopersonnel, dpv_risk_databreach,
        dpv_risk_decisiontreeanalysis, dpv_risk_deliberateincident, dpv_risk_delphitechnique, dpv_risk_denialofserviceattack, dpv_risk_detectioncontrol,
        dpv_risk_detriment, dpv_risk_detrimenttorecovery, dpv_risk_discrimination, dpv_risk_distributeddenialofserviceattack, dpv_risk_dpia,
    dpv_risk_eavesdropping, dpv_risk_ebios, dpv_risk_economicdisadvantage, dpv_risk_environmentalincident, dpv_risk_environmentalsafetyendangerment,
        dpv_risk_equipmentfailure, dpv_risk_equipmentmalfunction, dpv_risk_ermif, dpv_risk_erroneoussystemuse, dpv_risk_etsits1021651,
        dpv_risk_eventtreeanalysis, dpv_risk_extortion, dpv_risk_extremelyhighlikelihood, dpv_risk_extremelyhighrisk, dpv_risk_extremelyhighseverity,
        dpv_risk_extremelylowlikelihood, dpv_risk_extremelylowrisk, dpv_risk_extremelylowseverity,
    dpv_risk_fair, dpv_risk_fairprivacy, dpv_risk_faulttreeanalysis, dpv_risk_fee, dpv_risk_financialequipmentcosts,
        dpv_risk_financialinvestigationcosts, dpv_risk_financialloss, dpv_risk_financialpersonnelcosts, dpv_risk_financialrepaircosts, dpv_risk_fishbone,
        dpv_risk_fmea, dpv_risk_fmeca, dpv_risk_fndiagrams, dpv_risk_fraud,
    dpv_risk_gametheory, dpv_risk_gcsos, dpv_risk_governmentcrisis,
    dpv_risk_haccp, dpv_risk_haltsource, dpv_risk_harm, dpv_risk_harmfulspeech, dpv_risk_hazop, dpv_risk_healthandlifeimpact, dpv_risk_highlikelihood,
        dpv_risk_highrisk, dpv_risk_highseverity, dpv_risk_hitrustcsf, dpv_risk_humanerrors, dpv_risk_humanreliabilityanalysis,
    dpv_risk_identificationcontrol, dpv_risk_identitydispute, dpv_risk_identityfraud, dpv_risk_identitytheft, dpv_risk_illegalprocessingofdata,
        dpv_risk_imomscfal1circ3, dpv_risk_impactcontrol, dpv_risk_impactondatasubject, dpv_risk_impacttorights, dpv_risk_incident,
        ...
        dpv_risk_incidenthalted, dpv_risk_incidenthandlingreport, dpv_risk_incidentidentifier, dpv_risk_incidentimpactassessment,
        ...
        dpv_risk_incidentstatusunknown, dpv_risk_incidentsuspected, dpv_risk_incidentsuspectedreport, dpv_risk_incidentterminated,
        dpv_risk_increaseinternalcost, dpv_risk_industrialcrisis, dpv_risk_influencediagrams, dpv_risk_injury, dpv_risk_integrityincident,
        dpv_risk_interceptionofcommunications, dpv_risk_internaloperationdisruption, dpv_risk_interviews, dpv_risk_iram2, dpv_risk_isacariskit,
        dpv_risk_isamm, dpv_risk_isbm, dpv_risk_isoiec270052018, dpv_risk_isram, dpv_risk_itgrundschutz, dpv_risk_itsrm,
    dpv_risk_knownvulnerabilityexploited,
    dpv_risk_lawenforcementadverseeffects, dpv_risk_limitationofrights, dpv_risk_lopa, dpv_risk_lossassets, dpv_risk_losscompetitiveadvantage,
        dpv_risk_losscontroloverdata, dpv_risk_losscredibility, dpv_risk_losscustomerconfidence, dpv_risk_losscustomers, dpv_risk_lossdata,
        dpv_risk_lossfunds, dpv_risk_lossgoods, dpv_risk_lossgoodwill, dpv_risk_lossnegotiatingcapacity, dpv_risk_lossopportunity,
        dpv_risk_lossproprietaryinformation, dpv_risk_lossreputation, dpv_risk_lossresources, dpv_risk_losssuppliers,
        dpv_risk_losstechnologicaladvantage, dpv_risk_losstrust, dpv_risk_lowlikelihood, dpv_risk_lowrisk, dpv_risk_lowseverity,
    dpv_risk_magerit, dpv_risk_maliciouscodeattack, dpv_risk_malwareattack, dpv_risk_markovanalysis, dpv_risk_materialdamage, dpv_risk_mca, dpv_risk_mehari,
        dpv_risk_misinformationdisinformation, dpv_risk_misuse, dpv_risk_misusebreachedinformation, dpv_risk_moderatelikelihood,
        dpv_risk_moderaterisk, dpv_risk_moderateseverity, dpv_risk_monarc, dpv_risk_monitorconsequence, dpv_risk_monitorcontrol,
        dpv_risk_monitorimpact, dpv_risk_monitorrisk, dpv_risk_monitorriskcontrol, dpv_risk_monitorrisksource, dpv_risk_monitorvulnerabilities,
        dpv_risk_montecarlosimulation,
    dpv_risk_nistsp80030, dpv_risk_nistsp80037, dpv_risk_nistsp80039, dpv_risk_nistsp80082, dpv_risk_nominalgrouptechnique,
        dpv_risk_nonmaterialdamage,
    dpv_risk_octave, dpv_risk_octaveallegro, dpv_risk_octaveforte, dpv_risk_octaves, dpv_risk_ora, dpv_risk_organisationdisruption,
    dpv_risk_paretocharts, dpv_risk_payment, dpv_risk_personalsafetyendangerment, dpv_risk_personnelabsence, dpv_risk_phishingscam,
        dpv_risk_physicalassault, dpv_risk_physicalspying, dpv_risk_physicalstalking, dpv_risk_pia, dpv_risk_preventexercisingofrights,
        dpv_risk_privacyimpact, dpv_risk_psychologicalharm, dpv_risk_publicorderbreach,
    dpv_risk_qualitativeriskassessmenttechnique, dpv_risk_quantitativeriskassessmenttechnique,
    dpv_risk_ransomwareattack, dpv_risk_recoverycontrol, dpv_risk_reducelikelihood, dpv_risk_reduceseverity, dpv_risk_reductioncontrol,
        dpv_risk_reidentification, dpv_risk_reliabilitycentredmaintenance, dpv_risk_remedycontrol, dpv_risk_remotespying,
        dpv_risk_removeconsequence, dpv_risk_removeimpact, dpv_risk_removesource, dpv_risk_renumeration, dpv_risk_replacementcosts,
        dpv_risk_reputationandtrustimpact, dpv_risk_retrievalofdeleteddata, dpv_risk_retrievalofdiscardedequipment, dpv_risk_reward,
        dpv_risk_riskanalysis, dpv_risk_riskassessment, dpv_risk_riskassessmenttechnique, dpv_risk_riskcontrol, dpv_risk_riskindices,
        dpv_risk_riskmanagement, dpv_risk_riskmanagementmethodology, dpv_risk_riskmatrix, dpv_risk_riskmatrix3x3, dpv_risk_riskmatrix5x5,
        dpv_risk_riskmatrix7x7, dpv_risk_riskregisters, dpv_risk_risksource, dpv_risk_rm3x3s1l1, dpv_risk_rm3x3s1l2, dpv_risk_rm3x3s1l3,
        ...
        dpv_risk_rm7x7s7l6, dpv_risk_rm7x7s7l7,
    dpv_risk_sabotage, dpv_risk_scam, dpv_risk_scenarioanalysis, dpv_risk_scurves, dpv_risk_securitybreach,
        dpv_risk_serviceinterruption, dpv_risk_sexualviolence, dpv_risk_sfairp, dpv_risk_sharerisk, dpv_risk_socialdisadvantage,
        dpv_risk_sourcecontrol, dpv_risk_spam, dpv_risk_spoofing, dpv_risk_spying, dpv_risk_stalking, dpv_risk_surveys,
        dpv_risk_swift, dpv_risk_systemfailure, dpv_risk_systemintrusion, dpv_risk_systemmalfunction,
    dpv_risk_taxonomies, dpv_risk_terrorism, dpv_risk_theft, dpv_risk_theftequipment, dpv_risk_theftmedia,
        dpv_risk_thirdpartyoperationdisruption, dpv_risk_threat, dpv_risk_threatsource, dpv_risk_toxicologicalriskassessment,
    dpv_risk_unauthorisedaccesstopremises, dpv_risk_unauthorisedcodeaccess, dpv_risk_unauthorisedcodedisclosure,
        dpv_risk_unauthorisedcodemodification, dpv_risk_unauthoriseddataaccess, dpv_risk_unauthoriseddatadisclosure,
        dpv_risk_unauthoriseddatamodification, dpv_risk_unauthorisedimpersonation, dpv_risk_unauthorisedinformationdisclosure,
        dpv_risk_unauthorisedreidentification, dpv_risk_unauthorisedresourceuse, dpv_risk_unauthorisedsystemaccess,
        dpv_risk_unauthorisedsystemmodification, dpv_risk_unknownvulnerabilityexploited, dpv_risk_unwantedcodedeletion,
        dpv_risk_unwanteddatadeletion, dpv_risk_unwanteddisclosureofdata,
    dpv_risk_vandalism, dpv_risk_var, dpv_risk_veryhighlikelihood, dpv_risk_veryhighrisk, dpv_risk_veryhighseverity,
        dpv_risk_verylowlikelihood, dpv_risk_verylowrisk, dpv_risk_verylowseverity, dpv_risk_violationcodeofconduct,
        dpv_risk_violationcontractualobligations, dpv_risk_violationethicalcode, dpv_risk_violationregulatoryobligations,
        dpv_risk_violationrights, dpv_risk_violationstatutoryobligations, dpv_risk_vulnerability,
        dpv_risk_vulnerabilitycreated, dpv_risk_vulnerabilityexploited,
 
    dpv_tech_actor, dpv_tech_algorithmic, dpv_tech_android, dpv_tech_application, dpv_tech_applicationstore, dpv_tech_auditor,
    dpv_tech_bluetooth,
    dpv_tech_caas, dpv_tech_capability, dpv_tech_cellularnetwork, dpv_tech_cloudservice, dpv_tech_cloudstorage,
        dpv_tech_communicationmechanism, dpv_tech_component, dpv_tech_cookie, dpv_tech_covertsurveillancetechnology, dpv_tech_customer,
    dpv_tech_database, dpv_tech_datacopyingtechnology, dpv_tech_datadisclosuretechnology, dpv_tech_datamanagementtechnology,
        dpv_tech_dataobtainingtechnology, dpv_tech_dataorganisingtechnology, dpv_tech_dataremovaltechnology,
        dpv_tech_datasecuritytechnology, dpv_tech_datastorage, dpv_tech_datastoragetechnology, dpv_tech_datatechnology,
        dpv_tech_datatransfertechnology, dpv_tech_datatransformationtechnology, dpv_tech_datausagetechnology, dpv_tech_deployer,
        dpv_tech_deploymentlocation, dpv_tech_designer, dpv_tech_desktoppc, dpv_tech_detectionsecuritytechnology, dpv_tech_developer,
        dpv_tech_developmentplan, dpv_tech_device, dpv_tech_distributor, dpv_tech_documentation,
    dpv_tech_evaluator,
    ...
    dpv_tech_iaas, dpv_tech_identitymanagementtechnology, dpv_tech_identitytechnology, dpv_tech_identitywallet, dpv_tech_importer,
        dpv_tech_installer, dpv_tech_instructions, dpv_tech_intendeduse, dpv_tech_internet, dpv_tech_ios,
    dpv_tech_laptoppc, dpv_tech_localnetwork, dpv_tech_localstorage,
    dpv_tech_maintainer, dpv_tech_managementtechnology, dpv_tech_manual, dpv_tech_manufacturer, dpv_tech_marketavailabilitystatus,
        dpv_tech_marketavailable, dpv_tech_marketunavailable, dpv_tech_mbaas, dpv_tech_mitigationsecuritytechnology,
        dpv_tech_mobilephone, dpv_tech_monitoringsecuritytechnology, dpv_tech_mswindows,
    dpv_tech_networking, dpv_tech_notprovided,
    dpv_tech_operationaltechnology, dpv_tech_operationdevice, dpv_tech_operationenvironment, dpv_tech_operationmanagement,
        dpv_tech_operator, dpv_tech_os, dpv_tech_overtsurveillancetechnology, dpv_tech_owner,
    dpv_tech_paas, dpv_tech_partner, dpv_tech_personalcomputer, dpv_tech_personalinformationmanagementsystem, dpv_tech_pet, dpv_tech_plan,
        dpv_tech_preventionsecuritytechnology, dpv_tech_privatecloudservice, dpv_tech_producer, dpv_tech_product, dpv_tech_provided,
        dpv_tech_provider, dpv_tech_provisionmethod, dpv_tech_provisionstatus, dpv_tech_publiccloudservice, dpv_tech_purchaser,
    dpv_tech_saas, dpv_tech_securitymanagementtechnology, dpv_tech_securitytechnology, dpv_tech_serverlesscomputing,
        dpv_tech_service, dpv_tech_services, dpv_tech_smartphone, dpv_tech_smartphoneapplication, dpv_tech_software,
        dpv_tech_specification, dpv_tech_subject, dpv_tech_subscription, dpv_tech_supplier, dpv_tech_surveillancetechnology,
        dpv_tech_system, dpv_tech_systemintegrator,
    dpv_tech_technologyactor, dpv_tech_technologydeveloper, dpv_tech_technologyprovider, dpv_tech_technologyprovisionmethod,
        dpv_tech_technologyreadinesslevel, dpv_tech_technologystatus, dpv_tech_technologysubject, dpv_tech_technologyusagelocation, dpv_tech_technologyuser,
        dpv_tech_telephone, dpv_tech_testingplan,
    dpv_tech_user,
    dpv_tech_wifi,
...
{   op_context,
    ...
    dpv_hasactiveentity, dpv_hasactivitystatus, dpv_hasaddress, dpv_hasalgorithmiclogic, dpv_hasapplicability, dpv_hasapplicablelaw,
            dpv_hasassessment, dpv_hasauditstatus, dpv_hasauthority, dpv_hasautomationlevel,
        dpv_hascompliancestatus, dpv_hasconformancestatus, dpv_hasconsentcontrol, dpv_hasconsentnotice, dpv_hasconsentstatus, dpv_hasconsequence,
            dpv_hasconsequenceon, dpv_hasconsequences, dpv_hascontact, dpv_hascontext, dpv_hascountry,
        dpv_hasdata, dpv_hasdatacontroller, dpv_hasdataexporter, dpv_hasdataimporter, dpv_hasdataprocessor, dpv_hasdataprotectionofficer,
            dpv_hasdatasource, dpv_hasdatasubject, dpv_hasdatasubjectscale, dpv_hasdatavolume, dpv_hasduration,
        ...
        dpv_hashumaninvolvement,
        dpv_hasidentifier, dpv_hasimpact, dpv_hasimpactassessment, dpv_hasimpacton, dpv_hasimportance,
            dpv_hasindicationmethod, dpv_hasinformedstatus, dpv_hasintention, dpv_hasinvolvement,
        ...
        dpv_hasname, dpv_hasnecessity, dpv_hasnoninvolvedentity, dpv_hasnonpersonaldataprocess, dpv_hasnotice,
            dpv_hasnotificationstatus,
        dpv_hasobligation, dpv_hasorganisationalmeasure, dpv_hasorganisationalunit, dpv_hasoutcome,
        dpv_haspassiveentity, dpv_haspermission, dpv_haspersonaldata, dpv_haspersonaldatacategory,
            dpv_haspersonaldatahandling, dpv_haspersonaldataprocess, dpv_hasphysicalmeasure, dpv_haspolicy, dpv_hasprocess,
            dpv_hasprocessingcondition, dpv_hasprocessing, dpv_hasprocessingautomation, dpv_hasprohibition,
            dpv_hasprovisionby, dpv_hasprovisionbyjustification, dpv_hasprovisionmethod, dpv_hasprovisiontime,
            dpv_haspurpose,
        dpv_hasrecipient, dpv_hasrecipientdatacontroller, dpv_hasrecipientthirdparty, dpv_hasrecordofactivity,
            dpv_hasrelationwithdatasubject, dpv_hasrepresentative, dpv_hasrequeststatus, dpv_hasresponsibleentity,
            dpv_hasresidualrisk, dpv_hasright, dpv_hasrisk, dpv_hasrisklevel, dpv_hasriskassessment, dpv_hasrule,
        dpv_hasscale, dpv_hasscope, dpv_hassector, dpv_hassensitivitylevel, dpv_hasservice, dpv_hasserviceconsumer,
            dpv_hasserviceprovider, dpv_hasseverity, dpv_hasstatus, dpv_hasstorage, dpv_hasstoragecondition,
            dpv_hassubsidiary,
        dpv_hastechnicalmeasure, dpv_hastechnicalorganisationalmeasure, dpv_hasthirdcountry,
    ...
    // dpv tech
    dpv_tech_hasactor, dpv_tech_hasauditor,
    dpv_tech_hascapability, dpv_tech_hascommunicationmechanism, dpv_tech_hascustomer,
    dpv_tech_hasdeployer, dpv_tech_hasdeploymentlocation, dpv_tech_hasdesigner, dpv_tech_hasdeveloper, dpv_tech_hasdocumentation,
    dpv_tech_hasevaluator,
    dpv_tech_hasfunction,
    dpv_tech_hasinstaller, dpv_tech_hasintendeduse,
    dpv_tech_hasmaintainer, dpv_tech_hasmanufacturer, dpv_tech_hasmarketavailabilitystatus,
    dpv_tech_hasowner,
    dpv_tech_haspartner, dpv_tech_hasproducer, dpv_tech_hasprovider, dpv_tech_hasprovisionmethod, dpv_tech_hasprovisionstatus, dpv_tech_haspurchaser,
    dpv_tech_hassubject, dpv_tech_hassupplier, dpv_tech_hassystemintegrator,
    dpv_tech_hastrl,
    dpv_tech_hasuser,
