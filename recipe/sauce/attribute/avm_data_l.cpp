...
{   { { HTML_JUL16 }, { HTML_UNDEF }, elem_link, a_as },
    ...
    { { HTML_APR23 }, { HTML_UNDEF }, elem_link, a_fetchpriority },
    { { HTML_PLUS, HV_REQUIRED }, { XHTML_2_0 }, elem_link, a_href },
    { { HTML_JAN05 }, { HTML_DEC06 }, elem_link, a_href },
    { { HTML_JAN07, HV_REQUIRED }, { HTML_JUN19 }, elem_link, a_href },
    ...
    { { HTML_5_3 }, { HTML_JUL25 }, elem_link, a_ping },
    { { HTML_4_0, 0, HE_MOZILLA }, { HTML_JUL25 }, elem_link, a_prefetch },
    { { HTML_PLUS }, { HTML_DEC06 }, elem_link, a_rel },
    { { HTML_JAN07, HV_REQUIRED }, { HTML_DEC09 }, elem_link, a_rel },
