...
typedef enum {  cs_context,
                cs_adobe_standard_encoding, cs_adobe_symbol_encoding, cs_amiga_1251, cs_ansi_x3_110_1983, cs_ascii, cs_asmo_449, cs_axiom, cs_bocu_1, cs_brf, cs_bs_4730,
                cs_bs_viewdata, cs_big5, cs_cesu_8, cs_cp50220, cs_cp51932, cs_csa_z243_4_1985_1, cs_csa_z243_4_1985_2, cs_csa_z243_4_1985_gr, cs_csn_369103,
...
typedef enum { ecba_inherit, ecba_fixed, ecba_scroll } e_css_background_attachment;
typedef enum { ecbr_inherit, ecbr_no_repeat, ecbr_repeat, ecbr_repeat_x, ecbr_repeat_y } e_css_background_repeat;
...
typedef enum {  csc_aliceblue, csc_antiquewhite, csc_aqua, csc_aquamarine, csc_azure, csc_beige, csc_bisque, csc_black, csc_blanchedalmond, csc_blue,
                ...
                csc_activeborder, csc_activecaption, csc_appworkspace, csc_background, csc_buttonface, csc_buttonhighlight, csc_buttonshadow,csc_buttontext, csc_captiontext, csc_graytext,
                csc_highlight, csc_highlighttext, csc_inactiveborder, csc_inactivecaption, csc_inactivecaptiontext, csc_infobackground, csc_infotext, csc_menu, csc_menutext, csc_scrollbar,
                csc_threeddarkshadow, csc_threedface, csc_threedhighlight, csc_threedlightshadow, csc_threedshadow, csc_window, csc_windowframe, csc_windowtext } e_css_colour;
...
typedef enum {  ecd_inherit, ecd_block, ecd_compact, ecd_inline, ecd_inline_block, ecd_inline_table, ecd_list_item, ecd_marker, ecd_none,
                ecd_run_in, ecd_table, ecd_table_caption, ecd_table_cell, ecd_table_column, ecd_table_column_group,
                ecd_table_footer_group, ecd_table_header_group, ecd_table_row, ecd_table_row_group, } e_css_display;
...
typedef enum {  efn_none,
                ...
                efn_backdrop, efn_before, efn_blank,
                efn_checked, efn_cue, efn_cue_region, efn_current,
                efn_default, efn_defined, efn_dir, efn_disabled,
                efn_empty, efn_enabled,
                ...
                efn_indeterminate, efn_in_range, efn_invalid, efn_is,
                ...
                efn_only_child, efn_only_of_type, efn_optional, efn_out_of_range,
                ...
                efn_scope, efn_selection, efn_slotted, efn_spelling_error, efn_state,
                efn_target, efn_target_text, efn_target_within,
                efn_user_invalid,
                efn_valid, efn_visited,
                efn_where } e_css_fn;
...
typedef enum { ecp_absolute, ecp_fixed, ecp_inherit, ecp_relative, ecp_static } e_css_position;
typedef enum {  ec_unknown, ec_context, ec_inherit,
                ...
                ec_cap_height, ec_caption_side, ec_caret, ec_caret_colour, ec_caret_shape, ec_centre_line, ec_chains, ec_clear, ec_clip, ec_clip_path, ec_clip_rule, ec_colour,
                    ec_colour_adjust, ec_colour_interpolation_filters, ec_colour_scheme, ec_column_count, ec_column_fill, ec_column_gap, ec_column_rule, ec_column_rule_colour,
                ...
                ec_nav_down, ec_nav_left, ec_nav_right, ec_nav_up,
                ...
                ec_padding, ec_padding_block, ec_padding_block_end, ec_padding_block_start, ec_padding_bottom, ec_padding_inline, ec_padding_inline_end, ec_padding_inline_start,
                    ...
                    ec_play_during, ec_position, ec_print_colour_adjust,
                ec_quotes,
                ec_region_fragment, ec_resize, ec_rest, ec_rest_after, ec_rest_before, ec_richness, ec_right, ec_rotate, ec_row_gap, ec_ruby_align, ec_ruby_merge, ec_ruby_overhang,
                    ec_ruby_position, ec_running,
                ec_scale, ec_scroll_behavior, ec_scroll_margin, ec_scroll_margin_block, ec_scroll_margin_block_end, ec_scroll_margin_block_start, ec_scroll_margin_bottom,
                ...
                ec_tab_size, ec_table_layout, ec_text_align, ec_text_align_all, ec_text_align_last, ec_text_autospace, ec_text_combine_upright, ec_text_decoration,
                    ...
                    ec_text_emphasis_colour, ec_text_emphasis_position, ec_text_emphasis_skip, ec_text_emphasis_style, ec_text_group_align, ec_text_indent, ec_text_justify,
                    ec_text_orientation, ec_text_overflow, ec_text_resize, ec_text_shadow, ec_text_space_trim, ec_text_spacing, ec_text_spacing_trim, ec_text_transform, ec_text_underline_offset,
                    ec_text_underline_position, ec_text_wrap, ec_top, ec_topline, ec_transform, ec_transform_box, ec_transform_origin, ec_transform_style, ec_transition,
                    ec_transition_delay, ec_transition_duration, ec_transition_property, ec_transition_timing_function, ec_translate,
                ec_unicode_bidi, ec_unicode_range, ec_units_per_em, ec_user_select,
                ec_vertical_align, ec_view_timeline, ec_view_timeline_axis, ec_view_timeline_inset, ec_view_timeline_name, ec_view_transition_name, ec_visibility,
                ...
                // SVG
                ec_colour_interpolation, ec_colour_profile, ec_colour_rendering, ec_cx, ec_cy,
                ec_d, ec_enable_background, ec_glyph_orientation_horizontal, ec_kerning, ec_name, ec_paint_order, ec_pointer_events,
                ec_r, ec_rendering_intent, ec_rx, ec_ry, ec_shape_padding, ec_shape_rendering, ec_shape_subtract, ec_stop_colour, ec_stop_opacity,
                ec_text_anchor, ec_text_definition, ec_text_rendering, ec_vector_effect, ec_x, ec_y,
...
typedef enum { csp_inherit, csp_none, csp_normal, csp_spell_out } e_css_speak;
...
typedef enum {  ct_root, ct_whitespace, ct_comment, // root must be zero, all empty content must precede comment which must precede other values
                ...
                ct_at, ct_bang, ct_bar, ct_coco, ct_colon, ct_comma, ct_dash, ct_dollar, ct_dot, ct_eq, ct_gt, ct_lt, ct_hash, ct_hat, ct_plus, ct_semicolon, ct_slash, ct_splat, ct_squiggle,
...
typedef enum {  ed_mishmash, ed_dict, ed_tags, ed_1, ed_plus, ed_2, ed_3, ed_32, ed_4, ed_41, ed_x1, ed_x11, ed_x2,
                ...
                ed_css_1, ed_css_20, ed_css_21, ed_css_22, ed_css_media_4, ed_css_namespaces_3, ed_css_selectors_3, ed_css_selectors_4, ed_css_syntax,
...
{   he_context,
    ...
    he_www_authenticate, he_x400_content_identifier, he_x400_content_return, he_x400_content_type, he_x400_mts_identifier, he_x400_originator, he_x400_received, he_x400_recipients,
    he_x400_trace, he_x_archived_at, he_x_content_security_policy, he_x_content_type_options, he_x_dns_prefetch_control, he_x_forwarded_for, he_x_forwarded_host, he_x_forwarded_proto,
    he_x_frame_options, he_x_mittente, he_x_pgp_sig, he_x_ricevuta, he_x_riferimento_message_id, he_x_tiporicevuta, he_x_trasporto, he_x_ua_compatible, he_x_verificasicurezza,
    he_x_xss_protection, he_xref,
...
typedef enum { ir_auto, ir_optimisespeed, ir_optimisequality, ir_inherit } e_image_rendering;
...
typedef enum {  md_active, md_additive, md_all, md_and, md_any_hover, md_any_pointer, md_aspect_ratio, md_aural,
                ...
                md_scan, md_screen, md_scripting, md_scroll, md_slash, md_slow, md_space, md_speech, md_srgb, md_standalone, md_standard, md_subtractive,
                md_tty, md_tv,
                md_update,
...
{   nit_free,
    ...
    nit_not_not, nit_css_svg, nit_deprecated_media, nit_media_version, nit_media_ignored,
...
{   nm_none,
    nm_class_count, nm_class_decl_count, nm_class_decl_int, nm_class_int, nm_class_name, nm_class_title,
        ...
        nm_context_config, nm_context_copy, nm_context_corpus, nm_context_crosslinks, nm_context_css, nm_context_css_cascade, nm_context_css_colour,
        nm_context_css_extension, nm_context_css_media, nm_context_css_namespace, nm_context_css_selector, nm_context_css_style, nm_context_css_ui, nm_context_css_version, nm_context_custom_elements, nm_context_dc, nm_context_example,
        nm_context_export_root, nm_context_exports, nm_context_extensions, nm_context_ext_css, nm_context_foaf, nm_context_forward, nm_context_fred, nm_context_icu,
...
{   sty_context,
    ...
    sch_confirmaction, sch_consortium, sch_consumeaction, sch_contactpage, sch_contactpoint, sch_contactpointoption, sch_contagiousnesshealthaspect, sch_continent, sch_controlaction, sch_convenienceshop,
    ...
    sch_homeopathic, sch_male, sch_manuscript, sch_map, sch_mapcategorytype, sch_marryaction, sch_mass, sch_mathsolver, sch_maximumdoseschedule, sch_maytreathealthaspect, sch_measurementtypeenumeration, sch_mediagallery,
    ...
    sch_playaction, sch_playgameaction, sch_playground, sch_plumber, sch_podcastepisode, sch_podcastseason, sch_podcastseries, sch_podiatric, sch_policestation, sch_pond, sch_postaladdress, sch_postalcoderangespecification, sch_poster, sch_postoffice,
...
{   sp_context,
    ...
    sp_competencyrequired, sp_competitor, sp_composer, sp_comprisedof, sp_conditionsofaccess, sp_confirmationnumber, sp_connectedto, sp_constrainingproperty, sp_contactlesspayment, sp_contactoption, sp_contactpoint, sp_contactpoints, sp_contacttype,
    ...
    sp_countryofassembly, sp_countryoflastprocessing, sp_countryoforigin, sp_course, sp_coursecode,
    ...
    sp_labeldetails, sp_landlord, sp_language, sp_lastreviewed, sp_latitude, sp_layoutimage, sp_learningresourcetype, sp_leaselength, sp_legalname, sp_legalstatus, sp_legislationapplies, sp_legislationchanges, sp_legislationconsolidates, sp_legislationdate,
    ...
    sp_maincontentofpage, sp_mainentity, sp_mainentityofpage, sp_maintainer, sp_makesoffer, sp_manufacturer, sp_map, sp_maps, sp_maptype, sp_marginoferror, sp_masthead, sp_material, sp_materialextent, sp_mathexpression, sp_maximumattendeecapacity,
    sp_maximumenrollment, sp_maximumintake, sp_maximumphysicalattendeecapacity, sp_maximumvirtualattendeecapacity, sp_maxprice, sp_maxvalue, sp_mealservice, sp_measuredproperty, sp_measuredvalue, sp_measurementtechnique,sp_mechanismofaction,
    sp_mediaauthenticitycategory, sp_mediaitemappearance, sp_median, sp_medicalaudience, sp_medicalspeciality, sp_medicinesystem, sp_meetsemissionstandard, sp_member, sp_memberof, sp_members, sp_membershipnumber, sp_membershippointsearned,
    sp_memoryrequirements, sp_mentions, sp_menu, sp_menuaddon, sp_merchant, sp_merchantreturndays, sp_merchantreturnlink, sp_messageattachment, sp_mileagefromodometer, sp_minimummonthlyrepaymentamount, sp_minimumpaymentdue, sp_minprice, sp_minvalue,
    sp_missioncoverageprioritiespolicy, sp_model, sp_modeldate, sp_modifiedtime, sp_molecularformula, sp_molecularweight, sp_monoistopicmolecularweight, sp_monthsofexperience, sp_mpn, sp_multiplevalues, sp_muscleaction, sp_musicalkey,
    sp_musicarrangement, sp_musicby, sp_musiccompositionform, sp_musicgroupmember, sp_musicreleaseformat,
    ...
    sp_openinghours, sp_openinghoursspecification, sp_opens, sp_operatingsystem, sp_oponent, sp_opponent, sp_orderdate, sp_orderdelivery, sp_ordereditem, sp_orderitemnumber, sp_orderitemstatus, sp_ordernumber, sp_orderquantity, sp_orderstatus,
    sp_organiser, sp_origin, sp_originaddress, sp_originalmediacontentdescription, sp_originalmedialink, sp_originatesfrom, sp_outcome, sp_overdosage, sp_overview, sp_ownedfrom, sp_ownedto, sp_ownershipfundinginfo, sp_owns,

    sp_pageend, sp_pagestart, sp_pagination, sp_parent, sp_parentitem, sp_parentorganisation, sp_parents, sp_parentservice, sp_parenttaxon, sp_participant, sp_partofepisode, sp_partofinvoice, sp_partoforder, sp_partofseason, sp_partofseries, sp_partofsystem,
    sp_partoftrip, sp_partoftvseries, sp_partysize, sp_passengerprioritystatus, sp_passengersequencenumber, sp_pathophysiology, sp_pattern, sp_payload, sp_paymentaccepted, sp_paymentdue, sp_paymentduedate, sp_paymentmethod, sp_paymentmethodid,
    sp_paymentstatus, sp_paymenturl, sp_penciler, sp_percentile10, sp_percentile25, sp_percentile75, sp_percentile90, sp_performer, sp_performers, sp_performerin, sp_performtime, sp_permissions, sp_permissiontype, sp_permitaudience, sp_permittedusage,
    sp_petsallowed, sp_phase, sp_phonetictext, sp_photo, sp_photos, sp_physicalrequirement, sp_physiologicalbenefits, sp_pickuplocation, sp_pickuptime, sp_playersonline, sp_playertype, sp_playmode, sp_polygon, sp_population, sp_populationtype,
    sp_potentialuse, sp_position, sp_positivenotes, sp_possiblecomplication, sp_possibletreatment, sp_postalcode, sp_postalcodebegin, sp_postalcodeend, sp_postalcodeprefix, sp_postalcoderange, sp_postofficeboxnumber, sp_postop, sp_potentialaction, sp_predecessorof,
    ...
    sp_processorrequirements, sp_producer, sp_produces, sp_productgroupid, sp_productid, sp_productioncompany, sp_productiondate, sp_productreturndays, sp_productreturnlink, sp_productsupported, sp_proficiencylevel, sp_programmemembershipused, sp_programmename, sp_programminglanguage,
    ...
    sp_suggestedgender, sp_suggestedmaxage, sp_suggestedmeasurement, sp_suggestedminage, sp_suitablefordiet, sp_superevent, sp_supersededby, sp_supply, sp_supplyto, sp_supportingdata,
    ...
    sp_title, sp_titleeidr, sp_toccontinuation, sp_tocentry, sp_tolocation, sp_tongueweight, sp_tool, sp_torecipient, sp_torque, sp_totaljobopenings, sp_totalpaymentdue, sp_totalprice, sp_totaltime, sp_tourbookingpage, sp_touristtype, sp_track, sp_tracks, sp_trackingnumber,
...
typedef enum { es_undefined, es_catastrophic, es_error, es_warning, es_info, es_comment, es_debug, es_variable, es_structure, es_detail, es_splurge, es_all, es_silent, es_illegal } e_severity;
...
typedef enum {
    ...
    t_about, t_absolute_url, t_accept, t_accrual_method, t_accrual_periodicity, t_accrual_policy, t_accumulate, t_accumulate0, t_accumulate1,
        ...
        t_alignment_baseline, t_alignplus, t_angle, t_angle_a, t_angle_ai, t_angle_i, t_arabicenum, t_arabic_form, t_aria_autocomplete,
    ...
    t_cache, t_cachekey, t_calcmode, t_captionalign, t_capture, t_cc_permits, t_cc_prohibits, t_cc_requires, t_channelselector, t_char,
        ...
        t_colour_rendering, t_colour_scheme, t_colour_trans, t_colour_trans_i, t_colour_v, t_command, t_compact, t_comp_op, t_composite_operator, t_compositing, t_conlit,
        t_connect, t_content_encoding, t_content_encodings, t_content_type, t_context_menu, t_controlslist, t_cookie, t_cookieid, t_cookies,
        t_coordinatesystem, t_coords, t_corp, t_cors, t_country, t_cntype, t_crossout, t_csp, t_csp_ancestor, t_csp_directive, t_csp_keyword,
        t_csp_sauce, t_csp_source,
        t_css,
            t_css_aaalri, t_css_aai, t_css_absolute_size, t_css_all, t_css_all_2, t_css_appearance, t_css_attr,
                t_css_azimuth, t_css_azimuth_be, t_css_azimuth_e, t_css_azimuth_eb, t_css_azimuth_es, t_css_azimuth_lri,
            t_css_background, t_css_background_attachment, t_css_background_position, t_css_background_repeat, t_css_backval, t_css_bespoke,
            ...
            t_css_caret, t_css_caret_shape, t_css_clear, t_css_colour, t_css_colour_3, t_css_colour_a, t_css_content, t_css_content_base, t_css_content_enum, t_css_content_fn, t_css_content_twice, t_css_counter,
                t_css_counter_ii, t_css_counter_iin, t_css_counter_set, t_css_counters, t_css_cue, t_css_cues, t_css_cursor, t_css_cursor_e,
                t_css_cursor_url,
            t_css_display,
            t_css_earnest, t_css_elevation, t_css_elevation_e, t_css_empty_cells,
            t_css_font, t_css_font_families, t_css_font_size, t_css_font_style, t_css_font_style_e, t_css_font_weight, t_css_fn, t_css_frame,
            t_css_generic_family,
            t_css_id, t_css_image, t_css_inherit,
            t_css_kbd_lhs, t_css_kdb_nav, t_css_kbd_rhs,
            t_css_length, t_css_length_twice, t_css_length_a, t_css_length_ai, t_css_line_height, t_css_list_style, t_css_list_style_position,
                t_css_list_style_type, t_css_local_url, t_css_ls_val,
            t_css_margins, t_css_mark, t_css_marks, t_css_marx,
            t_css_nth, t_css_nth_oe,
            t_css_orientation, t_css_outline, t_css_outline_i, t_css_outline_style, t_css_outlines, t_css_overflow,
            t_css_pause, t_css_pause_i, t_css_pauses, t_css_pitch, t_css_pitch_e, t_css_play_during, t_css_play_during_mr, t_css_position,
                t_css_property,
            t_css_rect_ai, t_css_rect_fn, t_css_relative_size, t_css_resize,
            t_css_size, t_css_spacing, t_css_speak, t_css_speak_header, t_css_speak_numeral, t_css_speak_punctuation, t_css_speech_rate,
                t_css_speech_rate_e, t_css_src, t_css_statement,
    ...
    t_featurepolicy, t_figalign, t_filename, t_filesize, t_fill, t_fillanim, t_fill_opacity, t_fill_rule, t_fill_ve, t_filter_in, t_filterres,
        ...
        t_framespacing, t_frequency,
    t_gamut, t_gender, t_generic, t_glyphname, t_glyphnames, t_groupalign,
    t_halign, t_hash_ref, t_hash_fn, t_height, t_hex, t_hidden, t_hidden_ex, t_hour, t_hslafn, t_hslfn, t_html, t_html_boolean, t_httpequiv, t_hue, t_hv, t_hunit,
    ...
    t_lang, t_langq, t_langs, t_langqs, t_larnalign, t_layout, t_lcralign, t_lcraligns, t_lcrnalign, t_lcrd, t_lcrds, t_lcrdss, t_length, t_length_absolute,
        ...
        t_linkitself, t_linkparam, t_links, t_listtype, t_literal, t_loading, t_localfn, t_local_url, t_location, t_longdivstyle, t_loop, t_loopie, t_lraalign, t_lralign,
        t_lrnalign, t_lrnialign, t_lspace,
    t_mah, t_marked_up, t_marker, t_markerunits, t_mathalign, t_mathalign_n, t_mathaligns, t_mathclosure, t_mathdisplay, t_mathfontstyle, t_mathfontweight,
        ...
        t_mb, t_measure, t_measure_4, t_measure_a, t_measure_ai, t_measure_i, t_measure_in, t_measure_ni, t_measure_or_more, t_measures, t_measures_a, t_measures_i,
        t_media, t_media_display_mode, t_media_hover, t_media_inline, t_media_orientation, t_media_overflow, t_media_pointer, t_media_prefers, t_media_prefers_2,
        t_media_scripting, t_media_update, t_meetslice,
    ...
    t_q, t_quote_style,
    t_rap, t_rating, t_rdf_parsetype, t_rdfa_typeof, t_real, t_real_1_2, t_real_ai, t_real_i, t_real_ni, t_reals, t_referrer, t_refresh, t_refx, t_refy, t_regex, t_rel,
        ...
        t_result, t_reveal_trans, t_rgbafn, t_role, t_roles, t_roman_dsc, t_root_url, t_rotate, t_rotate_anim, t_rowscols,  t_rsvp, t_rules,
    t_sandbox, t_sandboxen, t_scan, t_scei, t_schema_type, t_scope, t_script, t_scrolling, t_second, t_setback_offset, t_settype, t_severity, t_sex, t_sgml,
        ...
        t_shape_uri, t_shape_rendering, t_shape_rcp, t_shadowinherit, t_short, t_side, t_size, t_size3,
        ...
        t_ssi_f, t_start, t_startend, t_stitchtiles, t_streamedcontents, t_ssi_include, t_ssi_set, t_ssi_sizefmt, t_step, t_style,
        t_svg_align, t_svg_baselineshift, t_svg_baseprofile, t_svg_clip, t_svg_colour_profile, t_svg_content, t_svg_direction, t_ltr_rtl, t_svg_display, t_svg_duration,
            t_svg_feature, t_svg_features, t_svg_fontstretch, t_svg_fontstretch_ff, t_svg_fontstyle, t_svg_fontstyle_ff, t_svg_fontvariant, t_svg_fontvariant_ff,
            t_svg_fontweight, t_svg_fontweight_ff, t_svg_fontweights, t_svg_host, t_svg_method, t_svg_mode, t_svg_name_iri, t_svg_overflow, t_svg_phase, t_svg_playbackorder,
            t_svg_profile_name, t_svg_rendering_intent, t_svg_shape, t_svg_shapefn, t_svg_side, t_svg_src, t_svg_svg, t_svg_time, t_svg_time_default, t_svg_time_inherit,
    ...
    t_tableframe, t_tablevalues, t_target, t_tbalign, t_tblri, t_tdscope, t_tel, t_tendstotype, t_text, t_text_decoration, t_textoverflow, t_text_rendering,
        ...
        t_transp, t_transparentsz, t_truefalseempty, t_turbulence_type, t_type, t_typeof, t_tz,
    t_ugeo, t_uid, t_unicode_bidi, t_unit, t_units, t_unsigned, t_unsigned_byte, t_unsigned_short, t_unsigned_1_or_2, t_un_ex, t_unsigned_dosh, t_uplr, t_urange,
