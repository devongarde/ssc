...
{   STANDARD_COLOURS (csc_, HTML_4_0),
    ...
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "activeborder", csc_activeborder },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "activecaption", csc_activecaption },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "appworkspace", csc_appworkspace },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "background", csc_background },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "buttonface", csc_buttonface },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "buttonhighlight", csc_buttonhighlight },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "buttonshadow", csc_buttonshadow },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 | H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "buttontext", csc_buttontext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "captiontext", csc_captiontext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 | H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "graytext", csc_greytext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 | H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "highlight", csc_highlight },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 | H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "highlighttext", csc_highlighttext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "inactiveborder", csc_inactiveborder },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "inactivecaption", csc_inactivecaption },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "inactivecaptiontext", csc_inactivecaptiontext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "infobackground", csc_infobackground },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "infotext", csc_infotext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "menu", csc_menu },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "menutext", csc_menutext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "scrollbar", csc_scrollbar },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "threeddarkshadow", csc_threeddarkshadow },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "threedface", csc_threedface },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "threedhighlight", csc_threedhighlight },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "threedlightshadow", csc_threedlightshadow },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "threedshadow", csc_threedshadow },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "window", csc_window },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "windowframe", csc_windowframe },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_3 }, { HTML_UNDEF }, "windowtext", csc_windowtext },

    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "accentcolor", csc_accentcolour },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "accentcolortext", csc_accentcolourtext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "activetext", csc_activetext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "buttonborder", csc_buttonborder },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "canvas", csc_canvas },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "canvastext", csc_canvastext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "field", csc_field },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "fieldtext", csc_fieldtext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "linktext", csc_linktext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "mark", csc_mark },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "marktext", csc_marktext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "selecteditem", csc_selecteditem },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "selecteditemtext", csc_selecteditemtext },
    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "visitedtext", csc_visitedtext },

    { { HTML_CSS, 0, 0, H2_CSS_COLOUR_4 }, { HTML_UNDEF }, "currentcolor", csc_currentcolour } };
