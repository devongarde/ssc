...
{   { { HTML_PLUS }, { HTML_UNDEF }, "!doctype", elem_faux_doctype, ns_default, EP_CLOSED | EP_TOP },
    ...
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "extensiondefs", elem_extensiondefs },
    ...
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "flowroot", elem_flowroot },
    ...
    { { HTML_3_2, HV_DEPRECATED4, HE_SVG_OLD_H | HE_SVG_10_11_2 }, { HTML_UNDEF }, "font", elem_font, ns_default, 0, EF_SPECIAL | EF_4_SPECIAL | EF_5_FLOW | EF_5_PHRASE },
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, "font-face", elem_fontface },
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, "font-face-format", elem_fontfaceformat },
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, "font-face-name", elem_fontfacename, ns_default, EP_CLOSED },
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, "font-face-src", elem_fontfacesrc },
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, "font-face-uri", elem_fontfaceuri },
    ...
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "hint", elem_hint, ns_default, EP_CLOSED, EF_SVG_DESC },
    ...
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "vectoreffect", elem_vectoreffect },
    ...
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "xa", elem_xa },
...
elem :: elem (nitpick& nits, const html_version& v, ns_ptr& nss, const ::std::string& x)
{   parse (nits, v, nss, x); }
...
bool elem::under_parse (nitpick& nits, const html_version& v, const ::std::string& el, const e_namespace n)
{   return symbol < html_version, e_element > :: parse (nits, v, el, n); }

bool elem::parse (nitpick& nits, const html_version& v, ns_ptr& nss, const ::std::string& x)
{   PRESUME (! x.empty (), __FILE__, __LINE__);
    ::std::string el (x), n;
    ns (examine_namespace (nits, v, nss, el, n));
