...
microdata_structure schema_structure [] =
{
    ...
    // microformats v1
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_adr, mp_country_name },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_adr, mp_extended_address, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_adr, mp_locality },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_adr, mp_post_office_box, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_adr, mp_postal_code },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_adr, mp_region },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_adr, mp_street_address, SS_REPEATABLE },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_geo, mp_latitude }, // looks like MF only, not living standard, but ...
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_geo, mp_longitude }, // looks like MF only, not living standard, but ...

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haggregate, mp_best },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haggregate, mp_count },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haggregate, mp_item, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haggregate, mp_rating, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haggregate, mp_summary },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haggregate, mp_votes },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haggregate, mp_worst },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_author, SS_REQUIRED | SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_bookmark, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_category, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_entry_content, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_entry_summary, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_entry_title, SS_REQUIRED | SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_feed_category },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_hentry, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_label, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_published, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_tag, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_tags },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_term, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_updated, SS_REQUIRED | SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_value, SS_REPEATABLE }, // XMDP
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hatom, mp_value_title, SS_REPEATABLE }, // XMDP

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_album },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_amount },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_category, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_contributor },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_currency },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_description },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_duration },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_enclosure },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_fn },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_h },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_item },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_min },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_payment, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_position },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_photo, SS_REPEATABLE  },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_published },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_price },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_s },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_haudio, mp_sample, SS_REPEATABLE },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_attach },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_attendee },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_category },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_class },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_comment },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_contact },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_created },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_description },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_dtstart, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_dtend },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_duration },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_exdate },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_geo },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_last_modified },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_latitude },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_location },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_longitude },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_method }, // XMDP
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_organiser },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_partstat },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_rdate },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_role },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_resources },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_rrule },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_sequence },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_status },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_summary, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_transp },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_uid },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_url },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_value }, // XMDP
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcalendar, mp_value_title }, // XMDP

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_author, SS_REQUIRED | SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_bookmark, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_entry_content, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_entry_summary, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_entry_title, SS_REQUIRED | SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_published, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_tag, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_tags },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hentry, mp_updated, SS_REQUIRED | SS_REPEATABLE },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_amount },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_currency },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_description, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_dtlisted },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_dtexpired },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_info, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_item },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_lister, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_listing_action },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_location },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_permalink },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_price },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_summary },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_tag },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_tags, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_type },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hlisting, mp_version },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hmedia, mp_contributor, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hmedia, mp_enclosure, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hmedia, mp_fn, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hmedia, mp_photo },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hmedia, mp_player },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hnews, mp_dateline },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hnews, mp_entry },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hnews, mp_geo },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hnews, mp_hentry },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hnews, mp_item_licence },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hnews, mp_principles },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hnews, mp_source_org, SS_REQUIRED },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_availability },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_brand },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_category, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_description },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_fn, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_identifier },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_listing, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_photo, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_price },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_review, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hproduct, mp_url },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_author, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_duration, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_fn, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_h, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_ingredient, SS_REQUIRED | SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_instructions },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_licence, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_min, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_nutrition, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_photo, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_published },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_s, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_summary },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_tag, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_tags },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_type },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_value },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hrecipe, mp_yield },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_affliation, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_contact, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_education, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_experience, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_include },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_publications, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_skill, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_summary },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_value },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hresume, mp_value_title },

    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_best },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_description },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_dtreviewed },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_fn },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_item, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_licence },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_reviewer },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_permalink },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_photo },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_rating },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_self },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_summary },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_tag, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_tags },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_type },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_url },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_version },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_worst },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_value },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hreview, mp_value_title },
    ...
    // the MF fields.
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_additional_name, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_adr, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_agent, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_anniversary },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_bday },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_categories, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_category }, // looks like MF only, not living standard, but ...
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_class }, // looks like MF only, not living standard, but ...
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_country_name },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_email, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_extended_address, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_family_name, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_fn, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_gender_identity },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_geo, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_given_name, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_honourific_prefix, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_honourific_suffix, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_impp, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_key }, // looks like MF only, not living standard, but ...
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_kind },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_lang, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_latitude }, // looks like MF only, not living standard, but ...
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_locality },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_logo, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_longitude }, // looks like MF only, not living standard, but ...
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_mailer }, // looks like MF only, not living standard, but ...
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_member, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_n, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_nickname, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_note, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_org, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_organisation_name },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_organisation_unit, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_photo, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_post_office_box, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_postal_code },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_region },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_rel },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_related, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_rev, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_role, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_sex },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_sort_string },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_sound, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_street_address, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_tel, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_title, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_type, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_tz, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_uid },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_url, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_value },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mft_hcard, mp_value_title },

    // living standard
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_attach, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_categories, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_class },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_comment, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_contact, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_created },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_description },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_dtstart, SS_REQUIRED },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_dtend },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_duration },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_exdate, SS_REPEATABLE },
    ...
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_rdate, SS_REPEATABLE },
    { { mdr_microformats, 1, 0 }, { 0, 0 }, mf_vevent, mp_resources, SS_REPEATABLE },
    ...
    // microformats v2
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_altitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_country_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_extended_address },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_region },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_geo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_label },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_latitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_locality },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_longitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_post_office_box },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_postal_code },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hadr, mp2_p_street_address },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hbreadcrumb, mp2_h_breadcrumb },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hbreadcrumb, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hbreadcrumb, mp2_u_url },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_dt_anniversary },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_dt_bday },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_dt_rev },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_additional_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_adr },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_altitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_category },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_country_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_extended_address },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_family_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_region },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_gender_identity },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_geo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_given_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_honourific_prefix },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_honourific_suffix },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_job_title },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_label },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_latitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_locality },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_longitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_nickname },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_note },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_post_office_box },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_postal_code },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_org },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_organisation_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_organisation_unit },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_role },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_sex },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_sort_string },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_street_address },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_tel },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_p_tz },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_email },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_geo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_impp },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_logo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_key },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_photo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_sound },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_uid },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcard, mp2_u_url },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcite, mp2_dt_accessed },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcite, mp2_p_author },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcite, mp2_p_content },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcite, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcite, mp2_p_publication },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcite, mp2_dt_published },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcite, mp2_u_uid },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hcite, mp2_u_url },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_audio },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_author },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_bookmark_of },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_category },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_comment },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_e_content },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_duration },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_featured },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_in_reply_to },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_like },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_like_of },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_listen_of },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_latitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_location },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_longitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_photo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_dt_published },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_repost },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_repost_of },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_read_of },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_read_of },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_rsvp },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_size },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_p_summary },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_syndication },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_translation_of },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_uid },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_dt_updated },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_url },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_video },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hentry, mp2_u_watch_of },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_p_attendee },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_p_category },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_p_description },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_dt_duration },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_e_content },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_dt_end },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_p_location },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_dt_start },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_p_summary },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hevent, mp2_u_url },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hfeed, mp2_p_author },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hfeed, mp2_h_entry },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hfeed, mp2_p_entry },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hfeed, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hfeed, mp2_u_photo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hfeed, mp2_p_summary },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hfeed, mp2_u_url },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hgeo, mp2_p_altitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hgeo, mp2_p_latitude },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hgeo, mp2_p_longitude },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hitem, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hitem, mp2_u_photo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hitem, mp2_u_url },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hlisting, mp2_p_action },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hlisting, mp2_p_category },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hlisting, mp2_dt_expired },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hlisting, mp2_dt_listed },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hlisting, mp2_p_lister },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hlisting, mp2_p_price },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hlisting, mp2_u_url },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_p_brand },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_p_category },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_e_description },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_u_identifier },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_u_photo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_p_price },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_p_review },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hproduct, mp2_u_url },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_p_author },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_p_category },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_dt_duration },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_p_ingredient },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_e_instructions },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_p_nutrition },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_u_photo },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_dt_published },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_p_summary },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hrecipe, mp2_p_yield },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hresume, mp2_p_affiliation },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hresume, mp2_p_contact },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hresume, mp2_p_education },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hresume, mp2_p_experience },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hresume, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hresume, mp2_p_skill },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hresume, mp2_p_summary },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_author },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_best },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_category },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_e_content },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_dt_published },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_item },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_location },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_rating },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_summary },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_u_syndication },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_u_url },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_hreview, mp2_p_worst },

    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_haggregate, mp2_p_average },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_haggregate, mp2_p_best },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_haggregate, mp2_p_count },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_haggregate, mp2_p_item },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_haggregate, mp2_p_name },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_haggregate, mp2_p_votes },
    { { mdr_microformats, 2, 0 }, { 0, 0 }, mft2_haggregate, mp2_p_worst },
