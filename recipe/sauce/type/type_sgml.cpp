...
{   { { HTML_UNDEF }, { HTML_UNDEF },  "html", doc_html },
    ...
    { { HTML_MATH4, 0, HE_MATH_4 }, { HTML_UNDEF }, "-//W3C//DTD MathML 4.0//EN", doc_math4 },
    { { HTML_MATH4, 0, HE_MATH_4 }, { HTML_UNDEF }, "-//W3C//ENTITIES MathML 4.0 Qualified Names 1.0//EN", doc_math4 },
    { { HTML_MATH3, 0, HE_MATH_3 }, { HTML_UNDEF }, "-//W3C//DTD MathML 3.0//EN", doc_math3 },
    { { HTML_MATH3, 0, HE_MATH_3 }, { HTML_UNDEF }, "-//W3C//ENTITIES MathML 3.0 Qualified Names 1.0//EN", doc_math3 },
    { { HTML_MATH3, 0, HE_MATH_3 }, { HTML_UNDEF }, "-//W3C//ENTITIES HTML MathML Set//EN//XML", doc_math3 },
    { { HTML_MATH2, 0, HE_MATH_2 }, { HTML_UNDEF }, "-//W3C//DTD MathML 2.0//EN", doc_math2 },
    { { HTML_MATH2, 0, HE_MATH_2 }, { HTML_UNDEF }, HTTP_W3 "/Math/DTD/mathml2/mathml2.dtd", doc_math2 },
    { { HTML_MATH2, 0, HE_MATH_2 }, { HTML_UNDEF }, HTTPS_W3 "/Math/DTD/mathml2/mathml2.dtd", doc_math2 },
    { { HTML_MATH1, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTP_W3 "/Math/DTD/mathml1/mathml.dtd", doc_math1 },
    { { HTML_MATH1, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTPS_W3 "/Math/DTD/mathml1/mathml.dtd", doc_math1 },
    { { HTML_MATH1, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTP_W3 "/TR/REC-MathML-19980407", doc_math1 },
    { { HTML_MATH1, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTPS_W3 "/TR/REC-MathML-19980407", doc_math1 },

    { { XHTML_1_0, 0, HE_RDF_1_0 }, { HTML_UNDEF }, "-//W3C//DTD XHTML+RDFa 1.0//EN", doc_rdfa_1_0 },
    { { XHTML_1_0, 0, HE_RDF_1_0 }, { HTML_UNDEF }, HTTP_W3 "/MarkUp/DTD/xhtml-rdfa-1.dtd", doc_rdfa_1_0 },
    { { XHTML_1_0, 0, HE_RDF_1_0 }, { HTML_UNDEF }, HTTPS_W3 "/MarkUp/DTD/xhtml-rdfa-1.dtd", doc_rdfa_1_0 },
    ...
    { { XHTML_1_1, 0, HE_MATH_2 | HE_SVG_10 }, { HTML_UNDEF }, "-//W3C//DTD XHTML 1.1 plus MathML 2.0 plus SVG 1.0//EN", doc_compound },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_SVG_10 }, { HTML_UNDEF }, HTTP_W3 "/2002/04/xhtml-math-svg/xhtml-math-svg.dtd", doc_compound },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_SVG_10 }, { HTML_UNDEF }, HTTPS_W3 "/2002/04/xhtml-math-svg/xhtml-math-svg.dtd", doc_compound },

    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, "-//W3C//DTD SVG 2.0//EN", doc_svg2 },
    ...
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, "-//W3C//DTD SVG 1.0//EN", doc_svg1 },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, HTTP_W3 "/TR/2001/REC-SVG-20010904/DTD/svg10.dtd", doc_svg1 },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, HTTPS_W3 "/TR/2001/REC-SVG-20010904/DTD/svg10.dtd", doc_svg1 },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, "-//W3C//DTD SVG July 1999//EN", doc_svg1 },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, HTTP_W3 "/Graphics/SVG/svg-19990706.dtd", doc_svg1 },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, HTTPS_W3 "/Graphics/SVG/svg-19990706.dtd", doc_svg1 },
