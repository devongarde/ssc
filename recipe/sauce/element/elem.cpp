...
{   { { HTML_PLUS }, { HTML_UNDEF }, "!doctype", elem_faux_doctype, ns_default, EP_CLOSED | EP_TOP },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "abs", elem_abs, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "and", elem_and, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "approx", elem_approx, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "arccos", elem_arccos, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arccosh", elem_arccosh, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arccot", elem_arccot, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arccoth", elem_arccoth, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arccsc", elem_arccsc, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arccsch", elem_arccsch, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arcsec", elem_arcsec, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arcsech", elem_arcsech, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "arcsin", elem_arcsin, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arcsinh", elem_arcsinh, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "arctan", elem_arctan, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "arctanh", elem_arctanh, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_2_0, HV_RFC_1980 | HV_NOT30 }, { HTML_UNDEF }, "area", elem_area, ns_default, EP_CLOSED, EF_5_FLOW | EF_5_PHRASE },
    { { HTML_PLUS, 0, HE_MATH_2 }, { HTML_UNDEF }, "arg", elem_arg, ns_default, 0, EF_EMPH | EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "card", elem_card, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "cartesianproduct", elem_cartesianproduct, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_2_0, HV_DEPRECATED23 }, { HTML_2_0 }, "cdata", elem_cdata },  // mentioned in RFC 2070
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "ceiling", elem_ceiling, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "conjugate", elem_conjugate, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_5_0, 0, HE_WEBCOMP }, { HTML_UNDEF }, "content", elem_content, ns_default, EP_CLOSED },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "cos", elem_cos, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "cosh", elem_cosh, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "cot", elem_cot, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "coth", elem_coth, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_3_0 }, { HTML_3_0 }, "credit", elem_credit },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "csc", elem_csc, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "csch", elem_csch, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "csymbol", elem_csymbol, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "curl", elem_curl, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "declare", elem_declare, ns_default, 0, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "determinant", elem_determinant, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "diff", elem_diff, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "divergence", elem_divergence, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "divide", elem_divide, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "eq", elem_eq, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "equivalent", elem_equivalent, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "exists", elem_exists, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_1, 0, HE_SVG_1_2_FULL }, { HTML_UNDEF }, "extensiondefs", elem_extensiondefs },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "exp", elem_exp, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "factorial", elem_factorial, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "factorof", elem_factorof, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "floor", elem_floor, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "forall", elem_forall, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "gcd", elem_gcd, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "geq", elem_geq, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "grad", elem_grad, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "gt", elem_gt, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "imaginary", elem_imaginary, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "implies", elem_implies, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "in", elem_in, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "int", elem_int, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "intersect", elem_intersect, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "interval", elem_interval, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "inverse", elem_inverse, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "laplacian", elem_laplacian, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_2_0, 0, HE_NETSCAPE }, { HTML_3_2 }, "layer", elem_layer },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "lcm", elem_lcm, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_3_0 }, { HTML_3_0 }, "left", elem_left, ns_default, EP_CLOSED },
    { { HTML_4_0 }, { HTML_UNDEF }, "legend", elem_legend },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "leq", elem_leq, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_3_0 }, { HTML_3_0 }, "lh", elem_lh },
    { { HTML_TAGS }, { HTML_UNDEF }, "li", elem_li, ns_default, EP_UNCLOSED1T, EF_X2_STRUCT | EF_X2_LIST },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "limit", elem_limit, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "ln", elem_ln, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_1, 0, HE_SVG_1_2_FULL }, { HTML_UNDEF }, "loc", elem_loc },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "log", elem_log, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "lt", elem_lt, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "max", elem_max, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "mean", elem_mean, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "median", elem_median, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "min", elem_min, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "minus", elem_minus, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "mode", elem_mode, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "moment", elem_moment, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "momentabout", elem_momentabout, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "neq", elem_neq, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "not", elem_not, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_PLUS, HV_NOT2 }, { HTML_3_0 }, "note", elem_note, ns_default, 0, EF_BLOK | EF_3_BLOCK },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "notin", elem_notin, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "notprsubset", elem_notprsubset, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "notsubset", elem_notsubset, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "or", elem_or, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "otherwise", elem_otherwise, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "outerproduct", elem_outerproduct, ns_default, 0, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "partialdiff", elem_partialdiff, ns_default, EP_CLOSED, EF_X_MATH },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "plus", elem_plus, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "power", elem_power, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "product", elem_product, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "prsubset", elem_prsubset, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "quotient", elem_quotient, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "real", elem_real, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "rem", elem_rem, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "scalarproduct", elem_scalarproduct, ns_default, 0, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "sdev", elem_sdev, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "sec", elem_sec, ns_default, 0, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "sech", elem_sech, ns_default, 0, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "selector", elem_selector, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "setdiff", elem_setdiff, ns_default, 0, EF_M_CONTENT },
    { { HTML_5_0, 0, HE_WEBCOMP }, { HTML_UNDEF }, "shadow", elem_shadow },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "sin", elem_sin, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "sinh", elem_sinh, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "subset", elem_subset, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "sum", elem_sum, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "tan", elem_tan, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "tanh", elem_tanh, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "times", elem_times, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "transpose", elem_transpose, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "union", elem_union, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "variance", elem_variance, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 | HE_M2_DEPRECAT }, { HTML_UNDEF }, "vector", elem_vector, ns_default, 0, EF_M_CONTINPRES },
    { { XHTML_1_1, 0, HE_SVG_1_2_FULL }, { HTML_UNDEF }, "vectoreffect", elem_vectoreffect },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "vectorproduct", elem_vectorproduct, ns_default, 0, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "xor", elem_xor, ns_default, EP_CLOSED, EF_M_CONTENT }
};
