...
template < > class type_master < t_alignment_baseline > : public enum_n < t_alignment_baseline, e_alignment_baseline > { };
...
template < > class type_master < t_baselineshift > : public enum_n < t_baselineshift, e_baselineshift > { };
...
template < > class type_master < t_comp_op > : public enum_n < t_comp_op, e_comp_op > { };
...
template < > class type_master < t_font_enum > : public enum_n < t_font_enum, e_font_enum > { };
template < > class type_master < t_font_variant_2 > : public enum_n < t_font_variant_2, e_font_variant_2 > { };
template < > class type_master < t_font_variant_caps > : public enum_n < t_font_variant_caps, e_font_variant_caps > { };
template < > class type_master < t_font_variant_east_asian > : public enum_n < t_font_variant_east_asian, e_font_variant_east_asian > { };
template < > class type_master < t_font_variant_ligature > : public enum_n < t_font_variant_ligature, e_font_variant_ligature > { };
...
template < > class type_master < t_page_orientation > : public enum_n < t_page_orientation, e_page_orientation > { };
...
template < > class type_master < t_rendering_in_tents > : public enum_n < t_rendering_in_tents, e_rendering_in_tents > { };
...
template < > class type_master < t_smei > : public enum_n < t_smei, e_smei > { };
...
template < > class type_master < t_svg_fontstyle > : public enum_n < t_svg_fontstyle, e_svg_fontstyle > { };
...
template < > class type_master < t_text_decoration > : public enum_n < t_text_decoration, e_text_decoration > { };
template < > class type_master < t_text_rendering > : public enum_n < t_text_rendering, e_text_rendering > { };
...
template < > class type_master < t_vertical_align_enum > : public enum_n < t_vertical_align_enum, e_vertical_align_enum > { };
