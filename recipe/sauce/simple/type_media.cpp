...
{   { { HTML_4_0, 0, 0, H2_CSS_MEDIA }, { HTML_UNDEF }, "(", md_brac },
    ...
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "max-performance", md_max_performance, ns_default, CF_MEDIA_PROPERTY },
    ...
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "min-performance", md_min_performance, ns_default, CF_MEDIA_PROPERTY },
    ...
    { { HTML_4_0, 0, HE_BESPOKE, H2_CSS_MEDIA | H2_CSS_COND_RULE }, { HTML_UNDEF }, "-moz-device-pixel-ratio", md_moz_device_pixel_ratio, ns_default, CF_MEDIA_PROPERTY },
    { { HTML_4_0, 0, HE_BESPOKE, H2_CSS_MEDIA | H2_CSS_COND_RULE }, { HTML_UNDEF }, "-moz-platform", md_moz_platform, ns_default, CF_MEDIA_PROPERTY },
    { { HTML_4_0, 0, HE_BESPOKE, H2_CSS_MEDIA | H2_CSS_COND_RULE }, { HTML_UNDEF }, "-moz-device-windows-glass", md_moz_windows_glass, ns_default, CF_MEDIA_PROPERTY },
