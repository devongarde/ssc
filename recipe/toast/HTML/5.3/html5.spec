-N 1 -f ../toast/HTML/5.3/html5.conf
...
PASS ../toast/HTML/5.3/example-2.html
2 naughty_lang
6 unrecognised_value
...
PASS ../toast/HTML/5.3/example-4.html
0 title_required
...
PASS ../toast/HTML/5.3/example-5.html
0 title_required
2 inserted_missing_parent missing_close naughty_lang
14 missing_close
...
PASS ../toast/HTML/5.3/html5-bad.html
2 naughty_lang
...
49 missing_open
50 missing_open
52 attribute_unrecognised unrecognised_attribute unrecognised_value
54 inserted_missing_closure
56 unrecognised_value
57 attributes_on_closure
...
64 attribute_required url_not_found naughty_alt
66 missing_close inserted_missing_closure missing_open
78 url_not_found
81 url_not_found
...
1540 url_not_found
1541 url_not_found
1545 inserted_missing_closure inserted_missing_closure

PASS ../toast/HTML/5.3/html5-good.html
2 naughty_lang
...
PASS ../toast/HTML/5.3/html5-legacy.html
2 naughty_lang

PASS ../toast/HTML/5.3/template-1.html
2 naughty_lang

PASS ../toast/HTML/5.3/template-2.html
2 naughty_lang

PASS ../toast/HTML/5.3/template-3.html
1 presume_html_1 attribute_unrecognised_here unrecognised_attribute

PASS ../toast/HTML/5.3/template-4.html
...
PASS ../toast/HTML/5.3/math-example-1.html
3 naughty_lang
...
section#public 0 1
select#unittype 0 1
select#unittype2 0 1
select#unittype3 0 1
span#msg1 0 1
span#msg2 0 1
span#msg3 0 1
template#fred 0 1
