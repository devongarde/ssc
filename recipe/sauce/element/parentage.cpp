...
{   { { HTML_PLUS }, { HTML_PLUS }, elem_a, elem_em },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_details, elem_summary },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_details, elem_undefined, 0, EF_4_FLOW },
...
//    { { HTML_JUL20 }, { HTML_UNDEF }, elem_menu, elem_li },
    ...
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_col },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_figcaption },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_legend },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_li },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_option },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_optgroup },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_param },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_rb },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_rp },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_rt },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_rtc },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_source },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_track },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_colgroup },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_tbody },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_tfoot },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_thead },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_tr },
    { { HTML_JUL13 }, { HTML_5_1 }, elem_template, elem_undefined, 0, EF_METADATA | EF_5_FLOW | EF_5_SCRIPT },
