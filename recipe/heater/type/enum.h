...
{   nm_none,
    nm_class_name, nm_class_count, nm_class_int, nm_compile_time, nm_config,
        ...
        nm_context_export_root, nm_context_exports, nm_context_mention_extension, nm_context_extensions, nm_context_fe, nm_context_filename, nm_context_foaf,
        ...
        nm_context_md_export, nm_context_mention_datapath, nm_context_mention_header, nm_context_mention_notify, nm_context_mention_process,
        nm_context_mention_secret, nm_context_mention_sender, nm_context_mention_stub, nm_context_mention_templates, nm_context_mention_user,
        nm_context_mention_write_path, nm_context_mentions, nm_context_meta, nm_context_mf_export, nm_context_mf_verify, nm_context_mf_version,
...
{   sty_context,
    ...
    // gs1
    gs1s_additionalproductclassificationdetails, gs1s_additivedetails, gs1s_ai, gs1s_allergendetails, gs1s_allergentypecode, gs1s_allergentypecode_13_bis_24_diaminophenoxypropane,
    ...
    gs1s_authenticitydetails, gs1s_awardprizedetails, gs1s_beverage,
    gs1s_brand, gs1s_certificationdetails, gs1s_cheesefirmnesscode,
    ...
    gs1s_colourcodelist_ncs, gs1s_colourcodelist_nrf, gs1s_colourcodelist_pantone_hexachrome, gs1s_colourcodelist_pantone_matching,
    gs1s_colourcodelist_pantone_process_colour, gs1s_colourcodelist_pantone_textile, gs1s_colourcodelist_ral, gs1s_colourcodelist_seller, gs1s_colourcodelistcode,
    ...
    gs1s_consumersalesconditionscode_restricted_to_sell_16, gs1s_consumersalesconditionscode_restricted_to_sell_18, gs1s_consumersalesconditionscode_restricted_to_sell_21,    gs1s_contactpoint, gs1s_country, gs1s_diettypecode,
    gs1s_diettypecode_coeliac, gs1s_diettypecode_free_from_gluten, gs1s_diettypecode_halal, gs1s_diettypecode_kosher, gs1s_diettypecode_organic,
    ...
    gs1s_foodbeveragetargetusecode_snack, gs1s_foodbeveragetargetusecode_unclassified,
    gs1s_foodbeveragetobaccoingredientdetails, gs1s_foodbeveragetobaccoproduct, gs1s_footwear, gs1s_footwearfasteningtypecode,
    ...
    gs1s_measurementprecisioncode, gs1s_measurementprecisioncode_approximately, gs1s_measurementprecisioncode_exact,
    gs1s_meatpoultry, gs1s_milkbuttercreamyogurtcheeseeggssubstitutes,
    gs1s_nonbinarylogiccode, gs1s_nutrientbasisquantitycode, gs1s_nutritionalclaimtypecode,
    ...
    gs1s_nutritionalclaimtypecode_with_no_added_sugars, gs1s_nutritionmeasurementtype, gs1s_offer, gs1s_offerredemptiontypecode,
    ...
    gs1s_packagingdetails, gs1s_packagingfeaturecode,
    ...
    gs1s_packagingrecyclingprocesstypecode, gs1s_packagingrecyclingschemecode,
    ...
    gs1s_pricespecification, gs1s_product, gs1s_productyielddetails, gs1s_productyieldtypecode,
    ...
    gs1s_referencedfiletypecode_warranty_information, gs1s_referencedfiletypecode_website,
    ...
    gs1s_targetmarketdetails, gs1s_textilematerialdetails,
    gs1s_tradechannelcode, gs1s_tradechannelcode_instore_only, gs1s_tradechannelcode_omnichannel, gs1s_tradechannelcode_online_only,
    ...
    gs1s_uppertypecode_unclassified, gs1s_warrantypromise, gs1s_wearableproduct,
    ...
    sch_frontwheeldriveconfiguration, sch_fullrefund, sch_fullgameavailability, sch_fundingagency, sch_fundingscheme, sch_fungus, sch_furniturestore,

    sch_game, sch_gameavailabilityenumeration, sch_gameplaymode, sch_gameserver, sch_gameserverstatus, sch_gardenstore, sch_gasstation, sch_gastroenterologic, sch_gatedresidencecommunity, sch_gendertype, sch_generalcontractor,
    ...
    sch_healthcareconsideration, sch_healthclub, sch_healthtopiccontent, sch_hearingimpairedsupported, sch_highschool, sch_hindudiet, sch_hindutemple, sch_hobbyshop, sch_homeandconstructionbusiness, sch_homegoodsstore, sch_hospital,
    ...
    sch_misconceptionshealthaspect, sch_missingcontext, sch_mixedeventattendancemode, sch_mixtapealbum, sch_molecularentity, sch_mobileapplication, sch_mobilephonestore, sch_mobilewebplatform, sch_monday, sch_monetaryamount, sch_monetaryamountdistribution,
    ...
    sch_readpermission, sch_realestateagent, sch_realestatelisting, sch_realitybased, sch_rearwheeldriveconfiguration, sch_receiveaction, sch_recipe, sch_recommendation, sch_recommendeddoseschedule, sch_recruiting, sch_recyclingcentre, sch_reducedrelevanceforchildrenconsideration,
    ...
    sch_selfcarehealthaspect, sch_selfstorage, sch_sellaction, sch_sendaction, sch_series, sch_service, sch_servicechannel, sch_sexualcontentconsideration, sch_shareaction, sch_sheetmusic, sch_shippingdeliverytime, sch_shippingratesettings, sch_shoestore,
...
{   sp_context,
    ...
    gs1p_chloridepernutrientbasis, gs1p_cholesterolpernutrientbasis, gs1p_chromiumpernutrientbasis, gs1p_clothingcut, gs1p_collartype, gs1p_colourcode,
    ...
    gs1p_pantothenicacidpernutrientbasis, gs1p_paymentlink, gs1p_paymentterms, gs1p_percentageofalcoholbyvolume, gs1p_phosphoruspernutrientbasis, gs1p_pip,
    gs1p_polyolspernutrientbasis, gs1p_polyunsaturatedfatpernutrientbasis, gs1p_postofficeboxnumber, gs1p_postalcode, gs1p_potassiumpernutrientbasis, gs1p_preparationcode,
    ...
    gs1p_promotion, gs1p_proteinpernutrientbasis, gs1p_provenancestatement, gs1p_purchasesuppliesoraccessories, gs1p_qualifyingbrandname, gs1p_qualifyinggpcs,
    ...
    gs1p_recallstatus, gs1p_recipeinfo, gs1p_referencedfile, gs1p_referencedfileeffectiveenddatetime, gs1p_referencedfileeffectivestartdatetime, gs1p_referencedfilesize,
    ...
    gs1p_sportingactivitytype, gs1p_starchpernutrientbasis, gs1p_statisticinfo, gs1p_streetaddress, gs1p_styledescription, gs1p_subbrandname, gs1p_sugarspernutrientbasis,
    ...
    sp_isinvolvedinbiologicalprocess, sp_islocatedinsubcellularlocation, sp_islivebroadcast, sp_iso6523code, sp_ispartof, sp_ispartofbiochementity,
    ...
    sp_processorrequirements, sp_producer, sp_productgroupid, sp_productid, sp_productioncompany, sp_productiondate, sp_productreturndays, sp_productreturnlink, sp_productsupported, sp_proficiencylevel, sp_programmemembershipused, sp_programmename, sp_programminglanguage,
