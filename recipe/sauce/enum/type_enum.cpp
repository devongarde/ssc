...
{   { { HTML_CSS, 0, HE_SVG_10_11, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "after-edge", ab_afteredge },
    { { HTML_CSS, 0, HE_SVG_10_11_2, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "alphabetic", ab_alphabetic },
    { { HTML_CSS, 0, HE_SVG_10_11, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "auto",  ab_auto },
    { { HTML_CSS, 0, HE_SVG_10_11_2, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "baseline", ab_baseline },
    { { HTML_CSS, 0, HE_SVG_10_11, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "before-edge", ab_beforeedge },
    { { HTML_CSS, 0, HE_SVG_10 | HE_SVG_DEPR_10 }, { HTML_UNDEF }, "bottom", ab_bottom },
    { { HTML_CSS, 0, HE_SVG_11_2, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "central", ab_central },
    { { HTML_CSS, 0, HE_SVG_10_11, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "hanging", ab_hanging },
    { { HTML_CSS, 0, HE_SVG_10_11_2, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "ideographic", ab_ideographic },
    { { HTML_CSS, 0, HE_SVG_10, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "inherit", ab_inherit },
    { { HTML_CSS, 0, HE_SVG_10_11_2, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "mathematical", ab_mathematical },
    { { HTML_CSS, 0, HE_SVG_10_11_2, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "middle", ab_middle },
    { { HTML_CSS, 0, HE_SVG_10_11_20 | HE_SVG_DEPR_20, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "text-after-edge", ab_textafteredge },
    { { HTML_CSS, 0, HE_SVG_10_11_20 | HE_SVG_DEPR_20, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "text-before-edge", ab_textbeforeedge },
    { { HTML_CSS, 0, HE_SVG_2, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "text-bottom", ab_textbottom },
    { { HTML_CSS, 0, HE_SVG_2, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "text-top", ab_texttop },
    { { HTML_CSS, 0, HE_SVG_10 | HE_SVG_DEPR_10 }, { HTML_UNDEF }, "top", ab_top } };
...
struct symbol_entry < html_version, e_aria_current > aria_current_symbol_table [] =
{   { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "date", acu_date },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "false", acu_false },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "location", acu_location },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "page", acu_page },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "step", acu_step },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "time", acu_time },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "true", acu_true } };

struct symbol_entry < html_version, e_aria_popup > aria_popup_symbol_table [] =
{   { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "dialog", ap_dialogue },
    { { HTML_ARIA_1_0 }, { HTML_UNDEF }, "false", ap_false },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "grid", ap_grid },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "listbox", ap_listbox },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "menu", ap_menu },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "tree", ap_tree },
    { { HTML_ARIA_1_0 }, { HTML_UNDEF }, "true", ap_true } };
...
{   { { HTML_JAN05, 0, 0, 0, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "cm", asu_cm },
...
{   { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT }, { HTML_UNDEF }, "angle", au_angle },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "apc", au_apc },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT }, { HTML_UNDEF }, "color", au_colour },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "cm", au_cm },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT }, { HTML_UNDEF }, "deg", au_deg },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "em", au_em },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "ex", au_ex },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT }, { HTML_UNDEF }, "frequency", au_frequency },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "ftn", au_ftn },
    ...
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "in", au_in },
    ...
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "ls", au_ls },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "mftn", au_mftn },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "mm", au_mm },
    ...
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "pc", au_pc },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "%", au_percent },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "pls", au_pls },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "pt", au_pt },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_CONTENT, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "px", au_px },
    ...
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "tmbl", au_tmbl },
...
struct symbol_entry < html_version, e_bcess > bcess_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "baseline", bce_baseline },
    { { HTML_CSS }, { HTML_UNDEF }, "center", bce_centre },
    { { HTML_CSS }, { HTML_UNDEF }, "end", bce_end },
    { { HTML_CSS }, { HTML_UNDEF }, "start", bce_start },
    { { HTML_CSS }, { HTML_UNDEF }, "stretch", bce_stretch } };
...
{   { { HTML_CSS, 0, HE_SVG, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "auto", ci_auto },
    { { HTML_CSS, 0, HE_SVG, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "sRGB", ci_srgb },
    { { HTML_CSS, 0, HE_SVG, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "linearRGB", ci_linearrgb },
...
{   { { HTML_TAGS }, { HTML_UNDEF }, "no", c_none },
    { { HTML_TAGS }, { HTML_UNDEF }, "pages", c_html },
#ifndef NOLYNX
    { { HTML_TAGS }, { HTML_UNDEF }, "hard", c_hard },
    { { HTML_TAGS }, { HTML_UNDEF }, "soft", c_soft },
#endif // NOLYNX
...
{   { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "baseline", ecac_baseline },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "end", ecac_end },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "flex-end", ecac_flex_end },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "flex-start", ecac_flex_start },
    { { HTML_CSS, 0, 0, H2_CSS_FBL, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "space-around", ecac_space_around },
    { { HTML_CSS, 0, 0, H2_CSS_FBL, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "space-between", ecac_space_between },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "space-evenly", ecac_space_evenly },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "start", ecac_start },
    { { HTML_CSS, 0, 0, H2_CSS_FBL, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "stretch", ecac_stretch } };
...
{   { { HTML_CSS, 0, 0, H2_CSS_CASCADE }, { HTML_UNDEF }, "inherit", all_inherit },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_CASCADE }, { HTML_UNDEF }, "-moz-initial", all_moz_initial },
...
struct symbol_entry < html_version, e_css_anchor_side_e > css_anchor_side_e_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "bottom", cas_bottom },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cas_centre },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "end", cas_end },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "inside", cas_inside },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "left", cas_left },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "outside", cas_outside },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "right", cas_right },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-end", cas_self_end },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-start", cas_self_start },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "start", cas_start },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "top", cas_top } };

struct symbol_entry < html_version, e_css_anchor_size_e > css_anchor_size_e_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "block", caz_block },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "height", caz_height },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "inline", caz_inline },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-block", caz_self_block },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-inline", caz_self_inline },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "width", caz_width } };

struct symbol_entry < html_version, e_css_anim_act > css_anim_act_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "none", caa_none },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "play", caa_play },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "play-backwards", caa_play_backwards },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "play-forwards", caa_play_forwards },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "play-once", caa_play_once },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "pause", caa_pause },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "replay", caa_replay },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "reset", caa_reset } };
...
{   { { HTML_CSS }, { HTML_UNDEF }, "inherit", eca_inherit },
    ...
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "base", eca_base },
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "base-select", eca_base_select },
...
struct symbol_entry < html_version, e_css_atf_ky > css_atf_ky_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "ease", aky_ease },
    { { HTML_CSS }, { HTML_UNDEF }, "ease-in", aky_ease_in },
    { { HTML_CSS }, { HTML_UNDEF }, "ease-out", aky_ease_out },
    { { HTML_CSS }, { HTML_UNDEF }, "ease-in-out", aky_ease_in_out },
    { { HTML_CSS }, { HTML_UNDEF }, "linear", aky_linear },
    { { HTML_CSS }, { HTML_UNDEF }, "step-start", aky_step_start },
    { { HTML_CSS }, { HTML_UNDEF }, "step-end", aky_step_end } };
...
{   { { HTML_CSS }, { HTML_UNDEF }, "inherit", ecba_inherit },
    ...
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_BACKGROUND_3 }, { HTML_UNDEF }, "local", ecba_local },
...
{   { { HTML_CSS }, { HTML_UNDEF }, "inherit", ecbr_inherit },
    ...
    { { HTML_CSS, 0, 0, 0, H3_CSS_MASKING, 0, H5_CSS_BACKGROUND_3 }, { HTML_UNDEF }, "round", ecbr_round },
    { { HTML_CSS, 0, 0, 0, H3_CSS_MASKING, 0, H5_CSS_BACKGROUND_3 }, { HTML_UNDEF }, "space", ecbr_space } };

// https://en.wikipedia.org/wiki/CSS_hack#Browser_prefixes
struct symbol_entry < html_version, e_css_bespoker > css_bespoker_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "ah", ecbes_ah },
    { { HTML_CSS }, { HTML_UNDEF }, "apple", ecbes_apple },
    { { HTML_CSS }, { HTML_UNDEF }, "atsc", ecbes_atsc },
    { { HTML_CSS }, { HTML_UNDEF }, "fx", ecbes_fx },
    { { HTML_CSS }, { HTML_UNDEF }, "hp", ecbes_hp },
    { { HTML_CSS }, { HTML_UNDEF }, "khtml", ecbes_khtml },
    { { HTML_CSS }, { HTML_UNDEF }, "moz", ecbes_moz },
    { { HTML_CSS }, { HTML_UNDEF }, "ms", ecbes_ms },
    { { HTML_CSS }, { HTML_UNDEF }, "o", ecbes_o },
    { { HTML_CSS }, { HTML_UNDEF }, "prince", ecbes_prince },
    { { HTML_CSS }, { HTML_UNDEF }, "rim", ecbes_rim },
    { { HTML_CSS }, { HTML_UNDEF }, "ro", ecbes_ro },
    { { HTML_CSS }, { HTML_UNDEF }, "tc", ecbes_tc },
    { { HTML_CSS }, { HTML_UNDEF }, "xv", ecbes_xv } };

struct symbol_entry < html_version, e_css_blend_mode > css_blend_mode_symbol_table [] =
{   { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "color", ecbm_colour },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "color-burn", ecbm_colour_burn },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "color-dodge", ecbm_colour_dodge },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "darken", ecbm_darken },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "difference", ecbm_difference },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "exclusion", ecbm_exclusion },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "hard-light", ecbm_hard_light },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "hue", ecbm_hue },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "lighten", ecbm_lighten },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "luminosity", ecbm_luminosity },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "multiply", ecbm_multiply },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "normal", ecbm_normal },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "overlay", ecbm_overlay },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "saturation", ecbm_saturation },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "screen", ecbm_screen },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "soft-light", ecbm_soft_light } };
...
{   { { HTML_CSS }, { HTML_UNDEF }, "inherit", ecbs_inherit },
    ...
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-bg-inset", ecb_moz_inset },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-bg-outset", ecb_moz_outset },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-bg-solid", ecb_moz_solid },
...
{   { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "auto", ebam_auto },
    ...
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "normal", ebam_normal },
    { { HTML_CSS, 0, 0, H2_CSS_FBL, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "stretch", ebam_stretch } };
...
{   { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "inline-size", lps_inline_size },
...
{   { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "aspect-ratio", ccf_aspect_ratio },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "block-size", ccf_block_size },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "height", ccf_height },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "inline-size", ccf_inline_size },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "orientation", ccf_orientation },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "width", ccf_width } };

struct symbol_entry < html_version, e_css_container_state > css_container_state_symbol_table [] =
{   { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "anchored", ccs_anchored },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "inline-size", ccs_inline_size },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "normal", ccs_normal },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "scroll-state", ccs_scroll_state },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "size", ccs_size } };
...
{   { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "center", eccp_centre },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "end", eccp_end },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "flex-end", eccp_flex_end },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "flex-start", eccp_flex_start },
    { { HTML_DEC25, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "self-end", eccp_self_end },
    { { HTML_DEC25, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "self-start", eccp_self_start },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "start", eccp_start } };

struct symbol_entry < html_version, e_css_continue > css_continue_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_45 }, { HTML_UNDEF }, "auto", ecse_auto },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_45 }, { HTML_UNDEF }, "discard", ecse_discard },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "fragments", ecse_fragments },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "overflow", ecse_overflow },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "paginate", ecse_paginate },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_45 }, { HTML_UNDEF }, "-webkit-discard", ecse_webkit_discard } };

struct symbol_entry < html_version, e_css_control_break > css_control_break_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "auto", ccb_auto },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "avoid", ccb_avoid },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "avoid-flex", ccb_avoid_flex },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "avoid-line", ccb_avoid_line },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "flex", ccb_flex },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "line", ccb_line } };

struct symbol_entry < html_version, e_css_coord_box > css_coord_box_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL | H3_CSS_MASKING | H3_CSS_FILL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "border-box", eccb_border_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL | H3_CSS_MASKING | H3_CSS_FILL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "content-box", eccb_content_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL | H3_CSS_MASKING | H3_CSS_FILL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "fill-box", eccb_fill_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_FILL }, { HTML_UNDEF }, "match-parent", eccb_match_parent },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL | H3_CSS_MASKING | H3_CSS_FILL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "padding-box", eccb_padding_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL | H3_CSS_MASKING | H3_CSS_FILL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "stroke-box", eccb_stroke_box },
...
{   { { HTML_CSS, 0, 0, H2_CSS_CS }, { HTML_UNDEF }, "arabic-indic", eccs_arabic_indic, ns_default, CF_CS_PREDEFINED },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_CS }, { HTML_UNDEF }, "-moz-initial", eccs_moz_initial, ns_default, CF_CS_CASCADE },
...
{   { { HTML_CSS, 0, 0, H2_CSS_1_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "block", ecd_block },
    { { HTML_CSS, HV_ABANDONED, 0, H2_CSS_FBL }, { HTML_UNDEF }, "box", ecd_box },
    ...
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_GRID }, { HTML_UNDEF }, "grid", ecd_flex },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_GRID }, { HTML_UNDEF }, "grid-inline", ecd_grid_inline },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_GRID_5 }, { HTML_UNDEF }, "grid-lanes", ecd_grid_lanes },
    { { HTML_CSS }, { HTML_UNDEF }, "inherit", ecd_inherit },
    { { HTML_CSS, 0, 0, H2_CSS_1_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "inline", ecd_inline },
    { { HTML_CSS, 0, 0, H2_CSS_21_22, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "inline-block", ecd_inline_block },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_GRID_5 }, { HTML_UNDEF }, "inline-grid-lanes", ecd_inline_grid_lanes },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "inline-table", ecd_inline_table },
    { { HTML_CSS, 0, 0, H2_CSS_1_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "list-item", ecd_list_item },
    { { HTML_CSS, 0, 0, H2_CSS_2_0 }, { HTML_UNDEF }, "marker", ecd_marker },
    { { HTML_CSS, HV_ABANDONED, HE_MOZILLA }, { HTML_UNDEF }, "-moz-box", ecd_moz_box },
    { { HTML_CSS, 0, 0, H2_CSS_1_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "none", ecd_none },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "run-in", ecd_run_in },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table", ecd_table },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-caption", ecd_table_caption },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-cell", ecd_table_cell },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-column", ecd_table_column },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-column-group", ecd_table_column_group },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-footer-group", ecd_table_footer_group },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-header-group", ecd_table_header_group },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-row", ecd_table_row },
    { { HTML_CSS, 0, 0, H2_CSS_2, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-row-group", ecd_table_row_group },
    { { HTML_CSS, HV_ABANDONED, HE_CHROME }, { HTML_UNDEF }, "-webkit-box", ecd_webkit_box } };

struct symbol_entry < html_version, e_css_display_inside > css_display_inside_symbol_table [] =
{   { { HTML_CSS, 0, 0, H2_CSS_FBL, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "flex", ecdi_flex },
    { { HTML_CSS, 0, 0, H2_CSS_FBL, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "flex-inline", ecdi_flex_inline },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "flow", ecdi_flow },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "flow-root", ecdi_flow_root },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 | H5_CSS_GRID }, { HTML_UNDEF }, "grid", ecdi_grid },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_GRID }, { HTML_UNDEF }, "grid-inline", ecdi_grid_inline },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "ruby", ecdi_ruby },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table", ecdi_table } };

struct symbol_entry < html_version, e_css_display_internal > css_display_internal_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "ruby-base", ecdi_ruby_base },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "ruby-base-container", ecdi_ruby_base_container },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "ruby-text", ecdi_ruby_text },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "ruby-text-container", ecdi_ruby_text_container },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-caption", ecdi_table_caption },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-cell", ecdi_table_cell },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-column", ecdi_table_column },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-column-group", ecdi_table_column_group },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-footer-group", ecdi_table_footer_group },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-header-group", ecdi_table_header_group },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-row", ecdi_table_row },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "table-row-group", ecdi_table_row_group } };
...
struct symbol_entry < html_version, e_css_ellipse_pos_e > css_ellipse_pos_e_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "block-end", cep_block_end },
    { { HTML_CSS }, { HTML_UNDEF }, "block-start", cep_block_start },
    { { HTML_CSS }, { HTML_UNDEF }, "bottom", cep_bottom },
    { { HTML_CSS }, { HTML_UNDEF }, "center", cep_centre },
    { { HTML_CSS }, { HTML_UNDEF }, "inline-end", cep_inline_end },
    { { HTML_CSS }, { HTML_UNDEF }, "inline-start", cep_inline_start },
    { { HTML_CSS }, { HTML_UNDEF }, "left", cep_left },
    { { HTML_CSS }, { HTML_UNDEF }, "right", cep_right },
    { { HTML_CSS }, { HTML_UNDEF }, "top", cep_top },
    { { HTML_CSS }, { HTML_UNDEF }, "x-end", cep_x_end },
...
{   { { HTML_CSS }, { HTML_UNDEF }, "center", cepx_centre },
    { { HTML_CSS }, { HTML_UNDEF }, "left", cepx_left },
    { { HTML_CSS }, { HTML_UNDEF }, "right", cepx_right },
    { { HTML_CSS }, { HTML_UNDEF }, "x-end", cepx_x_end },
    { { HTML_CSS }, { HTML_UNDEF }, "x-start", cepx_x_start } };

struct symbol_entry < html_version, e_css_ellipse_pos_y_2_e > css_ellipse_pos_y_2_e_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "bottom", cepy_bottom },
    { { HTML_CSS }, { HTML_UNDEF }, "center", cepy_centre },
    { { HTML_CSS }, { HTML_UNDEF }, "top", cepy_top },
    { { HTML_CSS }, { HTML_UNDEF }, "y-end", cepy_y_end },
    { { HTML_CSS }, { HTML_UNDEF }, "y-start", cepy_y_start } };

struct symbol_entry < html_version, e_css_env_var_predef > css_env_var_predef_symbol_table [] =
{   { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "keyboard-inset-bottom", evp_keyboard_inset_bottom },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "keyboard-inset-height", evp_keyboard_inset_height },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "keyboard-inset-left", evp_keyboard_inset_left },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "keyboard-inset-right", evp_keyboard_inset_right },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "keyboard-inset-top", evp_keyboard_inset_top },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "keyboard-inset-width", evp_keyboard_inset_width },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "preferred-text-scale", evp_preferred_text_scale },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "safe-area-inset-bottom", evp_safe_area_inset_bottom },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "safe-area-inset-left", evp_safe_area_inset_left },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "safe-area-inset-right", evp_safe_area_inset_right },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "safe-area-inset-top", evp_safe_area_inset_top },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "safe-area-max-inset-bottom", evp_safe_area_max_inset_bottom },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "safe-area-max-inset-left", evp_safe_area_max_inset_left },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "safe-area-max-inset-right", evp_safe_area_max_inset_right },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "safe-area-max-inset-top", evp_safe_area_max_inset_top },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "titlebar-area-height", evp_titlebar_area_height },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "titlebar-area-width", evp_titlebar_area_width },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "titlebar-area-x", evp_titlebar_area_x },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "titlebar-area-y", evp_titlebar_area_y },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "viewport-segment-bottom", evp_viewport_segment_bottom },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "viewport-segment-height", evp_viewport_segment_height },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "viewport-segment-left", evp_viewport_segment_left },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "viewport-segment-right", evp_viewport_segment_right },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "viewport-segment-top", evp_viewport_segment_top },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "viewport-segment-width", evp_viewport_segment_width } };

struct symbol_entry < html_version, e_css_etee > css_etee_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "activate", etee_activate },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "dblclick", etee_dblclick },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "click", etee_click },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "interest", etee_interest },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "touch", etee_touch } };
...
{   { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, UNKNOWN, efn_none },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_1_ARG, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "active-navigation", efn_active_navigation },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VIEWTRAN_4 }, { HTML_UNDEF }, "active-view-transition", efn_active_view_transition },
    { { HTML_CSS, 0, 0, H2_CSS_N_ARGS, 0, 0, H5_CSS_VIEWTRAN_4 }, { HTML_UNDEF }, "active-view-transition-type", efn_active_view_transition_type },
    { { HTML_CSS, 0, 0, H2_CSS_2 | H2_CSS_COCO | H2_CSS_SELECTOR, H3_NOT_TV, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "after", efn_after },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_IMG_ANIM }, { HTML_UNDEF }, "animated-image", efn_animated_image },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_3 | H2_CSS_COCO, H3_CSS_POSITION_4 }, { HTML_UNDEF }, "backdrop", efn_backdrop },
    { { HTML_CSS, 0, 0, H2_CSS_2 | H2_CSS_COCO | H2_CSS_SELECTOR, H3_NOT_TV, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "before", efn_before },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PRESENT }, { HTML_UNDEF }, "below-level", efn_below_level },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 | H3_CSS_PAGE_3 }, { HTML_UNDEF }, "blank", efn_blank },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "buffering", efn_buffering },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR }, { HTML_UNDEF }, "checked", efn_checked },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "checkmark", efn_checkmark },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE }, { HTML_UNDEF }, "circle", efn_circle },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "clear-icon", efn_clear_icon },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "closed", efn_closed, ns_default, CF_NOT_LV_STD_JUL23 },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "color-swatch", efn_colour_swatch },
    { { HTML_CSS, HV_ABANDONED, 0, H2_CSS_COCO, H3_CSS_SCOPE }, { HTML_FEB26 }, "content", efn_content },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_MULTCOL_4 }, { HTML_UNDEF }, "column", efn_column },
    { { HTML_CSS, 0, 0, H2_CSS_N_ARGS, 0, H4_CSS_ARG_OPTIONAL, H5_CSS_EASE_3 }, { HTML_UNDEF }, "cubic-bezier", efn_cubic_bezier },
    { { HTML_CSS, 0, 0, H2_CSS_3 | H2_CSS_COCO | H2_CSS_1_ARG, 0, H4_VTT | H4_CSS_ARG_OPTIONAL, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "cue", efn_cue },
    { { HTML_CSS, 0, 0, H2_CSS_3 | H2_CSS_COCO | H2_CSS_1_ARG, 0, H4_VTT | H4_CSS_ARG_OPTIONAL, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "cue-region", efn_cue_region },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 | H2_CSS_N_ARGS, 0, H4_CSS_ARG_OPTIONAL }, { HTML_UNDEF }, "current", efn_current },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_PSEUDO_4 }, { HTML_UNDEF }, "details-content", efn_details_content },
    { { HTML_CSS, 0, 0, H2_CSS_3 | H2_CSS_1_ARG, 0, H4_CSS_SAFE_2018 }, { HTML_UNDEF }, "dir", efn_dir },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR }, { HTML_UNDEF }, "disabled", efn_disabled },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE }, { HTML_UNDEF }, "ellipse", efn_ellipse },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR }, { HTML_UNDEF }, "empty", efn_empty },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR }, { HTML_UNDEF }, "enabled", efn_enabled, },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "field-component", efn_field_component },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "field-separator", efn_field_separator },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "field-text", efn_field_text },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "file-selector-button", efn_file_selector_button },
    { { HTML_CSS, 0, 0, H2_CSS_2 | H2_CSS_PAGETEMP, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "first", efn_first, ns_default, CF_PAGE },
    { { HTML_CSS, 0, 0, H2_CSS_2 | H2_CSS_SELECTOR }, { HTML_UNDEF }, "first-child", efn_first_child },
    { { HTML_CSS, 0, 0, H2_CSS_1_2 | H2_CSS_COCO | H2_CSS_SELECTOR, 0, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "first-letter", efn_first_letter },
    { { HTML_CSS, 0, 0, H2_CSS_1_2 | H2_CSS_COCO | H2_CSS_SELECTOR, 0, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "first-line", efn_first_line },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_4 }, { HTML_UNDEF }, "first-of-page", efn_first_of_page },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR }, { HTML_UNDEF }, "first-of-type", efn_first_of_type },
    { { HTML_CSS, 0, 0, H2_CSS_1_2 | H2_CSS_SELECTOR }, { HTML_UNDEF }, "focus", efn_focus },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 | H2_CSS_N_ARGS, 0, H4_VTT | H4_CSS_ARG_OPTIONAL }, { HTML_UNDEF }, "future", efn_future },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "grammar-error", efn_grammar_error },
    { { HTML_CSS, 0, 0, H2_CSS_3 | H2_CSS_N_ARGS, 0, H4_CSS_SAFE_2025 }, { HTML_UNDEF }, "has", efn_has },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHADOW | H3_CSS_SCOPE }, { HTML_UNDEF }, "has-slotted", efn_has_slotted },
    { { HTML_CSS, 0, 0, H2_CSS_1_ARG | H2_CSS_SELECTOR_5, 0, H4_CSS_ARG_OPTIONAL | H4_CSS_LIVING_STANDARD }, { HTML_UNDEF }, "heading", efn_heading },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 }, { HTML_UNDEF }, "interest-source", efn_interest_source, },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 }, { HTML_UNDEF }, "interest-target", efn_interest_target, },
    ...
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_4 }, { HTML_UNDEF }, "last-of-page", efn_last_of_page },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR }, { HTML_UNDEF }, "last-of-type", efn_last_of_type },
    { { HTML_CSS, 0, 0, H2_CSS_2, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "left", efn_left, ns_default, CF_PAGE },
    { { HTML_CSS, 0, 0, H2_CSS_1_2 | H2_CSS_SELECTOR }, { HTML_UNDEF }, "link", efn_link },
    { { HTML_CSS, 0, 0, H2_CSS_1_ARG, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "link-to", efn_link_to },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 | H2_CSS_1_ARG, 0, H4_CSS_ARG_OPTIONAL }, { HTML_UNDEF }, "local-link", efn_local_link },
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "low-value", efn_low_value },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, H3_CSS_LIST, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "marker", efn_marker },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "modal", efn_modal },
    { { HTML_CSS, 0, HE_BESPOKE | HE_IE, H2_CSS_COCO }, { HTML_UNDEF }, "-ms-browse", efn_ms_browse },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-alt-content", efn_moz_alt_content },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-any", efn_moz_any },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-any-link", efn_moz_any_link },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-broken", efn_moz_broken },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-canvas", efn_moz_canvas },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-cell-content", efn_moz_cell_content },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-color-swatch", efn_moz_colour_swatch },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-drag-over", efn_moz_drag_over },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-first-node", efn_moz_first_node },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-focus-inner", efn_moz_focus_inner },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-focus-outer", efn_moz_focus_outer },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-full-screen", efn_moz_full_screen },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-full-screen-ancestor", efn_moz_full_screen_ancestor },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-handler-blocked", efn_moz_handler_blocked },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-handler-crashed", efn_moz_handler_crashed },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-handler-disabled", efn_moz_handler_disabled },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-inline-table", efn_moz_inline_table },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-last-node", efn_moz_last_node },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-list-bullet", efn_moz_list_bullet },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-list-number", efn_moz_list_number },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-loading", efn_moz_loading },
    { { HTML_CSS, HV_BORKED, HE_BESPOKE | HE_MOZILLA, H2_CSS_1_ARG }, { HTML_UNDEF }, "-moz-locale-dir", efn_moz_locale_dir },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-lwtheme", efn_moz_lwtheme },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-lwtheme-brighttext", efn_moz_lwtheme_brighttext },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-lwtheme-darktext", efn_moz_lwtheme_darktext },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-meter-bar", efn_moz_meter_bar },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-native-anonymous", efn_moz_native_anonymous },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-only-whitespace", efn_moz_only_whitespace },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-pagebreak", efn_moz_pagebreak },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-pagecontent", efn_moz_pagecontent },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-placeholder", efn_moz_placeholder },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-progress-bar", efn_moz_progress_bar },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-range-progress", efn_moz_range_progress },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-range-thumb", efn_moz_range_thumb },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-range-track", efn_moz_range_track },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-read-only", efn_moz_read_only },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-read-write", efn_moz_read_write },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-scrolled-canvas", efn_moz_scrolled_canvas },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-scrolled-content", efn_moz_scrolled_content },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-selection", efn_moz_selection },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-submit-invalid", efn_moz_submit_invalid },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-suppressed", efn_moz_suppressed },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-svg-foreign-content", efn_moz_svg_foreign_content },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-table", efn_moz_table },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-table-cell", efn_moz_table_cell },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-table-column", efn_moz_table_column },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-table-column-group", efn_moz_table_column_group },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-table-outer", efn_moz_table_outer },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-table-row", efn_moz_table_row },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-table-row-group", efn_moz_table_row_group },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-cell", efn_moz_tree_cell },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-cell-text", efn_moz_tree_cell_text },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-cell-text(hover)", efn_moz_tree_cell_text_hover },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-column", efn_moz_tree_column },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-drop-feedback", efn_moz_tree_drop_feedback },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-image", efn_moz_tree_image },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-indentation", efn_moz_tree_indentation },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-line", efn_moz_tree_line },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-progressmeter", efn_moz_tree_progressmeter },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-row", efn_moz_tree_row },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-row(hover)", efn_moz_tree_row_hover },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-separator", efn_moz_tree_separator },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_CHROME }, { HTML_UNDEF }, "-moz-tree-twisty", efn_moz_tree_twisty },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-ui-invalid", efn_moz_ui_invalid },
    { { HTML_CSS, HV_ABANDONED, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-ui-valid", efn_moz_ui_valid },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-user-disabled", efn_moz_user_disabled },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-viewport", efn_moz_viewport },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA, H2_CSS_COCO }, { HTML_UNDEF }, "-moz-viewport-scroll", efn_moz_viewport_scroll },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-window-inactive", efn_moz_window_inactive },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "muted", efn_muted },
    { { HTML_CSS, 0, 0, H2_CSS_3 | H2_CSS_N_ARGS }, { HTML_UNDEF }, "not", efn_not },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR | H2_CSS_1_ARG }, { HTML_UNDEF }, "nth-child", efn_nth_child },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 | H2_CSS_1_ARG }, { HTML_UNDEF }, "nth-col", efn_nth_col, },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, H2_CSS_COCO | H2_CSS_1_ARG, 0, 0, H5_CSS_OVERFLOW_45 }, { HTML_UNDEF }, "nth-fragment", efn_nth_fragment, },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR | H2_CSS_1_ARG }, { HTML_UNDEF }, "nth-last-child", efn_nth_last_child },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 | H2_CSS_1_ARG }, { HTML_UNDEF }, "nth-last-col", efn_nth_last_col },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR | H2_CSS_1_ARG }, { HTML_UNDEF }, "nth-last-of-type", efn_nth_last_of_type },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR | H2_CSS_1_ARG }, { HTML_UNDEF }, "nth-of-type", efn_nth_of_type },
    { { HTML_CSS, 0, 0, H2_CSS_1_ARG, H3_CSS_PAGE_4 }, { HTML_UNDEF }, "nth-of-page", efn_nth_of_page },
    ...
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "optimal-value", efn_optimal_value },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_COCO | H2_CSS_1_ARG, H3_CSS_SHADOW | H3_CSS_SCOPE }, { HTML_UNDEF }, "part", efn_part },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 | H2_CSS_N_ARGS, 0, H4_VTT | H4_CSS_ARG_OPTIONAL }, { HTML_UNDEF }, "past", efn_past },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "paused", efn_paused },
    { { HTML_AUG25, 0, 0, H2_CSS_1_ARG | H2_CSS_COCO, 0, H4_CSS_FCS | H4_CSS_ARG_OPTIONAL }, { HTML_UNDEF }, "picker", efn_picker },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "picker-icon", efn_picker_icon },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_5 }, { HTML_UNDEF }, "picture-in-picture", efn_picture_in_picture },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "placeholder", efn_placeholder },
    ...
    { { HTML_AUG26, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "reveal-icon", efn_reveal_icon },
    { { HTML_CSS, 0, 0, H2_CSS_2, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "right", efn_right, ns_default, CF_PAGE },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR }, { HTML_UNDEF }, "root", efn_root },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "scope", efn_scope },
    { { HTML_CSS, 0, 0, H2_CSS_COCO | H2_CSS_1_ARG, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "scroll-button", efn_scroll_button },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "scroll-marker", efn_scroll_marker },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "scroll-marker-group", efn_scroll_marker_group },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "search-text", efn_search_text },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "seeking", efn_seeking },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "selection", efn_selection },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, H3_CSS_SCOPE }, { HTML_UNDEF }, "shadow", efn_shadow },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "slider-fill", efn_slider_fill },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "slider-thumb", efn_slider_thumb },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "slider-track", efn_slider_track },
    { { HTML_CSS, 0, 0, H2_CSS_3 | H2_CSS_COCO | H2_CSS_1_ARG, H3_CSS_SCOPE }, { HTML_UNDEF }, "slotted", efn_slotted },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_4 }, { HTML_UNDEF }, "snapped", efn_snapped },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_4 }, { HTML_UNDEF }, "snapped-block", efn_snapped_block },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_4 }, { HTML_UNDEF }, "snapped-inline", efn_snapped_inline },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_4 }, { HTML_UNDEF }, "snapped-x", efn_snapped_x },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_4 }, { HTML_UNDEF }, "snapped-y", efn_snapped_y },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "spelling-error", efn_spelling_error },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "stalled", efn_stalled },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_4 }, { HTML_UNDEF }, "start-of-page", efn_start_of_page },
    { { HTML_CSS, 0, 0, H2_CSS_3 | H2_CSS_1_ARG | H2_CSS_SELECTOR_5 }, { HTML_UNDEF }, "state", efn_state },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "step-control", enf_step_control },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "step-down", efn_step_down },
    { { HTML_AUG25, 0, 0, H2_CSS_COCO, 0, H4_CSS_FCS }, { HTML_UNDEF }, "step-up", efn_step_up },
    { { HTML_CSS, 0, 0, H2_CSS_3 }, { HTML_UNDEF }, "target", efn_target },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "target-after", efn_target_after },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "target-before", efn_target_before },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "target-current", efn_target_current },
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_PSEUDO_3 }, { HTML_UNDEF }, "target-text", efn_target_text },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "target-within", efn_target_within },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "trigger-link", efn_trigger_link },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_COCO, 0, 0, H5_CSS_VIEWTRAN }, { HTML_UNDEF }, "view-transition", efn_view_transition },
    { { HTML_CSS, 0, 0, H2_CSS_COCO | H2_CSS_1_ARG, 0, 0, H5_CSS_VIEWTRAN }, { HTML_UNDEF }, "view-transition-group", efn_view_transition_group },
    { { HTML_CSS, 0, 0, H2_CSS_COCO | H2_CSS_1_ARG, 0, 0, H5_CSS_VIEWTRAN_4 }, { HTML_UNDEF }, "view-transition-group-children", efn_view_transition_group_children },
    { { HTML_CSS, 0, 0, H2_CSS_COCO | H2_CSS_1_ARG, 0, 0, H5_CSS_VIEWTRAN }, { HTML_UNDEF }, "view-transition-new", efn_view_transition_new },
    { { HTML_CSS, 0, 0, H2_CSS_COCO | H2_CSS_1_ARG, 0, 0, H5_CSS_VIEWTRAN }, { HTML_UNDEF }, "view-transition-old", efn_view_transition_old },
    { { HTML_CSS, 0, 0, H2_CSS_COCO | H2_CSS_1_ARG, 0, 0, H5_CSS_VIEWTRAN }, { HTML_UNDEF }, "view-transition-image-pair", efn_view_transition_image_pair },
    ...
    { { HTML_CSS, 0, HE_BESPOKE }, { HTML_UNDEF }, "-webkit-any-link", efn_webkit_any_link },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_SELECTOR_4 }, { HTML_UNDEF }, "-webkit-autofill", efn_webkit_autofill }, // living standard
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-file-upload-button", efn_webkit_file_upload_button },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-inner-spin-button", efn_webkit_inner_spin_button },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-meter-bar", efn_webkit_meter_bar },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-meter-even-less-good-value", efn_webkit_meter_even_less_good_value },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-meter-inner-element", efn_webkit_meter_inner_element },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-meter-optimum-value", efn_webkit_meter_optimum_value },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-meter-suboptimum-value", efn_webkit_meter_suboptimum_value },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-progress-bar", efn_webkit_progress_bar },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-progress-inner-element", efn_webkit_progress_inner_element },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-progress-value", efn_webkit_progress_value },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-scrollbar", efn_webkit_scrollbar },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-scrollbar-button", efn_webkit_scrollbar_button },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-scrollbar-corner", efn_webkit_scrollbar_corner },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-scrollbar-thumb", efn_webkit_scrollbar_thumb },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-scrollbar-track", efn_webkit_scrollbar_track },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-scrollbar-track-piece", efn_webkit_scrollbar_track_piece },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-search-cancel-button", efn_webkit_search_cancel_button },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-search-results-button", efn_webkit_search_results_button },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-slider-runnable-track", efn_webkit_slider_runnable_track },
    { { HTML_CSS, 0, HE_BESPOKE, H2_CSS_COCO }, { HTML_UNDEF }, "-webkit-slider-thumb", efn_webkit_slider_thumb },
...
{   { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "center", ejc_centre },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "end", ejc_end },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "flex-end", ejc_flex_end },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "flex-start", ejc_flex_start },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "left", ejc_left },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "right", ejc_right },
    { { HTML_CSS, 0, 0, H2_CSS_FBL, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "space-around", ejc_space_around },
    { { HTML_CSS, 0, 0, H2_CSS_FBL, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "space-between", ejc_space_between },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "space-evenly", ejc_space_evenly },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "start", ejc_start },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN , 0, H5_CSS_GRID }, { HTML_UNDEF }, "stretch", ejc_stretch } };

struct symbol_entry < html_version, e_css_layout_box > css_layout_box_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "border-box", eclb_border_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "content-box", eclb_content_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "margin-box", eclb_margin_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "padding-box", eclb_padding_box } };
...
{   { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "arabic-indic", ecl_arabic_indic },
    { { HTML_CSS, 0, 0, H2_CSS_2_0 }, { HTML_UNDEF }, "bengali", ecl_bengali },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "cambodian", ecl_cambodian },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "circle", ecl_circle },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "cjk-decimal", ecl_cjk_decimal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "cjk-earthly-branch", ecl_cjk_earthly_branch },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "cjk-heavenly-stem", ecl_cjk_heavenly_stem },
    { { HTML_CSS, 0, 0, H2_CSS_2_0 }, { HTML_UNDEF }, "cjk-ideographic", ecl_cjk_ideographic },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "decimal", ecl_decimal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "decimal-leading-zero", ecl_decimal_leading_zero },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "devanagari", ecl_devanagari },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "disc", ecl_disc },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "disclosure-closed", ecl_disclosure_closed },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "disclosure-open", ecl_disclosure_open },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "ethiopic-numeric", ecl_ethiopic_numeric },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "georgian", ecl_georgian },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "gujarati", ecl_gujarati },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "gurmukhi", ecl_gurmukhi },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "hangul", ecl_hangul },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "hangul-consonant", ecl_hangul_consonant },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "hiragana-iroha", ecl_hiragana_iroha },
    { { HTML_CSS }, { HTML_UNDEF }, "inherit", ecls_inherit },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "japanese-formal", ecl_japanese_formal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "japanese-informal", ecl_japanese_informal },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "khmer", ecl_khmer },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "korean-hangul-formal", ecl_korean_hangul_formal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "korean-hanja-formal", ecl_korean_hanja_formal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "korean-hanja-informal", ecl_korean_hanja_informal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "loa", ecl_loa },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "lower-alpha", ecl_lower_alpha },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "lower-armenian", ecl_lower_armenian },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "lower-greek", ecl_lower_greek },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "lower-latin", ecl_lower_latin },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "lower-roman", ecl_lower_roman },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "malayalam", ecl_malayalam },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "mongolian", ecl_mongolian },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "myanmar", ecl_myanmar },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-arabic-indic", ecl_moz_arabic_indic },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-bengali", ecl_moz_bengali },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-cjk-earthly-branch", ecl_moz_cjk_earthly_branch },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-cjk-heavenly-stem", ecl_moz_cjk_heavenly_stem },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-devanagari", ecl_moz_devanagari },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-ethiopic-halehame", ecl_moz_ethiopic_halehame },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-ethiopic-halehame-am", ecl_moz_ethiopic_halehame_am },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-ethiopic-halehame-ti-er", ecl_moz_ethiopic_halehame_ti_er },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-ethiopic-halehame-ti-et", ecl_moz_ethiopic_halehame_ti_et },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-ethiopic-numeric", ecl_moz_ethiopic_numeric },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-gujarati", ecl_moz_gujarati },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-gurmukhi", ecl_moz_gurmukhi },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-hangul", ecl_moz_hangul },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-hangul-consonant", ecl_moz_hangul_consonant },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-loa", ecl_moz_loa },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-malayalam", ecl_moz_malayalam },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-myanmar", ecl_moz_myanmar },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-oriya", ecl_moz_oriya },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-persian", ecl_moz_persian },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-tamil", ecl_moz_tamil },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-telugu", ecl_moz_telugu },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-thai", ecl_moz_thai },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-urdu", ecl_moz_urdu },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "none", ecl_none },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "oriya", ecl_oriya },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "persian", ecl_persian },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "square", ecl_square },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "simp-chinese-formal", ecl_simp_chinese_formal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "simp-chinese-informal", ecl_simp_chinese_informal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "tamil", ecl_tamil },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "telugu", ecl_telugu },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "thai", ecl_thai },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "tibetan", ecl_tibetan },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "trad-chinese-formal", ecl_trad_chinese_formal },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "trad-chinese-informal", ecl_trad_chinese_informal },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "upper-alpha", ecl_upper_alpha },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "upper-armenian", ecl_upper_armenian },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "upper-greek", ecl_upper_greek },
    { { HTML_CSS, 0, 0, H2_CSS_2_2 }, { HTML_UNDEF }, "upper-latin", ecl_upper_latin },
    { { HTML_CSS, 0, 0, H2_CSS }, { HTML_UNDEF }, "upper-roman", ecl_upper_roman } };

struct symbol_entry < html_version, e_css_mask_composite > css_mask_composite_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "clear", ecmc_clear },
    { { HTML_CSS }, { HTML_UNDEF }, "copy", ecmc_copy },
    { { HTML_CSS }, { HTML_UNDEF }, "source-over", ecmc_source_over },
    { { HTML_CSS }, { HTML_UNDEF }, "source-in", ecmc_source_in },
    { { HTML_CSS }, { HTML_UNDEF }, "source-out", ecmc_source_out },
    { { HTML_CSS }, { HTML_UNDEF }, "source-atop", ecmc_source_atop },
    { { HTML_CSS }, { HTML_UNDEF }, "destination-over", ecmc_destination_over },
    { { HTML_CSS }, { HTML_UNDEF }, "destination-in", ecmc_destination_in },
    { { HTML_CSS }, { HTML_UNDEF }, "destination-out", ecmc_destination_out },
    { { HTML_CSS }, { HTML_UNDEF }, "destination-atop", ecmc_destination_atop },
    { { HTML_CSS }, { HTML_UNDEF }, "xor", ecmc_xor } };

struct symbol_entry < html_version, e_css_module, e_nit_macro, nm_none > css_module_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ADVLAY }, { HTML_UNDEF }, "Advanced Layout", c_advanced_layout, nm_context_advanced_layout, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "Anchoring Positioning", c_anchor_pos, nm_context_css_anchor_pos, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "Animation Trigger", c_animation_trigger, nm_context_css_animation_trigger, MOD_LEVEL_1 },
    { { HTML_CSS }, { HTML_UNDEF }, "Animation Worklet", c_animation_worklet, nm_none, MOD_LEVEL_3 | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, H2_CSS_ANIM_MASK }, { HTML_UNDEF }, "Animations", c_animation, nm_context_css_animation, MOD_LEVELS_12, H2_CSS_ANIM_34 },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_BACKGROUND_3 }, { HTML_UNDEF }, "Background and Borders", c_background_border, nm_context_css_background, MOD_LEVELS_34 },
    { { HTML_CSS, 0, 0, H2_CSS_UI_MASK }, { HTML_UNDEF }, "Basic User Interface", c_basic_user_interface, nm_context_css_ui, MOD_LEVELS_34 },
    { { HTML_CSS }, { HTML_UNDEF }, "Bahavioural Extensions", c_behavioural_extensions, nm_none, MOD_ON_OFF | MOD_ABANDONED | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_BORD_BOX_4 }, { HTML_UNDEF }, "Borders and Boxes", c_border_box, nm_context_css_border_box, MOD_LEVEL_4 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN }, { HTML_UNDEF }, "Box Alignment", c_box_alignment, nm_context_css_box_align, MOD_LEVEL_3 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL_MASK }, { HTML_UNDEF }, "Box Model", c_box_model, nm_context_css_box_model, MOD_LEVELS_34 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_SIZING_MASK }, { HTML_UNDEF }, "Box Sizing", c_box_sizing, nm_context_css_box_sizing, MOD_LEVELS_34 },
    { { HTML_CSS, 0, 0, H2_CSS_CASCADE_MASK }, { HTML_UNDEF }, "Cascading & Inheritance", c_cascade_inheritance, nm_context_css_cascade, MOD_LEVELS_3456 },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_MASK }, { HTML_UNDEF }, "Colour", c_colour, nm_context_css_colour, MOD_LEVELS_345 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ADJUST }, { HTML_UNDEF }, "Colour Adjustment", c_colour_adjustment, nm_context_css_adjust, MOD_LEVEL_3 },
    { { HTML_NOV25, 0, 0, 0, 0, H4_CSS_HDR }, { HTML_UNDEF }, "Colour HDR", c_hdr, nm_none, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, H2_CSS_COMBLE_3 }, { HTML_UNDEF }, "Compositing & Blending", c_compositing_blending, nm_context_css_compositing, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_MASK }, { HTML_UNDEF }, "Conditional Rules", c_conditional_rule, nm_context_css_cond_rule, MOD_LEVELS_345 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_MASK }, { HTML_UNDEF }, "Containment", c_containment, nm_context_css_contain, MOD_LEVELS_123 },
    { { HTML_CSS, 0, 0, H2_CSS_CS }, { HTML_UNDEF }, "Counter Style", c_counter_style, nm_context_css_cs, MOD_LEVEL_3 },
    { { HTML_CSS }, { HTML_UNDEF }, "CSS Object Model", c_cssom, nm_none, MOD_UNSUPPORTED },
    { { HTML_CSS }, { HTML_UNDEF }, "CSSOM View", c_cssom_view, nm_none, MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, H3_CSS_HIGHLIGHT }, { HTML_UNDEF }, "Custom Highlight API", c_custom_highlight, nm_context_css_highlight, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, H2_CSS_CUSTOM }, { HTML_UNDEF }, "Custom Properties for Cascading Variables", c_custom_property, nm_context_css_custom, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_DEVICE }, { HTML_UNDEF }, "Device Adaption", c_device_adaption, nm_context_css_device, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_3 }, { HTML_UNDEF }, "Display", c_display, nm_context_css_display, MOD_LEVEL_3 },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE_3 }, { HTML_UNDEF }, "Easing Functions", c_easing_function, nm_context_css_ease, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "Environment", c_environment, nm_context_css_environment, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_EXCLUDE }, { HTML_UNDEF }, "Exclusion", c_exclusion, nm_context_css_exclude, MOD_ON_OFF },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "Expressive Generalizations and Gadgetry", c_egg, nm_context_css_egg, MOD_LEVEL_1 },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_EXTENSION }, { HTML_UNDEF }, "Extensions", c_extension, nm_context_css_extensions, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_FILL }, { HTML_UNDEF }, "Fill and Stroke", c_fill_stroke, nm_context_css_fill, MOD_LEVEL_3 },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "Filter Effects", c_filter_effect, nm_context_css_filter, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, H2_CSS_FBL }, { HTML_UNDEF }, "Flexible Box Layout", c_flexible_box_layout, nm_context_css_fbl, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, H2_CSS_FONT_MASK }, { HTML_UNDEF }, "Fonts", c_font, nm_context_css_font, MOD_LEVELS_345 },
    { { HTML_CSS }, { HTML_UNDEF }, "Font Loading", c_font_loading, nm_none, MOD_LEVEL_3 | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "Form Control Styling", c_fcs, nm_none, MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, H2_CSS_FRAG_34 }, { HTML_UNDEF }, "Fragmentation", c_fragmentation, nm_context_css_fragmentation, MOD_LEVELS_34 },
    { { HTML_CSS }, { HTML_UNDEF }, "Fullscreen", c_fullscreen, nm_none, MOD_ON_OFF | MOD_ABANDONED | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, H2_CSS_MIXIN }, { HTML_UNDEF }, "Functions and Mixin", c_mixin, nm_context_mixin, MOD_LEVEL_3 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_GAP }, { HTML_UNDEF }, "Gaps", c_gap, nm_context_css_gap, MOD_LEVEL_3 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTENT }, { HTML_UNDEF }, "Generated Content", c_generated_content, nm_context_css_content, MOD_LEVEL_3 },
    { { HTML_CSS }, { HTML_UNDEF }, "Generated Content for Paged Media", c_generated_content_paged, nm_none, MOD_ON_OFF | MOD_FUTURE },
    { { HTML_CSS }, { HTML_UNDEF }, "Geometry Interfaces", c_geometry_interfaces, nm_none, MOD_LEVEL_1 | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_GRID }, { HTML_UNDEF }, "Grid Layout", c_grid_layout,nm_context_css_grid, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_HDR }, { HTML_UNDEF }, "HDR", c_hdr, nm_context_css_hdr, MOD_LEVEL_3 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_HYPERLINK }, { HTML_UNDEF }, "Hyperlink Presentation", c_hyperlink_presentation, nm_context_css_hyperlink, MOD_ON_OFF | MOD_ABANDONED },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_IMG_ANIM }, { HTML_UNDEF }, "Image Animation", c_image_animation, nm_context_css_image_animation, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, H3_CSS_IMAGE_MASK }, { HTML_UNDEF }, "Images / Values and Replaced Content", c_image, nm_context_css_image, MOD_LEVELS_345 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_INLINE }, { HTML_UNDEF }, "Inline Layout", c_inline_layout, nm_context_css_inline, MOD_LEVEL_3 },
    { { HTML_CSS }, { HTML_UNDEF }, "Layout API", c_layout, nm_none, MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, H3_CSS_LINE_GRID }, { HTML_UNDEF }, "Line Grid", c_line_grid, nm_context_css_line_grid, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, H3_CSS_LINK_PARAM }, { HTML_UNDEF }, "Linked Parameters", c_linked_parameters, nm_context_css_linked_parameters, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_LIST }, { HTML_UNDEF }, "Lists & Counters", c_list_counter, nm_context_css_list, MOD_LEVEL_3 },
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_LIVING_STANDARD }, { HTML_UNDEF }, "HTML5 Living Standard", c_living_standard, nm_none, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, H3_CSS_LOGIC }, { HTML_UNDEF }, "Logical Properties & Values", c_logical_property, nm_context_css_logic, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_MARQUEE }, { HTML_UNDEF }, "Marquee", c_marquee, nm_context_css_marquee, MOD_ON_OFF | MOD_ABANDONED },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_MATH_CORE }, { HTML_UNDEF }, "Math Core", c_math_core, nm_none, MOD_LEVEL_3 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_MASKING }, { HTML_UNDEF }, "Masking", c_masking, nm_context_css_masking, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, H2_CSS_MEDIA_MASK }, { HTML_UNDEF }, "Media Query", c_media_query, nm_context_css_media, MOD_LEVELS_345 },
    { { HTML_CSS, 0, 0, 0, H3_NOT_MOBILE }, { HTML_UNDEF }, "Mobile Profile", c_mobile_profile, nm_none, MOD_ON_OFF | MOD_ABANDONED },
    { { HTML_CSS, 0, 0, 0, H3_CSS_MOTION }, { HTML_UNDEF }, "Motion Path", c_motion_path, nm_context_css_motion, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_MULTCOL }, { HTML_UNDEF }, "Multicolumn Layout", c_multicolumn, nm_context_css_multi_column, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, H2_CSS_NAMESPACE }, { HTML_UNDEF }, "Namespaces", c_namespace, nm_context_css_namespace, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, H3_CSS_NESTING }, { HTML_UNDEF }, "Nesting", c_nesting, nm_context_css_nesting, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, H3_CSS_NES }, { HTML_UNDEF }, "Non-Element Selectors", c_non_element_selector, nm_context_css_selector, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_MASK }, { HTML_UNDEF }, "Overflow", c_overflow, nm_context_css_overflow, MOD_LEVELS_345 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_OVERSCROLL }, { HTML_UNDEF }, "Overscroll Behaviour", c_overscroll_behaviour, nm_context_css_overscroll, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_FLOAT }, { HTML_UNDEF }, "Page Floats", c_page_float, nm_context_css_float, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE }, { HTML_UNDEF }, "Paged Media", c_paged_media, nm_none, MOD_LEVEL_3 | MOD_FUTURE },
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP }, { HTML_UNDEF }, "Pagination Templates", c_page_template, nm_none, MOD_LEVEL_3 | MOD_FUTURE },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_PAINTAPI }, { HTML_UNDEF }, "Painting API", c_painting_api, nm_none, MOD_LEVEL_1 },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_PDA }, { HTML_UNDEF }, "Pointer-Driven Animation", c_pda, nm_context_css_pda, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_POSITION }, { HTML_UNDEF }, "Positioned Layout", c_positioned_layout, nm_context_css_position, MOD_LEVELS_34 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PRESENT }, { HTML_UNDEF }, "Presentation Level", c_presentation_level, nm_context_css_present, MOD_ON_OFF | MOD_ABANDONED },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_PRN_OPTIONAL }, { HTML_UNDEF }, "Print Profile", c_print_profile, nm_none, MOD_ON_OFF | MOD_ABANDONED },
    { { HTML_CSS }, { HTML_UNDEF }, "Properties & Values API", c_property_value, nm_none, MOD_LEVEL_1 | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PSEUDO }, { HTML_UNDEF }, "Pseudo Elements", c_pseudo_element, nm_context_css_pseudo, MOD_LEVELS_34 },
    { { HTML_CSS }, { HTML_UNDEF }, "Reader Media Type", c_reader_media_type, nm_none, MOD_ON_OFF | MOD_ABANDONED },
    { { HTML_CSS, 0, 0, 0, H3_CSS_REGION }, { HTML_UNDEF }, "Regions", c_region, nm_context_css_region, MOD_ON_OFF },
    { { HTML_CSS }, { HTML_UNDEF }, "Resize Observer", c_resize_observer, nm_none, MOD_ON_OFF | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, H3_CSS_RHYTHM }, { HTML_UNDEF }, "Rhythmic Sizing", c_rhythmic_sizing, nm_context_css_rhythm, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ROUND }, { HTML_UNDEF }, "Round Display", c_round_display, nm_context_css_round, MOD_LEVEL_1 },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "Route", c_route, nm_context_css_route, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, H3_CSS_RUBY }, { HTML_UNDEF }, "Ruby Annotation", c_ruby_annotation, nm_context_css_ruby, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SCOPE }, { HTML_UNDEF }, "Scoping / Shadow", c_scoping, nm_context_css_scope, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR }, { HTML_UNDEF }, "Scroll Anchoring", c_scroll_anchoring, nm_context_css_anchor, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SDA }, { HTML_UNDEF }, "Scroll-driven Animations", c_scroll_driven_animation, nm_none, MOD_ON_OFF | MOD_FUTURE },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_3 }, { HTML_UNDEF }, "Scroll Snap", c_scroll_snap, nm_context_css_snap, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_SNAP_POINTS }, { HTML_UNDEF }, "Scroll Snap Points", c_scroll_snap_point, nm_context_css_snap_point, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SCROLLBAR }, { HTML_UNDEF }, "Scrollbar Styling", c_scrollbar_styling, nm_none, MOD_LEVEL_1 | MOD_FUTURE },
    { { HTML_CSS, 0, 0, H2_CSS_SELECTOR_MASK }, { HTML_UNDEF }, "Selectors", c_selector, nm_context_css_selector, MOD_LEVELS_34 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHADOW }, { HTML_UNDEF }, "Shadow Parts", c_shadow_part, nm_context_css_shadow, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE_MASK }, { HTML_UNDEF }, "Shapes", c_shape, nm_context_css_shape, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_SPATIAL }, { HTML_UNDEF }, "Spatial Navigation", c_spatial_navigation, nm_context_css_spatial, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SPEECH }, { HTML_UNDEF }, "Speech", c_speech, nm_context_css_speech, MOD_LEVEL_1 },
    { { HTML_CSS, 0, 0, H2_CSS_STYLE }, { HTML_UNDEF }, "Style Attributes", c_style_attribute, nm_context_css_style, MOD_ON_OFF },
    { { HTML_CSS, 0, 0, H2_CSS_SVG_MASK }, { HTML_UNDEF }, "SVG", c_svg, nm_none, MOD_LEVELS_12 | MOD_FUTURE },
    { { HTML_CSS }, { HTML_UNDEF }, "Syntax", c_syntax, nm_context_css_syntax, MOD_LEVEL_3 | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TABLE }, { HTML_UNDEF }, "Table", c_table, nm_context_css_table, MOD_LEVEL_3 },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ADVLAY }, { HTML_UNDEF }, "Template Layout", c_template_layout, nm_none, MOD_ON_OFF | MOD_FUTURE },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_MASK }, { HTML_UNDEF }, "Text", c_text, nm_context_css_text, MOD_LEVELS_34 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXTDEC_MASK }, { HTML_UNDEF }, "Text Decoration", c_text_decoration, nm_context_css_text_decoration, MOD_LEVELS_34 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TRANSFORM_MASK }, { HTML_UNDEF }, "Transforms", c_transform, nm_context_css_transform, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_TRANSITION_MASK }, { HTML_UNDEF }, "Transitions", c_transition, nm_context_css_transition, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, 0, H3_NOT_TV }, { HTML_UNDEF }, "TV Profile", c_tv_profile, nm_none, MOD_ON_OFF | MOD_ABANDONED },
    { { HTML_CSS }, { HTML_UNDEF }, "Typed OM", c_typed_om, nm_none, MOD_LEVEL_1 | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_MASK }, { HTML_UNDEF }, "Values and Units", c_value_unit, nm_context_css_value, MOD_LEVELS_345 },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VIEWTRAN }, { HTML_UNDEF }, "View Transitions", c_view_transition, nm_context_css_view, MOD_LEVELS_12 },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_VIEWPORT }, { HTML_UNDEF }, "Viewport", c_viewport, nm_css_context_viewport, MOD_ON_OFF },
    { { HTML_CSS }, { HTML_UNDEF }, "Web Animations", c_web_animations, nm_none, MOD_LEVELS_12 | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, H3_CSS_WC }, { HTML_UNDEF }, "Will Change", c_will_change, nm_context_css_will_change, MOD_LEVEL_1 },
    { { HTML_CSS }, { HTML_UNDEF }, "Worklets", c_worklets, nm_none, MOD_LEVEL_1 | MOD_ABANDONED | MOD_UNSUPPORTED },
    { { HTML_CSS, 0, 0, 0, H3_CSS_WRITING_MASK }, { HTML_UNDEF }, "Writing Modes", c_writing_mode, nm_context_css_writing_mode, MOD_LEVELS_34 } };

struct symbol_entry < html_version, e_css_navigation_keyword > css_navigation_keyword_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "and", cnk_and },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "at", cnk_at },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "back", cnk_back },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "between", cnk_between },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "committed", cnk_committed },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "forward", cnk_forward },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "from", cnk_from },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "history", cnk_history },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "loading", cnk_loading },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "not", cnk_not },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "or", cnk_or },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "phase", cnk_phase },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "ready", cnk_ready },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "reload", cnk_reload },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "to", cnk_to },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "traverse", cnk_traverse },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "url", cnk_url },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "url-pattern", cnk_url_pattern },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "with", cnk_with } };

struct symbol_entry < html_version, e_css_overflow > css_overflow_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "auto", eco_auto },
    { { HTML_CSS }, { HTML_UNDEF }, "clip", eco_clip },
    { { HTML_CSS, 0, HE_SAFARI }, { HTML_UNDEF }, "hide", eco_hide },
    { { HTML_CSS }, { HTML_UNDEF }, "hidden", eco_hidden },
    { { HTML_CSS }, { HTML_UNDEF }, "scroll", eco_scroll },
    { { HTML_CSS }, { HTML_UNDEF }, "visible", eco_visible } };

struct symbol_entry < html_version, e_css_overflow_style > css_overflow_style_symbol_table [] =
{   { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP, H3_CSS_PAGE_3, H4_CSS_MARQUEE }, { HTML_UNDEF }, "auto", cos_auto },
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP, H3_CSS_PAGE_3, H4_CSS_MARQUEE }, { HTML_UNDEF }, "marquee-block", cos_marquee_block },
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP, H3_CSS_PAGE_3, H4_CSS_MARQUEE }, { HTML_UNDEF }, "marquee-line", cos_marquee_line },
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "paged-x", cos_paged_x },
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "paged-y", cos_paged_y },
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "paged-x-controls", cos_paged_x_controls },
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "paged-y-controls", cos_paged_y_controls } };

struct symbol_entry < html_version, e_css_pa_block > css_pa_block_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "any", cpb_any },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "block-end", cpb_block_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "block-start", cpb_block_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cpb_centre },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-all", cpb_span_all },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-block-end", cpb_span_block_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-block-start", cpb_span_block_start } };

struct symbol_entry < html_version, e_css_pa_inline > css_pa_inline_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "any", cpi_any },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "inline-end", cpi_inline_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "inline-start", cpi_inline_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cpi_centre },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-all", cpi_span_all },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-inline-end", cpi_span_inline_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-inline-start", cpi_span_inline_start } };

struct symbol_entry < html_version, e_css_pa_left > css_pa_left_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "any", cpl_any },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cpl_centre },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "left", cpl_left },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "right", cpl_right },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-x-end", cpl_self_x_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-x-start", cpl_self_x_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-all", cpl_span_all },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-left", cpl_span_left },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-right", cpl_span_right },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-self-x-end", cpl_span_self_x_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span_self-x-start", cpl_span_self_x_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-x-end", cpl_span_x_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-x-start", cpl_span_x_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "x-end", cpl_x_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "x-start", cpl_x_start } };

struct symbol_entry < html_version, e_css_pa_self_block > css_pa_self_block_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "any", cpsb_any },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cpsb_centre },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-block-end", cpsb_self_block_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-block-start", cpsb_self_block_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-all", cpsb_span_all },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-self-block-end", cpsb_span_self_block_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-self-block-start", cpsb_span_self_block_start } };

struct symbol_entry < html_version, e_css_pa_self_inline > css_pa_self_inline_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "any", cpsi_any },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cpsi_centre },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-inline-end", cpsi_self_inline_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-inline-start", cpsi_self_inline_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-all", cpsi_span_all },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-self-inline-end", cpsi_span_self_inline_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-self-inline-start", cpsi_span_self_inline_start } };

struct symbol_entry < html_version, e_css_pa_self > css_pa_self_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "any", cpss_any },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cpss_centre },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-end", cpss_self_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-start", cpss_self_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-all", cpss_span_all },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-self-end", cpss_span_self_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-self-start", cpss_span_self_start } };

struct symbol_entry < html_version, e_css_pa_start > css_pa_start_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "any", cps_any },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cps_centre },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "end", cps_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-all", cps_span_all },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-end", cps_span_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-start", cps_span_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "start", cps_start } };

struct symbol_entry < html_version, e_css_pa_top > css_pa_top_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "any", cpt_any },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "center", cpt_centre },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "top", cpt_top },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "bottom", cpt_bottom },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-y-end", cpt_self_y_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "self-y-start", cpt_self_y_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-all", cpt_span_all },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-top", cpt_span_top },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-bottom", cpt_span_bottom },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-self-y-end", cpt_span_self_y_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span_self-y-start", cpt_span_self_y_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-y-end", cpt_span_y_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "span-y-start", cpt_span_y_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "y-end", cpt_y_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "y-start", cpt_y_start } };

struct symbol_entry < html_version, e_css_paint_box > css_paint_box_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "border-box", ecpb_border_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "content-box", ecpb_content_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "fill-box", ecpb_fill_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "padding-box", ecpb_padding_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "stroke-box", ecpb_stroke_box } };
...
{   { { HTML_CSS }, { HTML_UNDEF }, "absolute", ecp_absolute },
    ...
    { { HTML_CSS, 0, 0, 0, H3_CSS_POSITION_3, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "sticky", ecp_sticky },
    { { HTML_CSS, 0, HE_BESPOKE }, { HTML_UNDEF }, "-webkit-sticky", ecp_webkit_sticky } };

struct symbol_entry < html_version, e_css_print_status > css_print_status_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_MOTION }, { HTML_UNDEF }, "required", cps_required },
    { { HTML_CSS, 0, 0, 0, H3_CSS_MOTION }, { HTML_UNDEF }, "partial", cps_partial },
    { { HTML_CSS, 0, 0, 0, H3_CSS_MOTION }, { HTML_UNDEF }, "optional", cps_optional },
    { { HTML_CSS, 0, 0, 0, H3_CSS_MOTION }, { HTML_UNDEF }, "similar", cps_similar } };
...
{   { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_4 }, { HTML_UNDEF }, "a98-rgb", crx_a98_rgb },
    ...
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_5 }, { HTML_UNDEF }, "display-p3-linear", crx_display_p3_linear },
    ...
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_5 }, { HTML_UNDEF }, "rec2020-hlg", crx_rec2020_hlg },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_5 }, { HTML_UNDEF }, "rec2020-linear", crx_rec2020_linear },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_5 }, { HTML_UNDEF }, "rec2020-pq", crx_rec2020_pq },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_HDR }, { HTML_UNDEF }, "rec2100-hlg", crx_rec2100_hlg },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_HDR }, { HTML_UNDEF }, "rec2100-linear", crx_rec2100_linear },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_HDR }, { HTML_UNDEF }, "rec2100-pq", crx_rec2100_pq },
...
struct symbol_entry < html_version, e_css_reading_flow > css_reading_flow_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_4 }, { HTML_UNDEF }, "flex-flow", crf_flex_flow },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_4 }, { HTML_UNDEF }, "flex-visual", crf_flex_visual },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_4 }, { HTML_UNDEF }, "grid-columns", crf_grid_columns },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_4 }, { HTML_UNDEF }, "grid-order", crf_grid_order },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_4 }, { HTML_UNDEF }, "grid-rows", crf_grid_rows },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_DISPLAY_4 }, { HTML_UNDEF }, "normal", crf_normal },
...
struct symbol_entry < html_version, e_css_scroll_button > css_scroll_button_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "block-end", csb_block_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "block-start", csb_block_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "down", csb_down },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "inline-end", csb_inline_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "inline-start", csb_inline_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "left", csb_left },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "right", csb_right },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "*", csb_splat },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW_5 }, { HTML_UNDEF }, "up", csb_up } };

struct symbol_entry < html_version, e_css_self_position > css_self_position_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN, 0, H5_CSS_ANCHOR_POS | H5_CSS_GRID }, { HTML_UNDEF }, "anchor-center", ecsp_anchor_centre },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN, 0, H5_CSS_GRID }, { HTML_UNDEF }, "center", ecsp_centre },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN, 0, H5_CSS_GRID }, { HTML_UNDEF }, "end", ecsp_end },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN, 0, H5_CSS_GRID }, { HTML_UNDEF }, "flex-end", ecsp_flex_end },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN, 0, H5_CSS_GRID }, { HTML_UNDEF }, "flex-start", ecsp_flex_start },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN, 0, H5_CSS_GRID }, { HTML_UNDEF }, "self-end", ecsp_self_end },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN, 0, H5_CSS_GRID }, { HTML_UNDEF }, "self-start", ecsp_self_start },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_ALIGN, 0, H5_CSS_GRID }, { HTML_UNDEF }, "start", ecsp_start } };

struct symbol_entry < html_version, e_css_shape_box > css_shape_box_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE }, { HTML_UNDEF }, "border-box", ecsb_border_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE }, { HTML_UNDEF }, "content-box", ecsb_content_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE }, { HTML_UNDEF }, "half-border-box", ecsb_half_border_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE }, { HTML_UNDEF }, "margin-box", ecsb_margin_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE }, { HTML_UNDEF }, "padding-box", ecsb_padding_box } };

struct symbol_entry < html_version, e_css_size_e > css_size_e_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "A3", cse_a3 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "A4", cse_a4 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "A5", cse_a5 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "B4", cse_b4 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "B5", cse_b5 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "JIS-B4", cse_jis_b4 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "JIS-B5", cse_jis_b5 },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "ledger", cse_ledger },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "legal", cse_legal },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "letter", cse_letter } };
...
{   { { HTML_CSS }, { HTML_UNDEF }, "auto", csz_auto },
    ...
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_SIZING, H4_CSS_SAFE_2018 }, { HTML_UNDEF }, "max-content", csz_max_content },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_SIZING, H4_CSS_SAFE_2018 }, { HTML_UNDEF }, "min-content", csz_min_content },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, " -moz-available", csz_moz_available },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, " -moz-fit-content", csz_moz_fit_content },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, " -moz-max-content", csz_moz_max_content },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, " -moz-min-content", csz_moz_min_content },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_SIZING_4 }, { HTML_UNDEF }, "stretch", csz_stretch } };

struct symbol_entry < html_version, e_css_slider_orientation > css_slider_orientation_symbol_table [] =
{   { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "auto", csco_auto },
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "bottom-to-top", csco_btt },
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "left-to-right", csco_ltr },
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "right-to-left", csco_rtl },
    { { HTML_AUG25, 0, 0, 0, 0, H4_CSS_FCS }, { HTML_UNDEF }, "top-to-bottom", csco_ttb }, };
...
struct symbol_entry < html_version, e_css_ss_scroll > css_ss_scroll_symbol_table [] =
{   { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "block", sss_block },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "block-end", sss_block_end },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "block-start", sss_block_start },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "bottom", sss_bottom },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "inline", sss_inline },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "inline-end", sss_inline_end },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "inline-start", sss_inline_start },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "left", sss_left },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "none", sss_none },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "right", sss_right },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "top", sss_top },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "x", sss_x },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "y", sss_y } };

struct symbol_entry < html_version, e_css_ss_snapped > css_ss_snapped_symbol_table [] =
{   { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "block", ssn_block },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "both", ssn_both },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "inline", ssn_inline },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "none", ssn_none },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "x", ssn_x },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "y", ssn_y } };

struct symbol_entry < html_version, e_css_ss_stuck > css_ss_stuck_symbol_table [] =
{   { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "block-end", sst_block_end },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "block-start", sst_block_start },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "bottom", sst_bottom },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "inline-end", sst_inline_end },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "inline-start", sst_inline_start },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "left", sst_left },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "none", sst_none },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "right", sst_right },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "top", sst_top } };

struct symbol_entry < html_version, e_css_ss_type_e > css_ss_type_e_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_3 }, { HTML_UNDEF }, "block", cst_block },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_3 }, { HTML_UNDEF }, "both", cst_both },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_3 }, { HTML_UNDEF }, "inline", cst_inline },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_3 }, { HTML_UNDEF }, "x", cst_x },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SNAP_3 }, { HTML_UNDEF }, "y", cst_y } };
...
{   { { HTML_CSS, 0, 0, H2_CSS_FONT_4 }, { HTML_UNDEF }, "annotation", css_annotation, ns_default, CF_MUST_FONT_FV },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "bottom-center", css_bottom_centre, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "bottom-left", css_bottom_left, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "bottom-left-corner", css_bottom_left_corner, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "bottom-right", css_bottom_right, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "bottom-right-corner", css_bottom_right_corner, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, H2_CSS_FONT_4 }, { HTML_UNDEF }, "character-variant", css_character_variant, ns_default, CF_MUST_FONT_FV },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "charset", css_charset },
    { { HTML_SVG11, 0, HE_SVG, 0, H3_NOT_TV }, { HTML_UNDEF }, "color-profile", css_colour_profile },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "container", css_container },
    ...
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_EXTENSION }, { HTML_UNDEF }, "custom-property", css_custom_property },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, H3_CSS_EXTENSION }, { HTML_UNDEF }, "custom-selector", css_custom_selector },
    { { HTML_CSS, 0, 0, H2_CSS_3 }, { HTML_UNDEF }, "document", css_document },
    { { HTML_CSS, 0, 0, H2_CSS_COND_RULE_5 }, { HTML_UNDEF }, "else", css_else },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "env", css_env },
    ...
    { { HTML_CSS }, { HTML_UNDEF }, "function", css_function },
    { { HTML_CSS, 0, 0, H2_CSS_FONT_4 }, { HTML_UNDEF }, "historical-forms", css_historical_forms, ns_default, CF_MUST_FONT_FV },
    { { HTML_CSS, 0, 0, H2_CSS, 0, H4_CSS_PRN_OPTIONAL }, { HTML_UNDEF }, "import", css_import },
    { { HTML_CSS, 0, 0, H2_CSS_3 }, { HTML_UNDEF }, "keyframes", css_keyframes },
    { { HTML_CSS, 0, 0, H2_CSS_CASCADE_5 }, { HTML_UNDEF }, "layer", css_layer },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "left-bottom", css_left_bottom, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "left-middle", css_left_middle, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "left-top", css_left_top, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "media", css_media },
    { { HTML_CSS, 0, HE_BESPOKE }, { HTML_UNDEF }, "-moz-document", css_moz_document },
    { { HTML_CSS, 0, 0, H2_CSS_3, H3_NOT_MOBILE }, { HTML_UNDEF }, "namespace", css_namespace },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "navigation", css_navigation },
    { { HTML_CSS, 0, 0, H2_CSS_FONT_4 }, { HTML_UNDEF }, "ornaments", css_ornaments, ns_default, CF_MUST_FONT_FV },
    { { HTML_CSS, 0, 0, H2_CSS_2, H3_NOT_TV | H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "page", css_page },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "position-try", css_position_try },
    { { HTML_CSS }, { HTML_UNDEF }, "starting-style", css_starting_style },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "right-bottom", css_right_bottom, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "right-middle", css_right_middle, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3 }, { HTML_UNDEF }, "right-top", css_right_top, ns_default, CF_PRINT },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "route", css_route },
    { { HTML_CSS, 0, 0, H2_CSS_CASCADE_6, H3_CSS_SCOPE }, { HTML_UNDEF }, "scope", css_scope },
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP }, { HTML_UNDEF }, "slot", css_slot },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VIEWTRAN_4 }, { HTML_UNDEF }, "view-transition", css_view_transition },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_PAGETEMP }, { HTML_UNDEF }, "template", css_template },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "top-center", css_top_centre, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "top-left", css_top_left, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "top-left-corner", css_top_left_corner, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "top-right", css_top_right, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_PAGE_3, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "top-right-corner", css_top_right_corner, ns_default, CF_PRINT },
    { { HTML_CSS, 0, 0, 0, H3_CSS_DEVICE }, { HTML_UNDEF }, "viewport", css_viewport },
    { { HTML_CSS }, { HTML_UNDEF }, "property", css_property },
...
{   { { HTML_CSS, 0, 0, H2_CSS, H3_CSS_TEXT }, { HTML_UNDEF }, "center", ecta_centre },
    ...
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-center", ecta_moz_centre },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-left", ecta_moz_left },
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-right", ecta_moz_right },
    ...
    { { HTML_CSS, 0, HE_BESPOKE | HE_SAFARI }, { HTML_UNDEF }, "-webkit-center", ecta_webkit_centre },
    { { HTML_CSS, 0, HE_BESPOKE | HE_SAFARI }, { HTML_UNDEF }, "-webkit-left", ecta_webkit_left },
    { { HTML_CSS, 0, HE_BESPOKE | HE_SAFARI }, { HTML_UNDEF }, "-webkit-right", ecta_webkit_right } };
...
struct symbol_entry < html_version, e_css_text_justify > css_text_justify_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT }, { HTML_UNDEF }, "auto", etj_auto },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT | H3_CSS_DEPRECATED }, { HTML_UNDEF }, "distribute", etj_distribute },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT }, { HTML_UNDEF }, "inter-character", etj_inter_character },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT }, { HTML_UNDEF }, "inter-word", etj_inter_word },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT }, { HTML_UNDEF }, "none", etj_none } };

struct symbol_entry < html_version, e_css_text_spacing_trim > css_text_spacing_trim_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "normal", tst_normal },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "space-all", tst_space_all },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "space-first", tst_space_first },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "trim-all", tst_trim_all },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_FEB24 }, "trim-auto", tst_trim_auto },
    { { HTML_FEB24, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "trim-both", tst_trim_both },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "trim-start", tst_trim_start } };
...
struct symbol_entry < html_version, e_css_textdec_skip > css_textdec_skip_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "box-decoration", tds_box_decoration },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "edges", tds_edges },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "leading-spaces", tds_leading_spaces },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "objects", tds_object },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "none", tds_none },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "spaces", tds_spaces },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "trailing-spaces", tds_trailing_spaces } };
...
struct symbol_entry < html_version, e_css_text_wrap_style > css_text_wrap_style_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "auto", ctws_auto },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "avoid-orphans", ctws_avoid_orphans },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "balance", ctws_balance },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "pretty", ctws_pretty },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "stable", ctws_stable } };

struct symbol_entry < html_version, e_css_touch_action > css_touch_action_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV }, { HTML_UNDEF }, "auto", cta_auto },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV }, { HTML_UNDEF }, "manipulation", cta_manipulation },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV }, { HTML_UNDEF }, "none", cta_none },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV_4 }, { HTML_UNDEF }, "pan-down", cta_pan_down },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV_4 }, { HTML_UNDEF }, "pan-left", cta_pan_left },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV_4 }, { HTML_UNDEF }, "pan-right", cta_pan_right },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV_4 }, { HTML_UNDEF }, "pan-up", cta_pan_up },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV }, { HTML_UNDEF }, "pan-x", cta_pan_x },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_PTR_EV }, { HTML_UNDEF }, "pan-y", cta_pan_y },
    { { HTML_JAN17, 0, 0, 0, 0, 0, H5_CSS_PTR_EV }, { HTML_UNDEF }, "pinch-zoom", cta_pinch_zoom } };
...
struct symbol_entry < html_version, e_css_trn > css_trn_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, H3_CSS_SDA }, { HTML_UNDEF }, "contain", ctrn_contain },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SDA }, { HTML_UNDEF }, "cover", ctrn_cover },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SDA }, { HTML_UNDEF }, "entry", ctrn_entry },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SDA }, { HTML_UNDEF }, "entry-crossing", ctrn_entry_crossing },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SDA }, { HTML_UNDEF }, "exit", ctrn_exit },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SDA }, { HTML_UNDEF }, "exit-crossing", ctrn_exit_crossing },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SDA }, { HTML_UNDEF }, "scroll", ctrn_scroll } };

struct symbol_entry < html_version, e_css_try_tactic > css_try_tactic_symbol_table [] =
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "flip-block", ctt_flip_block },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "flip-inline", ctt_flip_inline },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "flip-start", ctt_flip_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "flip-x", ctt_flip_x },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "flip-y", ctt_flip_y } };

struct symbol_entry < html_version, e_css_type > css_type_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "angle", cty_angle },
    { { HTML_CSS }, { HTML_UNDEF }, "color", cty_colour },
    { { HTML_CSS }, { HTML_UNDEF }, "custom-ident", cty_custom_ident },
    { { HTML_CSS }, { HTML_UNDEF }, "image", cty_image },
    { { HTML_CSS }, { HTML_UNDEF }, "integer", cty_integer },
    { { HTML_CSS }, { HTML_UNDEF }, "length", cty_length },
    { { HTML_CSS }, { HTML_UNDEF }, "length-percentage", cty_length_percentage },
    { { HTML_CSS }, { HTML_UNDEF }, "number", cty_number },
    { { HTML_CSS }, { HTML_UNDEF }, "percentage", cty_percentage },
    { { HTML_CSS }, { HTML_UNDEF }, "resolution", cty_resolution },
    { { HTML_CSS }, { HTML_UNDEF }, "string", cty_string },
    { { HTML_CSS }, { HTML_UNDEF }, "time", cty_time },
    { { HTML_CSS }, { HTML_UNDEF }, "transform-function", cty_transform_function },
    { { HTML_CSS }, { HTML_UNDEF }, "transform-list", cty_transform_list },
    { { HTML_CSS }, { HTML_UNDEF }, "url", cty_url } };
...
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "abs", cvf_abs, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "acos", cvf_acos, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_HDR }, { HTML_UNDEF }, "alpha", cvf_alpha },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "anchor", cvf_anchor, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANCHOR, 0, H5_CSS_ANCHOR_POS }, { HTML_UNDEF }, "anchor-size", cvf_anchor_size, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_ANCHOR_POS_4 }, { HTML_UNDEF }, "anchored", cvf_anchored },
    { { HTML_CSS, 0, 0, H2_CSS_FONT_4 }, { HTML_UNDEF }, "annotation", cvf_annotation },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "asin", cvf_asin, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "atan", cvf_atan, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "atan2", cvf_atan2, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_4 }, { HTML_UNDEF }, "auto", cvf_auto },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTENT, 0, H5_CSS_VALUE_5 }, { HTML_UNDEF }, "attr", cvf_attr },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "blur", cvf_blur },
    ...
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "contrast", cvf_contrast },
    { { HTML_CSS, 0, HE_EXPERIMENTAL, 0, 0, H4_CSS_COLOUR_6, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "contrast-color", cvf_contrast_colour },
    ...
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_HDR }, { HTML_UNDEF }, "dynamic-range-limit-mix", cvf_dynamic_range_limit_mix },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "ease", cvf_ease, ns_default, CF_NO_PARAMS },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "ease-in", cvf_ease_in, ns_default, CF_NO_PARAMS },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "ease-in-out", cvf_ease_in_out, ns_default, CF_NO_PARAMS },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "ease-out", cvf_ease_out, ns_default, CF_NO_PARAMS },
    { { HTML_CSS, 0, 0, 0, H3_CSS_IMAGE_45 }, { HTML_UNDEF }, "element", cvf_element },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE | H3_CSS_MASKING }, { HTML_UNDEF }, "ellipse", cvf_ellipse },
    { { HTML_CSS, 0, 0, 0, H3_CSS_ENVIRONMENT }, { HTML_UNDEF }, "env", cvf_env },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "exp", cvf_exp, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "filter", cvf_filter },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_OVERFLOW }, { HTML_UNDEF }, "fade", cvf_fade },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_GRID }, { HTML_UNDEF }, "fit-content", cvf_fit_content },
    { { HTML_CSS, 0, 0, H2_CSS_FONT_3 }, { HTML_UNDEF }, "format", cvf_format },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "grayscale", cvf_greyscale },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_HDR }, { HTML_UNDEF }, "hdr-color", cvf_hdr_colour },
    { { HTML_CSS, 0, 0, H2_CSS_FONT_4 }, { HTML_UNDEF }, "historical-forms", cvf_historical_forms },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_3 | H4_CSS_HDR }, { HTML_UNDEF }, "hsl", cvf_hsl },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_3 | H4_CSS_HDR }, { HTML_UNDEF }, "hsla", cvf_hsla },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "hue-rotate", cvf_hue_rotate },
    ...
    { { HTML_CSS, 0, 0, 0, H3_CSS_ANIM_TRIG }, { HTML_UNDEF }, "keypress", cvf_keypress },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_4 | H4_CSS_HDR }, { HTML_UNDEF }, "lab", cvf_lab },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_4 | H4_CSS_HDR }, { HTML_UNDEF }, "lch", cvf_lch },
    { { HTML_CSS, 0, 0, 0, H3_CSS_CONTENT }, { HTML_UNDEF }, "leader", cvf_leader },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_5 }, { HTML_UNDEF }, "light-dark", cvf_light_dark },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "linear", cvf_linear, ns_default, CF_MAYBE_NO_PARAMS },
    ...
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "log", cvf_log, ns_default, CF_CALC },
    ...
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "max", cvf_max, ns_default, CF_CALC },
    ...
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_4 | H4_CSS_HDR }, { HTML_UNDEF }, "oklab", cvf_oklab },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_4 | H4_CSS_HDR }, { HTML_UNDEF }, "oklch", cvf_oklch },
    ...
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_4 | H4_CSS_HDR }, { HTML_UNDEF }, "rgb", cvf_rgb },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_3 | H4_CSS_HDR }, { HTML_UNDEF }, "rgba", cvf_rgba },
    ...
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "round", cvf_round },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "saturate", cvf_saturate },
    ...
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_FILTER_3 }, { HTML_UNDEF }, "sepia", cvf_sepia },
    { { HTML_CSS, 0, 0, 0, H3_CSS_SHAPE }, { HTML_UNDEF }, "shape", cvf_shape },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_5 }, { HTML_UNDEF }, "sibling-count", cvf_sibling_count },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_5 }, { HTML_UNDEF }, "sibling-index", cvf_sibling_index },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "sign", cvf_sign },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "sin", cvf_sin, ns_default, CF_CALC },
    ...
    { { HTML_CSS, 0, 0, 0, H3_CSS_FLOAT }, { HTML_UNDEF }, "snap-block", cvf_snap_block, ns_default, CF_FLOAT | CF_MAYBE_NO_PARAMS },
    { { HTML_CSS, 0, 0, 0, H3_CSS_FLOAT }, { HTML_UNDEF }, "snap-inline", cvf_snap_inline, ns_default, CF_FLOAT | CF_MAYBE_NO_PARAMS },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "sqrt", cvf_sqrt, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "src", cvf_src },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "step-end", cvf_step_end, ns_default, CF_NO_PARAMS },
    ...
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_BORD_BOX_4 }, { HTML_UNDEF }, "superellipse", cvf_superellipse },
    { { HTML_CSS, 0, 0, H2_CSS_FONT_4 }, { HTML_UNDEF }, "swash", cvf_swash },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_5 }, { HTML_UNDEF }, "supports", cvf_supports, ns_default, CF_IF },
    { { HTML_CSS, 0, 0, H2_CSS_CS }, { HTML_UNDEF }, "symbols", cvf_symbols },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "tan", cvf_tan, ns_default, CF_CALC },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_MIXIN }, { HTML_UNDEF }, "type", cvf_type },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "url", cvf_url },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_ROUTE }, { HTML_UNDEF }, "url-pattern", cvf_url_pattern },
    { { HTML_CSS, 0, 0, H2_CSS_CUSTOM }, { HTML_UNDEF }, "var", cvf_var, ns_default, CF_CALC },
    { { HTML_CSS, 0, 0, 0, 0, H4_CSS_COLOUR_6 }, { HTML_UNDEF }, "wcag2", cvf_wcag2 },
...
{   { { HTML_TAGS }, { HTML_UNDEF }, "0", css_none },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "bespoke", css_bespoke },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "24", css_2024 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2024", css_2024 },
    { { HTML_TAGS }, { HTML_UNDEF }, "24+", css_2024_1 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2024+", css_2024_1 },
    { { HTML_TAGS }, { HTML_UNDEF }, "24++", css_2024_2 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2024++", css_2024_2 },
    { { HTML_TAGS }, { HTML_UNDEF }, "24+++", css_2024_3 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2024+++", css_2024_3 },
    { { HTML_TAGS }, { HTML_UNDEF }, "25", css_2025 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2025", css_2025 },
    { { HTML_TAGS }, { HTML_UNDEF }, "25+", css_2025_1 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2025+", css_2025_1 },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "26", css_2026 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2026", css_2026 },
    { { HTML_TAGS }, { HTML_UNDEF }, "26+", css_2026_1 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2026+", css_2026_1 },
    { { HTML_TAGS }, { HTML_UNDEF }, "26++", css_2026_2 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2026++", css_2026_2 },
    { { HTML_TAGS }, { HTML_UNDEF }, "26+++", css_2026_3 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2026+++", css_2026_3 },
    { { HTML_TAGS }, { HTML_UNDEF }, "html5/24", css_ls_2024 },
    { { HTML_TAGS }, { HTML_UNDEF }, "html5/25", css_ls_2025 },
    { { HTML_TAGS }, { HTML_UNDEF }, "html5/26", css_ls_2026 },
    { { HTML_TAGS }, { HTML_UNDEF }, "html5", css_ls_2026 } };
...
{   { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_BACKGROUND_34 | H5_CSS_DISPLAY_3 | H5_CSS_OVERFLOW }, { HTML_UNDEF }, "border-area", eccl_border_area },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_BACKGROUND_34 | H5_CSS_DISPLAY_3 | H5_CSS_OVERFLOW }, { HTML_UNDEF }, "border-box", eccl_border_box },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_BACKGROUND_4 }, { HTML_UNDEF }, "clip", eccl_clip },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_BACKGROUND_34 | H5_CSS_DISPLAY_3 | H5_CSS_OVERFLOW }, { HTML_UNDEF }, "content-box", eccl_content_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_BACKGROUND_34 | H5_CSS_DISPLAY_3 | H5_CSS_OVERFLOW }, { HTML_UNDEF }, "padding-box", eccl_padding_box },
    { { HTML_CSS, 0, 0, 0, H3_CSS_BOX_MODEL, 0, H5_CSS_BACKGROUND_34 | H5_CSS_DISPLAY_3 | H5_CSS_OVERFLOW }, { HTML_UNDEF }, "text", eccl_text } };
...
{   { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT }, { HTML_UNDEF }, "break-spaces", ecwh_break_spaces },
    { { HTML_CSS }, { HTML_UNDEF }, "collapse", ecwh_collapse },
    ...
    { { HTML_CSS }, { HTML_UNDEF }, "preserve", ecwh_preserve },
...
{   { { HTML_CSS, 0, 0, H2_CSS_2 | H2_CSS_CASCADE }, { HTML_UNDEF }, "default", cw_default },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_CASCADE }, { HTML_UNDEF }, "-moz-initial", cw_moz_initial },
...
struct symbol_entry < html_version, e_css_win_shad > css_win_shad_symbol_table [] =
{   { { HTML_CSS }, { HTML_UNDEF }, "default", ews_default },
    { { HTML_CSS }, { HTML_UNDEF }, "menu", ews_menu },
    { { HTML_CSS }, { HTML_UNDEF }, "none", ews_none },
    { { HTML_CSS }, { HTML_UNDEF }, "sheet", ews_sheet },
    { { HTML_CSS }, { HTML_UNDEF }, "tooltip", ews_tooltip } };

struct symbol_entry < html_version, e_css_word_break > css_word_break_symbol_table [] =
{   { { HTML_JAN26, 0, 0, 0, H3_CSS_TEXT_3 }, { HTML_UNDEF }, "auto-phrase", wb_auto_phrase },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_3 }, { HTML_UNDEF }, "break-all", wb_break_all },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_3 | H3_CSS_DEPRECATED }, { HTML_UNDEF }, "break-word", wb_break_word },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_3 }, { HTML_UNDEF }, "keep-all", wb_keep_all },
    { { HTML_CSS, 0, 0, 0, H3_CSS_TEXT_3 }, { HTML_UNDEF }, "normal", wb_normal } };
...
struct symbol_entry < html_version, e_directive > directive_symbol_table [] =
{   { { HTML_APR18 }, { HTML_UNDEF }, "accelerometer", dir_accelerometer },
    { { HTML_APR18 }, { HTML_UNDEF }, "ambient-light-sensor", dir_ambient_light_sensor },
    { { HTML_SEP23 }, { HTML_UNDEF }, "attribution-reporting", dir_attribution_reporting },
    { { HTML_JAN18 }, { HTML_UNDEF }, "autoplay", dir_autoplay },
    { { HTML_AUG22 }, { HTML_UNDEF }, "bluetooth", dir_bluetooth },
    { { HTML_JUL23 }, { HTML_UNDEF }, "browsing-topics", dir_browsing_topics },
    { { HTML_JAN18 }, { HTML_UNDEF }, "camera", dir_camera },
    { { HTML_MAY24 }, { HTML_UNDEF }, "compute-pressure", dir_compute_pressure },
    { { HTML_NOV20 }, { HTML_UNDEF }, "cross-origin-isolated", dir_cross_origin_isolated },
    { { HTML_SEP21 }, { HTML_UNDEF }, "display-capture", dir_display_capture },
    { { HTML_JAN18 }, { HTML_UNDEF }, "document-domain", dir_document_domain },
    { { HTML_JAN18 }, { HTML_UNDEF }, "encrypted-media", dir_encrypted_media },
    { { HTML_APR25 }, { HTML_UNDEF }, "focus-without-user-activation", dir_focus_without_user_activation },
    { { HTML_OCT17 }, { HTML_UNDEF }, "fullscreen", dir_fullscreen },
    { { HTML_JAN20 }, { HTML_UNDEF }, "gamepad", dir_gamepad },
    { { HTML_JAN18 }, { HTML_UNDEF }, "geolocation", dir_geolocation },
    { { HTML_APR18 }, { HTML_UNDEF }, "gyroscope", dir_gyroscope },
    { { HTML_MAR21 }, { HTML_UNDEF }, "hid", dir_hid },
    { { HTML_FEB23 }, { HTML_UNDEF }, "identity-credentials-get", dir_identity_credentials_get },
    { { HTML_SEP21 }, { HTML_UNDEF }, "idle-detection", dir_idle_detection },
    { { HTML_JUN22 }, { HTML_UNDEF }, "local-fonts", dir_local_fonts },
    { { HTML_APR18 }, { HTML_UNDEF }, "magnetometer", dir_magnetometer },
    { { HTML_JAN18 }, { HTML_UNDEF }, "microphone", dir_microphone },
    { { HTML_JAN18 }, { HTML_UNDEF }, "midi", dir_midi },
    { { HTML_AUG21 }, { HTML_UNDEF }, "otp-credentials", dir_otp_credentials },
    { { HTML_JUL17 }, { HTML_UNDEF }, "payment", dir_payment },
    { { HTML_DEC18 }, { HTML_UNDEF }, "picture-in-picture", dir_picture_in_picture },
    { { HTML_JUL20 }, { HTML_UNDEF }, "publickey-credentials-create", dir_publickey_credentials_create },
    { { HTML_JUL20 }, { HTML_UNDEF }, "publickey-credentials-get", dir_publickey_credentials_get },
    { { HTML_JUL20 }, { HTML_UNDEF }, "screen-wake-lock", dir_screen_wake_lock },
    { { HTML_MAR21 }, { HTML_UNDEF }, "serial", dir_serial },
    { { HTML_JAN20 }, { HTML_UNDEF }, "speaker-selection", dir_speaker_selection },
    { { HTML_MAY23 }, { HTML_UNDEF }, "storage-access", dir_storage_access },
    { { HTML_JUL17 }, { HTML_UNDEF }, "usb", dir_usb },
    { { HTML_OCT20 }, { HTML_UNDEF }, "web-share", dir_web_share },
    { { HTML_MAR22 }, { HTML_UNDEF }, "window-management", dir_window_management },
    { { HTML_DEC19 }, { HTML_UNDEF }, "xr-spatial-tracking", dir_xr_spatial_tracking } };
...
{   { { HTML_CSS, 0, 0, H2_CSS_CASCADE_56 }, { HTML_UNDEF }, "if", iiu_if, ns_default, CF_IF },
    ...
    { { HTML_CSS, 0, 0, H2_CSS_CASCADE_56 }, { HTML_UNDEF }, "revert-rule", iiu_revert_rule },
    { { HTML_CSS }, { HTML_UNDEF }, "unset", iiu_unset },
    { { HTML_CSS }, { HTML_UNDEF }, "(@function)", iiu_fn } };
...
{   { { HTML_SVG10, 0, HE_SVG, 0, H3_CSS_IMAGE }, { HTML_UNDEF }, "auto", ir_auto },
    ...
    { { HTML_CSS, 0, HE_BESPOKE | HE_MOZILLA }, { HTML_UNDEF }, "-moz-crisp-edges", ir_moz_crisp_edges },
...
struct symbol_entry < html_version, e_keycode > keycode_symbol_table [] =
{   { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AVRInput", ky_avrinput },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AVRPower", ky_avrpower },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Accept", ky_accept },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Again", ky_again },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AllCandidates", ky_allcandidates },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Alphanumeric", ky_alphanumeric },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Alt", ky_alt, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AltGraph", ky_altgraph, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AppSwitch", ky_appswitch },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ArrowDown", ky_arrowdown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ArrowLeft", ky_arrowleft },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ArrowRight", ky_arrowright },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ArrowUp", ky_arrowup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Attn", ky_attn },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioBalanceLeft", ky_audiobalanceleft },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioBalanceRight", ky_audiobalanceright },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioBassBoostDown", ky_audiobassboostdown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioBassBoostToggle", ky_audiobassboosttoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioBassBoostUp", ky_audiobassboostup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioFaderFront", ky_audiofaderfront },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioFaderRear", ky_audiofaderrear },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioSurroundModeNext", ky_audiosurroundmodenext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioTrebleDown", ky_audiotrebledown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioTrebleUp", ky_audiotrebleup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioVolumeDown", ky_audiovolumedown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioVolumeMute", ky_audiovolumemute },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "AudioVolumeUp", ky_audiovolumeup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Backspace", ky_backspace },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrightnessDown", ky_brightnessdown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrightnessUp", ky_brightnessup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrowserBack", ky_browserback },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrowserFavorites", ky_browserfavorites },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrowserForward", ky_browserforward },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrowserHome", ky_browserhome },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrowserRefresh", ky_browserrefresh },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrowserSearch", ky_browsersearch },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "BrowserStop", ky_browserstop },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Call", ky_call },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Camera", ky_camera },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "CameraFocus", ky_camerafocus },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Cancel", ky_cancel },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "CapsLock", ky_capslock, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ChannelDown", ky_channeldown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ChannelUp", ky_channelup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Clear", ky_clear },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Close", ky_close },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ClosedCaptionToggle", ky_closedcaptiontoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "CodeInput", ky_codeinput },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ColorF0Red", ky_colourf0red },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ColorF1Green", ky_colourf1green },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ColorF2Yellow", ky_colourf2yellow },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ColorF3Blue", ky_colourf3blue },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ColorF4Grey", ky_colourf4grey },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ColorF5Brown", ky_colourf5brown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Compose", ky_compose },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ContextMenu", ky_contextmenu },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Control", ky_control, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Convert", ky_convert },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Copy", ky_copy },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "CrSel", ky_crsel },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Cut", ky_cut },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "DVR", ky_dvr },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Dead", ky_dead },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Delete", ky_delete },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Dimmer", ky_dimmer },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "DisplaySwap", ky_displayswap },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Eisu", ky_eisu },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Eject", ky_eject },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "End", ky_end },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "EndCall", ky_endcall },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Enter", ky_enter },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "EraseEof", ky_eraseeof },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Escape", ky_escape },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ExSel", ky_exsel },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Execute", ky_execute },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Exit", ky_exit },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F1", ky_f1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F10", ky_f10 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F11", ky_f11 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F12", ky_f12 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F2", ky_f2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F3", ky_f3 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F4", ky_f4 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F5", ky_f5 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F6", ky_f6 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F7", ky_f7 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F8", ky_f8 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "F9", ky_f9 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteClear0", ky_favoriteclear0 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteClear1", ky_favoriteclear1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteClear2", ky_favoriteclear2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteClear3", ky_favoriteclear3 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteRecall0", ky_favoriterecall0 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteRecall1", ky_favoriterecall1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteRecall2", ky_favoriterecall2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteRecall3", ky_favoriterecall3 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteStore0", ky_favoritestore0 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteStore1", ky_favoritestore1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteStore2", ky_favoritestore2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FavoriteStore3", ky_favoritestore3 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FinalMode", ky_finalmode },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Find", ky_find },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Fn", ky_fn, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "FnLock", ky_fnlock, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "GoBack", ky_goback },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "GoHome", ky_gohome },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "GroupFirst", ky_groupfirst },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "GroupLast", ky_grouplast },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "GroupNext", ky_groupnext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "GroupPrevious", ky_groupprevious },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Guide", ky_guide },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "GuideNextDay", ky_guidenextday },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "GuidePreviousDay", ky_guidepreviousday },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "HangulMode", ky_hangulmode },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "HanjaMode", ky_hanjamode },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Hankaku", ky_hankaku },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "HeadsetHook", ky_headsethook },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Help", ky_help },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Hibernate", ky_hibernate },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Hiragana", ky_hiragana },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "HiraganaKatakana", ky_hiraganakatakana },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Home", ky_home },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Hyper", ky_hyper, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Info", ky_info },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Insert", ky_insert },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "InstantReplay", ky_instantreplay },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "JunjaMode", ky_junjamode },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "KanaMode", ky_kanamode },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "KanjiMode", ky_kanjimode },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Katakana", ky_katakana },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Key11", ky_key11 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Key12", ky_key12 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LastNumberRedial", ky_lastnumberredial },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchApplication1", ky_launchapplication1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchApplication2", ky_launchapplication2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchCalendar", ky_launchcalendar },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchContacts", ky_launchcontacts },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchMail", ky_launchmail },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchMediaPlayer", ky_launchmediaplayer },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchMusicPlayer", ky_launchmusicplayer },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchPhone", ky_launchphone },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchScreenSaver", ky_launchscreensaver },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchSpreadsheet", ky_launchspreadsheet },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchWebBrowser", ky_launchwebbrowser },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchWebCam", ky_launchwebcam },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LaunchWordProcessor", ky_launchwordprocessor },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Link", ky_link },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ListProgram", ky_listprogram },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LiveContent", ky_livecontent },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Lock", ky_lock },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "LogOff", ky_logoff },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MailForward", ky_mailforward },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MailReply", ky_mailreply },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MailSend", ky_mailsend },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MannerMode", ky_mannermode },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaApps", ky_mediaapps },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaAudioTrack", ky_mediaaudiotrack },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaClose", ky_mediaclose },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaFastForward", ky_mediafastforward },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaLast", ky_medialast },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaPause", ky_mediapause },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaPlay", ky_mediaplay },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaPlayPause", ky_mediaplaypause },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaRecord", ky_mediarecord },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaRewind", ky_mediarewind },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaSkipBackward", ky_mediaskipbackward },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaSkipForward", ky_mediaskipforward },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaStepBackward", ky_mediastepbackward },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaStepForward", ky_mediastepforward },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaStop", ky_mediastop },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaTopMenu", ky_mediatopmenu },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaTrackNext", ky_mediatracknext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MediaTrackPrevious", ky_mediatrackprevious },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Meta", ky_meta, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MicrophoneToggle", ky_microphonetoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MicrophoneVolumeDown", ky_microphonevolumedown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MicrophoneVolumeMute", ky_microphonevolumemute },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "MicrophoneVolumeUp", ky_microphonevolumeup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ModeChange", ky_modechange },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NavigateIn", ky_navigatein },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NavigateNext", ky_navigatenext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NavigateOut", ky_navigateout },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NavigatePrevious", ky_navigateprevious },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "New", ky_new },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NextCandidate", ky_nextcandidate },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NextFavoriteChannel", ky_nextfavoritechannel },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NextUserProfile", ky_nextuserprofile },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NonConvert", ky_nonconvert },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Notification", ky_notification },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "NumLock", ky_numlock, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "OnDemand", ky_ondemand },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Open", ky_open },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PageDown", ky_pagedown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PageUp", ky_pageup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Pairing", ky_pairing },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Paste", ky_paste },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Pause", ky_pause },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PinPDown", ky_pinpdown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PinPMove", ky_pinpmove },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PinPToggle", ky_pinptoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PinPUp", ky_pinpup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Play", ky_play },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PlaySpeedDown", ky_playspeeddown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PlaySpeedReset", ky_playspeedreset },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PlaySpeedUp", ky_playspeedup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Power", ky_power },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PowerOff", ky_poweroff },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PreviousCandidate", ky_previouscandidate },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Print", ky_print },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "PrintScreen", ky_printscreen },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Process", ky_process },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Props", ky_props },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "RandomToggle", ky_randomtoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "RcLowBattery", ky_rclowbattery },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "RecordSpeedNext", ky_recordspeednext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Redo", ky_redo },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "RfBypass", ky_rfbypass },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Romaji", ky_romaji },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "STBInput", ky_stbinput },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "STBPower", ky_stbpower },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Save", ky_save },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ScanChannelsToggle", ky_scanchannelstoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ScreenModeNext", ky_screenmodenext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ScrollLock", ky_scrolllock, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Select", ky_select },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Settings", ky_settings },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Shift", ky_shift, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "SingleCandidate", ky_singlecandidate },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Soft1", ky_soft1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Soft2", ky_soft2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Soft3", ky_soft3 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Soft4", ky_soft4 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "SpeechCorrectionList", ky_speechcorrectionlist },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "SpeechInputToggle", ky_speechinputtoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "SpellCheck", ky_spellcheck },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "SplitScreenToggle", ky_splitscreentoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Standby", ky_standby },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Subtitle", ky_subtitle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Super", ky_super, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Symbol", ky_symbol, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "SymbolLock", ky_symbollock, ns_default, KEY_MODIFIER },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TV", ky_tv },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TV3DMode", ky_tv3dmode },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVAntennaCable", ky_tvantennacable },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVAudioDescription", ky_tvaudiodescription },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVAudioDescriptionMixDown", ky_tvaudiodescriptionmixdown },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVAudioDescriptionMixUp", ky_tvaudiodescriptionmixup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVContentsMenu", ky_tvcontentsmenu },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVDataService", ky_tvdataservice },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInput", ky_tvinput },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputComponent1", ky_tvinputcomponent1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputComponent2", ky_tvinputcomponent2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputComposite1", ky_tvinputcomposite1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputComposite2", ky_tvinputcomposite2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputHDMI1", ky_tvinputhdmi1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputHDMI2", ky_tvinputhdmi2 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputHDMI3", ky_tvinputhdmi3 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputHDMI4", ky_tvinputhdmi4 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVInputVGA1", ky_tvinputvga1 },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVMediaContext", ky_tvmediacontext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVNetwork", ky_tvnetwork },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVNumberEntry", ky_tvnumberentry },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVPower", ky_tvpower },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVRadioService", ky_tvradioservice },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVSatellite", ky_tvsatellite },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVSatelliteBS", ky_tvsatellitebs },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVSatelliteCS", ky_tvsatellitecs },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVSatelliteToggle", ky_tvsatellitetoggle },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVTerrestrialAnalog", ky_tvterrestrialanalog },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVTerrestrialDigital", ky_tvterrestrialdigital },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "TVTimer", ky_tvtimer },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Tab", ky_tab },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Teletext", ky_teletext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Undo", ky_undo },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Unidentified", ky_unidentified },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "VideoModeNext", ky_videomodenext },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "VoiceDial", ky_voicedial },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "WakeUp", ky_wakeup },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Wink", ky_wink },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "Zenkaku", ky_zenkaku },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ZenkakuHankaku", ky_zenkakuhankaku },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ZoomIn", ky_zoomin },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ZoomOut", ky_zoomout },
    { { HTML_ARIA_1_1 }, { HTML_UNDEF }, "ZoomToggle", ky_zoomtoggle } };
...
{   { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "apc", l_apc },
    { { HTML_4_0, 0, 0, H2_CSS_ALL, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "cm", l_cm },
    { { HTML_4_0, 0, 0, H2_CSS_ALL, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "mm", l_mm },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "q", l_q },
    { { HTML_4_0, 0, 0, H2_CSS_ALL, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "in", l_in },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "ls", l_ls },
    { { HTML_4_0, 0, 0, H2_CSS_ALL, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "pc", l_pc },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "pls", l_pls },
    { { HTML_4_0, 0, 0, H2_CSS_ALL, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "pt", l_pt },
    { { HTML_4_0, 0, 0, H2_CSS_ALL, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "px", l_px } };
...
{   { { HTML_3_2, 0, 0, H2_CSS_ALL }, { HTML_UNDEF }, "%", l_percent },
    ...
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "cap", l_cap },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "ch", l_ch },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "ic", l_ic },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "rem", l_rem },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "lh", l_lh },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "rlh", l_rlh },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "vw", l_vw },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "vh", l_vh },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "vi", l_vi },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_4 }, { HTML_UNDEF }, "vb", l_vb },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "vmin", l_vmin },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "vmax", l_vmax } };
...
struct symbol_entry < html_version, e_locale > locale_symbol_table [] =
{   { { HTML_TAGS }, { HTML_UNDEF }, "aa", loc_aa },
    { { HTML_TAGS }, { HTML_UNDEF }, "aa-DJ", loc_aa_DJ },
    { { HTML_TAGS }, { HTML_UNDEF }, "aa-ER", loc_aa_ER },
    { { HTML_TAGS }, { HTML_UNDEF }, "aa-ET", loc_aa_ET },
    { { HTML_TAGS }, { HTML_UNDEF }, "af", loc_af },
    { { HTML_TAGS }, { HTML_UNDEF }, "af-ZA", loc_af_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "am", loc_am },
    { { HTML_TAGS }, { HTML_UNDEF }, "am-ET", loc_am_ET },
    { { HTML_TAGS }, { HTML_UNDEF }, "an", loc_an },
    { { HTML_TAGS }, { HTML_UNDEF }, "an-ES", loc_an_ES },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar", loc_ar },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-AE", loc_ar_AE },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-BH", loc_ar_BH },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-DZ", loc_ar_DZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-EG", loc_ar_EG },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-IN", loc_ar_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-IQ", loc_ar_IQ },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-JO", loc_ar_JO },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-KW", loc_ar_KW },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-LB", loc_ar_LB },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-LY", loc_ar_LY },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-MA", loc_ar_MA },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-OM", loc_ar_OM },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-QA", loc_ar_QA },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-SA", loc_ar_SA },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-SD", loc_ar_SD },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-SY", loc_ar_SY },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-TN", loc_ar_TN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ar-YE", loc_ar_YE },
    { { HTML_TAGS }, { HTML_UNDEF }, "as", loc_as },
    { { HTML_TAGS }, { HTML_UNDEF }, "as-IN", loc_as_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ast", loc_ast },
    { { HTML_TAGS }, { HTML_UNDEF }, "ast-ES", loc_ast_ES },
    { { HTML_TAGS }, { HTML_UNDEF }, "az", loc_az },
    { { HTML_TAGS }, { HTML_UNDEF }, "az-AZ", loc_az_AZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "be", loc_be },
    { { HTML_TAGS }, { HTML_UNDEF }, "be-BY", loc_be_BY },
    { { HTML_TAGS }, { HTML_UNDEF }, "bem", loc_bem },
    { { HTML_TAGS }, { HTML_UNDEF }, "bem-ZM", loc_bem_ZM },
    { { HTML_TAGS }, { HTML_UNDEF }, "ber", loc_ber },
    { { HTML_TAGS }, { HTML_UNDEF }, "ber-DZ", loc_ber_DZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "ber-MA", loc_ber_MA },
    { { HTML_TAGS }, { HTML_UNDEF }, "bg", loc_bg },
    { { HTML_TAGS }, { HTML_UNDEF }, "bg-BG", loc_bg_BG },
    { { HTML_TAGS }, { HTML_UNDEF }, "bho", loc_bho },
    { { HTML_TAGS }, { HTML_UNDEF }, "bho-IN", loc_bho_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "bn", loc_bn },
    { { HTML_TAGS }, { HTML_UNDEF }, "bn-BD", loc_bn_BD },
    { { HTML_TAGS }, { HTML_UNDEF }, "bn-IN", loc_bn_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "bo", loc_bo },
    { { HTML_TAGS }, { HTML_UNDEF }, "bo-CN", loc_bo_CN },
    { { HTML_TAGS }, { HTML_UNDEF }, "bo-IN", loc_bo_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "br", loc_br },
    { { HTML_TAGS }, { HTML_UNDEF }, "br-FR", loc_br_FR },
    { { HTML_TAGS }, { HTML_UNDEF }, "brx", loc_brx },
    { { HTML_TAGS }, { HTML_UNDEF }, "brx-IN", loc_brx_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "bs", loc_bs },
    { { HTML_TAGS }, { HTML_UNDEF }, "bs-BA", loc_bs_BA },
    { { HTML_TAGS }, { HTML_UNDEF }, "byn", loc_byn },
    { { HTML_TAGS }, { HTML_UNDEF }, "byn-ER", loc_byn_ER },
    { { HTML_TAGS }, { HTML_UNDEF }, "ca", loc_ca },
    { { HTML_TAGS }, { HTML_UNDEF }, "ca-AD", loc_ca_AD },
    { { HTML_TAGS }, { HTML_UNDEF }, "ca-ES", loc_ca_ES },
    { { HTML_TAGS }, { HTML_UNDEF }, "ca-FR", loc_ca_FR },
    { { HTML_TAGS }, { HTML_UNDEF }, "ca-IT", loc_ca_IT },
    { { HTML_TAGS }, { HTML_UNDEF }, "crh", loc_crh },
    { { HTML_TAGS }, { HTML_UNDEF }, "crh-UA", loc_crh_UA },
    { { HTML_TAGS }, { HTML_UNDEF }, "cs", loc_cs },
    { { HTML_TAGS }, { HTML_UNDEF }, "cs-CZ", loc_cs_CZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "csb", loc_csb },
    { { HTML_TAGS }, { HTML_UNDEF }, "csb-PL", loc_csb_PL },
    { { HTML_TAGS }, { HTML_UNDEF }, "cv", loc_cv },
    { { HTML_TAGS }, { HTML_UNDEF }, "cv-RU", loc_cv_RU },
    { { HTML_TAGS }, { HTML_UNDEF }, "cy", loc_cy },
    { { HTML_TAGS }, { HTML_UNDEF }, "cy-GB", loc_cy_GB },
    { { HTML_TAGS }, { HTML_UNDEF }, "da", loc_da },
    { { HTML_TAGS }, { HTML_UNDEF }, "da-DK", loc_da_DK },
    { { HTML_TAGS }, { HTML_UNDEF }, "de", loc_de },
    { { HTML_TAGS }, { HTML_UNDEF }, "de-AT", loc_de_AT },
    { { HTML_TAGS }, { HTML_UNDEF }, "de-BE", loc_de_BE },
    { { HTML_TAGS }, { HTML_UNDEF }, "de-CH", loc_de_CH },
    { { HTML_TAGS }, { HTML_UNDEF }, "de-DE", loc_de_DE },
    { { HTML_TAGS }, { HTML_UNDEF }, "de-LU", loc_de_LU },
    { { HTML_TAGS }, { HTML_UNDEF }, "dv", loc_dv },
    { { HTML_TAGS }, { HTML_UNDEF }, "dv-MV", loc_dv_MV },
    { { HTML_TAGS }, { HTML_UNDEF }, "dz", loc_dz },
    { { HTML_TAGS }, { HTML_UNDEF }, "dz-BT", loc_dz_BT },
    { { HTML_TAGS }, { HTML_UNDEF }, "el", loc_el },
    { { HTML_TAGS }, { HTML_UNDEF }, "el-CY", loc_el_CY },
    { { HTML_TAGS }, { HTML_UNDEF }, "el-GR", loc_el_GR },
    { { HTML_TAGS }, { HTML_UNDEF }, "en", loc_en },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-AG", loc_en_AG },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-AU", loc_en_AU },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-BW", loc_en_BW },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-CA", loc_en_CA },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-DK", loc_en_DK },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-GB", loc_en_GB },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-HK", loc_en_HK },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-IE", loc_en_IE },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-IN", loc_en_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-NG", loc_en_NG },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-NZ", loc_en_NZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-PH", loc_en_PH },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-SG", loc_en_SG },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-US", loc_en_US },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-ZA", loc_en_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-ZM", loc_en_ZM },
    { { HTML_TAGS }, { HTML_UNDEF }, "en-ZW", loc_en_ZW },
    { { HTML_TAGS }, { HTML_UNDEF }, "es", loc_es },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-AR", loc_es_AR },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-BO", loc_es_BO },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-CL", loc_es_CL },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-CO", loc_es_CO },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-CR", loc_es_CR },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-CU", loc_es_CU },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-DO", loc_es_DO },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-EC", loc_es_EC },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-ES", loc_es_ES },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-GT", loc_es_GT },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-HN", loc_es_HN },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-MX", loc_es_MX },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-NI", loc_es_NI },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-PA", loc_es_PA },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-PE", loc_es_PE },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-PR", loc_es_PR },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-PY", loc_es_PY },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-SV", loc_es_SV },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-US", loc_es_US },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-UY", loc_es_UY },
    { { HTML_TAGS }, { HTML_UNDEF }, "es-VE", loc_es_VE },
    { { HTML_TAGS }, { HTML_UNDEF }, "et", loc_et },
    { { HTML_TAGS }, { HTML_UNDEF }, "et-EE", loc_et_EE },
    { { HTML_TAGS }, { HTML_UNDEF }, "eu", loc_eu },
    { { HTML_TAGS }, { HTML_UNDEF }, "eu-ES", loc_eu_ES },
    { { HTML_TAGS }, { HTML_UNDEF }, "fa", loc_fa },
    { { HTML_TAGS }, { HTML_UNDEF }, "fa-IR", loc_fa_IR },
    { { HTML_TAGS }, { HTML_UNDEF }, "ff", loc_ff },
    { { HTML_TAGS }, { HTML_UNDEF }, "ff-SN", loc_ff_SN },
    { { HTML_TAGS }, { HTML_UNDEF }, "fi", loc_fi },
    { { HTML_TAGS }, { HTML_UNDEF }, "fi-FI", loc_fi_FI },
    { { HTML_TAGS }, { HTML_UNDEF }, "fil", loc_fil },
    { { HTML_TAGS }, { HTML_UNDEF }, "fil-PH", loc_fil_PH },
    { { HTML_TAGS }, { HTML_UNDEF }, "fo", loc_fo },
    { { HTML_TAGS }, { HTML_UNDEF }, "fo-FO", loc_fo_FO },
    { { HTML_TAGS }, { HTML_UNDEF }, "fr", loc_fr },
    { { HTML_TAGS }, { HTML_UNDEF }, "fr-BE", loc_fr_BE },
    { { HTML_TAGS }, { HTML_UNDEF }, "fr-CA", loc_fr_CA },
    { { HTML_TAGS }, { HTML_UNDEF }, "fr-CH", loc_fr_CH },
    { { HTML_TAGS }, { HTML_UNDEF }, "fr-FR", loc_fr_FR },
    { { HTML_TAGS }, { HTML_UNDEF }, "fr-LU", loc_fr_LU },
    { { HTML_TAGS }, { HTML_UNDEF }, "fur", loc_fur },
    { { HTML_TAGS }, { HTML_UNDEF }, "fur-IT", loc_fur_IT },
    { { HTML_TAGS }, { HTML_UNDEF }, "fy", loc_fy },
    { { HTML_TAGS }, { HTML_UNDEF }, "fy-DE", loc_fy_DE },
    { { HTML_TAGS }, { HTML_UNDEF }, "fy-NL", loc_fy_NL },
    { { HTML_TAGS }, { HTML_UNDEF }, "ga", loc_ga },
    { { HTML_TAGS }, { HTML_UNDEF }, "ga-IE", loc_ga_IE },
    { { HTML_TAGS }, { HTML_UNDEF }, "gd", loc_gd },
    { { HTML_TAGS }, { HTML_UNDEF }, "gd-GB", loc_gd_GB },
    { { HTML_TAGS }, { HTML_UNDEF }, "gez", loc_gez },
    { { HTML_TAGS }, { HTML_UNDEF }, "gez-ER", loc_gez_ER },
    { { HTML_TAGS }, { HTML_UNDEF }, "gez-ET", loc_gez_ET },
    { { HTML_TAGS }, { HTML_UNDEF }, "gl", loc_gl },
    { { HTML_TAGS }, { HTML_UNDEF }, "gl-ES", loc_gl_ES },
    { { HTML_TAGS }, { HTML_UNDEF }, "gu", loc_gu },
    { { HTML_TAGS }, { HTML_UNDEF }, "gu-IN", loc_gu_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "gv", loc_gv },
    { { HTML_TAGS }, { HTML_UNDEF }, "gv-GB", loc_gv_GB },
    { { HTML_TAGS }, { HTML_UNDEF }, "ha", loc_ha },
    { { HTML_TAGS }, { HTML_UNDEF }, "ha-NG", loc_ha_NG },
    { { HTML_TAGS }, { HTML_UNDEF }, "he", loc_he },
    { { HTML_TAGS }, { HTML_UNDEF }, "he-IL", loc_he_IL },
    { { HTML_TAGS }, { HTML_UNDEF }, "hi", loc_hi },
    { { HTML_TAGS }, { HTML_UNDEF }, "hi-IN", loc_hi_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "hne", loc_hne },
    { { HTML_TAGS }, { HTML_UNDEF }, "hne-IN", loc_hne_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "hr", loc_hr },
    { { HTML_TAGS }, { HTML_UNDEF }, "hr-HR", loc_hr_HR },
    { { HTML_TAGS }, { HTML_UNDEF }, "hsb", loc_hsb },
    { { HTML_TAGS }, { HTML_UNDEF }, "hsb-DE", loc_hsb_DE },
    { { HTML_TAGS }, { HTML_UNDEF }, "ht", loc_ht },
    { { HTML_TAGS }, { HTML_UNDEF }, "ht-HT", loc_ht_HT },
    { { HTML_TAGS }, { HTML_UNDEF }, "hu", loc_hu },
    { { HTML_TAGS }, { HTML_UNDEF }, "hu-HU", loc_hu_HU },
    { { HTML_TAGS }, { HTML_UNDEF }, "hy", loc_hy },
    { { HTML_TAGS }, { HTML_UNDEF }, "hy-AM", loc_hy_AM },
    { { HTML_TAGS }, { HTML_UNDEF }, "id", loc_id },
    { { HTML_TAGS }, { HTML_UNDEF }, "id-ID", loc_id_ID },
    { { HTML_TAGS }, { HTML_UNDEF }, "ig", loc_ig },
    { { HTML_TAGS }, { HTML_UNDEF }, "ig-NG", loc_ig_NG },
    { { HTML_TAGS }, { HTML_UNDEF }, "ik", loc_ik },
    { { HTML_TAGS }, { HTML_UNDEF }, "ik-CA", loc_ik_CA },
    { { HTML_TAGS }, { HTML_UNDEF }, "is", loc_is },
    { { HTML_TAGS }, { HTML_UNDEF }, "is-IS", loc_is_IS },
    { { HTML_TAGS }, { HTML_UNDEF }, "it", loc_it },
    { { HTML_TAGS }, { HTML_UNDEF }, "it-CH", loc_it_CH },
    { { HTML_TAGS }, { HTML_UNDEF }, "it-IT", loc_it_IT },
    { { HTML_TAGS }, { HTML_UNDEF }, "iu", loc_iu },
    { { HTML_TAGS }, { HTML_UNDEF }, "iu-CA", loc_iu_CA },
    { { HTML_TAGS }, { HTML_UNDEF }, "iw", loc_iw },
    { { HTML_TAGS }, { HTML_UNDEF }, "iw-IL", loc_iw_IL },
    { { HTML_TAGS }, { HTML_UNDEF }, "ja", loc_ja },
    { { HTML_TAGS }, { HTML_UNDEF }, "ja-JP", loc_ja_JP },
    { { HTML_TAGS }, { HTML_UNDEF }, "ka", loc_ka },
    { { HTML_TAGS }, { HTML_UNDEF }, "ka-GE", loc_ka_GE },
    { { HTML_TAGS }, { HTML_UNDEF }, "kk", loc_kk },
    { { HTML_TAGS }, { HTML_UNDEF }, "kk-KZ", loc_kk_KZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "kl", loc_kl },
    { { HTML_TAGS }, { HTML_UNDEF }, "kl-GL", loc_kl_GL },
    { { HTML_TAGS }, { HTML_UNDEF }, "km", loc_km },
    { { HTML_TAGS }, { HTML_UNDEF }, "km-KH", loc_km_KH },
    { { HTML_TAGS }, { HTML_UNDEF }, "kn", loc_kn },
    { { HTML_TAGS }, { HTML_UNDEF }, "kn-IN", loc_kn_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ko", loc_ko },
    { { HTML_TAGS }, { HTML_UNDEF }, "ko-KR", loc_ko_KR },
    { { HTML_TAGS }, { HTML_UNDEF }, "kok", loc_kok },
    { { HTML_TAGS }, { HTML_UNDEF }, "kok-IN", loc_kok_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ks", loc_ks },
    { { HTML_TAGS }, { HTML_UNDEF }, "ks-IN", loc_ks_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ku", loc_ku },
    { { HTML_TAGS }, { HTML_UNDEF }, "ku-TR", loc_ku_TR },
    { { HTML_TAGS }, { HTML_UNDEF }, "kw", loc_kw },
    { { HTML_TAGS }, { HTML_UNDEF }, "kw-GB", loc_kw_GB },
    { { HTML_TAGS }, { HTML_UNDEF }, "ky", loc_ky },
    { { HTML_TAGS }, { HTML_UNDEF }, "ky-KG", loc_ky_KG },
    { { HTML_TAGS }, { HTML_UNDEF }, "lb", loc_lb },
    { { HTML_TAGS }, { HTML_UNDEF }, "lb-LU", loc_lb_LU },
    { { HTML_TAGS }, { HTML_UNDEF }, "lg", loc_lg },
    { { HTML_TAGS }, { HTML_UNDEF }, "lg-UG", loc_lg_UG },
    { { HTML_TAGS }, { HTML_UNDEF }, "li", loc_li },
    { { HTML_TAGS }, { HTML_UNDEF }, "li-BE", loc_li_BE },
    { { HTML_TAGS }, { HTML_UNDEF }, "li-NL", loc_li_NL },
    { { HTML_TAGS }, { HTML_UNDEF }, "lij", loc_lij },
    { { HTML_TAGS }, { HTML_UNDEF }, "lij-IT", loc_lij_IT },
    { { HTML_TAGS }, { HTML_UNDEF }, "lo", loc_lo },
    { { HTML_TAGS }, { HTML_UNDEF }, "lo-LA", loc_lo_LA },
    { { HTML_TAGS }, { HTML_UNDEF }, "lt", loc_lt },
    { { HTML_TAGS }, { HTML_UNDEF }, "lt-LT", loc_lt_LT },
    { { HTML_TAGS }, { HTML_UNDEF }, "lv", loc_lv },
    { { HTML_TAGS }, { HTML_UNDEF }, "lv-LV", loc_lv_LV },
#ifdef HOMAGE
    { { HTML_TAGS }, { HTML_UNDEF }, "ma", loc_ma },
    { { HTML_TAGS }, { HTML_UNDEF }, "ma-CT", loc_ma_CT },
#endif // HOMAGE
    { { HTML_TAGS }, { HTML_UNDEF }, "mag", loc_mag },
    { { HTML_TAGS }, { HTML_UNDEF }, "mag-IN", loc_mag_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "mai", loc_mai },
    { { HTML_TAGS }, { HTML_UNDEF }, "mai-IN", loc_mai_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "mg", loc_mg },
    { { HTML_TAGS }, { HTML_UNDEF }, "mg-MG", loc_mg_MG },
    { { HTML_TAGS }, { HTML_UNDEF }, "mhr", loc_mhr },
    { { HTML_TAGS }, { HTML_UNDEF }, "mhr-RU", loc_mhr_RU },
    { { HTML_TAGS }, { HTML_UNDEF }, "mi", loc_mi },
    { { HTML_TAGS }, { HTML_UNDEF }, "mi-NZ", loc_mi_NZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "mk", loc_mk },
    { { HTML_TAGS }, { HTML_UNDEF }, "mk-MK", loc_mk_MK },
    { { HTML_TAGS }, { HTML_UNDEF }, "ml", loc_ml },
    { { HTML_TAGS }, { HTML_UNDEF }, "ml-IN", loc_ml_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "mn", loc_mn },
    { { HTML_TAGS }, { HTML_UNDEF }, "mn-MN", loc_mn_MN },
    { { HTML_TAGS }, { HTML_UNDEF }, "mr", loc_mr },
    { { HTML_TAGS }, { HTML_UNDEF }, "mr-IN", loc_mr_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ms", loc_ms },
    { { HTML_TAGS }, { HTML_UNDEF }, "ms-MY", loc_ms_MY },
    { { HTML_TAGS }, { HTML_UNDEF }, "mt", loc_mt },
    { { HTML_TAGS }, { HTML_UNDEF }, "mt-MT", loc_mt_MT },
    { { HTML_TAGS }, { HTML_UNDEF }, "my", loc_my },
    { { HTML_TAGS }, { HTML_UNDEF }, "my-MM", loc_my_MM },
    { { HTML_TAGS }, { HTML_UNDEF }, "nan", loc_nan },
    { { HTML_TAGS }, { HTML_UNDEF }, "nan-TW", loc_nan_TW },
    { { HTML_TAGS }, { HTML_UNDEF }, "nb", loc_nb },
    { { HTML_TAGS }, { HTML_UNDEF }, "nb-NO", loc_nb_NO },
    { { HTML_TAGS }, { HTML_UNDEF }, "nds", loc_nds },
    { { HTML_TAGS }, { HTML_UNDEF }, "nds-DE", loc_nds_DE },
    { { HTML_TAGS }, { HTML_UNDEF }, "nds-NL", loc_nds_NL },
    { { HTML_TAGS }, { HTML_UNDEF }, "ne", loc_ne },
    { { HTML_TAGS }, { HTML_UNDEF }, "ne-NP", loc_ne_NP },
    { { HTML_TAGS }, { HTML_UNDEF }, "nl", loc_nl },
    { { HTML_TAGS }, { HTML_UNDEF }, "nl-AW", loc_nl_AW },
    { { HTML_TAGS }, { HTML_UNDEF }, "nl-BE", loc_nl_BE },
    { { HTML_TAGS }, { HTML_UNDEF }, "nl-NL", loc_nl_NL },
    { { HTML_TAGS }, { HTML_UNDEF }, "nn", loc_nn },
    { { HTML_TAGS }, { HTML_UNDEF }, "nn-NO", loc_nn_NO },
    { { HTML_TAGS }, { HTML_UNDEF }, "nr", loc_nr },
    { { HTML_TAGS }, { HTML_UNDEF }, "nr-ZA", loc_nr_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "nso", loc_nso },
    { { HTML_TAGS }, { HTML_UNDEF }, "nso-ZA", loc_nso_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "oc", loc_oc },
    { { HTML_TAGS }, { HTML_UNDEF }, "oc-FR", loc_oc_FR },
    { { HTML_TAGS }, { HTML_UNDEF }, "om", loc_om },
    { { HTML_TAGS }, { HTML_UNDEF }, "om-ET", loc_om_ET },
    { { HTML_TAGS }, { HTML_UNDEF }, "om-KE", loc_om_KE },
    { { HTML_TAGS }, { HTML_UNDEF }, "or", loc_or },
    { { HTML_TAGS }, { HTML_UNDEF }, "or-IN", loc_or_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "os", loc_os },
    { { HTML_TAGS }, { HTML_UNDEF }, "os-RU", loc_os_RU },
    { { HTML_TAGS }, { HTML_UNDEF }, "pa", loc_pa },
    { { HTML_TAGS }, { HTML_UNDEF }, "pa-IN", loc_pa_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "pa-PK", loc_pa_PK },
    { { HTML_TAGS }, { HTML_UNDEF }, "pap", loc_pap },
    { { HTML_TAGS }, { HTML_UNDEF }, "pap-AN", loc_pap_AN },
    { { HTML_TAGS }, { HTML_UNDEF }, "pl", loc_pl },
    { { HTML_TAGS }, { HTML_UNDEF }, "pl-PL", loc_pl_PL },
    { { HTML_TAGS }, { HTML_UNDEF }, "ps", loc_ps },
    { { HTML_TAGS }, { HTML_UNDEF }, "ps-AF", loc_ps_AF },
    { { HTML_TAGS }, { HTML_UNDEF }, "pt", loc_pt },
    { { HTML_TAGS }, { HTML_UNDEF }, "pt-BR", loc_pt_BR },
    { { HTML_TAGS }, { HTML_UNDEF }, "pt-PT", loc_pt_PT },
    { { HTML_TAGS }, { HTML_UNDEF }, "ro", loc_ro },
    { { HTML_TAGS }, { HTML_UNDEF }, "ro-RO", loc_ro_RO },
    { { HTML_TAGS }, { HTML_UNDEF }, "ru", loc_ru },
    { { HTML_TAGS }, { HTML_UNDEF }, "ru-RU", loc_ru_RU },
    { { HTML_TAGS }, { HTML_UNDEF }, "ru-UA", loc_ru_UA },
    { { HTML_TAGS }, { HTML_UNDEF }, "rw", loc_rw },
    { { HTML_TAGS }, { HTML_UNDEF }, "rw-RW", loc_rw_RW },
    { { HTML_TAGS }, { HTML_UNDEF }, "sa", loc_sa },
    { { HTML_TAGS }, { HTML_UNDEF }, "sa-IN", loc_sa_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "sc", loc_sc },
    { { HTML_TAGS }, { HTML_UNDEF }, "sc-IT", loc_sc_IT },
    { { HTML_TAGS }, { HTML_UNDEF }, "sd", loc_sd },
    { { HTML_TAGS }, { HTML_UNDEF }, "sd-IN", loc_sd_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "se", loc_se },
    { { HTML_TAGS }, { HTML_UNDEF }, "se-NO", loc_se_NO },
    { { HTML_TAGS }, { HTML_UNDEF }, "shs", loc_shs },
    { { HTML_TAGS }, { HTML_UNDEF }, "shs-CA", loc_shs_CA },
    { { HTML_TAGS }, { HTML_UNDEF }, "si", loc_si },
    { { HTML_TAGS }, { HTML_UNDEF }, "si-LK", loc_si_LK },
    { { HTML_TAGS }, { HTML_UNDEF }, "sid", loc_sid },
    { { HTML_TAGS }, { HTML_UNDEF }, "sid-ET", loc_sid_ET },
    { { HTML_TAGS }, { HTML_UNDEF }, "sk", loc_sk },
    { { HTML_TAGS }, { HTML_UNDEF }, "sk-SK", loc_sk_SK },
    { { HTML_TAGS }, { HTML_UNDEF }, "sl", loc_sl },
    { { HTML_TAGS }, { HTML_UNDEF }, "sl-SI", loc_sl_SI },
    { { HTML_TAGS }, { HTML_UNDEF }, "so", loc_so },
    { { HTML_TAGS }, { HTML_UNDEF }, "so-DJ", loc_so_DJ },
    { { HTML_TAGS }, { HTML_UNDEF }, "so-ET", loc_so_ET },
    { { HTML_TAGS }, { HTML_UNDEF }, "so-KE", loc_so_KE },
    { { HTML_TAGS }, { HTML_UNDEF }, "so-SO", loc_so_SO },
    { { HTML_TAGS }, { HTML_UNDEF }, "sq", loc_sq },
    { { HTML_TAGS }, { HTML_UNDEF }, "sq-AL", loc_sq_AL },
    { { HTML_TAGS }, { HTML_UNDEF }, "sq-MK", loc_sq_MK },
    { { HTML_TAGS }, { HTML_UNDEF }, "sr", loc_sr },
    { { HTML_TAGS }, { HTML_UNDEF }, "sr-ME", loc_sr_ME },
    { { HTML_TAGS }, { HTML_UNDEF }, "sr-RS", loc_sr_RS },
    { { HTML_TAGS }, { HTML_UNDEF }, "ss", loc_ss },
    { { HTML_TAGS }, { HTML_UNDEF }, "ss-ZA", loc_ss_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "st", loc_st },
    { { HTML_TAGS }, { HTML_UNDEF }, "st-ZA", loc_st_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "sv", loc_sv },
    { { HTML_TAGS }, { HTML_UNDEF }, "sv-FI", loc_sv_FI },
    { { HTML_TAGS }, { HTML_UNDEF }, "sv-SE", loc_sv_SE },
    { { HTML_TAGS }, { HTML_UNDEF }, "sw", loc_sw },
    { { HTML_TAGS }, { HTML_UNDEF }, "sw-KE", loc_sw_KE },
    { { HTML_TAGS }, { HTML_UNDEF }, "sw-TZ", loc_sw_TZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "ta", loc_ta },
    { { HTML_TAGS }, { HTML_UNDEF }, "ta-IN", loc_ta_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ta-LK", loc_ta_LK },
    { { HTML_TAGS }, { HTML_UNDEF }, "te", loc_te },
    { { HTML_TAGS }, { HTML_UNDEF }, "te-IN", loc_te_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "tg", loc_tg },
    { { HTML_TAGS }, { HTML_UNDEF }, "tg-TJ", loc_tg_TJ },
    { { HTML_TAGS }, { HTML_UNDEF }, "th", loc_th },
    { { HTML_TAGS }, { HTML_UNDEF }, "th-TH", loc_th_TH },
    { { HTML_TAGS }, { HTML_UNDEF }, "ti", loc_ti },
    { { HTML_TAGS }, { HTML_UNDEF }, "ti-ER", loc_ti_ER },
    { { HTML_TAGS }, { HTML_UNDEF }, "ti-ET", loc_ti_ET },
    { { HTML_TAGS }, { HTML_UNDEF }, "tig", loc_tig },
    { { HTML_TAGS }, { HTML_UNDEF }, "tig-ER", loc_tig_ER },
    { { HTML_TAGS }, { HTML_UNDEF }, "tk", loc_tk },
    { { HTML_TAGS }, { HTML_UNDEF }, "tk-TM", loc_tk_TM },
    { { HTML_TAGS }, { HTML_UNDEF }, "tl", loc_tl },
    { { HTML_TAGS }, { HTML_UNDEF }, "tl-PH", loc_tl_PH },
    { { HTML_TAGS }, { HTML_UNDEF }, "tn", loc_tn },
    { { HTML_TAGS }, { HTML_UNDEF }, "tn-ZA", loc_tn_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "tr", loc_tr },
    { { HTML_TAGS }, { HTML_UNDEF }, "tr-CY", loc_tr_CY },
    { { HTML_TAGS }, { HTML_UNDEF }, "tr-TR", loc_tr_TR },
    { { HTML_TAGS }, { HTML_UNDEF }, "ts", loc_ts },
    { { HTML_TAGS }, { HTML_UNDEF }, "ts-ZA", loc_ts_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "tt", loc_tt },
    { { HTML_TAGS }, { HTML_UNDEF }, "tt-RU", loc_tt_RU },
    { { HTML_TAGS }, { HTML_UNDEF }, "ug", loc_ug },
    { { HTML_TAGS }, { HTML_UNDEF }, "ug-CN", loc_ug_CN },
    { { HTML_TAGS }, { HTML_UNDEF }, "uk", loc_uk },
    { { HTML_TAGS }, { HTML_UNDEF }, "uk-UA", loc_uk_UA },
    { { HTML_TAGS }, { HTML_UNDEF }, "unm", loc_unm },
    { { HTML_TAGS }, { HTML_UNDEF }, "unm-US", loc_unm_US },
    { { HTML_TAGS }, { HTML_UNDEF }, "ur", loc_ur },
    { { HTML_TAGS }, { HTML_UNDEF }, "ur-IN", loc_ur_IN },
    { { HTML_TAGS }, { HTML_UNDEF }, "ur-PK", loc_ur_PK },
    { { HTML_TAGS }, { HTML_UNDEF }, "uz", loc_uz },
    { { HTML_TAGS }, { HTML_UNDEF }, "uz-UZ", loc_uz_UZ },
    { { HTML_TAGS }, { HTML_UNDEF }, "ve", loc_ve },
    { { HTML_TAGS }, { HTML_UNDEF }, "ve-ZA", loc_ve_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "vi", loc_vi },
    { { HTML_TAGS }, { HTML_UNDEF }, "vi-VN", loc_vi_VN },
    { { HTML_TAGS }, { HTML_UNDEF }, "wa", loc_wa },
    { { HTML_TAGS }, { HTML_UNDEF }, "wa-BE", loc_wa_BE },
    { { HTML_TAGS }, { HTML_UNDEF }, "wae", loc_wae },
    { { HTML_TAGS }, { HTML_UNDEF }, "wae-CH", loc_wae_CH },
    { { HTML_TAGS }, { HTML_UNDEF }, "wal", loc_wal },
    { { HTML_TAGS }, { HTML_UNDEF }, "wal-ET", loc_wal_ET },
    { { HTML_TAGS }, { HTML_UNDEF }, "wo", loc_wo },
    { { HTML_TAGS }, { HTML_UNDEF }, "wo-SN", loc_wo_SN },
    { { HTML_TAGS }, { HTML_UNDEF }, "xh", loc_xh },
    { { HTML_TAGS }, { HTML_UNDEF }, "xh-ZA", loc_xh_ZA },
    { { HTML_TAGS }, { HTML_UNDEF }, "yi", loc_yi },
    { { HTML_TAGS }, { HTML_UNDEF }, "yi-US", loc_yi_US },
    { { HTML_TAGS }, { HTML_UNDEF }, "yo", loc_yo },
    { { HTML_TAGS }, { HTML_UNDEF }, "yo-NG", loc_yo_NG },
    { { HTML_TAGS }, { HTML_UNDEF }, "yue", loc_yue },
    { { HTML_TAGS }, { HTML_UNDEF }, "yue-HK", loc_yue_HK },
    { { HTML_TAGS }, { HTML_UNDEF }, "zh", loc_zh },
    { { HTML_TAGS }, { HTML_UNDEF }, "zh-CN", loc_zh_CN },
    { { HTML_TAGS }, { HTML_UNDEF }, "zh-HK", loc_zh_HK },
    { { HTML_TAGS }, { HTML_UNDEF }, "zh-SG", loc_zh_SG },
    { { HTML_TAGS }, { HTML_UNDEF }, "zh-TW", loc_zh_TW },
    { { HTML_TAGS }, { HTML_UNDEF }, "zu", loc_zu },
    { { HTML_TAGS }, { HTML_UNDEF }, "zu-ZA", loc_zu_ZA } };
...
struct symbol_entry < html_version, e_math_constant > math_constant_symbol_table [] =
{   { { HTML_DEC25 }, { HTML_UNDEF }, "e", mc_e },
    { { HTML_DEC25 }, { HTML_UNDEF }, "infinity", mc_infinity },
    { { HTML_DEC25 }, { HTML_UNDEF }, "-infinity", mc_minus_infinity },
    { { HTML_DEC25 }, { HTML_UNDEF }, "NaN", mc_nan },
    { { HTML_DEC25 }, { HTML_UNDEF }, "pi", mc_pi } };
...
{   { { XHTML_1_0, 0, 0, H2_MATH_1_2_3 }, { HTML_UNDEF }, "longdiv", mn_longdiv },
    { { XHTML_1_0 }, { HTML_UNDEF }, "actuarial", mn_actuarial },
    { { XHTML_1_0, 0, 0, H2_MATH_1_2_3 }, { HTML_UNDEF }, "radical", mn_radical },
...
struct symbol_entry < html_version, e_math_version > math_version_symbol_table [] =
{   { { HTML_TAGS }, { HTML_UNDEF }, "0", math_none },
    { { HTML_TAGS }, { HTML_UNDEF }, "1", math_1 },
    { { HTML_TAGS }, { HTML_UNDEF }, "2", math_2 },
    { { HTML_TAGS }, { HTML_UNDEF }, "3", math_3 },
    { { HTML_TAGS }, { HTML_UNDEF }, "4", math_4 },
    { { HTML_TAGS }, { HTML_UNDEF }, "core", math_core } };
...
{   { { HTML_JAN06 }, { HTML_UNDEF }, "atom", ns_atom },
    ...
    { { HTML_PTR }, { HTML_UNDEF }, "ptr", ns_ptr },
...
{   { { HTML_TAGS }, { HTML_UNDEF }, "class-count", nm_class_count },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-address", nm_context_address },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-animation-trigger", nm_context_css_animation_trigger },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-background", nm_context_css_background },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-border-box", nm_context_css_border_box },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-egg", nm_context_css_egg },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-environment", nm_context_css_environment },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-extensions", nm_context_css_extensions },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-gap", nm_context_css_gap },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-grid", nm_context_css_grid },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-hdr", nm_context_css_hdr },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-image-animation", nm_context_css_image_animation },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-linked-parameters", nm_context_css_linked_parameters },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-lists", nm_context_css_list },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-mixin", nm_context_mixin },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-pda", nm_context_css_pda },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-route", nm_context_css_route },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-snap-points", nm_context_css_snap_point },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-css-viewport", nm_css_context_viewport },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-gui", nm_context_gui },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-help", nm_context_help },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-home", nm_context_home },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-http-11", nm_context_http_11 },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-ipv4", nm_context_ipv4 },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-ipv6", nm_context_ipv6 },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-konqueror", nm_context_konqueror },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-lang", nm_context_lang },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-line-length", nm_contect_line_length },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-md-pretty", nm_context_md_pretty },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mozilla", nm_context_mozilla },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-msg", nm_context_msg },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-netscape", nm_context_netscape },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-naughty", nm_context_naughty },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-nice", nm_context_nice },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-no-ex-check", nm_context_no_ex_check },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-note", nm_context_note },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-once", nm_context_once },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-output", nm_context_output },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-output-description", nm_context_output_description},
    { { HTML_TAGS }, { HTML_UNDEF }, "context-output-operator", nm_context_output_operator },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-output-sign", nm_context_output_sign },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-output-time", nm_context_output_time },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-opera", nm_context_opera },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-output-password", nm_context_output_password },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-output-private", nm_context_output_private },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-output-public", nm_context_output_public },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-persisted", nm_context_persisted },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-port", nm_context_port },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-sign", nm_context_sign },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-signature", nm_context_signature },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-special", nm_context_special },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-ssi-doc-args", nm_context_ssi_doc_args },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-ssi-echomsg", nm_context_ssi_echomsg },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-ssi-errmsg", nm_context_ssi_errmsg },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-ssi-exec-run", nm_context_ssi_exec_run },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-ssi-exec-text", nm_context_ssi_exec_text },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-anchor", nm_context_stats_anchor },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-annotation", nm_context_stats_annotation },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-attribute", nm_context_stats_attribute },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-custom-selector", nm_context_stats_custom_selector },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-error", nm_context_stats_error },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-function", nm_context_stats_function },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-id", nm_context_stats_id },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-param", nm_context_stats_param },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stats-property", nm_context_stats_property },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-stylesheet", nm_context_stylesheet },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "output-account", nm_output_account },
    { { HTML_TAGS }, { HTML_UNDEF }, "output-build", nm_output_build },
    { { HTML_TAGS }, { HTML_UNDEF }, "output-description", nm_output_description },
    { { HTML_TAGS }, { HTML_UNDEF }, "output-operator", nm_output_operator },
    { { HTML_TAGS }, { HTML_UNDEF }, "output-time", nm_output_time },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "nit-pdf", nm_nit_doc_pdf },
    { { HTML_TAGS }, { HTML_UNDEF }, "nit-ref", nm_nit_ref },
    { { HTML_TAGS }, { HTML_UNDEF }, "nit-text", nm_nit_doc_text },
    { { HTML_TAGS }, { HTML_UNDEF }, "nit-zip", nm_nit_doc_zip },
    { { HTML_TAGS }, { HTML_UNDEF }, "nits-lost", mn_nits_lost },
    { { HTML_TAGS }, { HTML_UNDEF }, "note-content", nm_note_content },
    { { HTML_TAGS }, { HTML_UNDEF }, "note-note", nm_note_note },
    { { HTML_TAGS }, { HTML_UNDEF }, "note-title", nm_note_title },
    { { HTML_TAGS }, { HTML_UNDEF }, "output-format", nm_output_format },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "page-path", nm_page_path },
...
{   { { HTML_TAGS }, { HTML_UNDEF }, "class", ns_class },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "du", ns_du },
    { { HTML_TAGS }, { HTML_UNDEF }, "du-foot", ns_du_foot },
    { { HTML_TAGS }, { HTML_UNDEF }, "du-head", ns_du_head },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "note", ns_note },
    { { HTML_TAGS }, { HTML_UNDEF }, "note-foot", ns_note_foot },
    { { HTML_TAGS }, { HTML_UNDEF }, "note-head", ns_note_head },
...
struct symbol_entry < html_version, e_output_template > output_template_symbol_table [] =
{   { { HTML_TAGS }, { HTML_UNDEF }, NIT_HTML, eot_html },
    { { HTML_TAGS }, { HTML_UNDEF }, NIT_SPEC, eot_spec },
    { { HTML_TAGS }, { HTML_UNDEF }, NIT_STYLESHEET, eot_stylesheet },
    { { HTML_TAGS }, { HTML_UNDEF }, NIT_TEST, eot_test },
    { { HTML_TAGS }, { HTML_UNDEF }, NIT_TEXT, eot_text },
    { { HTML_TAGS }, { HTML_UNDEF }, NIT_XHTML, eot_xhtml } };
...
struct symbol_entry < html_version, e_report, e_nit_macro, nm_none > report_symbol_table [] =
{   { { HTML_TAGS }, { HTML_UNDEF }, "A&bbr.", rcb_abbreviation, nm_context_stats_abbr },
    { { HTML_TAGS }, { HTML_UNDEF }, "A&nchor.", rcb_anchor, nm_context_stats_anchor },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "C&har Var.", rcb_character_variant, nm_context_stats_character_variant },
    { { HTML_TAGS }, { HTML_UNDEF }, "C&lass", rcb_class, nm_context_stats_class },
    { { HTML_TAGS }, { HTML_UNDEF }, "C&ontent", rcb_content_name, nm_context_stats_content_name },
    { { HTML_TAGS }, { HTML_UNDEF }, "C&ounter", rcb_counter_style, nm_context_stats_counter_style },
    { { HTML_TAGS }, { HTML_UNDEF }, "CSS &Prop.", rcb_css_property, nm_context_stats_css_property },
    { { HTML_TAGS }, { HTML_UNDEF }, "C&ust. Media", rcb_custom_media, nm_context_stats_custom_media },
    { { HTML_TAGS }, { HTML_UNDEF }, "C&ust. Prop.", rcb_custom_property, nm_context_stats_custom_property },
    { { HTML_TAGS }, { HTML_UNDEF }, "C&ust. Sel.", rcb_custom_selector, nm_context_stats_custom_selector },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "&File", rcb_file, nm_context_stats_file },
    { { HTML_TAGS }, { HTML_UNDEF }, "&Font", rcb_font, nm_context_stats_font },
    { { HTML_TAGS }, { HTML_UNDEF }, "Fa&mily", rcb_font_family, nm_context_stats_font_family },
    { { HTML_TAGS }, { HTML_UNDEF }, "F&unction", rcb_function, nm_context_stats_function },
    { { HTML_TAGS }, { HTML_UNDEF }, "Hi&ghlight", rcb_highlight, nm_context_stats_highlight },
    { { HTML_TAGS }, { HTML_UNDEF }, "H&ist. Form", rcb_historical_form, nm_context_stats_historical_form },
    { { HTML_TAGS }, { HTML_UNDEF }, "I&D", rcb_id, nm_context_stats_id },
    { { HTML_TAGS }, { HTML_UNDEF }, "&ItemId", rcb_itemid, nm_context_stats_itemid },
    { { HTML_TAGS }, { HTML_UNDEF }, "&Keyframe", rcb_keyframe, nm_context_stats_keyframe },
    { { HTML_TAGS }, { HTML_UNDEF }, "La&yer", rcb_layer, nm_context_stats_layer },
    { { HTML_TAGS }, { HTML_UNDEF }, "Met&a", rcb_meta, nm_context_stats_meta },
    { { HTML_TAGS }, { HTML_UNDEF }, "Name/&Val", rcb_name_value, nm_context_stats_dtdd },
    { { HTML_TAGS }, { HTML_UNDEF }, "&Ontology", rcb_ontology, nm_context_stats_ontology },
    { { HTML_TAGS }, { HTML_UNDEF }, "Ornaments", rcb_ornament, nm_context_stats_ornament },
    { { HTML_TAGS }, { HTML_UNDEF }, "&Page", rcb_page, nm_context_stats_page },
    { { HTML_TAGS }, { HTML_UNDEF }, "Page &Name", rcb_page_name, nm_context_stats_page_name },
    { { HTML_TAGS }, { HTML_UNDEF }, "Pa&lette", rcb_palette, nm_context_stats_palette },
    { { HTML_TAGS }, { HTML_UNDEF }, "Pa&ram", rcb_param, nm_context_stats_param },
    { { HTML_TAGS }, { HTML_UNDEF }, "Pr&operty", rcb_property, nm_context_stats_property },
    { { HTML_TAGS }, { HTML_UNDEF }, "Re&ference", rcb_reference, nm_context_stats_reference },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "S&tatement", rcb_statement, nm_context_stats_statement },
    { { HTML_TAGS }, { HTML_UNDEF }, "Style&set", rcb_styleset, nm_context_stats_styleset },
    { { HTML_TAGS }, { HTML_UNDEF }, "Stylis&tic", rcb_stylistic, nm_context_stats_stylistic },
    { { HTML_TAGS }, { HTML_UNDEF }, "S&ummary", rcb_summary, nm_context_stats_summary },
    { { HTML_TAGS }, { HTML_UNDEF }, "S&wash", rcb_swash, nm_context_stats_swash },
    { { HTML_TAGS }, { HTML_UNDEF }, "Ve&rsion", rcb_version, nm_context_stats_version },
    { { HTML_TAGS }, { HTML_UNDEF }, "&View", rcb_view, nm_context_stats_view } };
...
{   { { HTML_TAGS }, { HTML_UNDEF }, CATASTROPHE, es_catastrophic },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, WHOOPS, es_error },
...
struct symbol_entry < html_version, e_speculationrules > speculationrules_symbol_table [] =
{   { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "eagerness", spc_eagerness },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "expects_no_vary_search", spc_expectsnovarysearch },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "prefetch", spc_prefetch },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "prerender", spc_prerender },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "referrer_policy", spc_referrerpolicy },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "relative_to", spc_relativeto },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "requires", spc_requires },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "source", spc_source },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "tag", spc_tag },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "target_hint", spc_targethint },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "urls", spc_urls },
    { { HTML_DEC25, 0, HE_EXPERIMENTAL }, { HTML_UNDEF }, "where", spc_where } };
...
{   { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "end", sp_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "jump-both", sp_jump_both },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "jump-end", sp_jump_end },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "jump-none", sp_jump_none },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "jump-start", sp_jump_start },
    { { HTML_CSS, 0, 0, 0, 0, 0, H5_CSS_EASE }, { HTML_UNDEF }, "start", sp_start } };
...
{   { { HTML_TAGS }, { HTML_UNDEF }, "aaa", tld_aaa },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "an", tld_an, ns_default, TLD_ARCHAIC },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "bit", tld_bit, ns_default, TLD_UNOFFICIAL },
    { { HTML_TAGS }, { HTML_UNDEF }, "bitnet", tld_bitnet, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "corp", tld_corp, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "cs", tld_cs, ns_default, TLD_ARCHAIC },
    { { HTML_TAGS }, { HTML_UNDEF }, "csc", tld_csc },
    { { HTML_TAGS }, { HTML_UNDEF }, "csnet", tld_csnet, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "dd", tld_dd, ns_default, TLD_ARCHAIC },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "home", tld_home, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "internet", tld_internet, ns_default, TLD_UNOFFICIAL },
    { { HTML_TAGS }, { HTML_UNDEF }, "intuit", tld_intuit },
    { { HTML_TAGS }, { HTML_UNDEF }, "intranet", tld_intranet, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "lan", tld_lan, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "nato", tld_nato, ns_default, TLD_ARCHAIC },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "oz", tld_oz, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "private", tld_private, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "swift", tld_swift, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "uucp", tld_uucp, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "vm", tld_vm, ns_default, TLD_UNOFFICIAL },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "yu", tld_yu, ns_default, TLD_ARCHAIC },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "zr", tld_zr, ns_default, TLD_ARCHAIC },
...
{   { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "adafish", eu_adafish },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "apc", eu_apc },
    { { HTML_JAN21 }, { HTML_UNDEF }, "cap", eu_cap },
    { { HTML_JUN19 }, { HTML_UNDEF }, "ch", eu_ch },
    { { HTML_2_0, 0, 0, H2_CSS, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "cm", eu_cm },
    { { HTML_2_0, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "cqb", eu_cqb },
    { { HTML_2_0, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "cqh", eu_cqh },
    { { HTML_2_0, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "cqi", eu_cqi },
    { { HTML_2_0, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "cqmin", eu_cqmin },
    { { HTML_2_0, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "cqmax", eu_cqmax },
    { { HTML_2_0, 0, 0, 0, H3_CSS_CONTAIN_45 }, { HTML_UNDEF }, "cqw", eu_cqw },
    ...
    { { HTML_2_0, 0, 0, H2_CSS, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "em", eu_em },
    { { HTML_2_0, 0, 0, H2_CSS, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "ex", eu_ex },
    { { HTML_2_0, 0, 0, 0, 0, 0, H5_CSS_GRID }, { HTML_UNDEF }, "fr", eu_fr },
    { { HTML_JAN21 }, { HTML_UNDEF }, "ic", eu_ic },
    { { HTML_2_0, 0, 0, H2_CSS, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "in", eu_in },
    { { HTML_JAN21 }, { HTML_UNDEF }, "lh", eu_lh },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "ls", eu_ls },
    { { HTML_2_0, 0, 0, H2_CSS, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "mm", eu_mm },
    { { HTML_2_0, 0, 0, H2_CSS, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "pc", eu_pc },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "pls", eu_pls },
    { { HTML_2_0, 0, 0, H2_CSS, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "pt", eu_pt },
    { { HTML_2_0, 0, 0, H2_CSS, 0, H4_CSS_PRN_GOOD }, { HTML_UNDEF }, "px", eu_px },
    ...
    { { HTML_2_0, 0, 0, H2_CSS_MEDIA_4 }, { HTML_UNDEF }, "x", eu_x } };

struct symbol_entry < html_version, e_unit_abs_len > unit_abs_len_symbol_table [] =
{   { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "apc", eua_apc },
    { { HTML_4_0, 0, 0, 0, 0, H4_CSS_PRN_GOOD, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "cm", eua_cm },
    { { HTML_4_0, 0, 0, 0, 0, H4_CSS_PRN_GOOD, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "in", eus_in },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "ls", eua_ls },
    { { HTML_4_0, 0, 0, 0, 0, H4_CSS_PRN_GOOD, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "mm", eua_mm },
    { { HTML_4_0, 0, 0, 0, 0, H4_CSS_PRN_GOOD, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "pc", eua_pc },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "pls", eua_pls },
    { { HTML_4_0, 0, 0, 0, 0, H4_CSS_PRN_GOOD, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "pt", eua_pt },
    { { HTML_4_0, 0, 0, 0, 0, H4_CSS_PRN_GOOD, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "px", eua_px },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "Q", eua_q } };

struct symbol_entry < html_version, e_unit_angle > unit_angle_symbol_table [] =
{   { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "deg", ean_deg },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "grad", ean_grad },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "rad", ean_rad },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "turn", ean_turn } };

struct symbol_entry < html_version, e_unit_freq > unit_freq_symbol_table [] =
{   { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "adafish", euf_adafish },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "Hz", euf_hz },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "kHz", euf_khz } };

struct symbol_entry < html_version, e_unit_rel_len > unit_rel_len_symbol_table [] =
{   { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "ch", eur_ch },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "em", eur_em },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "ex", eur_ex },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "rem", eur_rem },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "vh", eur_vh },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "vmax", eur_vmax },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "vmin", eur_vmin },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "vw", eur_vw } };

struct symbol_entry < html_version, e_unit_res > unit_res_symbol_table [] =
{   { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "dpcm", eur_dpcm },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "dpi", eur_dpi },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "dppx", eur_dppx },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "x", eur_x } };

struct symbol_entry < html_version, e_unit_time > unit_time_symbol_table [] =
{   { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "ftn", eut_ftn  },
    { { HTML_FEB23, 0, HE_EXPERIMENTAL, 0, H3_CSS_EGG }, { HTML_UNDEF }, "mftn", eut_mftn  },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "ms", eut_ms  },
    { { HTML_4_0, 0, 0, 0, 0, 0, H5_CSS_VALUE_3 }, { HTML_UNDEF }, "s", eur_s } };
...
{   { { HTML_4_0 }, { HTML_UNDEF }, NSL_ATOM, x_atom },
    ...
    { { HTML_CNT }, { HTML_UNDEF }, HTTPS_W3 "/2011/content#", x_cnt },
    ...
    { { HTML_PTR }, { HTML_UNDEF }, HTTPS_W3 "/2009/pointers#", x_ptr },
...
#define INIT_FIXED_ENUM(XX,NN) \
    type_master < t_##XX > :: init (nits, XX##_symbol_table, NN);

#define INIT_ENUM(XX) \
    INIT_FIXED_ENUM (XX, sizeof (XX##_symbol_table) / sizeof (symbol_entry < html_version, e_##XX >)) \
    if (context.validation ().find (VALIDATION #XX) == context.validation ().cend ()) \
        context.validation ().insert (::std::pair (VALIDATION #XX, "add a valid '" #XX "'."))
...
{   INIT_ENUM (abfmt);
    ...
    INIT_ENUM (alignplus);
    INIT_ENUM (aria_current);
    INIT_ENUM (aria_popup);
    INIT_ENUM (as);
    INIT_ENUM (as_units);
    INIT_ENUM (attr_unit);
    ...
    INIT_ENUM (css_all_2);
    INIT_ENUM (css_anchor_side_e);
    INIT_ENUM (css_anchor_size_e);
    INIT_ENUM (css_anim_act);
    INIT_ENUM (css_appearance);
    INIT_ENUM (css_atf_ky);
    INIT_ENUM (css_azimuth_e);
    INIT_ENUM (css_background_attachment);
    INIT_ENUM (css_background_repeat);
    INIT_ENUM (css_bespoker);
    ...
    INIT_ENUM (css_ellipse_pos_e);
    INIT_ENUM (css_ellipse_pos_x_2_e);
    INIT_ENUM (css_ellipse_pos_y_2_e);
    INIT_ENUM (css_env_var_predef);
    INIT_ENUM (css_etee);
    INIT_ENUM (css_float);
    INIT_ENUM (css_fn);
    ...
    INIT_ENUM (css_mask_composite);
    INIT_FIXED_ENUM (css_module, c_bad);
    INIT_ENUM (css_navigation_keyword);
    INIT_ENUM (css_overflow);
    INIT_ENUM (css_overflow_style);
    INIT_ENUM (css_pa_block);
    INIT_ENUM (css_pa_inline);
    INIT_ENUM (css_pa_left);
    INIT_ENUM (css_pa_self_block);
    INIT_ENUM (css_pa_self_inline);
    INIT_ENUM (css_pa_self);
    INIT_ENUM (css_pa_start);
    INIT_ENUM (css_pa_top);
    INIT_ENUM (css_paint_box);
    INIT_ENUM (css_pause_3_e);
    INIT_ENUM (css_pitch_e);
    INIT_ENUM (css_position);
    INIT_ENUM (css_print_status);
    INIT_ENUM (css_ray_size);
    INIT_ENUM (css_rgb_xyz);
    INIT_ENUM (css_reading_flow);
    INIT_ENUM (css_rect);
    INIT_ENUM (css_relative_size);
    INIT_ENUM (css_resize);
    INIT_ENUM (css_scroll_button);
    INIT_ENUM (css_self_position);
    INIT_ENUM (css_shape_box);
    INIT_ENUM (css_size_e);
    INIT_ENUM (css_sizing);
    INIT_ENUM (css_slider_orientation);
    INIT_ENUM (css_speak_as_e);
    INIT_ENUM (css_speech_rate_e);
    INIT_ENUM (css_ss_scroll);
    INIT_ENUM (css_ss_snapped);
    INIT_ENUM (css_ss_stuck);
    ...
    INIT_ENUM (css_text_justify);
    INIT_ENUM (css_text_spacing_trim);
    INIT_ENUM (css_text_transform);
    INIT_ENUM (css_textdec_line_e);
    INIT_ENUM (css_textdec_skip);
    INIT_ENUM (css_textdec_style);
    INIT_ENUM (css_textemph_shape);
    INIT_ENUM (css_text_wrap);
    INIT_ENUM (css_text_wrap_style);
    INIT_ENUM (css_touch_action);
    INIT_ENUM (css_transform_box);
    INIT_ENUM (css_trn);
    INIT_ENUM (css_try_tactic);
    INIT_ENUM (css_type);
    ...
    INIT_ENUM (css_wide);
    INIT_ENUM (css_win_shad);
    INIT_ENUM (css_word_break);
...
#undef INIT_ENUM
#undef INIT_FIXED_ENUM

#define RETURN_SIZE(XX) \
    case t_##XX : return sizeof (XX##_symbol_table) / sizeof (symbol_entry < html_version, e_##XX >);

::std::size_t enum_base_count (const e_type t)
{   extern ::std::size_t charset_count ();
    extern ::std::size_t class_count ();
    extern ::std::size_t css_colour_count ();
    extern ::std::size_t country_count ();
    extern ::std::size_t currency_count ();
    extern ::std::size_t dingbat_count ();
    extern ::std::size_t fixedcolour_count ();
    extern ::std::size_t format_count ();
    extern ::std::size_t css_property_count ();
    extern ::std::size_t httpequiv_count ();
    extern ::std::size_t lang_count ();
    extern ::std::size_t media_count ();
    extern ::std::size_t metaname_count ();
    extern ::std::size_t mime_count ();
    extern ::std::size_t rel_count ();
    extern ::std::size_t sgml_count ();
    extern ::std::size_t svg_feature_count ();

    switch (t)
    {   case t_charset : return charset_count ();
        case t_class : return class_count ();
        case t_css_colour : return css_colour_count ();
        case t_fixedcolour : return fixedcolour_count ();
        case t_country : return country_count ();
        case t_currency : return currency_count ();
        case t_format : return format_count ();
        case t_css_property : return css_property_count ();
        case t_httpequiv : return httpequiv_count ();
        case t_lang : return lang_count ();
        case t_rel : return rel_count ();
        case t_media : return media_count ();
        case t_metaname : return metaname_count ();
        case t_mime : return mime_count ();
        case t_sgml : return sgml_count (); 
        case t_svg_feature : return svg_feature_count ();
        RETURN_SIZE (abfmt);
        RETURN_SIZE (accrual_method);
        ...
        RETURN_SIZE (aria_current);
        RETURN_SIZE (aria_popup);
        RETURN_SIZE (as);
        RETURN_SIZE (as_units);
        RETURN_SIZE (attr_unit);
        RETURN_SIZE (autocapitalise);
        RETURN_SIZE (autocomplete);
        ...
        RETURN_SIZE (container_condition);
        RETURN_SIZE (copy);
        RETURN_SIZE (cr_fileproperty);
        RETURN_SIZE (crossout);
        RETURN_SIZE (crs_whitebalance);
        RETURN_SIZE (css_aaalri);
        RETURN_SIZE (css_absolute_size);
        RETURN_SIZE (css_align_content);
        RETURN_SIZE (css_align_items);
        RETURN_SIZE (css_all_2);
        RETURN_SIZE (css_anchor_side_e);
        RETURN_SIZE (css_anchor_size_e);
        RETURN_SIZE (css_anim_act);
        RETURN_SIZE (css_appearance);
        RETURN_SIZE (css_atf_ky);
        RETURN_SIZE (css_azimuth_e);
        RETURN_SIZE (css_background_attachment);
        RETURN_SIZE (css_background_repeat);
        RETURN_SIZE (css_bespoker);
        RETURN_SIZE (css_blend_mode);
        RETURN_SIZE (css_border_style);
        RETURN_SIZE (css_border_width);
        RETURN_SIZE (css_box_alignself_mess);
        RETURN_SIZE (css_box_snap);
        RETURN_SIZE (css_break);
        RETURN_SIZE (css_break_inside);
        ...
        RETURN_SIZE (css_container_state);
        RETURN_SIZE (css_content_enum);
        RETURN_SIZE (css_content_position);
        RETURN_SIZE (css_continue);
        RETURN_SIZE (css_control_break);
        RETURN_SIZE (css_coord_box);
        RETURN_SIZE (css_corner_shape_name);
        RETURN_SIZE (css_counter_style);
        RETURN_SIZE (css_cursor_e);
        RETURN_SIZE (css_display);
        RETURN_SIZE (css_display_inside);
        RETURN_SIZE (css_display_internal);
        RETURN_SIZE (css_elevation_e);
        RETURN_SIZE (css_ellipse_pos_e);
        RETURN_SIZE (css_ellipse_pos_x_2_e);
        RETURN_SIZE (css_ellipse_pos_y_2_e);
        RETURN_SIZE (css_env_var_predef);
        RETURN_SIZE (css_etee);
        RETURN_SIZE (css_float);
        RETURN_SIZE (css_fn);
        RETURN_SIZE (css_font_display);
        RETURN_SIZE (css_font_feature);
        RETURN_SIZE (css_font_format);
        RETURN_SIZE (css_font_size_adjust_e);
        RETURN_SIZE (css_font_tech);
        RETURN_SIZE (css_font_variation);
        RETURN_SIZE (css_font_weight);
        RETURN_SIZE (css_generic_family);
        RETURN_SIZE (css_hll);
        RETURN_SIZE (css_inline_bem_1);
        RETURN_SIZE (css_inline_bem_2);
        RETURN_SIZE (css_justify_content);
        RETURN_SIZE (css_layout_box);
        RETURN_SIZE (css_line_break);
        RETURN_SIZE (css_list_style_position);
        RETURN_SIZE (css_list_style_type);
        RETURN_SIZE (css_mask_composite);
        case t_css_module : return c_bad;
        RETURN_SIZE (css_navigation_keyword);
        RETURN_SIZE (css_overflow);
        RETURN_SIZE (css_overflow_style);
        RETURN_SIZE (css_pa_block);
        RETURN_SIZE (css_pa_inline);
        RETURN_SIZE (css_pa_left);
        RETURN_SIZE (css_pa_self_block);
        RETURN_SIZE (css_pa_self_inline);
        RETURN_SIZE (css_pa_self);
        RETURN_SIZE (css_pa_start);
        RETURN_SIZE (css_pa_top);
        RETURN_SIZE (css_paint_box);
        RETURN_SIZE (css_pause_3_e);
        RETURN_SIZE (css_pitch_e);
        RETURN_SIZE (css_position);
        RETURN_SIZE (css_print_status);
        RETURN_SIZE (css_ray_size);
        RETURN_SIZE (css_rgb_xyz);
        RETURN_SIZE (css_reading_flow);
        RETURN_SIZE (css_rect);
        RETURN_SIZE (css_relative_size);
        RETURN_SIZE (css_resize);
        RETURN_SIZE (css_scroll_button);
        RETURN_SIZE (css_shape_box);
        RETURN_SIZE (css_size_e);
        RETURN_SIZE (css_sizing);
        RETURN_SIZE (css_ss_scroll);
        RETURN_SIZE (css_ss_snapped);
        RETURN_SIZE (css_ss_stuck);
        RETURN_SIZE (css_self_position);
        RETURN_SIZE (css_speak_as_e);
        RETURN_SIZE (css_ss_type_e);
        RETURN_SIZE (css_statement);
        RETURN_SIZE (css_speech_rate_e);
        RETURN_SIZE (css_system_e);
        RETURN_SIZE (css_text_align);
        RETURN_SIZE (css_text_align_all);
        RETURN_SIZE (css_text_align_last);
        RETURN_SIZE (css_text_autospace);
        RETURN_SIZE (css_text_decoration);
        RETURN_SIZE (css_text_justify);
        RETURN_SIZE (css_text_spacing_trim);
        RETURN_SIZE (css_text_transform);
        RETURN_SIZE (css_textdec_line_e);
        RETURN_SIZE (css_textdec_skip);
        RETURN_SIZE (css_textdec_style);
        RETURN_SIZE (css_textemph_shape);
        RETURN_SIZE (css_text_wrap);
        RETURN_SIZE (css_text_wrap_style);
        RETURN_SIZE (css_touch_action);
        RETURN_SIZE (css_transform_box);
        RETURN_SIZE (css_trn);
        RETURN_SIZE (css_try_tactic);
        RETURN_SIZE (css_type);
        RETURN_SIZE (css_user_select);
        RETURN_SIZE (css_val_fn);
        RETURN_SIZE (css_version);
        RETURN_SIZE (css_vertical_align);
        RETURN_SIZE (css_visual_box);
        RETURN_SIZE (css_voice_balance_e);
        RETURN_SIZE (css_volume_e);
        RETURN_SIZE (css_whitespace);
        RETURN_SIZE (css_wide);
        RETURN_SIZE (css_win_shad);
        RETURN_SIZE (css_word_break);
        RETURN_SIZE (css_wrap_flow);
        RETURN_SIZE (css_wsc);
        RETURN_SIZE (css_wst);
        RETURN_SIZE (cursor);
        RETURN_SIZE (dcmitype);
        RETURN_SIZE (decalign);
        RETURN_SIZE (determiner);
        RETURN_SIZE (dingbat);
        RETURN_SIZE (dir);
        RETURN_SIZE (directive);
        RETURN_SIZE (display_align);
        RETURN_SIZE (dominantbaseline);
        RETURN_SIZE (enterkeyhint);
        RETURN_SIZE (evt_action);
        RETURN_SIZE (figalign);
        RETURN_SIZE (filter_in);
        RETURN_SIZE (font_enum);
        RETURN_SIZE (fontname);
        RETURN_SIZE (font_variant_2);
        RETURN_SIZE (font_variant_caps);
        RETURN_SIZE (font_variant_east_asian);
        RETURN_SIZE (font_variant_ligature);
        ...
        RETURN_SIZE (inputplus);
        RETURN_SIZE (inputtype);
        RETURN_SIZE (inputtype3);
        RETURN_SIZE (inputtype32);
        RETURN_SIZE (inputtype4);
        RETURN_SIZE (inputtype5);
        RETURN_SIZE (jtoken);
        RETURN_SIZE (keycode);
        RETURN_SIZE (kind);
        RETURN_SIZE (length_absolute);
        RETURN_SIZE (length_relative);
        RETURN_SIZE (linebreak);
        RETURN_SIZE (linkparam);
        RETURN_SIZE (listtype);
        RETURN_SIZE (locale);
        RETURN_SIZE (longdivstyle);
        RETURN_SIZE (lrnialign);
        RETURN_SIZE (mah);
        RETURN_SIZE (mathalign);
        RETURN_SIZE (math_constant);
        RETURN_SIZE (mathlocation);
        RETURN_SIZE (mathnotation);
        RETURN_SIZE (mathoverflow);
        RETURN_SIZE (mathvariant);
        RETURN_SIZE (math_version);
        RETURN_SIZE (matrixtype);
        RETURN_SIZE (method);
        RETURN_SIZE (mf_identifier);
        RETURN_SIZE (mf_itemtype);
        RETURN_SIZE (mf_listing_action);
        RETURN_SIZE (mf_method);
        RETURN_SIZE (mf_relationship);
        RETURN_SIZE (mf_reviewtype);
        RETURN_SIZE (mf_tel);
        RETURN_SIZE (month_english_long);
        RETURN_SIZE (month_english_short);
        RETURN_SIZE (mrss_medium);
        RETURN_SIZE (mrss_role);
        RETURN_SIZE (musickey);
        RETURN_SIZE (myersbriggs);
        RETURN_SIZE (namedspace);
        RETURN_SIZE (namespace);
        RETURN_SIZE (nit_macro);
        RETURN_SIZE (nit_section);
        RETURN_SIZE (ogtype);
        RETURN_SIZE (output_template);
        RETURN_SIZE (page_orientation);
        RETURN_SIZE (paintkeyword);
        RETURN_SIZE (pam_ccv);
        RETURN_SIZE (pcmm_status);
        RETURN_SIZE (plusstyle);
        RETURN_SIZE (pointer_events);
        RETURN_SIZE (pri_img_colour);
        RETURN_SIZE (pri_img_technique);
        RETURN_SIZE (pri_img_viewpoint);
        RETURN_SIZE (print);
        RETURN_SIZE (prism_ad_pos);
        RETURN_SIZE (prism_ad_type);
        RETURN_SIZE (prism_ag_type);
        RETURN_SIZE (prism_audience_sector);
        RETURN_SIZE (prism_ccv);
        RETURN_SIZE (prism_class);
        RETURN_SIZE (prism_contenttype);
        RETURN_SIZE (prism_cvp);
        RETURN_SIZE (prism_genre);
        RETURN_SIZE (prism_icv);
        RETURN_SIZE (prism_pasv);
        RETURN_SIZE (prism_pcv);
        RETURN_SIZE (prism_pfv);
        RETURN_SIZE (prism_ptv);
        RETURN_SIZE (prism_rcv);
        RETURN_SIZE (prism_role);
        RETURN_SIZE (prs_action);
        RETURN_SIZE (quote_style);
        RETURN_SIZE (recipe_content);
        RETURN_SIZE (recipe_course);
        RETURN_SIZE (recipe_cuisine);
        RETURN_SIZE (recipe_dietary);
        RETURN_SIZE (recipe_dish);
        RETURN_SIZE (recipe_exclusion);
        RETURN_SIZE (recipe_kit);
        RETURN_SIZE (recipe_meal);
        RETURN_SIZE (recipe_method);
        RETURN_SIZE (recipe_source);
        RETURN_SIZE (recipe_special);
        RETURN_SIZE (recipe_time);
        RETURN_SIZE (referrer);
        RETURN_SIZE (rendering_in_tents);
        RETURN_SIZE (rfc822_zone);
        ...
        RETURN_SIZE (stress);
        RETURN_SIZE (supports);
        RETURN_SIZE (svg_align);
        RETURN_SIZE (svg_display);
        RETURN_SIZE (svg_fontstretch);
        RETURN_SIZE (svg_fontstretch_ff);
        RETURN_SIZE (svg_fontstyle);
        RETURN_SIZE (svg_fontweight);
        RETURN_SIZE (svg_fontweight_ff);
        RETURN_SIZE (svg_mode);
        RETURN_SIZE (svg_overflow);
        RETURN_SIZE (svg_rendering_intent);
        RETURN_SIZE (svg_type);
        RETURN_SIZE (svg_version);
        RETURN_SIZE (svg_version_grand);
        RETURN_SIZE (tableframe);
        RETURN_SIZE (tblri);
        RETURN_SIZE (text_decoration);
        RETURN_SIZE (text_rendering);
        RETURN_SIZE (tld);
        RETURN_SIZE (transform_anim);
        RETURN_SIZE (transformbehaviour);
        RETURN_SIZE (transform_fn);
        RETURN_SIZE (turbulence_type);
        RETURN_SIZE (unicode_bidi);
        RETURN_SIZE (unit);
        RETURN_SIZE (unit_abs_len);
        RETURN_SIZE (unit_angle);
        RETURN_SIZE (unit_freq);
        RETURN_SIZE (unit_rel_len);
        ...
        RETURN_SIZE (xmlns);
        RETURN_SIZE (xmpdm_audio_channel);
        RETURN_SIZE (xmpdm_audio_sample);
        RETURN_SIZE (xmpdm_camera_angle);
        RETURN_SIZE (xmpdm_camera_move);
        RETURN_SIZE (xmpdm_pulldown);
        RETURN_SIZE (xmpdm_shotsize);
        RETURN_SIZE (xmpdm_stretchmode);
        RETURN_SIZE (xmpdm_time_format);
        RETURN_SIZE (xmpdm_time_signature);
        RETURN_SIZE (xmpdm_video_pixeldepth);
        default: break; }
