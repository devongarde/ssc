...
{   { { HTML_JAN05 }, { HTML_UNDEF }, elem_a, role_link },
    ...
    { { HTML_JAN05 }, { HTML_5_3 }, elem_main, role_main },
...
{   { { HTML_JAN05 }, { HTML_UNDEF }, elem_a, role_button },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_b, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_bdi, role_any },
    ...
    { { HTML_JAN05 }, { HTML_5_1 }, elem_button, role_menuitem },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_data, role_any },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_embed, role_application },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_embed, role_document },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_embed, role_img },
    { { HTML_5_3 }, { HTML_UNDEF }, elem_embed, role_none },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_embed, role_presentation },
    ...
    { { HTML_JAN05 }, { HTML_5_1 }, elem_figcaption, role_any },
    ...
    { { HTML_JAN05 }, { HTML_5_1 }, elem_figure, role_any },
    ...
    { { HTML_JAN05 }, { HTML_5_2 }, elem_main, role_presentation },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_mark, role_any },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_ruby, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_s, role_any },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_table, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_tbody, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_td, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_tfoot, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_thead, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_th, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_time, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_tr, role_any },
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_u, role_any },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, elem_wbr, role_any },
    { { HTML_UNDEF }, { HTML_UNDEF }, elem_undefined, role_any } };
