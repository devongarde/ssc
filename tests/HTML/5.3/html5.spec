-f tests/HTML/5.3/html5.conf

PASS tests/HTML/5.3/example-1.html
2 naughty_lang
6 unrecognised_value
8 missing_close inserted_missing_closure

PASS tests/HTML/5.3/example-2.html
2 naughty_lang
6 unrecognised_value

PASS tests/HTML/5.3/example-3.html
0 title_required
...
PASS tests/HTML/5.3/example-4.html
0 title_required
...
PASS tests/HTML/5.3/example-5.html
0 title_required
2 inserted_missing_parent missing_close naughty_lang
14 missing_close
...
PASS tests/HTML/5.3/html5-bad.html
2 naughty_lang
5 mime
7 only_once
8 link_rel_off
...
110 attribute_required
112 bad_select
121 attribute_required
123 bad_select bad_select
132 attribute_required
144 attribute_required
149 bad_datalist
154 bad_datalist

PASS tests/HTML/5.3/html5-bad-2.html
4 unrecognised_value

PASS tests/HTML/5.3/html5-example.html
2 naughty_lang
...
PASS tests/HTML/5.3/html5-good.html
2 naughty_lang
34 requires_href
38 url_not_found
58 lonely_radio
...
PASS tests/HTML/5.3/html5-legacy.html
2 naughty_lang

PASS tests/HTML/5.3/template-1.html
2 naughty_lang

PASS tests/HTML/5.3/template-2.html
2 naughty_lang

PASS tests/HTML/5.3/template-3.html
1 presume_html_1 attribute_unrecognised_here attribute_unrecognised_here unrecognised_attribute

PASS tests/HTML/5.3/template-4.html
...
PASS tests/HTML/5.3/math-example-1.html
3 naughty_lang
