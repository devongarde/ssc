...
typedef typed_property < t_generic, ec_accent_colour > prop_accent_colour;
typedef typed_property < t_generic, ec_align_content > prop_align_content;
typedef typed_property < t_generic, ec_align_items > prop_align_items;
typedef typed_property < t_generic, ec_align_self > prop_align_self;
typedef typed_property < t_generic, ec_alignment_baseline > prop_alignment_baseline;
typedef typed_property < t_css_all_2, ec_all > prop_all;
typedef typed_property < t_generic, ec_animation > prop_animation;
typedef typed_property < t_generic, ec_animation_composition > prop_animation_composition;
typedef typed_property < t_generic, ec_animation_delay > prop_animation_delay;
typedef typed_property < t_generic, ec_animation_delay_end > prop_animation_delay_end;
typedef typed_property < t_generic, ec_animation_delay_start > prop_animation_delay_start;
typedef typed_property < t_generic, ec_animation_direction > prop_animation_direction;
typedef typed_property < t_generic, ec_animation_duration > prop_animation_duration;
typedef typed_property < t_generic, ec_animation_fill_mode > prop_animation_fill_mode;
typedef typed_property < t_generic, ec_animation_iteration_count > prop_animation_iteration_count;
typedef typed_property < t_generic, ec_animation_name > prop_animation_name;
typedef typed_property < t_generic, ec_animation_play_state > prop_animation_play_state;
typedef typed_property < t_generic, ec_animation_range > prop_animation_range;
typedef typed_property < t_generic, ec_animation_timeline > prop_animation_timeline;
typedef typed_property < t_generic, ec_animation_timing_function > prop_animation_timing_function;
typedef typed_property < t_generic, ec_appearance > prop_appearance;
...
typedef typed_property < t_generic, ec_background_blend_mode > prop_background_blend_mode;
typedef typed_property < t_generic, ec_background_clip > prop_background_clip;
...
typedef typed_property < t_generic, ec_background_origin > prop_background_origin;
...
typedef typed_property < t_generic, ec_background_size > prop_background_size;
typedef typed_property < t_real, ec_baseline > prop_baseline;
typedef typed_property < t_generic, ec_baseline_shift > prop_baseline_shift;
...
typedef typed_property < t_generic, ec_border_block_colour > prop_border_block_colour;
typedef typed_property < t_generic, ec_border_block_end > prop_border_block_end;
typedef typed_property < t_generic, ec_border_block_end_colour > prop_border_block_end_colour;
...
typedef typed_property < t_generic, ec_border_block_start_colour > prop_border_block_start_colour;
...
typedef typed_property < t_generic, ec_border_bottom_left_radius > prop_border_bottom_left_radius;
typedef typed_property < t_generic, ec_border_bottom_right_radius > prop_border_bottom_right_radius;
...
typedef typed_property < t_generic, ec_border_image > prop_border_image;
typedef typed_property < t_generic, ec_border_image_outset > prop_border_image_outset;
typedef typed_property < t_generic, ec_border_image_repeat > prop_border_image_repeat;
typedef typed_property < t_generic, ec_border_image_slice > prop_border_image_slice;
typedef typed_property < t_generic, ec_border_image_source > prop_border_image_source;
typedef typed_property < t_generic, ec_border_image_width > prop_border_image_width;
typedef typed_property < t_generic, ec_border_inline > prop_border_inline;
typedef typed_property < t_generic, ec_border_inline_colour > prop_border_inline_colour;
typedef typed_property < t_generic, ec_border_inline_end > prop_border_inline_end;
typedef typed_property < t_generic, ec_border_inline_end_colour > prop_border_inline_end_colour;
...
typedef typed_property < t_generic, ec_border_inline_start_colour > prop_border_inline_start_colour;
...
typedef typed_property < t_generic, ec_border_radius > prop_border_radius;
...
typedef typed_property < t_generic, ec_border_top_left_radius > prop_border_top_left_radius;
typedef typed_property < t_generic, ec_border_top_right_radius > prop_border_top_right_radius;
...
typedef typed_property < t_generic, ec_box_decoration_break > prop_box_decoration_break;
typedef typed_property < t_generic, ec_box_shadow > prop_box_shadow;
typedef typed_property < t_generic, ec_box_sizing > prop_box_sizing;
typedef typed_property < t_generic, ec_box_snap > prop_box_snap;
typedef typed_property < t_generic, ec_break_after > prop_break_after;
typedef typed_property < t_generic, ec_break_before > prop_break_before;
typedef typed_property < t_generic, ec_break_inside > prop_break_inside;
...
typedef typed_property < t_generic, ec_caret > prop_caret;
typedef typed_property < t_generic, ec_caret_colour > prop_caret_colour;
typedef typed_property < t_generic, ec_caret_shape > prop_caret_shape;
...
typedef typed_property < t_generic, ec_clip_rule > prop_clip_rule;
typedef typed_property < t_generic, ec_colour_adjust > prop_colour_adjust;
typedef typed_property < t_generic, ec_colour_interpolation_filters > prop_colour_interpolation_filters;
...
typedef typed_property < t_generic, ec_column_count > prop_column_count;
typedef typed_property < t_generic, ec_column_fill > prop_column_fill;
typedef typed_property < t_generic, ec_column_gap > prop_column_gap;
typedef typed_property < t_generic, ec_column_rule > prop_column_rule;
typedef typed_property < t_generic, ec_column_rule_colour > prop_column_rule_colour;
typedef typed_property < t_generic, ec_column_rule_style > prop_column_rule_style;
typedef typed_property < t_generic, ec_column_rule_width > prop_column_rule_width;
typedef typed_property < t_generic, ec_column_span > prop_column_span;
typedef typed_property < t_generic, ec_column_width > prop_column_width;
typedef typed_property < t_generic, ec_columns > prop_columns;
typedef typed_property < t_generic, ec_contain > prop_contain;
...
typedef typed_property < t_generic, ec_container > prop_container;
typedef typed_property < t_generic, ec_container_name > prop_container_name;
typedef typed_property < t_generic, ec_container_type > prop_container_type;
typedef typed_property < t_css_content, ec_content > prop_content;
typedef typed_property < t_generic, ec_content_visibility > prop_content_visibility;
...
typedef typed_property < t_generic, ec_dominant_baseline > prop_dominant_baseline;
...
typedef typed_property < t_generic, ec_fill > prop_fill;
typedef typed_property < t_generic, ec_fill_break > prop_fill_break;
typedef typed_property < t_generic, ec_fill_colour > prop_fill_colour;
typedef typed_property < t_generic, ec_fill_image > prop_fill_image;
typedef typed_property < t_generic, ec_fill_opacity > prop_fill_opacity;
...
typedef typed_property < t_generic, ec_fill_rule > prop_fill_rule;
typedef typed_property < t_generic, ec_fill_size > prop_fill_size;
typedef typed_property < t_generic, ec_flex > prop_flex;
typedef typed_property < t_generic, ec_flex_basis > prop_flex_basis;
typedef typed_property < t_generic, ec_flex_direction > prop_flex_direction;
typedef typed_property < t_generic, ec_flex_flow > prop_flex_flow;
typedef typed_property < t_generic, ec_flex_grow > prop_flex_grow;
typedef typed_property < t_generic, ec_flex_shrink > prop_flex_shrink;
typedef typed_property < t_generic, ec_flex_wrap > prop_flex_wrap;
...
typedef typed_property < t_generic, ec_flood_colour > prop_flood_colour;
typedef typed_property < t_generic, ec_flood_opacity > prop_flood_opacity;
...
typedef typed_property < t_generic, ec_font_synthesis > prop_font_synthesis;
...
typedef typed_property < t_generic, ec_gap > prop_gap;
typedef typed_property < t_generic, ec_glyph_orientation_vertical > prop_glyph_orientation_vertical;
typedef typed_property < t_generic, ec_grid > prop_grid;
typedef typed_property < t_generic, ec_grid_area > prop_grid_area;
typedef typed_property < t_generic, ec_grid_auto_columns > prop_grid_auto_columns;
typedef typed_property < t_generic, ec_grid_auto_flow > prop_grid_auto_flow;
typedef typed_property < t_generic, ec_grid_auto_rows > prop_grid_auto_rows;
typedef typed_property < t_generic, ec_grid_column > prop_grid_column;
typedef typed_property < t_generic, ec_grid_column_end > prop_grid_column_end;
typedef typed_property < t_generic, ec_grid_column_start > prop_grid_column_start;
typedef typed_property < t_generic, ec_grid_row > prop_grid_row;
typedef typed_property < t_generic, ec_grid_row_end > prop_grid_row_end;
typedef typed_property < t_generic, ec_grid_row_start > prop_grid_row_start;
typedef typed_property < t_generic, ec_grid_template > prop_grid_template;
typedef typed_property < t_generic, ec_grid_template_areas > prop_grid_template_areas;
typedef typed_property < t_generic, ec_grid_template_columns > prop_grid_template_columns;
typedef typed_property < t_generic, ec_grid_template_rows > prop_grid_template_rows;
...
typedef typed_property < t_generic, ec_image_rendering > prop_image_rendering;
...
typedef typed_property < t_generic, ec_inline_size > prop_inline_size;
typedef typed_property < t_generic, ec_inline_sizing > prop_inline_sizing;
typedef typed_property < t_generic, ec_inset > prop_inset;
typedef typed_property < t_generic, ec_inset_block > prop_inset_block;
typedef typed_property < t_generic, ec_inset_block_end > prop_inset_block_end;
typedef typed_property < t_generic, ec_inset_block_start > prop_inset_block_start;
typedef typed_property < t_generic, ec_inset_inline > prop_inset_inline;
typedef typed_property < t_generic, ec_inset_inline_end > prop_inset_inline_end;
typedef typed_property < t_generic, ec_inset_inline_start > prop_inset_inline_start;
typedef typed_property < t_generic, ec_isolation > prop_isolation;
typedef typed_property < t_generic, ec_justify_content > prop_justify_content;
typedef typed_property < t_generic, ec_justify_items > prop_justify_items;
typedef typed_property < t_generic, ec_justify_self > prop_justify_self;
...
typedef typed_property < t_generic, ec_lighting_colour > prop_lighting_colour;
...
typedef typed_property < t_generic, ec_margin_break > prop_margin_break;
...
typedef typed_property < t_generic, ec_margin_trim > prop_margin_trim;
typedef typed_property < t_generic, ec_marker > prop_marker;
typedef typed_property < t_generic, ec_marker_end > prop_marker_end;
...
typedef typed_property < t_generic, ec_marker_mid > prop_marker_mid;
...
typedef typed_property < t_generic, ec_marker_start > prop_marker_start;
typedef typed_property < t_css_marx, ec_marks > prop_marks;
typedef typed_property < t_generic, ec_mask > prop_mask;
typedef typed_property < t_generic, ec_mask_border > prop_mask_border;
typedef typed_property < t_generic, ec_mask_border_mode > prop_mask_border_mode;
typedef typed_property < t_generic, ec_mask_border_outset > prop_mask_border_outset;
typedef typed_property < t_generic, ec_mask_border_repeat > prop_mask_border_repeat;
typedef typed_property < t_generic, ec_mask_border_slice > prop_mask_border_slice;
typedef typed_property < t_generic, ec_mask_border_source > prop_mask_border_source;
typedef typed_property < t_generic, ec_mask_border_width > prop_mask_border_width;
typedef typed_property < t_generic, ec_mask_clip > prop_mask_clip;
typedef typed_property < t_generic, ec_mask_composite > prop_mask_composite;
typedef typed_property < t_generic, ec_mask_image > prop_mask_image;
typedef typed_property < t_generic, ec_mask_mode > prop_mask_mode;
typedef typed_property < t_generic, ec_mask_origin > prop_mask_origin;
typedef typed_property < t_generic, ec_mask_position > prop_mask_position;
typedef typed_property < t_generic, ec_mask_repeat > prop_mask_repeat;
typedef typed_property < t_generic, ec_mask_size > prop_mask_size;
typedef typed_property < t_generic, ec_mask_type > prop_mask_type;
...
typedef typed_property < t_generic, ec_mix_blend_mode > prop_mix_blend_mode;
typedef typed_property < t_generic, ec_nav_down > prop_nav_down;
typedef typed_property < t_generic, ec_nav_left > prop_nav_left;
typedef typed_property < t_generic, ec_nav_right > prop_nav_right;
typedef typed_property < t_generic, ec_nav_up > prop_nav_up;
...
typedef typed_property < t_generic, ec_opacity > prop_opacity;
typedef typed_property < t_generic, ec_order > prop_order;
...
typedef typed_property < t_generic, ec_outline_offset > prop_outline_offset;
...
typedef typed_property < t_generic, ec_overflow_block > prop_overflow_block;
typedef typed_property < t_generic, ec_overflow_clip_margin > prop_overflow_clip_margin;
...
typedef typed_property < t_generic, ec_overflow_inline > prop_overflow_inline;
...
typedef typed_property < t_generic, ec_perspective > prop_perspective;
typedef typed_property < t_generic, ec_perspective_origin > prop_perspective_origin;
typedef typed_property < t_css_pitch, ec_pitch > prop_pitch;
typedef typed_property < t_real_i, ec_pitch_range > prop_pitch_range;
typedef typed_property < t_generic, ec_place_content > prop_place_content;
typedef typed_property < t_generic, ec_place_items > prop_place_items;
typedef typed_property < t_generic, ec_place_self > prop_place_self;
...
typedef typed_property < t_generic, ec_resize > prop_resize;
typedef typed_property < t_generic, ec_rest > prop_rest;
typedef typed_property < t_generic, ec_rest_after > prop_rest_after;
typedef typed_property < t_generic, ec_rest_before > prop_rest_before;
typedef typed_property < t_real_i, ec_richness > prop_richness;
typedef typed_property < t_css_length_ai, ec_right > prop_right;
typedef typed_property < t_generic, ec_rotate > prop_rotate;
typedef typed_property < t_generic, ec_row_gap > prop_row_gap;
...
typedef typed_property < t_generic, ec_scale > prop_scale;
typedef typed_property < t_generic, ec_scroll_behavior > prop_scroll_behavior;
typedef typed_property < t_generic, ec_scroll_margin > prop_scroll_margin;
typedef typed_property < t_generic, ec_scroll_margin_block > prop_scroll_margin_block;
typedef typed_property < t_generic, ec_scroll_margin_block_end > prop_scroll_margin_block_end;
typedef typed_property < t_generic, ec_scroll_margin_block_start > prop_scroll_margin_block_start;
typedef typed_property < t_generic, ec_scroll_margin_bottom > prop_scroll_margin_bottom;
typedef typed_property < t_generic, ec_scroll_margin_inline > prop_scroll_margin_inline;
typedef typed_property < t_generic, ec_scroll_margin_inline_end > prop_scroll_margin_inline_end;
typedef typed_property < t_generic, ec_scroll_margin_inline_start > prop_scroll_margin_inline_start;
typedef typed_property < t_generic, ec_scroll_margin_left > prop_scroll_margin_left;
typedef typed_property < t_generic, ec_scroll_margin_right > prop_scroll_margin_right;
typedef typed_property < t_generic, ec_scroll_margin_top > prop_scroll_margin_top;
typedef typed_property < t_generic, ec_scroll_padding > prop_scroll_padding;
typedef typed_property < t_generic, ec_scroll_padding_block > prop_scroll_padding_block;
typedef typed_property < t_generic, ec_scroll_padding_block_end > prop_scroll_padding_block_end;
typedef typed_property < t_generic, ec_scroll_padding_block_start > prop_scroll_padding_block_start;
typedef typed_property < t_generic, ec_scroll_padding_bottom > prop_scroll_padding_bottom;
typedef typed_property < t_generic, ec_scroll_padding_inline > prop_scroll_padding_inline;
typedef typed_property < t_generic, ec_scroll_padding_inline_end > prop_scroll_padding_inline_end;
typedef typed_property < t_generic, ec_scroll_padding_inline_start > prop_scroll_padding_inline_start;
typedef typed_property < t_generic, ec_scroll_padding_left > prop_scroll_padding_left;
typedef typed_property < t_generic, ec_scroll_padding_right > prop_scroll_padding_right;
typedef typed_property < t_generic, ec_scroll_padding_top > prop_scroll_padding_top;
typedef typed_property < t_generic, ec_scroll_snap_align > prop_scroll_snap_align;
typedef typed_property < t_generic, ec_scroll_snap_stop > prop_scroll_snap_stop;
typedef typed_property < t_generic, ec_scroll_snap_type > prop_scroll_snap_type;
...
typedef typed_property < t_generic, ec_scrollbar_colour > prop_scrollbar_colour;
typedef typed_property < t_generic, ec_scrollbar_gutter > prop_scrollbar_gutter;
typedef typed_property < t_generic, ec_scrollbar_width > prop_scrollbar_width;
typedef typed_property < t_generic, ec_shape_image_threshold > prop_shape_image_threshold;
...
typedef typed_property < t_generic, ec_speak_as > prop_speak_as;
...
typedef typed_property < t_generic, ec_stroke > prop_stroke;
...
typedef typed_property < t_generic, ec_stroke_colour > prop_stroke_colour;
...
typedef typed_property < t_generic, ec_stroke_dasharray > prop_stroke_dasharray;
...
typedef typed_property < t_generic, ec_stroke_linecap > prop_stroke_linecap;
typedef typed_property < t_generic, ec_stroke_linejoin > prop_stroke_linejoin;
typedef typed_property < t_generic, ec_stroke_miterlimit > prop_stroke_miterlimit;
typedef typed_property < t_generic, ec_stroke_opacity > prop_stroke_opacity;
...
typedef typed_property < t_generic, ec_stroke_width > prop_stroke_width;
...
typedef typed_property < t_generic, ec_text_combine_upright > prop_text_combine_upright;
typedef typed_property < t_css_text_decoration, ec_text_decoration > prop_text_decoration;
typedef typed_property < t_generic, ec_text_decoration_colour > prop_text_decoration_colour;
typedef typed_property < t_generic, ec_text_decoration_line > prop_text_decoration_line;
typedef typed_property < t_generic, ec_text_decoration_skip > prop_text_decoration_skip;
typedef typed_property < t_generic, ec_text_decoration_skip_box > prop_text_decoration_skip_box;
typedef typed_property < t_generic, ec_text_decoration_skip_ink > prop_text_decoration_skip_ink;
typedef typed_property < t_generic, ec_text_decoration_skip_inset > prop_text_decoration_skip_inset;
typedef typed_property < t_generic, ec_text_decoration_skip_self > prop_text_decoration_skip_self;
typedef typed_property < t_generic, ec_text_decoration_skip_spaces > prop_text_decoration_skip_spaces;
typedef typed_property < t_generic, ec_text_decoration_style > prop_text_decoration_style;
typedef typed_property < t_generic, ec_text_decoration_thickness > prop_text_decoration_thickness;
typedef typed_property < t_generic, ec_text_edge > prop_text_edge;
typedef typed_property < t_generic, ec_text_emphasis > prop_text_emphasis;
typedef typed_property < t_generic, ec_text_emphasis_colour > prop_text_emphasis_colour;
typedef typed_property < t_generic, ec_text_emphasis_position > prop_text_emphasis_position;
typedef typed_property < t_generic, ec_text_emphasis_skip > prop_text_emphasis_skip;
typedef typed_property < t_generic, ec_text_emphasis_style > prop_text_emphasis_style;
...
typedef typed_property < t_generic, ec_text_overflow > prop_text_overflow;
...
typedef typed_property < t_generic, ec_text_underline_offset > prop_text_underline_offset;
typedef typed_property < t_generic, ec_text_underline_position > prop_text_underline_position;
...
typedef typed_property < t_generic, ec_transform > prop_transform;
typedef typed_property < t_generic, ec_transform_box > prop_transform_box;
typedef typed_property < t_generic, ec_transform_origin > prop_transform_origin;
typedef typed_property < t_generic, ec_transform_style > prop_transform_style;
typedef typed_property < t_generic, ec_transition > prop_transition;
typedef typed_property < t_generic, ec_transition_delay > prop_transition_delay;
typedef typed_property < t_generic, ec_transition_duration > prop_transition_duration;
typedef typed_property < t_generic, ec_transition_property > prop_transition_property;
...
typedef typed_property < t_generic, ec_user_select > prop_user_select;
...
typedef typed_property < t_generic, ec_voice_balance > prop_voice_balance;
typedef typed_property < t_generic, ec_voice_duration > prop_voice_duration;
typedef typed_property < t_css_voice_family, ec_voice_family > prop_voice_family;
typedef typed_property < t_generic, ec_voice_pitch > prop_voice_pitch;
typedef typed_property < t_generic, ec_voice_range > prop_voice_range;
typedef typed_property < t_generic, ec_voice_rate > prop_voice_rate;
typedef typed_property < t_generic, ec_voice_stress > prop_voice_stress;
typedef typed_property < t_generic, ec_voice_volume > prop_voice_volume;
...
typedef typed_property < t_generic, ec_writing_mode > prop_writing_mode;
...
typedef typed_property < t_css_bespoke, ec_text_rendering > prop_text_rendering;
...
typedef typed_property < t_css_bespoke, ec_clip_path > prop_clip_path;
typedef typed_property < t_css_bespoke, ec_filter > prop_filter;
...
typedef typed_property < t_css_bespoke, ec_pointer_events > prop_pointer_events;
...
#define LAST_CSS_2_PROP ec_pointer_events
