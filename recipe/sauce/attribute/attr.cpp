...
{   { { HTML_TAGS }, { HTML_UNDEF }, "(custom)", a_custom },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "altimg", a_altimg },
    { { HTML_5_3, 0, MATH_3_4 }, { HTML_UNDEF }, "altimg-height", a_altimg_height },
    { { HTML_5_3, 0, MATH_3_4 }, { HTML_UNDEF }, "altimg-valign", a_altimg_valign },
    { { HTML_5_3, 0, MATH_3_4 }, { HTML_UNDEF }, "altimg-width", a_altimg_width },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "base", a_base },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "bevelled", a_bevelled },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "cdgroup", a_cdgroup },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "cd", a_cd },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "charalign", a_charalign },
    { { HTML_2_0 }, { HTML_UNDEF }, "charoff", a_charoff },
    { { HTML_2_0, HV_RFC_2070 }, { HTML_UNDEF }, "charset", a_charset },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "charspacing", a_charspacing },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "closure", a_closure },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "crossout", a_crossout },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "decimalpoint", a_decimalpoint },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "denomalign", a_denomalign },
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "depth", a_depth },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "fence", a_fence },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "fontfamily", a_fontfamily },
    { { XHTML_1_0, 0, MATH_1_2_3_4 | HE_M2_DEPRECAT }, { HTML_UNDEF }, "fontsize", a_fontsize },
    { { XHTML_1_0, 0, MATH_1_2_3_4 | HE_M2_DEPRECAT }, { HTML_UNDEF }, "fontstyle", a_fontstyle },
    { { XHTML_1_0, 0, MATH_1_2_3_4 | HE_M2_DEPRECAT }, { HTML_UNDEF }, "fontweight", a_fontweight },
    { { HTML_4_0 }, { HTML_UNDEF }, "for", a_for },
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "form", a_form },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "indentalign", a_indentalign },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "indentalignfirst", a_indentalignfirst },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "indentalignlast", a_indentalignlast },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "indentshift", a_indentshift },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "indentshiftfirst", a_indentshiftfirst },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "indentshiftlast", a_indentshiftlast },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "indenttarget", a_indenttarget },
    { { HTML_PLUS }, { HTML_UNDEF }, "index", a_index },
    { { HTML_JUL12 }, { HTML_UNDEF }, "inert", a_inert },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "infixlinebreakstyle", a_infixlinebreakstyle },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "largeop", a_largeop },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "leftoverhang", a_leftoverhang },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "length", a_length },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "linebreak", a_linebreak },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "linebreakmultichar", a_linebreakmultichar },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "linebreakstyle", a_linebreakstyle },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "lineleading", a_lineleading },
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "linethickness", a_linethickness },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "location", a_location },
    { { HTML_4_0 }, { HTML_UNDEF }, "longdesc", a_longdesc },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "longdivstyle", a_longdivstyle },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "lquote", a_lquote },
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "lspace", a_lspace },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "mathbackground", a_mathbackground },
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "mathcolor", a_mathcolour },
    { { XHTML_1_0, 0, HE_SVG_1_1 | HE_SVG_1_2 }, { HTML_UNDEF }, "mathematical", a_mathematical },
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "mathsize", a_mathsize },
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "mathvariant", a_mathvariant },
    { { HTML_PLUS, HV_NOT234 }, { HTML_UNDEF }, "max", a_max },
    { { HTML_2_0 }, { HTML_UNDEF }, "maxlength", a_maxlength },
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "maxsize", a_maxsize },
    { { XHTML_1_0, 0, MATH_3_4 }, { HTML_UNDEF }, "maxwidth", a_maxwidth },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "minsize", a_minsize },
    { { XHTML_1_0, 0, HE_MATH_1 }, { HTML_UNDEF }, "mode", a_mode },
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "movablelimits", a_movablelimits },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "mslinethickness", a_mslinethickness },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "numalign", a_numalign },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 | HE_M2_DEPRECAT | HE_M3_DEPRECAT | HE_M4_DEPRECAT }, { HTML_UNDEF }, "other", a_other },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "position", a_position },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "rightoverhang", a_rightoverhang },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "rquote", a_rquote },
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "rspace", a_rspace },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "separator", a_separator },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "shift", a_shift },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "stackalign", a_stackalign },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "stretchy", a_stretchy },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "symmetric", a_symmetric },
    ...
    { { XHTML_1_0, 0, HE_SVG_1_1 | HE_SVG_1_2 | MATH_2_3_4 }, { HTML_UNDEF }, "type", a_xlinktype, ns_xlink },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, "voffset", a_voffset },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, "xref", a_xref },
