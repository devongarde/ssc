...
{   { { HTML_PLUS }, { HTML_UNDEF }, "!doctype", elem_faux_doctype, ns_default, EP_CLOSED | EP_TOP },
    ...
    { { HTML_JAN05 }, { HTML_UNDEF }, "audio", elem_audio, ns_default, EP_5_TRANSPARENT, EF_5_FLOW | EF_5_PHRASE | EF_5_EMBEDDED | EF_5_INTERACTIVE | EF_5_PALPABLE | EF_SVG2_GRAPH },
    ...
    { { HTML_JAN07 }, { HTML_UNDEF }, "canvas", elem_canvas, ns_default, EP_5_TRANSPARENT, EF_5_FLOW | EF_5_PHRASE | EF_5_EMBEDDED | EF_5_PALPABLE | EF_SVG2_GRAPH | EF_SVG20_STR },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, "cursor", elem_cursor, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11 },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feBlend", elem_feblend, ns_default, EP_CLOSED, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feColorMatrix", elem_fecolourmatrix, ns_default, EP_CLOSED, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feComponentTransfer", elem_fecomponenttransfer, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feComposite", elem_fecomposite, ns_default, EP_CLOSED, EF_SVG_FILTER },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feDistantLight", elem_fedistantlight, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feFuncA", elem_fefunca, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feFuncB", elem_fefuncb, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feFuncG", elem_fefuncg, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feFuncR", elem_fefuncr, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feGaussianBlur", elem_fegaussianblur, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feImage", elem_feimage, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feMerge", elem_femerge, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feMergeNode", elem_femergenode, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feMorphology", elem_femorphology, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feOffset", elem_feoffset, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "fePointLight", elem_fepointlight, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feSpecularLighting", elem_fespecularlighting, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feSpotLight", elem_fespotlight, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feTile", elem_fetile, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_2 }, { HTML_UNDEF }, "feTurbulence", elem_feturbulence, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    ...
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "foreignObject", elem_foreignobject, ns_default, 0, EF_SVG2_GRAPH },
    ...
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "svg", elem_svg, ns_default, 0, EF_4_SPECIAL | EF_X2_TEXT | EF_5_FLOW | EF_5_PHRASE | EF_5_EMBEDDED | EF_S_G | EF_SVG10_STR | EF_SVG11_STR | EF_SVG_CONTAIN },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "switch", elem_switch, ns_default, 0, EF_S_G | EF_SVG_CONTAIN }, // should be transparent for SVG 1.2
    ...
    { { HTML_PLUS, HV_NOT2L1 | HV_NOTX2 }, { HTML_UNDEF }, "textarea", elem_textarea, ns_default, 0, EF_MISC | EF_32_FORM | EF_4_FORM | EF_5_FLOW | EF_5_PHRASE | EF_5_INTERACTIVE | EF_5_PALPABLE | EF_5_FORM },
    ...
    { { HTML_JUL07 }, { HTML_UNDEF }, "video", elem_video, ns_default, EP_5_TRANSPARENT, EF_5_FLOW | EF_5_PHRASE | EF_5_EMBEDDED | EF_5_INTERACTIVE | EF_5_PALPABLE | EF_SVG2_GRAPH },
