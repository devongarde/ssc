...
#define MATH2DEFCOM a_encoding, MATH2UNIDEF, MATH2COMMON
...
{   { elem_undefined, { a_unknown } },
    ...
    { elem_cn, { a_base, a_type, MATH2DEFCOM, a_unknown } },
    ...
    { elem_csymbol, { a_type, MATH2DEFCOM, a_unknown } },
    ...
    { elem_maction, { a_actiontype, a_selection, MATH2COMMON, a_unknown } },
    { elem_main, { COMMON54, a_unknown } },
    { elem_maligngroup, { a_groupalign, MATH2COMMON, a_unknown } },
    ...
    { elem_math, {  a_altimg, a_alttext, a_baseline, a_box, a_display, a_macros, a_mode, a_name, a_overflow, /* a_schemalocation, */ a_style, a_type,
                    MATH2SHARED, MATH2UNIQUE, WIDEHIGH, LANGCLASS3, a_unknown } },
    ...
    { elem_menclose, { a_notation, MATH2COMMON, a_unknown } },
    ...
    { elem_merror, { MATH2COMMON, a_unknown } },
    ...
    { elem_mfenced, { a_close, a_open, a_separators, MATH2COMMON, a_unknown } },
    { elem_mfrac, { a_bevelled, a_denomalign, a_linethickness, a_numalign,  MATH2COMMON, a_unknown } },
    { elem_mglyph, { a_alt, a_fontfamily, a_index, a_unknown } },
    ...
    { elem_mlabeledtr, { a_columnalign, a_groupalign, a_rowalign, MATH2COMMON, a_unknown } },
    { elem_mn, { MATH2FONT, MATH2COMMON, a_unknown } },
    { elem_mmultiscripts, { a_subscriptshift, a_superscriptshift, MATH2COMMON, a_unknown } },
    ...
    { elem_mover, { a_accent, MATH2COMMON, a_unknown } },
    { elem_mpadded, { a_lspace, MATHSIZE, MATH2COMMON, a_unknown } },
    { elem_mpath, { a_externalresourcesrequired, SVG11XLINK, COMMON54, a_unknown } },
    { elem_mphantom, { MATH2COMMON, a_unknown } },
    { elem_mprescripts, { a_xmlns, a_unknown } },
    { elem_mroot, { MATH2COMMON, a_unknown } },
    { elem_mrow, { MATH2COMMON, a_unknown } },
    { elem_ms, { a_lquote, a_rquote, MATH2FONT, MATH2COMMON, a_unknown } },
    { elem_mspace, { a_linebreak, MATHSIZE, MATH2COMMON, a_unknown } },
    { elem_msqrt, { MATH2COMMON, a_unknown } },
    { elem_mstyle, {    a_accentunder, a_background, a_bevelled, a_close, a_columnspan, a_depth, a_edge, a_height, a_linethickness, a_lquote,
                        a_mediummathspace, a_rowspan, a_rquote, a_open, a_scriptlevel, a_scriptminsize, a_scriptsizemultiplier, a_selection,
                        a_separators, a_subscriptshift, a_superscriptshift, a_thickmathspace, a_thinmathspace, a_verythickmathspace,
                        a_verythinmathspace, a_veryverythickmathspace, a_veryverythinmathspace,
                        MATH2TABLE, MATH2FONT, MATHOPINFO, MATH2COMMON, a_unknown } },
    { elem_msub, { a_subscriptshift, MATH2COMMON, a_unknown } },
    { elem_msubsup, { a_subscriptshift, a_superscriptshift, MATH2COMMON, a_unknown } },
    { elem_msup, { a_superscriptshift, MATH2COMMON, a_unknown } },
    { elem_mtable, { MATH2TABLE, MATH2COMMON, a_unknown } },
    { elem_mtd, { a_columnalign, a_columnspan, a_groupalign, a_rowalign, a_rowspan, MATH2COMMON, a_unknown } },
    { elem_mtr, { a_columnalign, a_groupalign, a_rowalign, MATH2COMMON, a_unknown } },
    { elem_mtext, { MATH2FONT, MATH2COMMON, a_unknown } },
    { elem_multicol, { a_class, a_cols, a_gutter, a_id, a_style, a_width, a_unknown } },
    { elem_munder, { a_accent, a_accentunder, MATH2COMMON, a_unknown } },
    { elem_munderover, { a_accentunder, MATH2COMMON, a_unknown } },
