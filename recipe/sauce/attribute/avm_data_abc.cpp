...
{   { { HTML_2_0, HV_RFC_2070 | HV_NOT3 }, { XHTML_2_0 }, elem_a, a_charset },
    ...
    SVG_ANIMADD_ATTRIBUTES (elem_animate),
    SVG11_ANAT_ATTRIBUTES (elem_animate),
    SVG11_ANEV_ATTRIBUTES (elem_animate),
    SVG_ANTIME_ATTRIBUTES (elem_animate),
    ...
    SVG_ANIMADD_ATTRIBUTES (elem_animatecolour),
    SVG11_ANAT_ATTRIBUTES (elem_animatecolour),
    SVG11_ANEV_ATTRIBUTES (elem_animatecolour),
    SVG_ANTIME_ATTRIBUTES (elem_animatecolour),
    ...
    SVG_ANIMADD_ATTRIBUTES (elem_animatemotion),
    SVG11_ANEV_ATTRIBUTES (elem_animatemotion),
    SVG_ANTIME_ATTRIBUTES (elem_animatemotion),
    ...
    SVG_ANIMADD_ATTRIBUTES (elem_animatetransform),
    SVG11_ANAT_ATTRIBUTES (elem_animatetransform),
    SVG11_ANEV_ATTRIBUTES (elem_animatetransform),
    SVG_ANTIME_ATTRIBUTES (elem_animatetransform),
    ...
    SVG_ANTIME_ATTRIBUTES (elem_animation),
    ...
    SVG_ANTIME_ATTRIBUTES (elem_audio),
