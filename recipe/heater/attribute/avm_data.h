...
#define RDFA_STANDARD_ATTRIBUTES(ELEM) \
    { { HTML_RDF10, 0, HE_RDF_1_0 | HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_about }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 }, { HTML_UNDEF }, ELEM, a_content }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 | HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_datatype }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 }, { HTML_UNDEF }, ELEM, a_inlist }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 }, { HTML_UNDEF }, ELEM, a_prefix }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 | HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_property }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 | HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_rel }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 | HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_resource }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 | HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_rev }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 }, { HTML_UNDEF }, ELEM, a_src }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 | HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_typeof }, \
    { { HTML_RDF10, 0, HE_RDF_1_0 }, { HTML_UNDEF }, ELEM, a_vocab }
...
#define SVG10_DXY_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_dx }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_dy }

#define SVG10_BOX_ATTRIBUTES(ELEM) \
    SVG10_XY_ATTRIBUTES (ELEM), \
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, ELEM, a_fitbbox }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_height }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_width }

#define SVG10_COMP_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_amplitude }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_exponent }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_intercept }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_offset }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 | REQUIRED }, { HTML_UNDEF }, ELEM, a_type }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_slope }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 | HE_SVG_11 }, { HTML_UNDEF }, ELEM, a_tablevalues }

#define SVG10_FILTER_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_in }, \
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, ELEM, a_nodeid }

#define SVG10_FIT_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, ELEM, a_fitboxtoviewport }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_preserveaspectratio }

#define SVG10_G_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_onload }, \
...
#define SVG10_GRAD_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_gradienttransform }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_gradientunits }

#define SVG10_REF_XY_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_refx }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_refy }
...
#define SVG11_ANADD_ATTRIBUTES(ELEM) \
    { { HTML_SVG11, 0, HE_SVG_11_12_20 }, { HTML_UNDEF }, ELEM, a_additive }, \
...
#define SVG11_ANEV_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_onbegin }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_onend }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_onrepeat }
...
#define SVG11_FILTER_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_height }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_result }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_width }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_x }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_y }

#define SVG11_GREV_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, ELEM, a_onactivate }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_onfocusin }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_onfocusout }
...
#define SVGx_CONDPROC_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_requiredextensions }, \
    { { HTML_SVG11, 0, HE_SVG_11_12 }, { HTML_UNDEF }, ELEM, a_requiredfeatures }, \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_requiredfonts }, \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_requiredformats }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_systemlanguage }

#define SVGx_XTRA_CORE_ATTRIBUTES(ELEM) \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_property }, \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_rel }, \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_resource }, \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_rev }, \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_role }, \
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, ELEM, a_tabindex }, \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_typeof }, \
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, ELEM, a_xmlbase }, \
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, ELEM, a_xmlid }, \
    { { HTML_SVG11, 0, HE_SVG_11_12 }, { HTML_UNDEF }, ELEM, a_xmllang }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_xmlspace }

#define SVGx_PRES_ATTRIBUTES(ELEM) \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_alignmentbaseline }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_baselineshift }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_clip }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_clip_path }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_clip_rule }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_colour }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_colour_interpolation }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_colour_interpolation_filters }, \
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, ELEM, a_colour_profile }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_colour_rendering }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_cursor }, \
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_dominant_baseline }, \
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, ELEM, a_enablebackground }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_fill }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_fill_opacity }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_fill_rule }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_filter }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_flood_colour }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_flood_opacity }, \
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_font_size_adjust }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_font_stretch }, \
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_letter_spacing }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_lighting_colour }, \
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_overflow }, \
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, ELEM, a_paint_order }, \
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_text_decoration }, \
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, ELEM, a_text_overflow }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_text_rendering }, \
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, ELEM, a_unicode_bidi }, \
    { { HTML_SVG12, 0, HE_SVG_12_20 }, { HTML_UNDEF }, ELEM, a_vector_effect }, \
    ...
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, ELEM, a_white_space }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_word_spacing }, \
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_writing_mode }
...
#define MATH2_DEFS_ATTRIBUTES_EX(ELEM, FLAGS) \
    { { HTML_MATH1, 0, ( FLAGS | HE_MATH_1 | HE_MATH_2 ) }, { HTML_UNDEF }, ELEM, a_definitionurl }, \
...
#define MATH2_TABLE_ATTRIBUTES_EX(ELEM, FLAGS) \
    ...
    { { HTML_MATH2, 0, ( FLAGS | HE_MATH_2 ) }, { HTML_UNDEF }, ELEM, a_minilabelspacing }, \
...
#define MATH3_STANDARD_ATTRIBUTES_EX(ELEM, FLAGS) \
    { { HTML_MATH3, 0, ( FLAGS | MATH_3_4 ) }, { HTML_UNDEF }, ELEM, a_href }, \
...
#define MATH3_FONT_ATTRIBUTES(ELEM) \
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, ELEM, a_dir }, \
...
#define MATH3_PRES_ATTRIBUTES_EX(ELEM, FLAGS) \
    { { HTML_MATH3, 0, ( FLAGS | MATH_3_4 ) }, { HTML_UNDEF }, ELEM, a_mathbackground }, \
    { { HTML_MATH3, 0, ( FLAGS | MATH_3_4 ) }, { HTML_UNDEF }, ELEM, a_mathcolour }, \
    MATH3_STANDARD_ATTRIBUTES_EX (ELEM, FLAGS)
...
#define MATH3_TOKEN_ATTRIBUTES(ELEM) \
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, ELEM, a_dir }, \
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, ELEM, a_mathsize }, \
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, ELEM, a_mathvariant }
...
#define XHTML2_COMMON_ATTRIBUTES(ELEM) \
    ...
    { { HTML_SVG12 }, { HTML_UNDEF }, ELEM, a_defaultaction }, \
