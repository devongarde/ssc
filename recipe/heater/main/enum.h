...
typedef enum { ecdi_flex, ecdi_flex_inline, ecdi_flow, ecdi_flow_root, ecdi_grid, ecdi_ruby, ecdi_table } e_css_display_inside;
...
#define SSC_TYPES_3 \
            ...
            t_css_gap, t_css_generic_family, t_css_gradient, \
