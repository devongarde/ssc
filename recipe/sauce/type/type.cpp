...
#define TEST_VALUE(ENUM) case ENUM : return test_value < ENUM > (nits, v, s)
    ...
    {   TEST_VALUE (t_unknown);
        ...
        TEST_VALUE (t_10_int); 
        TEST_VALUE (t_2pt);
        TEST_VALUE (t_2string);
        TEST_VALUE (t_4string);
        TEST_VALUE (t_4string_ni);
        TEST_VALUE (t_about);
        ...
        TEST_VALUE (t_csp);
        TEST_VALUE (t_css);
        TEST_VALUE (t_css_aaalri);
        TEST_VALUE (t_css_aai);
        TEST_VALUE (t_css_all);
        TEST_VALUE (t_css_all_2);
        TEST_VALUE (t_css_alpha);
        TEST_VALUE (t_css_alpha_n);
        TEST_VALUE (t_css_attr);
        TEST_VALUE (t_css_absolute_size);
        TEST_VALUE (t_css_azimuth);
        TEST_VALUE (t_css_azimuth_be);
        TEST_VALUE (t_css_azimuth_e);
        TEST_VALUE (t_css_azimuth_eb);
        TEST_VALUE (t_css_azimuth_es);
        TEST_VALUE (t_css_azimuth_lri);
        ...
        TEST_VALUE (t_css_borders_measure_i);
        TEST_VALUE (t_css_border_style);
        TEST_VALUE (t_css_border_style_i);
        TEST_VALUE (t_css_border_styles);
        TEST_VALUE (t_css_border_width);
        TEST_VALUE (t_css_border_width_i);
        TEST_VALUE (t_css_border_wsc);
        TEST_VALUE (t_css_border_wsc_i);
        TEST_VALUE (t_css_box_sizing);
        TEST_VALUE (t_css_caret);
        TEST_VALUE (t_css_caret_shape);
        TEST_VALUE (t_css_clear);
        TEST_VALUE (t_css_coin1);
        TEST_VALUE (t_css_coin2);
        TEST_VALUE (t_css_coin3);
        TEST_VALUE (t_css_col);
        TEST_VALUE (t_css_colour);
        TEST_VALUE (t_css_colour_3);
        TEST_VALUE (t_css_colour_4);
        TEST_VALUE (t_css_colour_a);
        TEST_VALUE (t_css_colour_interpolation);
        TEST_VALUE (t_css_content);
        TEST_VALUE (t_css_content_base);
        TEST_VALUE (t_css_content_enum);
        TEST_VALUE (t_css_content_fn);
        TEST_VALUE (t_css_content_twice);
        TEST_VALUE (t_css_counter);
        TEST_VALUE (t_css_counter_ii);
        TEST_VALUE (t_css_counter_iin);
        TEST_VALUE (t_css_counter_set);
        TEST_VALUE (t_css_counters);
        TEST_VALUE (t_css_cursor);
        TEST_VALUE (t_css_cursor_e);
        TEST_VALUE (t_css_cursor_url);
        TEST_VALUE (t_css_display);
        TEST_VALUE (t_css_earnest);
        TEST_VALUE (t_css_elevation_e);
        TEST_VALUE (t_css_empty_cells);
        TEST_VALUE (t_css_font);
        TEST_VALUE (t_css_font_families);
        TEST_VALUE (t_css_font_size);
        TEST_VALUE (t_css_font_style);
        TEST_VALUE (t_css_font_style_e);
        TEST_VALUE (t_css_font_weight);
        TEST_VALUE (t_css_fn);
        TEST_VALUE (t_css_frame);
        TEST_VALUE (t_css_generic_family);
        TEST_VALUE (t_css_hue);
        TEST_VALUE (t_css_hue_interpolation);
        TEST_VALUE (t_css_hue_n);
        TEST_VALUE (t_css_id);
        TEST_VALUE (t_css_image);
        TEST_VALUE (t_css_inherit);
        TEST_VALUE (t_css_kbd_lhs);
        TEST_VALUE (t_css_kdb_nav);
        TEST_VALUE (t_css_kbd_rhs);
        TEST_VALUE (t_css_lang);
        TEST_VALUE (t_css_langs);
        TEST_VALUE (t_css_length);
        TEST_VALUE (t_css_length_a);
        TEST_VALUE (t_css_length_ai);
        TEST_VALUE (t_css_length_twice);
        ...
        TEST_VALUE (t_css_outline_style);
        TEST_VALUE (t_css_outlines);
        TEST_VALUE (t_css_overflow);
        TEST_VALUE (t_css_pitch_e);
        TEST_VALUE (t_css_polar);
        TEST_VALUE (t_css_position);
        TEST_VALUE (t_css_property);
        TEST_VALUE (t_css_rect);
        TEST_VALUE (t_css_rect_ai);
        TEST_VALUE (t_css_rect_fn);
        TEST_VALUE (t_css_relative_size);
        TEST_VALUE (t_css_resize);
        TEST_VALUE (t_css_rgb_xyz);
        TEST_VALUE (t_css_size);
        TEST_VALUE (t_css_spacing);
        TEST_VALUE (t_css_speak);
        TEST_VALUE (t_css_speak_header);
        TEST_VALUE (t_css_speak_numeral);
        TEST_VALUE (t_css_speak_punctuation); 
        TEST_VALUE (t_css_statement);
        TEST_VALUE (t_css_speech_rate);
        TEST_VALUE (t_css_speech_rate_e);
        TEST_VALUE (t_css_text_align);
        TEST_VALUE (t_css_text_decoration);
        ...
        TEST_VALUE (t_curies);
        TEST_VALUE (t_current_colour_sz);
        ...
        TEST_VALUE (t_integer_ai);
        TEST_VALUE (t_integer_i);
        TEST_VALUE (t_integer_or_percent);
        TEST_VALUE (t_intent);
        ...
        TEST_VALUE (t_og);
        TEST_VALUE (t_ogtype);
        TEST_VALUE (t_oklabfn);
        TEST_VALUE (t_oklchfn);
        TEST_VALUE (t_onoff);
        ...
        TEST_VALUE (t_percent_flexible);
        TEST_VALUE (t_percent_n);
        TEST_VALUE (t_phase);
        ...
        TEST_VALUE (t_real_i);
        TEST_VALUE (t_real_ni);
        TEST_VALUE (t_reals);
        TEST_VALUE (t_real_percent_n);
