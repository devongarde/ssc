...
{   { { HTML_UNDEF }, { HTML_UNDEF },  "html", doc_html },
    ...
    { { XHTML_1_1, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTP_W3 "/Math/DTD/mathml2/mathml2.dtd", doc_math2 },
    { { XHTML_1_1, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTPS_W3 "/Math/DTD/mathml2/mathml2.dtd", doc_math2 },
    { { XHTML_1_0, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTP_W3 "/Math/DTD/mathml1/mathml.dtd", doc_math1 },
    { { XHTML_1_0, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTPS_W3 "/Math/DTD/mathml1/mathml.dtd", doc_math1 },
    { { XHTML_1_0, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTP_W3 "/TR/REC-MathML-19980407", doc_math1 },
    { { XHTML_1_0, 0, HE_MATH_1 }, { HTML_UNDEF }, HTTPS_W3 "/TR/REC-MathML-19980407", doc_math1 },
    ...
    { { HTML_4_01, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTP_W3 "/Graphics/SVG/1.1/DTD/svg11.dtd", doc_svg11 },
    { { HTML_4_01, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTPS_W3 "/Graphics/SVG/1.1/DTD/svg11.dtd", doc_svg11 },
    { { HTML_4_0, 0, HE_SVG_1_0 }, { HTML_UNDEF }, "-//W3C//DTD SVG 1.0//EN", doc_svg1 },
    { { HTML_4_0, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTP_W3 "/TR/2001/REC-SVG-20010904/DTD/svg10.dtd", doc_svg1 },
    { { HTML_4_0, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTPS_W3 "/TR/2001/REC-SVG-20010904/DTD/svg10.dtd", doc_svg1 },
    { { HTML_4_0, 0, HE_SVG_1_0 }, { HTML_UNDEF }, "-//W3C//DTD SVG July 1999//EN", doc_svg1 },
    { { HTML_4_0, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTP_W3 "/Graphics/SVG/svg-19990706.dtd", doc_svg1 },
    { { HTML_4_0, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTPS_W3 "/Graphics/SVG/svg-19990706.dtd", doc_svg1 },
    { { HTML_4_01, 0, HE_SVG_1_0 }, { HTML_UNDEF }, "-//W3C//DTD SVG 1.1 Basic//EN", doc_svg11 },
    { { HTML_4_01, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTP_W3 "/Graphics/SVG/1.1/DTD/svg11-basic.dtd", doc_svg11 },
    { { HTML_4_01, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTPS_W3 "/Graphics/SVG/1.1/DTD/svg11-basic.dtd", doc_svg11 },
    { { HTML_4_01, 0, HE_SVG_1_0 }, { HTML_UNDEF }, "-//W3C//DTD SVG 1.1 Tiny//EN", doc_svg11 },
    { { HTML_4_01, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTP_W3 "/Graphics/SVG/1.1/DTD/svg11-tiny.dtd", doc_svg11 },
    { { HTML_4_01, 0, HE_SVG_1_0 }, { HTML_UNDEF }, HTTPS_W3 "/Graphics/SVG/1.1/DTD/svg11-tiny.dtd", doc_svg11 } };
