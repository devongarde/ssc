...
{   // implied by many specifications but rarely actually stated
    ...
    { { s_as, 2, 0, }, { 0, 0 }, asc_object, asp_content },
    ...
    { { s_as, 2, 0, }, { 0, 0 }, asc_object, asp_id },
    { { s_as, 2, 0, }, { 0, 0 }, asc_object, asp_image },
...
// sioc documents mention, but don't specify, a property called content:encoded
    ...
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_address, vcard_haslabel },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_address, vcard_locality },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_address, vcard_post_office_box },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_address, vcard_postal_code },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_address, vcard_region },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_address, vcard_street_address },

    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_location, vcard_latitude },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_location, vcard_longitude },

    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_name, vcard_additional_name },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_name, vcard_family_name },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_name, vcard_given_name },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_name, vcard_honourific_prefix },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_name, vcard_honourific_suffix },

    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_organisation, vcard_organisational_name },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_organisation, vcard_organisational_unit },

    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_tel, rdf_value },

    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_adr },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_agent },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_category },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_class },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_hasfax },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_fn },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_geo },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_hasemail },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_homeadr },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_hometel },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_key },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_mailer },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_mobileemail },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_mobiletel },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_n },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_nickname },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_note },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_org },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_personalemail },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_phone },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_photo },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_prodid },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_sound },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_unlabeledadr },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_unlabeledemail },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_unlabeledtel },
    { { s_vcard, 1, 0 }, { 0, 0 }, vcard_vcard, vcard_url },
