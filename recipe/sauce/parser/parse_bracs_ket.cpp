...
void faux_xmp_check (brac_element_ket& current, e_element& xmp_tag, bool& xmp_mode, const ::std::string::const_iterator& i, ::std::string::const_iterator& x)
                ...
                {   case ' ' :  if (xmp_mode) { status = s_dull; break; }
                    ...
                    case '>' :  if (xmp_mode)
                                ...
                                {   if (twas > text)
                                    ...
                                    {   brac_element_ket& current = ve_.back ();
...
::std::string bracs_ket::rpt () const
{   ::std::string res;
    for (auto e : ve_)
        res += e.rpt () + "\n";
    return res; }
