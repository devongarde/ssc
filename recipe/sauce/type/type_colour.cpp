...
struct symbol_entry < html_version, e_fixedcolour > css_colour_symbol_table [] =
{   { { HTML_SVG10 }, { HTML_UNDEF }, "aliceblue", fc_aliceblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "antiquewhite", fc_antiquewhite },
    { { HTML_SVG10 }, { HTML_UNDEF }, "aquamarine", fc_aquamarine },
    { { HTML_SVG10 }, { HTML_UNDEF }, "azure", fc_azure },
    { { HTML_SVG10 }, { HTML_UNDEF }, "beige", fc_beige },
    { { HTML_SVG10 }, { HTML_UNDEF }, "bisque", fc_bisque },
    { { HTML_2_0 }, { HTML_UNDEF }, "black", fc_black },
    { { HTML_SVG10 }, { HTML_UNDEF }, "blanchedalmond", fc_blanchedalmond },
    { { HTML_2_0 }, { HTML_UNDEF }, "blue", fc_blue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "blueviolet", fc_blueviolet },
    { { HTML_SVG10 }, { HTML_UNDEF }, "brown", fc_brown },
    { { HTML_SVG10 }, { HTML_UNDEF }, "burlywood", fc_burlywood },
    { { HTML_SVG10 }, { HTML_UNDEF }, "cadetblue", fc_cadetblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "chartreuse", fc_chartreuse },
    { { HTML_SVG10 }, { HTML_UNDEF }, "chocolate", fc_chocolate },
    { { HTML_SVG10 }, { HTML_UNDEF }, "coral", fc_coral },
    { { HTML_SVG10 }, { HTML_UNDEF }, "cornflowerblue", fc_cornflowerblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "cornsilk", fc_cornsilk },
    { { HTML_SVG10 }, { HTML_UNDEF }, "crimson", fc_crimson },
    { { HTML_SVG10 }, { HTML_UNDEF }, "cyan", fc_cyan },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkblue", fc_darkblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkcyan", fc_darkcyan },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkgoldenrod", fc_darkgoldenrod },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkgray", fc_darkgray },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkgreen", fc_darkgreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkgrey", fc_darkgrey },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkkhaki", fc_darkkhaki },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkmagenta", fc_darkmagenta },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkolivegreen", fc_darkolivegreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkorange", fc_darkorange },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkorchid", fc_darkorchid },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkred", fc_darkred },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darksalmon", fc_darksalmon },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkseagreen", fc_darkseagreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkslateblue", fc_darkslateblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkslategray", fc_darkslategray },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkslategrey", fc_darkslategrey },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkturquoise", fc_darkturquoise },
    { { HTML_SVG10 }, { HTML_UNDEF }, "darkviolet", fc_darkviolet },
    { { HTML_SVG10 }, { HTML_UNDEF }, "deeppink", fc_deeppink },
    { { HTML_SVG10 }, { HTML_UNDEF }, "deepskyblue", fc_deepskyblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "dimgray", fc_dimgray },
    { { HTML_SVG10 }, { HTML_UNDEF }, "dimgrey", fc_dimgrey },
    { { HTML_SVG10 }, { HTML_UNDEF }, "dodgerblue", fc_dodgerblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "firebrick", fc_firebrick },
    { { HTML_SVG10 }, { HTML_UNDEF }, "floralwhite", fc_floralwhite },
    { { HTML_SVG10 }, { HTML_UNDEF }, "forestgreen", fc_forestgreen },
    { { HTML_2_0 }, { HTML_UNDEF }, "fuchsia", fc_fuchsia },
    { { HTML_SVG10 }, { HTML_UNDEF }, "gainsboro", fc_gainsboro },
    { { HTML_SVG10 }, { HTML_UNDEF }, "ghostwhite", fc_ghostwhite },
    { { HTML_SVG10 }, { HTML_UNDEF }, "gold", fc_gold },
    { { HTML_SVG10 }, { HTML_UNDEF }, "goldenrod", fc_goldenrod },
    { { HTML_2_0 }, { HTML_UNDEF }, "gray", fc_grey },
    { { HTML_2_0 }, { HTML_UNDEF }, "green", fc_green },
    { { HTML_SVG10 }, { HTML_UNDEF }, "greenyellow", fc_greenyellow },
    { { HTML_SVG10 }, { HTML_UNDEF }, "honeydew", fc_honeydew },
    { { HTML_SVG10 }, { HTML_UNDEF }, "hotpink", fc_hotpink },
    { { HTML_SVG10 }, { HTML_UNDEF }, "indianred", fc_indianred },
    { { HTML_SVG10 }, { HTML_UNDEF }, "indigo", fc_indigo },
    { { HTML_SVG10 }, { HTML_UNDEF }, "ivory", fc_ivory },
    { { HTML_SVG10 }, { HTML_UNDEF }, "khaki", fc_khaki },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lavender", fc_lavender },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lavenderblush", fc_lavenderblush },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lawngreen", fc_lawngreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lemonchiffon", fc_lemonchiffon },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightblue", fc_lightblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightcoral", fc_lightcoral },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightcyan", fc_lightcyan },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightgoldenrodyellow", fc_lightgoldenrodyellow },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightgray", fc_lightgray },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightgreen", fc_lightgreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightgrey", fc_lightgrey },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightpink", fc_lightpink },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightsalmon", fc_lightsalmon },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightseagreen", fc_lightseagreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightskyblue", fc_lightskyblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightslategray", fc_lightslategray },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightslategrey", fc_lightslategrey },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightsteelblue", fc_lightsteelblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "lightyellow", fc_lightyellow },
    { { HTML_2_0 }, { HTML_UNDEF }, "lime", fc_lime },
    { { HTML_SVG10 }, { HTML_UNDEF }, "limegreen", fc_limegreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "linen", fc_linen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "magenta", fc_magenta },
    { { HTML_2_0 }, { HTML_UNDEF }, "maroon", fc_maroon },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumaquamarine", fc_mediumaquamarine },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumblue", fc_mediumblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumorchid", fc_mediumorchid },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumpurple", fc_mediumpurple },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumseagreen", fc_mediumseagreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumslateblue", fc_mediumslateblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumspringgreen", fc_mediumspringgreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumturquoise", fc_mediumturquoise },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mediumvioletred", fc_mediumvioletred },
    { { HTML_SVG10 }, { HTML_UNDEF }, "midnightblue", fc_midnightblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mintcream", fc_mintcream },
    { { HTML_SVG10 }, { HTML_UNDEF }, "mistyrose", fc_mistyrose },
    { { HTML_SVG10 }, { HTML_UNDEF }, "moccasin", fc_moccasin },
    { { HTML_SVG10 }, { HTML_UNDEF }, "navajowhite", fc_navajowhite },
    { { HTML_2_0 }, { HTML_UNDEF }, "navy", fc_navy },
    { { HTML_SVG10 }, { HTML_UNDEF }, "oldlace", fc_oldlace },
    { { HTML_2_0 }, { HTML_UNDEF }, "olive", fc_olive },
    { { HTML_SVG10 }, { HTML_UNDEF }, "olivedrab", fc_olivedrab },
    { { HTML_SVG10 }, { HTML_UNDEF }, "orange", fc_orange },
    { { HTML_SVG10 }, { HTML_UNDEF }, "orangered", fc_orangered },
    { { HTML_SVG10 }, { HTML_UNDEF }, "orchid", fc_orchid },
    { { HTML_SVG10 }, { HTML_UNDEF }, "palegoldenrod", fc_palegoldenrod },
    { { HTML_SVG10 }, { HTML_UNDEF }, "palegreen", fc_palegreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "paleturquoise", fc_paleturquoise },
    { { HTML_SVG10 }, { HTML_UNDEF }, "palevioletred", fc_palevioletred },
    { { HTML_SVG10 }, { HTML_UNDEF }, "papayawhip", fc_papayawhip },
    { { HTML_SVG10 }, { HTML_UNDEF }, "peachpuff", fc_peachpuff },
    { { HTML_SVG10 }, { HTML_UNDEF }, "peru", fc_peru },
    { { HTML_SVG10 }, { HTML_UNDEF }, "pink", fc_pink },
    { { HTML_SVG10 }, { HTML_UNDEF }, "plum", fc_plum },
    { { HTML_SVG10 }, { HTML_UNDEF }, "powderblue", fc_powderblue },
    { { HTML_2_0 }, { HTML_UNDEF }, "purple", fc_purple },
    { { HTML_SVG10 }, { HTML_UNDEF }, "rebeccapurple ", fc_rebeccapurple  },
    { { HTML_2_0 }, { HTML_UNDEF }, "red", fc_red },
    { { HTML_SVG10 }, { HTML_UNDEF }, "rosybrown", fc_rosybrown },
    { { HTML_SVG10 }, { HTML_UNDEF }, "royalblue", fc_royalblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "saddlebrown", fc_saddlebrown },
    { { HTML_SVG10 }, { HTML_UNDEF }, "salmon", fc_salmon },
    { { HTML_SVG10 }, { HTML_UNDEF }, "sandybrown", fc_sandybrown },
    { { HTML_SVG10 }, { HTML_UNDEF }, "seagreen", fc_seagreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "seashell", fc_seashell },
    { { HTML_SVG10 }, { HTML_UNDEF }, "sienna", fc_sienna },
    { { HTML_2_0 }, { HTML_UNDEF }, "silver", fc_silver },
    { { HTML_SVG10 }, { HTML_UNDEF }, "skyblue", fc_skyblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "slateblue", fc_slateblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "slategray", fc_slategray },
    { { HTML_SVG10 }, { HTML_UNDEF }, "slategrey", fc_slategrey },
    { { HTML_SVG10 }, { HTML_UNDEF }, "snow", fc_snow },
    { { HTML_SVG10 }, { HTML_UNDEF }, "springgreen", fc_springgreen },
    { { HTML_SVG10 }, { HTML_UNDEF }, "steelblue", fc_steelblue },
    { { HTML_SVG10 }, { HTML_UNDEF }, "tan", fc_tan },
    { { HTML_2_0 }, { HTML_UNDEF }, "teal", fc_teal },
    { { HTML_SVG10 }, { HTML_UNDEF }, "thistle", fc_thistle },
    { { HTML_SVG10 }, { HTML_UNDEF }, "tomato", fc_tomato },
    { { HTML_MATH2, 0, 0, H2_MATH_2 }, { HTML_UNDEF }, "transparent", fc_transparent },
    { { HTML_SVG10 }, { HTML_UNDEF }, "turquoise", fc_turquoise },
    { { HTML_SVG10 }, { HTML_UNDEF }, "violet", fc_violet },
    { { HTML_SVG10 }, { HTML_UNDEF }, "wheat", fc_wheat },
    { { HTML_2_0 }, { HTML_UNDEF }, "white", fc_white },
    { { HTML_SVG10 }, { HTML_UNDEF }, "whitesmoke", fc_whitesmoke },
    { { HTML_2_0 }, { HTML_UNDEF }, "yellow", fc_yellow },
    { { HTML_SVG10 }, { HTML_UNDEF }, "yellowgreen", fc_yellowgreen } };
...
{   { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "aliceblue", fc_aliceblue },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "black", fc_black },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "blanchedalmond", fc_blanchedalmond },
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "blue", fc_blue },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "fuchsia", fc_fuchsia },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "gray", fc_grey },
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "green", fc_green },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "lime", fc_lime },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "maroon", fc_maroon },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "navy", fc_navy },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "oldlace", fc_oldlace },
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "olive", fc_olive },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "purple", fc_purple },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "rebeccapurple ", fc_rebeccapurple  },
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "red", fc_red },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "silver", fc_silver },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "teal", fc_teal },
    ...
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "white", fc_white },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "whitesmoke", fc_whitesmoke },
    { { HTML_3_2, 0, 0, H2_CSS }, { HTML_UNDEF }, "yellow", fc_yellow },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "yellowgreen", fc_yellowgreen } };

void fixedcolour_init (nitpick& nits)
{   type_master < t_css_colour > :: init (nits, css_colour_symbol_table, sizeof (css_colour_symbol_table) / sizeof (symbol_entry < html_version, e_fixedcolour >)); 
