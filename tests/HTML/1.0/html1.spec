-f tests/HTML/1.0/html1.conf

PASS tests/HTML/1.0/index.html
1 presume_html_1

PASS tests/HTML/1.0/html1-bad.html
0 title_required
...
PASS tests/HTML/1.0/html1-bad2.html
...
PASS tests/HTML/1.0/html1-good.html
1 presume_html_1

PASS tests/HTML/1.0/html1-simple.html
1 presume_html_1
