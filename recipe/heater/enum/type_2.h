...
template < > struct type_master < t_rule_over > : two_value < t_rule_over, e_rule_over, sz_column_over_row, sz_row_over_column >
{ using two_value < t_rule_over, e_rule_over, sz_column_over_row, sz_row_over_column > :: two_value; };
