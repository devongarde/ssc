...
{   { { HTML_JAN11 }, { HTML_JUN11 }, elem_video, a_audio },
    ...
    { { HTML_JUL07, 0, HE_EXPERIMENTAL }, { HTML_JUL25 }, elem_video, a_autopictureinpicture },
    { { HTML_JUL07 }, { HTML_UNDEF }, elem_video, a_autoplay },
    { { HTML_JUL07, 0, HE_MOZILLA | HE_OPERA }, { HTML_JUL25 }, elem_video, a_buffered },
    { { HTML_JUL07 }, { HTML_UNDEF }, elem_video, a_controls },
    { { HTML_JUL07, 0, HE_EXPERIMENTAL }, { HTML_JUL25 }, elem_video, a_controlslist },
    { { HTML_JUL11 }, { HTML_UNDEF }, elem_video, a_crossorigin },
    { { HTML_JUL07, 0, HE_BESPOKE }, { HTML_JUL25 }, elem_video, a_currenttime },
    { { HTML_JUL07, 0, HE_EXPERIMENTAL }, { HTML_JUL25 }, elem_video, a_disablepictureinpicture },
    { { HTML_5_3, HV_W3 }, { HTML_5_3 }, elem_video, a_disableremoteplayback },
    { { HTML_JUL07, 0, HE_BESPOKE }, { HTML_JUL25 }, elem_video, a_duration },
    ...
    { { HTML_JUL07, 0, HE_CHROME | HE_OPERA }, { HTML_JUL25 }, elem_video, a_intrinsicsize },
