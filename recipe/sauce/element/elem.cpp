...
{   { { HTML_PLUS }, { HTML_UNDEF }, "!doctype", elem_faux_doctype, ns_default, EP_CLOSED | EP_TOP },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "abs", elem_abs, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "and", elem_and, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "apply", elem_apply, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH2, 0, 0, H2_MATH_2_3_4 }, { HTML_UNDEF }, "approx", elem_approx, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "arccos", elem_arccos, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "arcsin", elem_arcsin, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, 0, H2_MATH_2_3_4 }, { HTML_UNDEF }, "arcsinh", elem_arcsinh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "arctan", elem_arctan, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "bvar", elem_bvar, ns_default, 0, EF_M_CONTENT | EF_M_DQ },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "ci", elem_ci, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "cn", elem_cn, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "compose", elem_compose, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "condition", elem_condition, ns_default, 0, EF_M_CONTENT | EF_M_DQ },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "conjugate", elem_conjugate, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_JAN05, 0, HE_WEBCOMP }, { HTML_UNDEF }, "content", elem_content, ns_default, EP_CLOSED },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "cos", elem_cos, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "cosh", elem_cosh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "cot", elem_cot, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "coth", elem_coth, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "csc", elem_csc, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "csch", elem_csch, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, 0, H2_MATH_2_3_4 }, { HTML_UNDEF }, "csymbol", elem_csymbol, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "curl", elem_curl, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "degree", elem_degree, ns_default, 0, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "determinant", elem_determinant, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "diff", elem_diff, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "divergence", elem_divergence, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "divide", elem_divide, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "eq", elem_eq, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "exists", elem_exists, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "exp", elem_exp, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "factorial", elem_factorial, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "forall", elem_forall, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "gcd", elem_gcd, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "geq", elem_geq, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "grad", elem_grad, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "gt", elem_gt, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "ident", elem_ident, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "implies", elem_implies, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "in", elem_in, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "int", elem_int, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH2, 0, 0, H2_MATH_2_3_4 }, { HTML_UNDEF }, "integers", elem_integers, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "intersect", elem_intersect, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "interval", elem_interval, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "inverse", elem_inverse, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "lambda", elem_lambda, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_3_0 }, { HTML_3_0 }, "lang", elem_lang, ns_default, 0, EF_3_MISC },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "laplacian", elem_laplacian, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "leq", elem_leq, ns_default, EP_CLOSED| EP_ARGS_2| EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "limit", elem_limit, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "list", elem_list, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "ln", elem_ln, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "loc", elem_loc },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "log", elem_log, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "logbase", elem_logbase, ns_default, 0, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "lowlimit", elem_lowlimit, ns_default, 0, EF_M_CONTENT | EF_M_DQ },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "lt", elem_lt, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "maligngroup", elem_maligngroup, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "malignmark", elem_malignmark, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "matrix", elem_matrix, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "matrixrow", elem_matrixrow, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "max", elem_max, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "mean", elem_mean, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "median", elem_median, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "mfenced", elem_mfenced, ns_default, 0, EF_M_PRESINCONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "min", elem_min, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "minus", elem_minus, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "mode", elem_mode, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "moment", elem_moment, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "neq", elem_neq, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "not", elem_not, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "notin", elem_notin, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "notprsubset", elem_notprsubset, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "notsubset", elem_notsubset, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "or", elem_or, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "partialdiff", elem_partialdiff, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_X_MATH | EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "plus", elem_plus, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "power", elem_power, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "product", elem_product, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "prsubset", elem_prsubset, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "quotient", elem_quotient, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "rem", elem_rem, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "sdev", elem_sdev, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "sec", elem_sec, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "sech", elem_sech, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "selector", elem_selector, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "semantics", elem_semantics, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "sep", elem_sep, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, HE_SVG, H2_MATH }, { HTML_UNDEF }, "set", elem_set, ns_default, EP_CLOSED | EP_SET_XLINKCAT (se_animation), EF_M_CONTENT | EF_M_CONTINPRES | EF_SVG_ANIM },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "setdiff", elem_setdiff, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "sin", elem_sin, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "sinh", elem_sinh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "subset", elem_subset, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "sum", elem_sum, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "tan", elem_tan, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "tanh", elem_tanh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "tendsto", elem_tendsto, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "times", elem_times, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "transpose", elem_transpose, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "union", elem_union, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "uplimit", elem_uplimit, ns_default, 0, EF_M_CONTENT | EF_M_DQ },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "variance", elem_variance, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH | H2_M2_DEPRECAT }, { HTML_UNDEF }, "vector", elem_vector, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, 0, H2_MATH }, { HTML_UNDEF }, "xor", elem_xor, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT } };
