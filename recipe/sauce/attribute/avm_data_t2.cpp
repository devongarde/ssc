...
{   { { HTML_2_0, HV_RFC_1942 | HV_NOT3 | HV_DEPRECATED4 }, { XHTML_2_0 }, elem_tfoot, a_align },
    ...
    { { HTML_5_2, HV_W3 }, { HTML_JUL25 }, elem_tfoot, a_rowgroup },
...
{   { { HTML_4_0 }, { XHTML_2_0 }, elem_th, a_abbr },
    ...
    { { HTML_PLUS }, { HTML_UNDEF }, elem_th, a_rowspan, EP_WX },
    { { HTML_2_0, HV_NOT32 }, { HTML_UNDEF }, elem_th, a_scope },
    { { HTML_JAN13 }, { HTML_DEC15 }, elem_th, a_sorted },
    { { HTML_2_0 }, { XHTML_2_0 }, elem_th, a_valign, EP_WX },
    { { HTML_3_2, HV_DEPRECATED4 }, { XHTML_2_0 }, elem_th, a_width, EP_WX },
...
{   { { HTML_2_0, HV_RFC_1942 | HV_NOT3 | HV_DEPRECATED4 }, { XHTML_2_0 }, elem_thead, a_align },
    ...
    { { HTML_5_2, HV_W3 }, { HTML_JUL25 }, elem_thead, a_rowgroup },
...
hav_t havt_tr [] =
{   { { HTML_2_0, HV_RFC_1942 | HV_DEPRECATED4 }, { XHTML_2_0 }, elem_tr, a_align, EP_WX },
    { { HTML_2_0, HV_NOT3, HE_IE }, { HTML_2_0 }, elem_tr, a_bgcolour, EP_WX },
    ...
    { { HTML_5_2, HV_W3 }, { HTML_JUL25 }, elem_tr, a_row },
    { { HTML_2_0, HV_RFC_1942 }, { XHTML_2_0 }, elem_tr, a_valign, EP_WX },
