...
PASS ../toast/HTML/5.1/example-2.html
2 naughty_lang
6 unrecognised_value

PASS ../toast/HTML/5.1/example-3.html
0 title_required
...
PASS ../toast/HTML/5.1/example-4.html
0 title_required
...
PASS ../toast/HTML/5.1/example-5.html
0 title_required
2 inserted_missing_parent missing_close naughty_lang
14 missing_close
...
21 missing_open
23 not_an_integer not_an_integer
28 title_required
31 mixed_mess
33 key
42 key
...
94 url_not_found
95 url_not_found requires_href
96 url_not_found requires_href bad_coords
97 bad_coords url_not_found requires_href
98 bad_coords url_not_found requires_href
99 bad_coords url_not_found requires_href
100 bad_coords url_not_found requires_href
...
1473 unrecognised_value unrecognised_value
1474 use_double_quote_code
1489 url_not_found
1499 inserted_missing_closure inserted_missing_closure

PASS ../toast/HTML/5.1/html5-good.html
2 naughty_lang
...
PASS ../toast/HTML/5.1/html5-legacy.html
2 naughty_lang

PASS ../toast/HTML/5.1/template-1.html
2 naughty_lang

PASS ../toast/HTML/5.1/template-2.html
2 naughty_lang

PASS ../toast/HTML/5.1/template-3.html
1 presume_html_1 attribute_unrecognised_here unrecognised_attribute

PASS ../toast/HTML/5.1/template-4.html
...
PASS ../toast/HTML/5.1/math-example-1.html
3 naughty_lang
