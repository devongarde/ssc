...
{   return descriptor_constructor < FUNCTION_DESCRIPTORS, desc_unknown > :: make (args, start, to, nits, p, s, t); }
...
{   PRESUME ((i >= 0) && (i < GSL_NARROW_CAST < int > (args.t_.size ())), __FILE__, __LINE__);
    ::std::string n (args.t_.at (i).val_);
    return make_function_v_ptr (args, start, to, nits, examine_value < t_css_property > (nits, args.v_, n), value, t); }
...
{   return descriptor_constructor < POSITION_TRY_DESCRIPTORS, desc_unknown > :: make (args, start, to, nits, p, s, t); }
...
{   PRESUME ((i >= 0) && (i < GSL_NARROW_CAST < int > (args.t_.size ())), __FILE__, __LINE__);
    ::std::string n (args.t_.at (i).val_);
    return make_position_try_v_ptr (args, start, to, nits, examine_value < t_css_property > (nits, args.v_, n), value, t); }
...
{   return descriptor_constructor < ROUTE_DESCRIPTORS, desc_unknown > :: make (args, start, to, nits, p, s, t); }
...
{   PRESUME ((i >= 0) && (i < GSL_NARROW_CAST < int > (args.t_.size ())), __FILE__, __LINE__);
    ::std::string n (args.t_.at (i).val_);
    return make_route_v_ptr (args, start, to, nits, examine_value < t_css_property > (nits, args.v_, n), value, t); }
...
{   return descriptor_constructor < VIEW_TRANSITION_DESCRIPTORS, desc_unknown > :: make (args, start, to, nits, p, s, t); }
...
{   PRESUME ((i >= 0) && (i < GSL_NARROW_CAST < int > (args.t_.size ())), __FILE__, __LINE__);
    ::std::string n (args.t_.at (i).val_);
    return make_view_transition_v_ptr (args, start, to, nits, examine_value < t_css_property > (nits, args.v_, n), value, t); }
