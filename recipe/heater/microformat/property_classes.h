...
typedef typed_mf_value < t_tel, r_tag > tag_at1;
...
typedef typed_mf_value < t_rel, r_bookmark > bookmark_rt;
...
typedef typed_mf_value < t_rel, r_coresident > coresident_rt;
typedef typed_mf_value < t_rel, r_coworker > coworker_rt;
typedef typed_mf_value < t_rel, r_crush > crush_rt;
typedef typed_mf_value < t_rel, r_date > date_rt;
...
typedef typed_mf_value < t_rel, r_friend > friend_rt;
...
typedef typed_mf_value < t_rel, r_met > met_rt;
typedef typed_mf_value < t_rel, r_muse > muse_rt;
typedef typed_mf_value < t_generic, p_name > name_at;
typedef typed_mf_value < t_rel, r_neighbour > neighbour_rt;
typedef typed_mf_value < t_rel, r_next > next_rt;
typedef typed_mf_value < t_generic, p_nickname > nickname_at;
typedef typed_mf_value < t_rel, r_nofollow > nofollow_rt;
...
typedef typed_mf_value < t_rel, r_spouse > spouse_rt;
...
typedef typed_mf_value < t_rel, r_sweetheart > sweetheart_rt;
typedef typed_mf_value < t_url, u_syndication > syndication_at;
typedef typed_mf_value < t_rel, r_tag > tag_rt;
...
typedef typed_mf_value < t_rel, r_vcs_bzr > vcs_bzr_rt;
...
typedef typed_mf_value < t_rel, r_micropub > micropub_rt;
typedef typed_mf_value < t_rel, r_pingback > pingback_rt;
...
typedef typed_mf_value < t_rel, u_dnsprefetch > dnsprefetch_rt;
typedef typed_mf_value < t_rel, u_external > external_rt;
typedef typed_mf_value < t_rel, u_icon > icon_rt;
typedef typed_mf_value < t_rel, u_noopener > noopener_rt;
typedef typed_mf_value < t_rel, u_noreferrer > noreferrer_rt;
typedef typed_mf_value < t_rel, u_preconnect > preconnect_rt;
...
typedef typed_mf_value < t_rel, r_donation > donation_rt;
typedef typed_mf_value < t_rel, r_duplicate > duplicate_rt;
typedef typed_mf_value < t_rel, r_edit > edit_rt;
...
typedef typed_mf_value < t_rel, r_main > main_rt;
...
typedef typed_mf_value < t_rel, r_service > service_rt;
...
typedef typed_mf_value < t_rel, r_apple_touch_icon > apple_touch_icon_rt;
typedef typed_mf_value < t_rel, r_apple_touch_icon_precomposed > apple_touch_icon_precomposed_rt;
typedef typed_mf_value < t_rel, r_apple_touch_startup_image > apple_touch_startup_image_rt;
typedef typed_mf_value < t_rel, r_archive > archive_rt;
typedef typed_mf_value < t_rel, r_archived > archived_rt;
typedef typed_mf_value < t_rel, r_attachment > attachment_rt;
typedef typed_mf_value < t_rel, r_authorisation_endpoint > authorisation_endpoint_rt;
typedef typed_mf_value < t_rel, r_category > category_rt;
typedef typed_mf_value < t_rel, r_chrome_webstore_item > chrome_webstore_item_rt;
typedef typed_mf_value < t_rel, r_code_repository > code_repository_rt;
typedef typed_mf_value < t_rel, r_component > component_rt;
typedef typed_mf_value < t_rel, r_compression_dictionary > compression_dictionary_rt;
typedef typed_mf_value < t_rel, r_content_repository > content_repository_rt;
typedef typed_mf_value < t_rel, r_dcterms_conformsto > dcterms_conformsto_rt;
typedef typed_mf_value < t_rel, r_dcterms_contributor > dcterms_contributor_rt;
typedef typed_mf_value < t_rel, r_dcterms_creator > dcterms_creator_rt;
typedef typed_mf_value < t_rel, r_dcterms_description > dcterms_description_rt;
typedef typed_mf_value < t_rel, r_dcterms_hasformat > dcterms_hasformat_rt;
typedef typed_mf_value < t_rel, r_dcterms_haspart > dcterms_haspart_rt;
typedef typed_mf_value < t_rel, r_dcterms_hasversion > dcterms_hasversion_rt;
typedef typed_mf_value < t_rel, r_dcterms_isformatof > dcterms_isformatof_rt;
typedef typed_mf_value < t_rel, r_dcterms_ispartof > dcterms_ispartof_rt;
typedef typed_mf_value < t_rel, r_dcterms_isreferencedby > dcterms_isreferencedby_rt;
typedef typed_mf_value < t_rel, r_dcterms_isreplacedby > dcterms_isreplacedby_rt;
typedef typed_mf_value < t_rel, r_dcterms_isrequiredby > dcterms_isrequiredby_rt;
typedef typed_mf_value < t_rel, r_dcterms_isversionof > dcterms_isversionof_rt;
typedef typed_mf_value < t_rel, r_dcterms_licence > dcterms_licence_rt;
typedef typed_mf_value < t_rel, r_dcterms_mediator > dcterms_mediator_rt;
typedef typed_mf_value < t_rel, r_dcterms_publisher > dcterms_publisher_rt;
typedef typed_mf_value < t_rel, r_dcterms_references > dcterms_references_rt;
typedef typed_mf_value < t_rel, r_dcterms_relation > dcterms_relation_rt;
typedef typed_mf_value < t_rel, r_dcterms_replaces > dcterms_replaces_rt;
typedef typed_mf_value < t_rel, r_dcterms_requires > dcterms_requires_rt;
typedef typed_mf_value < t_rel, r_dcterms_rightsholder > dcterms_rightsholder_rt;
typedef typed_mf_value < t_rel, r_dcterms_source > dcterms_source_rt;
typedef typed_mf_value < t_rel, r_dcterms_subject > dcterms_subject_rt;
typedef typed_mf_value < t_rel, r_disclosure > disclosure_rt;
typedef typed_mf_value < t_rel, r_edituri > edituri_rt;
typedef typed_mf_value < t_rel, r_entry_content > entry_content_rt;
typedef typed_mf_value < t_rel, r_gbfs > gbfs_rt;
typedef typed_mf_value < t_rel, r_gtfs_static > gtfs_static_rt;
typedef typed_mf_value < t_rel, r_gtfs_realtime > gtfs_realtime_rt;
typedef typed_mf_value < t_rel, r_image_src > image_src_rt;
typedef typed_mf_value < t_rel, r_import > import_rt;
typedef typed_mf_value < t_rel, r_jslicence > jslicence_rt;
typedef typed_mf_value < t_rel, r_lightbox > lightbox_rt;
typedef typed_mf_value < t_rel, r_lightvideo > lightvideo_rt;
typedef typed_mf_value < t_rel, r_manifest > manifest_rt;
typedef typed_mf_value < t_rel, r_maskicon > maskicon_rt;
typedef typed_mf_value < t_rel, r_meta > meta_rt;
typedef typed_mf_value < t_rel, r_openid_delegate > openid_delegate_rt;
typedef typed_mf_value < t_rel, r_openid_server > openid_server_rt;
typedef typed_mf_value < t_rel, r_openid2_local_id > openid2_local_id_rt;
typedef typed_mf_value < t_rel, r_openid2_provider > openid2_provider_rt;
typedef typed_mf_value < t_rel, r_p3pv1 > p3pv1_rt;
typedef typed_mf_value < t_rel, r_pgpkey > pgpkey_rt;
...
typedef typed_mf_value < t_rel, r_ontology_dcterms > ontology_dcterms_rt;
typedef typed_mf_value < t_rel, r_shortlink > shortlink_rt;
typedef typed_mf_value < t_rel, r_sitemap > sitemap_rt;
typedef typed_mf_value < t_rel, r_stylesheetless > stylesheetless_rt;
typedef typed_mf_value < t_rel, r_subresource > subresource_rt;
typedef typed_mf_value < t_rel, r_sword > sword_rt;
typedef typed_mf_value < t_rel, r_syndication > syndication_rt;
typedef typed_mf_value < t_rel, r_timesheet > timesheet_rt;
typedef typed_mf_value < t_rel, r_token_endpoint > token_endpoint_rt;
typedef typed_mf_value < t_rel, r_widget > widget_rt;
typedef typed_mf_value < t_rel, r_wlwmanifest > wlwmanifest_rt;
typedef typed_mf_value < t_rel, r_yandex_tableau_widget > yandex_tableau_widget_rt;
...
typedef typed_mf_value < t_rel, r_comments > comments_rt;
...
typedef typed_mf_value < t_rel, r_ontology_dc > ontology_dc_rt;
