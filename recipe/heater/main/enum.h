...
constexpr e_css_version css_version_max = css_ls_aug25;
...
{   nm_none,
    nm_class_count, nm_class_decl_count, nm_class_decl_int, nm_class_int, nm_class_name, nm_class_title, nm_compile_time, nm_config,
        nm_context_absolute_path, nm_context_account, nm_context_analysis, nm_context_article, nm_context_atomic_exts, nm_context_back, nm_context_body,
        ...
        nm_context_rfc_1942, nm_context_rfc_1980, nm_context_rfc_2070, nm_context_role, nm_context_root, nm_context_rsl_exts,
        nm_context_rss_exts, nm_context_rss_version, nm_context_ruby,
...
{   ont_context,
    ...
    sch_audioobject, sch_audioobjectsnapshot, sch_authenticcontent, sch_authoriseaction, sch_authoritativelegalvalue, sch_autobodyshop, sch_autodealer, sch_automatedteller,
    sch_automotivebusiness, sch_carpartsshop, sch_autorental, sch_autorepair, sch_autowash,
    ...
    sch_offlicence, sch_listenaction, sch_listitem, sch_listprice, sch_literaryevent, sch_livealbum, sch_liveblogposting, sch_livingwithhealthaspect, sch_loanorcredit, sch_localbusiness,
    sch_locationfeaturespecification, sch_lockerdelivery, sch_locksmith, sch_lodgingbusiness, sch_lodgingreservation, sch_longitudinal, sch_loseaction, sch_lowcaloriediet, sch_lowfatdiet,
    sch_lowlactosediet, sch_lowsaltdiet, sch_lung, sch_lymphaticvessel,
    ...
    sch_mixedeventattendancemode, sch_mixtapealbum, sch_molecularentity, sch_mobileapplication, sch_mobilephoneshop, sch_mobilewebplatform, sch_monday, sch_monetaryamount, sch_monetaryamountdistribution,
    sch_monetarygrant, sch_moneytransfer, sch_mortgageloan, sch_mosque, sch_motel, sch_motorcycle, sch_motorcycledealer, sch_msrp, sch_motorcyclerepair, sch_motorisedbicycle, sch_mountain,
    sch_moveaction, sch_movie, sch_movieclip, sch_filmhireshop, sch_movieseries, sch_movietheatre, sch_removers, sch_mri, sch_multicellularparasite, sch_multicentretrial, sch_multiplayer, sch_muscle,
    sch_musculoskeletal, sch_musculoskeletalexam, sch_museum, sch_musical_bum, sch_musicalbumproductiontype, sch_musicalbumreleasetype, sch_musiccomposition, sch_musicevent, sch_musicgroup,
    sch_musicplaylist, sch_musicrecording, sch_musicrelease, sch_musicreleaseformattype, sch_musicshop, sch_musicvenue, sch_musicvideoobject,
    ...
    sch_oncologic, sch_ondemandevent, sch_onetimepayments, sch_online, sch_onlinebusiness, sch_onlineeventattendancemode, sch_onlinefull, sch_onlineonly, sch_onlinemarketplace, sch_onlinestore, sch_onsitepickup,
    sch_openinghoursspecification, sch_opentrial, sch_opinionnewsarticle, sch_optician, sch_optometric, sch_order, sch_orderaction, sch_ordercancelled, sch_orderdelivered, sch_orderintransit, sch_orderitem,
    sch_orderpaymentdue, sch_orderpickupavailable, sch_orderproblem, sch_orderprocessing, sch_orderreturned, sch_orderstatus, sch_organisation, sch_organisationrole, sch_organiseaction, sch_originalmediacontent,
    sch_originalshippingfees, sch_osteopathic, sch_otc, sch_otolaryngologic, sch_outletstore, sch_outofstock, sch_overviewhealthaspect, sch_ownershipinfo,

    sch_paediatric, sch_paidleave, sch_paintaction, sch_painting, sch_palliativeprocedure, sch_paperback, sch_parceldelivery, sch_parcelservice, sch_parentalsupport, sch_parentaudience,
    ...
    sch_returnlabelsourceenumeration, sch_returnmethodenumeration, sch_returnshippingfees, sch_review, sch_reviewaction, sch_reviewnewsarticle, sch_rheumatologic, sch_righthanddriving,
    ...
    sch_seatingmap, sch_seedoctorhealthaspect, sch_seektoaction, sch_selfcarehealthaspect, sch_selfstorage, sch_sellaction, sch_sendaction, sch_series, sch_service, sch_servicechannel, sch_serviceperiod,
    sch_sexualcontentconsideration, sch_shareaction, sch_sheetmusic, sch_shippingconditions, sch_shippingdeliverytime, sch_shippingratesettings, sch_shippingservice, sch_shoeshop, sch_shoppingcentre, sch_shortstory, sch_sideeffectshealthaspect,
    ...
    sch_touristtrip, sch_townhall, sch_toxicologic, sch_toyshop, sch_trackaction, sch_tradeaction, sch_trainreservation, sch_trainstation, sch_traintrip, sch_transferaction, sch_transformedcontent,
    sch_transitmap, sch_travelaction, sch_travelagency, sch_treatmentindication, sch_treatmentshealthaspect, sch_trip, sch_tripleblindedtrial, sch_true, sch_tuesday, sch_tvclip, sch_tvepisode,
    sch_tvseason, sch_tvseries, sch_typeandquantitynode, sch_typeshealthaspect, sch_tyreshop,
    ...
    sch_vacationrental, sch_vegandiet, sch_vegetariandiet, sch_vehicle, sch_vein, sch_venuemap, sch_vessel, sch_veterinarycare, sch_videogallery, sch_videogame, sch_videogameclip, sch_videogameseries,
    sch_videoobject, sch_videoobjectsnapshot, sch_viewaction, sch_vinylformat, sch_violenceconsideration, sch_virtuallocation, sch_virus, sch_visualartsevent, sch_visualartwork, sch_vitalsign, sch_volcano, sch_voteaction,
...
{   op_context,
    ...
    sp_bookingagent, sp_bookingtime, sp_borrower, sp_box, sp_branch, sp_branchcode, sp_branchof, sp_brand, sp_breadcrumb, sp_breastfeedingwarning, sp_bribeamount, sp_bribeitem, sp_bribestatus, sp_bribetype,
    sp_broadcastaffiliateof, sp_broadcastchannelid, sp_broadcastdisplayname, sp_broadcaster, sp_broadcastfrequency, sp_broadcastfrequencyvalue, sp_broadcastofevent, sp_broadcastservicetier,
    sp_broadcastsignalmodulation, sp_broadcastsubchannel, sp_broadcasttimezone, sp_broker, sp_browserrequirements, sp_businessdays, sp_businessfunction, sp_busname, sp_busnumber, sp_buyer,
    sp_byartist, sp_byday, sp_bymonth, sp_bymonthday, sp_bymonthweek,
    ...
    sp_datafeedelement, sp_dataset, sp_datasettimeinterval, sp_datecreated, sp_datedeleted, sp_dateissued, sp_dateline, sp_datemodified, sp_dateposted, sp_datepublished, sp_dateread,
    ...
    sp_lender, sp_lesser, sp_lesserorequal, sp_letterer, sp_license, sp_line, sp_linkrelationship, sp_liveblogupdate, sp_loanmortgagamandateamount, sp_loanpaymentamount, sp_loanpaymentfrequency,
    sp_loanrepaymentform, sp_loanterm, sp_loantype, sp_location, sp_locationcreated, sp_lodgingunitdescription, sp_lodgingunittype, sp_logo, sp_longitude, sp_loser, sp_lowprice, sp_lyricist,
    sp_lyrics,
