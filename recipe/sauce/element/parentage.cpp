...
{   { { HTML_PLUS }, { HTML_PLUS }, elem_a, elem_em },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_annotation_xml, elem_undefined },
    ...
    { { HTML_JAN05, 0, MATH_3_4 }, { HTML_UNDEF }, elem_bvar, elem_degree },
    { { HTML_JAN05, 0, MATH_3_4 }, { HTML_UNDEF }, elem_bvar, elem_semantics },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_ci, elem_mglyph },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_ci, elem_mglyph },
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_ci, elem_undefined, 0, EF_M_PRESINCONTENT },
    { { XHTML_1_0, 0, MATH_3_4 }, { HTML_UNDEF }, elem_cn, elem_mglyph },
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_cn, elem_sep },
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_cn, elem_undefined, 0, EF_M_PRESINCONTENT },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_condition, elem_undefined, 0, EF_M_CONTENTEXPR },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_csymbol, elem_mglyph },
    ...
    { { HTML_JAN07, 0, HE_SVG_2_0 }, { HTML_UNDEF }, elem_defs, elem_canvas },
    ...
    { { HTML_JAN07, 0, HE_SVG_2_0 }, { HTML_UNDEF }, elem_g, elem_canvas },
    ...
    { { HTML_JAN07, 0, HE_SVG_2_0 }, { HTML_UNDEF }, elem_marker, elem_canvas },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_math, elem_declare },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, elem_mlabeledtr, elem_mtd },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_mn, elem_mglyph },
    { { XHTML_1_0 }, { HTML_UNDEF }, elem_mo, elem_malignmark },
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_mo, elem_mglyph },
    ...
    { { XHTML_1_0, 0, MATH_2_3_4 }, { HTML_UNDEF }, elem_ms, elem_mglyph },
    ...
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, elem_mtable, elem_mlabeledtr },
    { { HTML_5_2, 0, MATH_3_4 }, { HTML_UNDEF }, elem_mtable, elem_mtr },
    ...
    { { HTML_JAN07, 0, HE_SVG_2_0 }, { HTML_UNDEF }, elem_pattern, elem_canvas },
    ...
    { { XHTML_1_0, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, elem_set, elem_undefined, 0, EF_M_CONTENTEXPR },
    ...
    { { HTML_JAN07, 0, HE_SVG_2_0 }, { HTML_UNDEF }, elem_svg, elem_canvas },
    ...
    { { HTML_JAN07, 0, HE_SVG_2_0 }, { HTML_UNDEF }, elem_switch, elem_canvas },
    ...
    { { HTML_JAN05 }, { HTML_DEC06 }, elem_switch, elem_undefined, 0, EF_5_SECTION },
    ...
    { { HTML_JAN07, 0, HE_SVG_2_0 }, { HTML_UNDEF }, elem_symbol, elem_canvas },
