...
{   mmac_t table = mac_title (REPORT_CAREGORY);
    ...
    res += saybe (table, category_.at (ec_robotic), "Robot");
    res += saybe (table, category_.at (ec_rsl), "RSL");
    res += saybe (table, category_.at (ec_rss), "RSS");
    res += saybe (table, category_.at (ec_rudeness), "Rudeness");
    res += saybe (table, category_.at (ec_schema), "Schema");
    res += saybe (table, category_.at (ec_security), "Security");
