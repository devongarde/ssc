...
{   { nit_308, "308" },
    ...
    { nit_ontology_url, "ontology_url" },
    { nit_unrecognised_ontology, "unrecognised_ontology" },
    { nit_ontology_domain, "ontology_domain" },
    ...
    { nit_ontology_property, "ontology_property" },
    { nit_forgotten_name, "forgotten_name" },
    { nit_incompatible_itemtype, "incompatible_itemtype" },
    { nit_inlist, "inlist" },
    { nit_ontology_hierarchy, "ontology_hierarchy" },
    { nit_angle, "angle" },
    { nit_html, "html" },
    ...
    { nit_not_ontology_property, "not_ontology_property" },
    { nit_curses, "curses" },
    ...
    { nit_minute, "minute" },
    { nit_second, "second" },
    { nit_deprecated_ontology, "deprecated_ontology" },
    ...
    { nit_missing_ontology, "missing_ontology" },
    ...
    { nit_nan, "nan" },
    { nit_a_expected, "a_expected" },
    { nit_block_expected, "block_expected" },
    { nit_elements_repeated, "elements_repeated" },
    { nit_bad_background, "bad_background" },
    { nit_css_url, "css_url" },
    { nit_css_dubious, "css_dubious" },
    { nit_bad_import, "bad_import" },
    { nit_spotted_id, "spotted_id" },
    ...
    { nit_css_attribute, "css_attribute" },
    { nit_css_element, "css_element" },
    { nit_selector, "selector" },
    { nit_pseud, "pseud" },
    { nit_property, "property" },
    { nit_rule, "rule" },
    { nit_statement, "statement" },
    { nit_weight, "weight" },
    { nit_naughty_content, "naughty_content" },
    { nit_naughty_decoration, "naughty_decoration" },
    { nit_bad_page, "bad_page" },
    { nit_naughty_page, "naughty_page" },
    { nit_page_name_again, "page_name_again" },
    { nit_css_unfinished, "css_unfinished" },
    { nit_missing_units, "missing_units" },
    ...
    { nit_vtt_cue, "vtt_cue" },
    { nit_webvtt, "webvtt" },
    { nit_vtt_timestamp, "vtt_timestamp" },
    { nit_vtt_css, "vtt_css" },
    { nit_vtt_bad_cue, "vtt_bad_cue" },
    { nit_vtt_bad_id, "vtt_bad_id" },
    { nit_vtt_region, "vtt_region" },
    { nit_vtt_class, "vtt_class" },
    { nit_vtt_annotation, "vtt_annotation" },
    ...
    { nit_content_language, "content_language" },
    { nit_inefficient, "inefficient" },
    { nit_h1_h6, "h1_h6" },
    { nit_slash_gt, "slash_gt" },
    { nit_url_template, "url_template" },
    { nit_template_variable, "template_variable" },
    { nit_misplaced_rel, "misplaced_rel" },
    { nit_rel_version, "rel_version" },
    { nit_rel_bad_element, "rel_bad_element" },
    { nit_role_conflict, "role_conflict" },
    { nit_inadvisable_element, "inadvisable_element" },
    { nit_bad_rowspan, "bad_rowspan" },
    { nit_details, "details" },
    { nit_rss, "rss" },
    { nit_rsl_missing_child, "rsl_missing_child" },
    { nit_rsl_webpage, "rsl_webpage" },
    { nit_rsl_overpopulation, "rsl_overpopulation" },
    { nit_robotic, "robotic" },
    { nit_wacky, "wacky" },
    { nit_rss_missing_child, "rss_missing_child" },
    { nit_rss_missing_attribute, "rss_missing_attribute" },
    { nit_con, "con" },
    { nit_atom, "atom" },
    { nit_atom_repeated_child, "atom_repeated_child" },
    { nit_atom_missing_child, "atom_missing_child" },
    { nit_rfc822_zone, "rfc822_zone" },
    { nit_time_space, "time_space" },
    { nit_time_char, "time_char" },
    { nit_time_digit, "time_digit" },
    { nit_bad_year, "bad_year" },
    { nit_bad_month, "bad_month" },
    { nit_bad_week, "bad_week" },
    { nit_bad_date, "bad_date" },
    { nit_bad_day, "bad_day" },
    { nit_bad_hour, "bad_hour" },
    { nit_bad_minute, "bad_minute" },
    { nit_bad_second, "bad_second" },
    { nit_bad_kangeroo, "bad_kangeroo" },
    { nit_bad_microsecond, "bad_microsecond" },
    { nit_time_value, "time_value" },
    { nit_bad_weekday, "bad_weekday" },
    { nit_bad_monthname, "bad_monthname" },
    { nit_bad_zone, "bad_zone" },
    { nit_duration, "duration" },
    { nit_svg_duration, "svg_duration" },
    { nit_rather_too_vague, "rather_too_vague" },
