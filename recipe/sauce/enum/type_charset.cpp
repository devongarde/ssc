...
{   { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "context", cs_context },

    // source: https://www.iana.org/assignments/character-sets/character-sets.xhtml
    // decorated from whatwg june 2020 encodings
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ansi_x3.110-1983", cs_ansi_x3_110_1983 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "asmo_449", cs_asmo_449 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "adobe-standard-encoding", cs_adobe_standard_encoding },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "adobe-symbol-encoding", cs_adobe_symbol_encoding },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "amiga-1251", cs_amiga_1251 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "bocu-1", cs_bocu_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "brf", cs_brf },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "bs_4730", cs_bs_4730 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "bs_viewdata", cs_bs_viewdata },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "cesu-8", cs_cesu_8 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "cp50220", cs_cp50220 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "cp51932", cs_cp51932 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "csa_z243.4-1985-1", cs_csa_z243_4_1985_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "csa_z243.4-1985-2", cs_csa_z243_4_1985_2 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "csa_z243.4-1985-gr", cs_csa_z243_4_1985_gr },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "csn_369103", cs_csn_369103 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "dec-mcs", cs_dec_mcs },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "din_66003", cs_din_66003 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ds_2089", cs_ds_2089 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-at-de", cs_ebcdic_at_de },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-at-de-a", cs_ebcdic_at_de_a },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-ca-fr", cs_ebcdic_ca_fr },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-dk-no", cs_ebcdic_dk_no },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-dk-no-a", cs_ebcdic_dk_no_a },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-es", cs_ebcdic_es },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-es-a", cs_ebcdic_es_a },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-es-s", cs_ebcdic_es_s },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-fi-se", cs_ebcdic_fi_se },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-fi-se-a", cs_ebcdic_fi_se_a },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-fr", cs_ebcdic_fr },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-it", cs_ebcdic_it },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-pt", cs_ebcdic_pt },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-uk", cs_ebcdic_uk },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ebcdic-us", cs_ebcdic_us },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ecma-cyrillic", cs_ecma_cyrillic },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "es", cs_es },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "es2", cs_es2 },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "extended_unix_code_fixed_width_for_japanese", cs_extended_unix_code_fixed_width_for_japanese },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "extended_unix_code_packed_format_for_japanese", cs_extended_unix_code_packed_format_for_japanese },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "gb_1988-80", cs_gb_1988_80 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "gost_19768-74", cs_gost_19768_74 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "hp-desktop", cs_hp_desktop },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "hp-legal", cs_hp_legal },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "hp-math8", cs_hp_math8 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "hp-pi-font", cs_hp_pi_font },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm-symbols", cs_ibm_symbols },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm-thai", cs_ibm_thai },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm00858", cs_ibm00858 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm00924", cs_ibm00924 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01140", cs_ibm01140 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01141", cs_ibm01141 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01142", cs_ibm01142 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01143", cs_ibm01143 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01144", cs_ibm01144 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01145", cs_ibm01145 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01146", cs_ibm01146 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01147", cs_ibm01147 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01148", cs_ibm01148 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm01149", cs_ibm01149 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm037", cs_ibm037 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm038", cs_ibm038 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm1026", cs_ibm1026 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm1047", cs_ibm1047 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm273", cs_ibm273 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm274", cs_ibm274 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm275", cs_ibm275 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm277", cs_ibm277 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm278", cs_ibm278 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm280", cs_ibm280 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm281", cs_ibm281 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm284", cs_ibm284 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm285", cs_ibm285 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm290", cs_ibm290 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm297", cs_ibm297 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm420", cs_ibm420 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm423", cs_ibm423 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm424", cs_ibm424 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm437", cs_ibm437 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm500", cs_ibm500 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm775", cs_ibm775 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm850", cs_ibm850 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm851", cs_ibm851 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm852", cs_ibm852 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm855", cs_ibm855 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm857", cs_ibm857 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm860", cs_ibm860 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm861", cs_ibm861 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm862", cs_ibm862 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm863", cs_ibm863 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm864", cs_ibm864 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm865", cs_ibm865 },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm868", cs_ibm868 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm869", cs_ibm869 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm870", cs_ibm870 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm871", cs_ibm871 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm880", cs_ibm880 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm891", cs_ibm891 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm903", cs_ibm903 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm904", cs_ibm904 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm905", cs_ibm905 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ibm918", cs_ibm918 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iec_p27-1", cs_iec_p27_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "inis", cs_inis },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "inis-8", cs_inis_8 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "inis-cyrillic", cs_inis_cyrillic },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "invariant", cs_invariant },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-10646-j-1", cs_iso_10646_j_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-10646-ucs-4", cs_iso_10646_ucs_4 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-10646-ucs-basic", cs_iso_10646_ucs_basic },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-10646-utf-1", cs_iso_10646_utf_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-10646-unicode-latin1", cs_iso_10646_unicode_latin1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-11548-1", cs_iso_11548_1 },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-2022-jp-2", cs_iso_2022_jp_2 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-8859-1-windows-3.0-latin-1", cs_iso_8859_1_windows_3_0_latin_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-8859-1-windows-3.1-latin-1", cs_iso_8859_1_windows_3_1_latin_1 },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-8859-2-windows-latin-2", cs_iso_8859_2_windows_latin_2 },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-8859-9", cs_iso_8859_9 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-8859-9-windows-latin-5", cs_iso_8859_9_windows_latin_5 },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-unicode-ibm-1261", cs_iso_unicode_ibm_1261 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-unicode-ibm-1264", cs_iso_unicode_ibm_1264 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-unicode-ibm-1265", cs_iso_unicode_ibm_1265 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-unicode-ibm-1268", cs_iso_unicode_ibm_1268 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-unicode-ibm-1276", cs_iso_unicode_ibm_1276 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_10367-box", cs_iso_10367_box },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_2033-1983", cs_iso_2033_1983 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_5427", cs_iso_5427 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_5427:1981", cs_iso_5427_1981 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_5428:1980", cs_iso_5428_1980 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_646.basic:1983", cs_iso_646_basic_1983 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_646.irv:1983", cs_iso_646_irv_1983 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_6937-2-25", cs_iso_6937_2_25 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_6937-2-add", cs_iso_6937_2_add },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_8859-3:1988", cs_iso_8859_3_1988 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_8859-4:1988", cs_iso_8859_4_1988 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_8859-8-e", cs_iso_8859_8_e },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_8859-8-i", cs_iso_8859_8_i },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_8859-9:1989", cs_iso_8859_9_1989 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso_8859-supp", cs_iso_8859_supp },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "it", cs_it },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6220-1969-jp", cs_jis_c6220_1969_jp },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6220-1969-ro", cs_jis_c6220_1969_ro },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6226-1978", cs_jis_c6226_1978 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6226-1983", cs_jis_c6226_1983 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6229-1984-a", cs_jis_c6229_1984_a },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6229-1984-b", cs_jis_c6229_1984_b },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6229-1984-b-add", cs_jis_c6229_1984_b_add },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6229-1984-hand", cs_jis_c6229_1984_hand },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6229-1984-hand-add", cs_jis_c6229_1984_hand_add },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_c6229-1984-kana", cs_jis_c6229_1984_kana },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_encoding", cs_jis_encoding },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_x0201", cs_jis_x0201 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jis_x0212-1990", cs_jis_x0212_1990 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jus_i.b1.002", cs_jus_i_b1_002 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jus_i.b1.003-mac", cs_jus_i_b1_003_mac },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "jus_i.b1.003-serb", cs_jus_i_b1_003_serb },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "koi7-switched", cs_koi7_switched },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ksc5636", cs_ksc5636 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "kz-1048", cs_kz_1048 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "latin-greek-1", cs_latin_greek_1 },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "mnem", cs_mnem },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "mnemonic", cs_mnemonic },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "msz_7795.3", cs_msz_7795_3 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "microsoft-publishing", cs_microsoft_publishing },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "nats-dano", cs_nats_dano },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "nats-dano-add", cs_nats_dano_add },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "nats-sefi", cs_nats_sefi },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "nats-sefi-add", cs_nats_sefi_add },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "nc_nc00-10:81", cs_cs_nc_nc00_10_81 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "nf_z_62-010", cs_nf_z_62_010 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "nf_z_62-010_(1973)", cs_nf_z_62_010_1973 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ns_4551-1", cs_ns_4551_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ns_4551-2", cs_ns_4551_2 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "osd_ebcdic_df03_irv", cs_osd_ebcdic_df03_irv },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "osd_ebcdic_df04_1", cs_osd_ebcdic_df04_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "osd_ebcdic_df04_15", cs_osd_ebcdic_df04_15 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "pc8-danish-norwegian", cs_pc8_danish_norwegian },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "pc8-turkish", cs_pc8_turkish },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "pt", cs_pt },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "pt2", cs_pt2 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ptcp154", cs_ptcp154 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "scsu", cs_scsu },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "sen_850200_b", cs_sen_850200_b },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "sen_850200_c", cs_sen_850200_c },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "t.101-g2", cs_t_101_g2 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "t.61-7bit", cs_t_61_7bit },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "t.61-8bit", cs_t_61_8bit },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "tscii", cs_tscii },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "unicode-1-1", cs_unicode_1_1 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "unicode-1-1-utf-7", cs_unicode_1_1_utf_7 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "unknown-8bit", cs_unknown_8bit },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "utf-32", cs_utf_32 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "utf-32be", cs_utf_32be },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "utf-32le", cs_utf_32le },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "utf-7", cs_utf_7 },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "viqr", cs_viqr },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "viscii", cs_viscii },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ventura-international", cs_ventura_international },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ventura-math", cs_ventura_math },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "ventura-us", cs_ventura_us },
    ...
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "dk-us", cs_dk_us },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "greek-ccitt", cs_greek_ccitt },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "greek7", cs_greek7 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "greek7-old", cs_greek7_old },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "hp-roman8", cs_hp_roman8 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "iso-ir-90", cs_iso_ir_90 },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "latin-greek", cs_latin_greek },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "latin-lap", cs_latin_lap },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "us-dk", cs_us_dk },
    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, "videotex-suppl", cs_videotex_suppl },
    ...
    // MathML 1
    { { HTML_MATH1, 0, 0, H2_MATH_1 }, { HTML_UNDEF }, "axiom", cs_axiom },
    { { HTML_MATH1, 0, 0, H2_MATH_1 }, { HTML_UNDEF }, "maple", cs_maple },
    { { HTML_MATH1, 0, 0, H2_MATH_1 }, { HTML_UNDEF }, "mathematica", cs_mathematica },
    { { HTML_MATH1, 0, 0, H2_MATH_1 }, { HTML_UNDEF }, "mathml-content", cs_mathml_content },
    { { HTML_MATH1, 0, 0, H2_MATH_1 }, { HTML_UNDEF }, "mathml-presentation", cs_mathml_presentation },
    { { HTML_MATH1, 0, 0, H2_MATH_1 }, { HTML_UNDEF }, "openmath", cs_openmath },
    { { HTML_MATH1, 0, 0, H2_MATH_1 }, { HTML_UNDEF }, "tex", cs_tex },
    { { HTML_MATH1, 0, 0, H2_MATH_1 }, { HTML_UNDEF }, "text", cs_text },

    { { HTML_4_0, HV_REJECT }, { HTML_UNDEF }, nullptr, cs_illegal } };
