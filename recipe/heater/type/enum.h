...
{   a_unknown,
    ...
    a_calcmode, a_cancelable, a_capheight, a_capture, a_cd, a_cdgroup, a_cell, a_cellpadding, a_cellspacing, a_challenge, a_char, a_charalign, a_charoff,
        ...
        a_cols, a_colspan, a_colspec, a_columnalign, a_columnlines, a_columnspacing, a_columnspan, a_columnwidth, a_command, a_compact, a_content,
        a_contenteditable, a_contentlength, a_contentscripttype, a_contentstyletype, a_contextmenu, a_continue, a_controls, a_controlslist, a_coords,
        a_crossorigin, a_crossout, a_csp, a_currenttime, a_cursor, a_cx, a_cy,
...
typedef enum {
    ...
    elem_data, elem_datagrid, elem_datalist, elem_dd, elem_ddot, elem_declare, elem_defs, elem_degree, elem_del, elem_desc, elem_details, elem_determinant,
        elem_device, elem_dfn, elem_di, elem_dialogue, elem_diff, elem_dir, elem_discard, elem_dispatchevent, elem_div, elem_divergence, elem_divide, elem_dl,
        elem_domain, elem_domainofapplication, elem_dot, elem_dt,
...
{   nit_free,
    ...
    nit_bad_command, nit_bad_datagrid,
