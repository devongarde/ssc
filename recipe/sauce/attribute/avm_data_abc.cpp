...
{   { { HTML_2_0, HV_RFC_2070 | HV_NOT3 }, { XHTML_2_0 }, elem_a, a_charset },
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_a),
    ...
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_animate, a_from },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_animate, a_to},
    ...
    SVG_ANVAL_ATTRIBUTES (elem_animate),
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_animatecolour, a_externalresourcesrequired },
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_animatecolour, a_from },
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_animatecolour, a_to },
    ...
    SVG_ANVAL_ATTRIBUTES (elem_animatecolour),
    ...
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_animatemotion, a_externalresourcesrequired },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_animatemotion, a_from },
    ...
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_animatemotion, a_to },
    ...
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_animatetransform, a_from },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_animatetransform, a_to },
    { { HTML_SVG11, 0, HE_SVG_11_20 }, { HTML_UNDEF }, elem_animatetransform, a_type },
    ...
    SVG_ANVAL_ATTRIBUTES (elem_animatetransform),
    ...
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_animation, a_syncbehaviour },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_animation, a_syncmaster },
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_animation, a_synctolerance },
    SVG12_CONDGRAPH_ATTRIBUTES (elem_animation),
    STANDARD_HTMLS_4_5_ATTRIBUTES (elem_animation),

    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_annotation, a_cd },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_annotation, a_definitionurl },
    { { XHTML_1_0 }, { HTML_UNDEF }, elem_annotation, a_encoding },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_annotation, a_name },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_annotation, a_src },
    MATH3_STANDARD_ATTRIBUTES (elem_annotation),

    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_annotation_xml, a_cd },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_annotation_xml, a_definitionurl },
    { { XHTML_1_0 }, { HTML_UNDEF }, elem_annotation_xml, a_encoding },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_annotation_xml, a_name },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_annotation_xml, a_src },
    ...
    { { HTML_SVG12, 0, HE_SVG_12 }, { HTML_UNDEF }, elem_audio, a_audio_level },
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_circle),
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_clippath, a_clippathunits },
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_clippath, a_externalresourcesrequired },
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, elem_clippath, a_transform },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, elem_colourprofile, a_local },
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, elem_colourprofile, a_renderingintent },
