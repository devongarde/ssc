...
{   { { HTML_PLUS }, { HTML_UNDEF }, "!doctype", elem_faux_doctype, ns_default, EP_CLOSED | EP_TOP },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "abs", elem_abs, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "and", elem_and, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "animate", elem_animate, ns_default, 0, EF_SVG_ANIM | EF_SVG2_ANIM },
    { { HTML_SVG10, 0, HE_SVG_1 }, { HTML_UNDEF }, "animateColor", elem_animatecolour, ns_default, 0, EF_SVG_ANIM },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "animateMotion", elem_animatemotion, ns_default, 0, EF_SVG_ANIM | EF_SVG2_ANIM },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "animateTransform", elem_animatetransform, ns_default, 0, EF_SVG_ANIM | EF_SVG2_ANIM },
    { { XHTML_1_0, 0, HE_SVG_12 }, { HTML_UNDEF }, "animation", elem_animation },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "annotation", elem_annotation, ns_default, 0, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "annotation-xml", elem_annotation_xml, ns_default, 0, EF_M_CONTENT },
    { { HTML_3_2, HV_DEPRECATED4 }, { XHTML_2_0 }, "applet", elem_applet, ns_default, 0, EF_SPECIAL | EF_4_SPECIAL },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "apply", elem_apply, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "approx", elem_approx, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "arccos", elem_arccos, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arccosh", elem_arccosh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arccot", elem_arccot, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arccoth", elem_arccoth, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arccsc", elem_arccsc, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arccsch", elem_arccsch, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arcsec", elem_arcsec, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arcsech", elem_arcsech, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "arcsin", elem_arcsin, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arcsinh", elem_arcsinh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "arctan", elem_arctan, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arctanh", elem_arctanh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_2_0, HV_RFC_1980 | HV_NOT30 }, { HTML_UNDEF }, "area", elem_area, ns_default, EP_CLOSED, EF_5_FLOW | EF_5_PHRASE },
    { { HTML_PLUS, 0, MATH_2_3_4 }, { HTML_UNDEF }, "arg", elem_arg, ns_default, EP_CLOSED | EP_ARGS_1, EF_EMPH | EF_M_CONTENT },
    ...
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "bind", elem_bind, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "bvar", elem_bvar, ns_default, 0, EF_M_CONTENT | EF_M_DQ },
    ...
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "cartesianproduct", elem_cartesianproduct, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "cbytes", elem_cbytes, ns_default, EP_SIMPLE, EF_M_CONTENT },
    { { HTML_2_0, HV_DEPRECATED23 }, { HTML_2_0 }, "cdata", elem_cdata },  // mentioned in RFC 2070
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "ceiling", elem_ceiling, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_3_2 }, { XHTML_1_1 }, "center", elem_centre, ns_default, 0, EF_32_BLOCK | EF_4_BLOCK },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "cerror", elem_cerror, ns_default, 0, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "ci", elem_ci, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "clipPath", elem_clippath },
    { { HTML_PLUS }, { HTML_PLUS }, "cmd", elem_cmd, ns_default, 0, EF_EMPH },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "cn", elem_cn, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "codomain", elem_codomain, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11 }, { HTML_UNDEF }, "color-profile", elem_colourprofile },
    ...
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "complexes", elem_complexes, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "compose", elem_compose, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "condition", elem_condition, ns_default, 0, EF_M_CONTENT | EF_M_DQ },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "conjugate", elem_conjugate, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_JAN05, 0, HE_WEBCOMP }, { HTML_UNDEF }, "content", elem_content, ns_default, EP_CLOSED },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "cos", elem_cos, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "cosh", elem_cosh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "cot", elem_cot, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "coth", elem_coth, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_3_0 }, { HTML_3_0 }, "credit", elem_credit },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "cs", elem_cs, ns_default, EP_SIMPLE, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "csc", elem_csc, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "csch", elem_csch, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "csymbol", elem_csymbol, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "curl", elem_curl, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, "cursor", elem_cursor, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11 },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 | HE_M3_DEPRECAT | HE_M4_DEPRECAT }, { HTML_UNDEF }, "declare", elem_declare, ns_default, 0, EF_M_CONTENT /*  | EF_M_CONTINPRES */ },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, "definition-src", elem_definition_src, ns_default },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "defs", elem_defs, ns_default, 0, EF_S_G | EF_SVG_STR | EF_SVG2_STR | EF_SVG_CONTAIN },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "degree", elem_degree, ns_default, 0, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "determinant", elem_determinant, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "diff", elem_diff, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { XHTML_2_0, 0, HE_SVG_12 | HE_SVG_20 }, { HTML_UNDEF }, "discard", elem_discard, ns_default, EF_SVG2_ANIM },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "divergence", elem_divergence, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "divide", elem_divide, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "domain", elem_domain, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "domainofapplication", elem_domainofapplication, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_DQ },
    ...
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "emptyset", elem_emptyset, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "eq", elem_eq, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "equivalent", elem_equivalent, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "eulergamma", elem_eulergamma, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "exists", elem_exists, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "exp", elem_exp, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "exponentiale", elem_exponentiale, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "extensiondefs", elem_extensiondefs },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "factorial", elem_factorial, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "factorof", elem_factorof, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "false", elem_false, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feBlend", elem_feblend, ns_default, EP_CLOSED, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feColorMatrix", elem_fecolourmatrix, ns_default, EP_CLOSED, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feComponentTransfer", elem_fecomponenttransfer, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feComposite", elem_fecomposite, ns_default, EP_CLOSED, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feConvolveMatrix", elem_feconvolvematrix, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feDiffuseLighting", elem_fediffuselighting, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feDisplacementMap", elem_fedisplacementmap, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feDistantLight", elem_fedistantlight, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_20 }, { HTML_UNDEF }, "feDropShadow", elem_fedropshadow, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_20 }, { HTML_UNDEF }, "feFlood", elem_feflood, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feFuncA", elem_fefunca, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feFuncB", elem_fefuncb, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feFuncG", elem_fefuncg, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feFuncR", elem_fefuncr, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feGaussianBlur", elem_fegaussianblur, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feImage", elem_feimage, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feMerge", elem_femerge, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feMergeNode", elem_femergenode, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feMorphology", elem_femorphology, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feOffset", elem_feoffset, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "fePointLight", elem_fepointlight, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feSpecularLighting", elem_fespecularlighting, ns_default, 0, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feSpotLight", elem_fespotlight, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feTile", elem_fetile, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "feTurbulence", elem_feturbulence, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_SVG_FILTER },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "filter", elem_filter, ns_default, 0, EF_S_G },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "floor", elem_floor, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_3_2, HV_DEPRECATED4, HE_SVG_OLD_H | HE_SVG_11 | HE_SVG_20 }, { HTML_UNDEF }, "font", elem_font, ns_default, 0, EF_SPECIAL | EF_4_SPECIAL | EF_5_FLOW | EF_5_PHRASE },
    { { HTML_SVG11, 0, HE_SVG_11 |  HE_SVG_12 }, { HTML_UNDEF }, "font-face", elem_fontface },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, "font-face-format", elem_fontfaceformat },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, "font-face-name", elem_fontfacename, ns_default, EP_CLOSED },
    { { HTML_SVG11, 0, HE_SVG_11 |  HE_SVG_12 }, { HTML_UNDEF }, "font-face-src", elem_fontfacesrc },
    { { HTML_SVG11, 0, HE_SVG_11 |  HE_SVG_12 }, { HTML_UNDEF }, "font-face-uri", elem_fontfaceuri },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "forall", elem_forall, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "foreignObject", elem_foreignobject, ns_default, 0, EF_SVG_STR | EF_SVG2_GRAPH },
    { { HTML_4_0 }, { XHTML_1_1 }, "frame", elem_frame, ns_default, EP_CLOSED },
    { { HTML_4_0, HV_FRAMESET }, { HTML_4_01 }, "frameset", elem_frameset },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "g", elem_g, ns_default, 0, EF_S_G | EF_SVG_STR | EF_SVG2_STR | EF_SVG_CONTAIN },
    { { HTML_JAN05 }, { HTML_JUN06 }, "gauge", elem_gauge, ns_default, 0, EF_5_FLOW | EF_5_PHRASE | EF_5_PALPABLE },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "gcd", elem_gcd, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "geq", elem_geq, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_SVG11, 0, HE_SVG_11 |  HE_SVG_12 }, { HTML_UNDEF }, "glyph", elem_glyph, ns_default, 0, EF_SVG_CONTAIN },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, "glyphref", elem_glyphref },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "grad", elem_grad, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "gt", elem_gt, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { XHTML_1_1, 0, HE_SVG_12 | HE_SVG_X2 }, { HTML_UNDEF }, "handler", elem_handler, ns_default, EP_SIMPLE },
    ...
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_12 }, { HTML_UNDEF }, "hkern", elem_hkern, ns_default, EP_CLOSED | EP_UNCLOSEDSVG12 },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "ident", elem_ident, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "imaginary", elem_imaginary, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "imaginaryi", elem_imaginaryi, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "implies", elem_implies, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "in", elem_in, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "infinity", elem_infinity, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "int", elem_int, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "integers", elem_integers, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "intersect", elem_intersect, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "interval", elem_interval, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "inverse", elem_inverse, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "lambda", elem_lambda, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_3_0 }, { HTML_3_0 }, "lang", elem_lang, ns_default, 0, EF_3_MISC },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "laplacian", elem_laplacian, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_2_0, 0, HE_NETSCAPE }, { HTML_3_2 }, "layer", elem_layer },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "lcm", elem_lcm, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_3_0 }, { HTML_3_0 }, "left", elem_left, ns_default, EP_CLOSED },
    { { HTML_4_0 }, { HTML_UNDEF }, "legend", elem_legend },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "leq", elem_leq, ns_default, EP_CLOSED| EP_ARGS_2| EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_3_0 }, { HTML_3_0 }, "lh", elem_lh },
    { { HTML_TAGS }, { HTML_UNDEF }, "li", elem_li, ns_default, EP_UNCLOSED1T, EF_X2_STRUCT | EF_X2_LIST },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "limit", elem_limit, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "list", elem_list, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "ln", elem_ln, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "loc", elem_loc },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "log", elem_log, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "logbase", elem_logbase, ns_default, 0, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "lowlimit", elem_lowlimit, ns_default, 0, EF_M_CONTENT | EF_M_DQ },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "lt", elem_lt, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_JUL05 }, { HTML_JUN08 }, "m", elem_m, ns_default, 0, EF_5_FLOW | EF_5_PHRASE | EF_5_PALPABLE | EF_SVG_CONTAIN },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "maction", elem_maction, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_JUL13 }, { HTML_UNDEF }, "main", elem_main, ns_default, 0, EF_5_FLOW | EF_5_PALPABLE },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "maligngroup", elem_maligngroup, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "malignmark", elem_malignmark, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "marker", elem_marker, ns_default, 0, EF_SVG_CONTAIN },
    { { HTML_2_0, 0, HE_IE }, { HTML_3_2 }, "marquee", elem_marquee, ns_default, EP_CLOSED },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "mask", elem_mask },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "matrix", elem_matrix, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "matrixrow", elem_matrixrow, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "max", elem_max, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mean", elem_mean, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "median", elem_median, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "menclose", elem_menclose, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "merror", elem_merror, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_2_0 }, { HTML_UNDEF }, "meta", elem_meta, ns_default, EP_CLOSED | EP_X2_OPEN, EF_METADATA | EF_5_FLOW | EF_5_PHRASE },
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_12 | HE_SVG_20 }, { HTML_UNDEF }, "metadata", elem_metadata, ns_default, 0, EF_SVG_DESC },
    { { HTML_JUL06 }, { HTML_UNDEF }, "meter", elem_meter, ns_default, EP_SIMPLE, EF_5_FLOW | EF_5_PHRASE | EF_5_PALPABLE },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mfenced", elem_mfenced, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mfrac", elem_mfrac, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "mglyph", elem_mglyph, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    { { HTML_PLUS }, { HTML_PLUS }, "mh", elem_mh, ns_default, EP_SIMPLE },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mi", elem_mi, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "min", elem_min, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "minus", elem_minus, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_12 }, { HTML_UNDEF }, "missing-glyph", elem_missingglyph, ns_default, 0, EF_SVG_CONTAIN },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "mlabeledtr", elem_mlabeledtr, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "mlongdiv", elem_mlongdiv, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mmultiscripts", elem_mmultiscripts, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mn", elem_mn, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mo", elem_mo, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mode", elem_mode, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "moment", elem_moment, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "momentabout", elem_momentabout, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mover", elem_mover, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mpadded", elem_mpadded, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_12 | HE_SVG_20 }, { HTML_UNDEF }, "mpath", elem_mpath },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mphantom", elem_mphantom, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mprescripts", elem_mprescripts, ns_default, EP_CLOSED, EF_M_PRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mroot", elem_mroot, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mrow", elem_mrow, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "ms", elem_ms, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "mscarries", elem_mscarries },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "mscarry", elem_mscarry, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "msgroup", elem_msgroup, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "msline", elem_msline, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mspace", elem_mspace, ns_default, EP_CLOSED, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "msqrt", elem_msqrt, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "msrow", elem_msrow, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "mstack", elem_mstack, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mstyle", elem_mstyle, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "msub", elem_msub, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "msubsup", elem_msubsup, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "msup", elem_msup, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mtable", elem_mtable, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mtd", elem_mtd, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mtext", elem_mtext, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "mtr", elem_mtr, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_2_0, 0, HE_NETSCAPE }, { HTML_4_01 }, "multicol", elem_multicol },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "munder", elem_munder, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "munderover", elem_munderover, ns_default, 0, EF_M_PRESINCONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "naturalnumbers", elem_naturalnumbers, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "neq", elem_neq, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "none", elem_none, ns_default, EP_CLOSED, EF_M_PRES },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "not", elem_not, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "notanumber", elem_notanumber, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_PLUS, HV_NOT2 }, { HTML_3_0 }, "note", elem_note, ns_default, 0, EF_BLOK | EF_3_BLOCK },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "notin", elem_notin, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "notprsubset", elem_notprsubset, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "notsubset", elem_notsubset, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "or", elem_or, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "otherwise", elem_otherwise, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "outerproduct", elem_outerproduct, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "partialdiff", elem_partialdiff, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_X_MATH | EF_M_CONTENT },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "path", elem_path, ns_default, 0, EF_S_G | EF_SVG_GRAPH | EF_SVG_SHAPE | EF_SVG2_GRAPH },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "pattern", elem_pattern, ns_default, 0, EF_S_G | EF_SVG_CONTAIN | EF_SVG_PSGRAD },
    { { HTML_PLUS, HV_NOT2 }, { HTML_3_0 }, "person", elem_person, ns_default, 0, EF_EMPH | EF_3_MISC },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "pi", elem_pi, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "piece", elem_piece, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "piecewise", elem_piecewise, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "plus", elem_plus, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "polygon", elem_polygon, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_S_G | EF_SVG_SHAPE | EF_SVG_GRAPH | EF_SVG2_GRAPH },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "polyline", elem_polyline, ns_default, EP_CLOSED | EP_UNCLOSEDSVG11, EF_S_G | EF_SVG_SHAPE | EF_SVG_GRAPH | EF_SVG2_GRAPH },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "power", elem_power, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { XHTML_1_1, 0, HE_SVG_12 }, { HTML_UNDEF }, "prefetch", elem_prefetch },
    { { XHTML_2_0 }, { XHTML_2_0 }, "preventdefault", elem_preventdefault, ns_default, EP_CLOSED },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "primes", elem_primes, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_PLUS }, { HTML_PLUS }, "printed", elem_printed, ns_default, 0, EF_EMPH },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "product", elem_product, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "prsubset", elem_prsubset, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "quotient", elem_quotient, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "radialGradient", elem_radialgradient, ns_default, 0, EF_SVG_PSGRAD },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "rationals", elem_rationals, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "real", elem_real, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "reals", elem_reals, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 | HE_M2_DEPRECAT | HE_M3_DEPRECAT | HE_M4_DEPRECAT }, { HTML_UNDEF }, "reln", elem_reln, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "rem", elem_rem, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "scalarproduct", elem_scalarproduct, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "sdev", elem_sdev, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "sec", elem_sec, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "sech", elem_sech, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "selector", elem_selector, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "semantics", elem_semantics, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "sep", elem_sep, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_2_0 }, { XHTML_2_0 }, "separator", elem_separator, ns_default, EP_CLOSED, EF_X2_STRUCT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 | HE_SVG_11 | HE_SVG_12 | HE_SVG_20 }, { HTML_UNDEF }, "set", elem_set, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES | EF_SVG_ANIM | EF_SVG2_ANIM },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "setdiff", elem_setdiff, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    { { HTML_JAN05, 0, HE_WEBCOMP }, { HTML_UNDEF }, "shadow", elem_shadow },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, "share", elem_share, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { HTML_JAN05 }, { HTML_JUN05 }, "sidebar", elem_sidebar, ns_default, 0, EF_5_FLOW | EF_5_SECTION | EF_5_PALPABLE },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "sin", elem_sin, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "sinh", elem_sinh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { XHTML_1_1, 0, HE_SVG_12 }, { HTML_UNDEF }, "solidcolor", elem_solidcolour },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "subset", elem_subset, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "sum", elem_sum, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "svg", elem_svg, ns_default, 0, EF_4_SPECIAL | EF_X2_TEXT | EF_5_FLOW | EF_5_PHRASE | EF_5_EMBEDDED | EF_S_G | EF_SVG_STR | EF_SVG2_STR | EF_SVG_CONTAIN },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "switch", elem_switch, ns_default, 0, EF_S_G | EF_SVG_CONTAIN },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, "symbol", elem_symbol, ns_default, 0, EF_SVG_STR | EF_SVG2_STR | EF_SVG_CONTAIN },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "tan", elem_tan, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "tanh", elem_tanh, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_2_0, HV_RFC_1942 | HV_NOT3 }, { HTML_UNDEF }, "tbody", elem_tbody },
    { { XHTML_1_1, 0, HE_SVG_12 }, { HTML_UNDEF }, "tbreak", elem_tbreak, ns_default, EP_CLOSED },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "tendsto", elem_tendsto, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_3_0, HV_NOT32, HE_SVG }, { HTML_UNDEF }, "text", elem_text, ns_default, 0, EF_S_G | EF_SVG_GRAPH | EF_SVG_TEXT | EF_SVG2_GRAPH },
    { { HTML_PLUS, HV_NOT2L1 | HV_NOTX2 | HE_SVG_12 }, { HTML_UNDEF }, "textarea", elem_textarea, ns_default, 0, EF_MISC | EF_32_FORM | EF_4_FORM | EF_5_FLOW | EF_5_PHRASE | EF_5_INTERACTIVE | EF_5_PALPABLE | EF_5_FORM },
    { { HTML_SVG10, 0, HE_SVG_10 }, { HTML_UNDEF }, "textPath", elem_textpath, ns_default, 0, EF_SVG_TEXT | EF_SVG2_GRAPH },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "times", elem_times, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "transpose", elem_transpose, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, "tref", elem_tref, ns_default, 0, EF_SVG_TEXT },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "true", elem_true, ns_default, EP_CLOSED, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "tspan", elem_tspan, ns_default, 0, EF_SVG_TEXT | EF_SVG2_GRAPH },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "union", elem_union, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "uplimit", elem_uplimit, ns_default, 0, EF_M_CONTENT | EF_M_DQ },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, "use", elem_use, ns_default, 0, EF_S_G | EF_SVG_STR | EF_SVG2_STR | EF_SVG_GRAPH | EF_SVG2_GRAPH },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "variance", elem_variance, ns_default, EP_CLOSED | EP_ARGS_1 | EP_ARGS_MORE, EF_M_CONTENT },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 | HE_M2_DEPRECAT }, { HTML_UNDEF }, "vector", elem_vector, ns_default, 0, EF_M_CONTENT | EF_M_CONTINPRES },
    { { HTML_SVG12, 0, HE_SVG_12_FULL }, { HTML_UNDEF }, "vectoreffect", elem_vectoreffect },
    { { HTML_MATH2, 0, MATH_2_3_4 }, { HTML_UNDEF }, "vectorproduct", elem_vectorproduct, ns_default, EP_CLOSED | EP_ARGS_2, EF_M_CONTENT },
    ...
    { { HTML_SVG11, 0, HE_SVG_11 | HE_SVG_20 }, { HTML_UNDEF }, "view", elem_view },
    { { HTML_SVG11, 0, HE_SVG_11 }, { HTML_UNDEF }, "vkern", elem_vkern, ns_default, EP_CLOSED },
    ...
    { { HTML_MATH1, 0, MATH_1_2_3_4 }, { HTML_UNDEF }, "xor", elem_xor, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT } };
...
{   DBG_ASSERT (! x.empty ());
    ::std::string el (x), n;
    ns (examine_namespace (nits, v, el, n));
