...
hav_t havt_table [] =
{   { { HTML_2_0, HV_DEPRECATED4 }, { XHTML_2_0 }, elem_table, a_align, EP_WX },
    { { HTML_3_2, 0, HE_BESPOKE }, { XHTML_2_0 }, elem_table, a_background },
    { { HTML_4_0, HV_DEPRECATED4 }, { XHTML_2_0 }, elem_table, a_bgcolour, EP_WX },
    { { HTML_PLUS, HV_DEPRECATED4 | HV_RFC_2070 }, { XHTML_2_0 }, elem_table, a_border, EP_WX },
    { { HTML_JUL11 }, { HTML_DEC12 }, elem_table, a_border, EP_WX },
    { { HTML_5_0, HV_W3 }, { HTML_5_3 }, elem_table, a_border, EP_WX },
    { { HTML_2_0, HV_NOT30 }, { XHTML_2_0 }, elem_table, a_cellspacing, EP_WX },
    { { HTML_2_0, HV_NOT30 }, { XHTML_2_0 }, elem_table, a_cellpadding, EP_WX },
    ...
    { { HTML_2_0 }, { XHTML_2_0 }, elem_table, a_valign, EP_WX | EP_WXONLY },
    { { HTML_2_0 }, { XHTML_2_0 }, elem_table, a_width, EP_WX },
...
{   { { HTML_4_0 }, { XHTML_2_0 }, elem_td, a_abbr },
    { { HTML_PLUS, HV_DEPRECATED4 | HV_RFC_1942 }, { XHTML_2_0 }, elem_td, a_align, EP_WX },
    ...
    { { HTML_PLUS }, { HTML_UNDEF }, elem_td, a_colspan, EP_WX },
    ...
    { { HTML_2_0, HV_DEPRECATED4 }, { XHTML_2_0 }, elem_td, a_nowrap, EP_WX },
    { { HTML_PLUS }, { HTML_UNDEF }, elem_td, a_rowspan, EP_WX },
    { { HTML_4_0 }, { XHTML_2_0 }, elem_td, a_scope },
    { { HTML_2_0, HV_RFC_1942 }, { XHTML_2_0 }, elem_td, a_valign, EP_WX },
    { { HTML_3_2, HV_DEPRECATED4 }, { XHTML_2_0 }, elem_td, a_width, EP_WX },
...
{   { { HTML_3_0 }, { HTML_3_0 }, elem_textarea, a_align },
    ...
    { { HTML_2_0, HV_REQUIRED }, { HTML_4_01 }, elem_textarea, a_cols },
    ...
    { { HTML_2_0, HV_REQUIRED }, { HTML_3_2 }, elem_textarea, a_name },
    ...
    { { HTML_2_0, HV_REQUIRED }, { HTML_4_01 }, elem_textarea, a_rows },
