...
{   { { HTML_UNDEF }, { HTML_UNDEF }, "html", doc_html },
    ...
    { { HTML_1_0, 0, 0, 0, 0, H4_RSS }, { HTML_UNDEF }, HTTP "my.netscape.com/publish/formats/rss-0.91.dtd", doc_rss_91 },
    ...
    { { HTML_MATH4, 0, 0, H2_MATH_4 }, { HTML_UNDEF }, "-//W3C//DTD MathML 4.0//EN", doc_math4 },
    { { HTML_MATH4, 0, 0, H2_MATH_4 }, { HTML_UNDEF }, "-//W3C//ENTITIES MathML 4.0 Qualified Names 1.0//EN", doc_math4 },
...
{   type_master < t_sgml > :: init (nits, doctype_symbol_table, sgml_count ()); }
