...
{   STANDARD_HTML5_ATTRIBUTES (elem_m),
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_marker, a_markerheight },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_marker, a_markerunits },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_marker, a_markerwidth },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_marker, a_orient },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_marker, a_preserveaspectratio },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_marker, a_viewbox },
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_mask, a_maskcontentunits },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_mask, a_maskunits },
    ...
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_math, a_altimg_height },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_math, a_altimg_width },
    { { HTML_MATH1 }, { HTML_UNDEF }, elem_math, a_alttext },
    { { HTML_MATH1 }, { HTML_UNDEF }, elem_math, a_baseline },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_math, a_cdgroup },
    ...
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_math, a_maxwidth },
    ...
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_mglyph, a_height },
    { { XHTML_1_0 }, { HTML_UNDEF }, elem_mglyph, a_index },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_mglyph, a_src },
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_mglyph, a_width },
    ...
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_mover, a_align },
    ...
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_munder, a_align },
    ...
    { { HTML_MATH3, 0, MATH_3_4 }, { HTML_UNDEF }, elem_munderover, a_align },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_20 }, { HTML_UNDEF }, elem_path, a_marker },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_path, a_marker_end },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_path, a_marker_mid },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_path, a_marker_start },
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_path),
    ...
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_pattern, a_patterncontentunits },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_pattern, a_patterntransform },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_pattern, a_patternunits },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_pattern, a_viewbox },
    ...
    { { HTML_SVG11, 0, HE_SVG_11_20 }, { HTML_UNDEF }, elem_polygon, a_marker },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_polygon, a_marker_end },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_polygon, a_marker_mid },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_polygon, a_marker_start },
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_polygon),
    ...
    { { HTML_SVG11, 0, HE_SVG_11_20 }, { HTML_UNDEF }, elem_polyline, a_marker },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_polyline, a_marker_end },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_polyline, a_marker_mid },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_polyline, a_marker_start },
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_polyline),
    ...
    { { HTML_SVG20, 0, HE_SVG_20 }, { HTML_UNDEF }, elem_radialgradient, a_fr },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_radialgradient, a_fx },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_radialgradient, a_fy },
    { { HTML_SVG10, 0, HE_SVG }, { HTML_UNDEF }, elem_radialgradient, a_r },
    { { HTML_SVG10, 0, HE_SVG_10_11_20 }, { HTML_UNDEF }, elem_radialgradient, a_spreadmethod },
    ...
    SVG12_CONDGRAPH_ATTRIBUTES (elem_rect),
