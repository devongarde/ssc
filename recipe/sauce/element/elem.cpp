...
{   { { HTML_PLUS }, { HTML_UNDEF }, "!doctype", elem_faux_doctype, ns_default, EP_CLOSED | EP_TOP },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "complexes", elem_complexes, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "emptyset", elem_emptyset, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "eulergamma", elem_eulergamma, ns_default, EP_CLOSED, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "exists", elem_exists, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_M_CONTENT },
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "exponentiale", elem_exponentiale, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "false", elem_false, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "imaginary", elem_imaginary, ns_default, EP_CLOSED | EP_ARGS_1, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "infinity", elem_infinity, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "integers", elem_integers, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "naturalnumbers", elem_naturalnumbers, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "notanumber", elem_notanumber, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_1 | HE_MATH_2 }, { HTML_UNDEF }, "partialdiff", elem_partialdiff, ns_default, EP_CLOSED | EP_ARGS_2 | EP_ARGS_MORE, EF_X_MATH },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "pi", elem_pi, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "primes", elem_primes, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "rationals", elem_rationals, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "reals", elem_reals, ns_default, EP_CLOSED, EF_M_CONTENT },
    ...
    { { XHTML_1_0, 0, HE_MATH_2 }, { HTML_UNDEF }, "true", elem_true, ns_default, EP_CLOSED, EF_M_CONTENT },
