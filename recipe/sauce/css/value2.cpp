...
{   PRESUME ((args.t_.at (start).t_ == ct_keyword) || (args.t_.at (start).t_ == ct_identifier) || (args.t_.at (start).t_ == ct_number), __FILE__, __LINE__);
    ...
    if (t <= SSC_TYPES_CSS_B_5_MAX) return property_by_type < SSC_TYPES_CSS_B_5, t_unknown > :: check (args, start, to, nits, t);
    ...
    if (t <= SSC_TYPES_CSS_E_1_MAX) return property_by_type < SSC_TYPES_CSS_E_1, t_unknown > :: check (args, start, to, nits, t);
    if (t <= SSC_TYPES_CSS_E_2_MAX) return property_by_type < SSC_TYPES_CSS_E_2, t_unknown > :: check (args, start, to, nits, t);
    ...
    if (t <= SSC_TYPES_CSS_FN_3_MAX) return property_by_type < SSC_TYPES_CSS_FN_3, t_unknown > :: check (args, start, to, nits, t);
    ...
    if (t <= SSC_TYPES_CSS_M_1_MAX) return property_by_type < SSC_TYPES_CSS_M_1, t_unknown > :: check (args, start, to, nits, t);
    if (t <= SSC_TYPES_CSS_M_2_MAX) return property_by_type < SSC_TYPES_CSS_M_2, t_unknown > :: check (args, start, to, nits, t);
    if (t <= SSC_TYPES_CSS_N_O_MAX) return property_by_type < SSC_TYPES_CSS_N_O, t_unknown > :: check (args, start, to, nits, t);
    ...
    if (t <= SSC_TYPES_CSS_R_1_MAX) return property_by_type < SSC_TYPES_CSS_R_1, t_unknown > :: check (args, start, to, nits, t);
    if (t <= SSC_TYPES_CSS_R_2_MAX) return property_by_type < SSC_TYPES_CSS_R_2, t_unknown > :: check (args, start, to, nits, t);
    ...
    if (t <= SSC_TYPES_CSS_T_5_MAX) return property_by_type < SSC_TYPES_CSS_T_5, t_unknown > :: check (args, start, to, nits, t);
