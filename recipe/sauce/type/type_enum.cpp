...
{   { { HTML_TAGS }, { HTML_UNDEF }, "class-count", nm_class_count },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-code", nm_context_code },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-fe", nm_context_fe },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-filename", nm_context_filename },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-process-webmentions", nm_context_mention_process },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-sarcasm", nm_context_sarcasm },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-datapath", nm_context_mention_datapath },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-extension", nm_context_mention_extension },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-header", nm_context_mention_header },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-notify", nm_context_mention_notify },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-sender", nm_context_mention_sender },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-secret", nm_context_mention_secret },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-templates", nm_context_mention_templates },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-stub", nm_context_mention_stub },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-user", nm_context_mention_user },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mention-write-path", nm_context_mention_write_path },
    { { HTML_TAGS }, { HTML_UNDEF }, "context-mentions", nm_context_mentions },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "id-line", nm_id_line },
    { { HTML_TAGS }, { HTML_UNDEF }, "id-name", nm_id_name },
    { { HTML_TAGS }, { HTML_UNDEF }, "id-page", nm_id_page },
...
{   { { HTML_TAGS }, { HTML_UNDEF }, "class", ns_class },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "id", ns_itemid },
    ...
    { { HTML_TAGS }, { HTML_UNDEF }, "webmention", ns_webmention },
    { { HTML_TAGS }, { HTML_UNDEF }, "webmention-foot", ns_webmention_foot },
