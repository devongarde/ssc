...
{   if (t <= SSC_TYPES_0_9_MAX) return test_typed_value < SSC_TYPES_0_9, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_CSS_U_V_MAX) return test_typed_value < SSC_TYPES_CSS_U_V, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_I_MAX) return test_typed_value < SSC_TYPES_I, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_J_K_MAX) return test_typed_value < SSC_TYPES_J_K, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_L_MAX) return test_typed_value < SSC_TYPES_L, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_T_MAX) return test_typed_value < SSC_TYPES_T, t_unknown > :: test (nits, v, t, s);
