...
{   { elem_undefined, { a_unknown } },
    { elem_a, { a_actuate, a_charset, a_download, a_effect, a_externalresourcesrequired, a_md, a_methods, a_name, a_ping, a_print, a_referrerpolicy,
    ...
    { elem_button, {    a_action, a_autocomplete, a_disabled, a_enctype, a_form, a_formaction, a_formenctype, a_formmethod, a_formnovalidate, a_formtarget,
    ...
    { elem_input, { a_accept, a_action, a_align, a_alt, a_autocorrect, a_autocomplete, a_capture, a_checked, a_dirname,
