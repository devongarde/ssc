...
{   { { HTML_DEC25 }, { HTML_UNDEF }, elem_a, a_attributionsrc },
    ...
    { { HTML_TAGS, HV_DEPRECATED30 | HV_DEPRECATEDX1 }, { XHTML_1_1 }, elem_a, a_name, EP_WX },
    ...
    { { HTML_4_0 }, { XHTML_2_0 }, elem_a, a_target, EP_WX },
...
{   { { HTML_MATH3, 0, 0, H2_MATH_3_4 }, { HTML_UNDEF }, elem_annotation, a_cd },
    ...
    { { HTML_MATH1, 0, 0, H2_MATHML }, { HTML_UNDEF }, elem_annotation, a_encoding },
...
{   { { HTML_MATH3, 0, 0, H2_MATH_3_4 }, { HTML_UNDEF }, elem_annotation_xml, a_cd },
    { { HTML_MATH2, 0, 0, H2_MATH_2_3 }, { HTML_UNDEF }, elem_annotation_xml, a_definitionurl },
    ...
    { { HTML_MATH3, 0, 0, H2_MATH_3 }, { HTML_UNDEF }, elem_annotation_xml, a_src },
...
{   { { HTML_2_0, HV_NOT30 | HV_RFC_1980 }, { HTML_DEC06 }, elem_area, a_alt },
    ...
    { { HTML_MAY26 }, { HTML_UNDEF }, elem_area, a_hreflang },
    ...
    { { HTML_2_0, HV_NOT30 | HV_RFC_1980 }, { HTML_UNDEF }, elem_area, a_shape, EP_WX },
    ...
    { { HTML_MAY26 }, { HTML_UNDEF }, elem_area, a_type },
