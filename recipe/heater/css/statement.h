...
{   type_master < t_css_statement > st_;
    ...
    void parse_custom_property (arguments& args, nitpick& nits, const int from, const int to);
    void parse_custom_selector (arguments& args, nitpick& nits, const int from, const int to);
    void parse_else (arguments& args, nitpick& nits, const int from, const int to);
    void parse_env (arguments& args, nitpick& nits, const int from, const int to);
    ...
    void parse_view_transition (arguments& args, nitpick& nits, const int from, const int to);
