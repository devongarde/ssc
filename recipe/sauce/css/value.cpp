...
{   int test_value_fns_0_9 (arguments& args, int& start, const int to, nitpick& nits, const e_type t, const e_css_val_fn fn, const e_css_property id);
    ...
    int test_value_fns_css_u_v (arguments& args, int& start, const int to, nitpick& nits, const e_type t, const e_css_val_fn fn, const e_css_property id);
    ...
    int test_value_fns_l (arguments& args, int& start, const int to, nitpick& nits, const e_type t, const e_css_val_fn fn, const e_css_property id);
    ...
    if (t <= SSC_TYPES_CSS_U_V_MAX) return test_value_fns_css_u_v (args, start, to, nits, t, fn, id);
    ...
    if (t <= SSC_TYPES_L_MAX) return test_value_fns_l (args, start, to, nits, t, fn, id);
