...
{   { { HTML_4_0 }, { XHTML_2_0 }, elem_iframe, a_align },
    { { HTML_JUL18, 0, HE_EXPERIMENTAL }, { HTML_JUL25 }, elem_iframe, a_allow },
    { { HTML_AUG25 }, { HTML_UNDEF }, elem_iframe, a_allow },
    ...
    { { HTML_DEC25 }, { HTML_UNDEF }, elem_iframe, a_browsingtopics },
    { { HTML_DEC25 }, { HTML_UNDEF }, elem_iframe, a_credentialless },
    { { HTML_JUL20, 0, HE_EXPERIMENTAL }, { HTML_JUL25 }, elem_iframe, a_csp },
    ...
    { { HTML_JUL20, 0, HE_EXPERIMENTAL }, { HTML_JUL25 }, elem_iframe, a_importance },
...
{   { { HTML_PLUS }, { HTML_PLUS }, elem_image, a_align },
    ...
    { { HTML_PLUS, HV_REQUIRED }, { HTML_PLUS }, elem_image, a_src },
...
hav_t havt_img [] =
{   { { HTML_1_0, HV_DEPRECATED4 }, { XHTML_2_0 }, elem_img, a_align, EP_WX },
    { { HTML_1_0 }, { XHTML_2_0 }, elem_img, a_alt },
    { { HTML_JAN05, HV_REQUIRED }, { HTML_EOJ21 }, elem_img, a_alt },
    ...
    { { HTML_3_0 }, { HTML_UNDEF }, elem_img, a_height, EP_WX },
    ...
    { { HTML_3_0 }, { HTML_UNDEF }, elem_img, a_width, EP_WX },
...
{   { { HTML_2_0, HV_RFC_1867 | HV_NOT32 }, { HTML_UNDEF }, elem_input, a_accept },
    ...
    { { HTML_NOV24 }, { HTML_UNDEF }, elem_input, a_alpha },
    ...
    { { HTML_NOV24 }, { HTML_UNDEF }, elem_input, a_colourspace },
    ...
    { { HTML_JAN09, 0, HE_SAFARI | HE_OPERA | HE_CHROME }, { HTML_AUG25 }, elem_input, a_incremental },
    ...
    { { HTML_JAN05, 0, HE_MOZILLA }, { HTML_AUG25 }, elem_input, a_orient },
    ...
    { { HTML_JAN09, 0, HE_BESPOKE }, { HTML_AUG25 }, elem_input, a_webkitdirectory },
...
hav_t havt_interval [] =
{   { { HTML_MATH1, 0, 0, H2_MATHML }, { HTML_UNDEF }, elem_interval, a_closure },
