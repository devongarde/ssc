...
#define ATOMIC      a_xmlbase, a_xmllang, a_xmlns, RDFa
...
#define XHTML       a_role, ATOMIC, a_xmlspace
...
#define RDFa_META   RDFa, METADATA
...
{   { elem_undefined, { a_unknown } },
    ...
    { elem_atom_feed, { ATOMIC, a_unknown } },
    ...
    { elem_fecustom, { a_fragmentshader, a_params, a_vertexmesh, a_vertexshader, SVG_FILTER, SVG_PRES, METADATA, LIVING_STANDARD, a_unknown } },
    ...
    { elem_font, {  a_bgcolour, a_externalresourcesrequired, a_face, a_horiz_adv_x, a_horiz_origin_x, a_horiz_origin_y, a_size, a_vert_adv_y, a_vert_origin_x,
                    a_vert_origin_y, SVG_PRES, METADATA, LIVING_STANDARD, a_unknown } },
    { elem_font_face, {  a_accent_height, a_alpha, a_alphabetic, a_ascent, a_bbox, a_cap_height, a_colourspace, a_descent, a_font_family, a_font_size,
                        a_font_stretch, a_font_style, a_font_variant, a_font_weight, a_hanging, a_ideographic, a_mathematical, a_overline_position,
                        a_overline_thickness, a_panose_1, a_slope, a_stemh, a_stemv, a_strikethrough_position, a_strikethrough_thickness,
                        a_underline_position, a_underline_thickness, a_unicode_range, a_units_per_em, a_v_alphabetic, a_v_hanging, a_v_ideographic,
                        a_v_mathematical, a_widths, a_x_height, METADATA, LIVING_STANDARD, a_unknown } },
    ...
    { elem_geo_lat, { RDFa_META, a_unknown } },
    { elem_geo_long, { RDFa_META, a_unknown } },
    { elem_geo_point, { RDFa_META, a_unknown } },
    { elem_georss_box, { RDFa_META, a_unknown } },
    { elem_georss_elev, { RDFa_META, a_unknown } },
    { elem_georss_featurename, { RDFa_META, a_unknown } },
    { elem_georss_featuretypetag, { RDFa_META, a_unknown } },
    { elem_georss_floor, { RDFa_META, a_unknown } },
    { elem_georss_line, { RDFa_META, a_unknown } },
    { elem_georss_point, { RDFa_META, a_unknown } },
    { elem_georss_polygon, { RDFa_META, a_unknown } },
    { elem_georss_radius, { RDFa_META, a_unknown } },
    { elem_georss_relationshiptag, { RDFa_META, a_unknown } },
    { elem_georss_where, { RDFa_META, a_unknown } },
    { elem_gml_envelope, { a_unknown } },
    { elem_gml_exterior, { a_unknown } },
    { elem_gml_linearring, { a_unknown } },
    { elem_gml_linestring, { a_unknown } },
    { elem_gml_lowercorner, { a_unknown } },
    { elem_gml_point, { a_unknown } },
    { elem_gml_polygon, { a_unknown } },
    { elem_gml_pos, { a_unknown } },
    { elem_gml_poslist, { a_unknown } },
    { elem_gml_uppercorner, { a_unknown } },
    ...
    { elem_img, {   a_align, a_alt, a_border, a_controls, a_crossorigin, a_decoding, a_fetchpriority, a_hspace, a_importance, a_intrinsicsize,
    ...
    { elem_mglyph, { a_alt, a_fontfamily, a_height, a_index, a_mathvariant, a_mathsize, a_other, a_src, a_width, MATH4PRES, a_unknown } },
    { elem_mh, { a_action, a_hidden, a_method, HTMLPLUS, a_unknown } },
    { elem_mi, { a_mathvariant, MATH4CFONT, a_unknown } },
    ...
    { elem_mrss_adult, { RDFa_META, a_unknown } } ,
    { elem_mrss_backlink, { RDFa_META, a_unknown } } ,
    { elem_mrss_backlinks, { RDFa_META, a_unknown } } ,
    { elem_mrss_category, { a_mrss_scheme, RDFa_META, a_unknown } } ,
    { elem_mrss_comment, { RDFa_META, a_unknown } } ,
    { elem_mrss_comments, { RDFa_META, a_unknown } } ,
    { elem_mrss_community, { RDFa_META, a_unknown } } ,
    { elem_mrss_content, {  a_mrss_bitrate, a_mrss_channels, a_mrss_duration, a_mrss_expression, a_mrss_filesize, a_mrss_framerate, a_mrss_height,
                            a_mrss_isdefault, a_mrss_lang, a_mrss_medium, a_mrss_samplingrate, a_mrss_type, a_mrss_url, a_mrss_width, RDFa_META, a_unknown } } ,
    { elem_mrss_copyright, { a_mrss_url, RDFa_META, a_unknown } } ,
    { elem_mrss_credit, { a_mrss_role, a_mrss_scheme, RDFa_META, a_unknown } } ,
    { elem_mrss_description, { a_mrss_type, RDFa_META, a_unknown } } ,
    { elem_mrss_embed, { a_mrss_height, a_mrss_url, a_mrss_width, RDFa_META, a_unknown } } ,
    { elem_mrss_group, { RDFa_META, a_unknown } } ,
    { elem_mrss_hash, { a_mrss_algo, RDFa_META, a_unknown } } ,
    { elem_mrss_keywords, { RDFa_META, a_unknown } } ,
    { elem_mrss_licence, { a_href, a_mrss_type, RDFa_META, a_unknown } } ,
    { elem_mrss_location, { a_mrss_description, a_mrss_end, a_mrss_start, RDFa_META, a_unknown } } ,
    { elem_mrss_param, { a_mrss_name, RDFa_META, a_unknown } } ,
    { elem_mrss_peerlink, { a_href, a_mrss_type, RDFa_META, a_unknown } } ,
    { elem_mrss_player, {  a_mrss_height,a_mrss_url, a_mrss_width, RDFa_META, a_unknown } } ,
    { elem_mrss_price, { a_mrss_currency, a_mrss_info, a_mrss_price, a_mrss_type, RDFa_META, a_unknown } } ,
    { elem_mrss_rating, { a_mrss_scheme, RDFa_META, a_unknown } } ,
    { elem_mrss_response, { RDFa_META, a_unknown } } ,
    { elem_mrss_responses, { RDFa_META, a_unknown } } ,
    { elem_mrss_restriction, { a_mrss_relationship, a_mrss_type, RDFa_META, a_unknown } },
    { elem_mrss_rights, { a_mrss_status, RDFa_META, a_unknown } } ,
    { elem_mrss_scene, { RDFa_META, a_unknown } } ,
    { elem_mrss_scenedescription, { RDFa_META, a_unknown } } ,
    { elem_mrss_sceneendtime, { RDFa_META, a_unknown } } ,
    { elem_mrss_scenes, { RDFa_META, a_unknown } } ,
    { elem_mrss_scenestarttime, { RDFa_META, a_unknown } } ,
    { elem_mrss_scenetitle, {RDFa_META, a_unknown } } ,
    { elem_mrss_starrating, { a_mrss_average, a_mrss_count, a_mrss_max, a_mrss_min, RDFa_META, a_unknown } } ,
    { elem_mrss_statistics, { a_mrss_favourites, a_mrss_views, RDFa_META, a_unknown } } ,
    { elem_mrss_status, { a_mrss_reason, a_mrss_state, RDFa_META, a_unknown } } ,
    { elem_mrss_subtitle, { a_href, a_mrss_lang, a_mrss_type, RDFa_META, a_unknown } } ,
    { elem_mrss_tags, { RDFa_META, a_unknown } } ,
    { elem_mrss_text, { a_mrss_end, a_mrss_lang, a_mrss_start, a_mrss_type, RDFa_META, a_unknown } } ,
    { elem_mrss_thumbnail, { a_mrss_height, a_mrss_time, a_mrss_url, a_mrss_width, RDFa_META, a_unknown } } ,
    { elem_mrss_title, { a_mrss_type, RDFa_META, a_unknown } } ,
    ...
    { elem_munder, { a_accent, a_accentunder, a_align, MATH4CPRES, a_unknown } },
    ...
    { elem_rsl, { a_xmlns, RDFa_META, a_unknown } },
    { elem_rsl_amount, { a_rsl_currency,RDFa_META,  a_unknown } },
    { elem_rsl_content, { a_rsl_encrypted, a_rsl_lastmod, a_rsl_server, a_rsl_url, RDFa_META, a_unknown } },
    { elem_rsl_copyright, { a_rsl_contactemail, a_rsl_contacturl, a_rsl_type, RDFa_META, a_unknown } },
    { elem_rsl_custom, { RDFa_META, a_unknown } },
    { elem_rsl_legal, { a_rsl_type, RDFa_META, a_unknown } },
    { elem_rsl_licence, { RDFa_META, a_unknown } },
    { elem_rsl_payment, { a_rsl_type, RDFa_META, a_unknown } },
    { elem_rsl_permits, { a_rsl_type, RDFa_META, a_unknown } },
    { elem_rsl_prohibits, { a_rsl_type, RDFa_META, a_unknown } },
    { elem_rsl_schema, { RDFa_META, a_unknown } },
    { elem_rsl_standard, { RDFa_META, a_unknown } },
    { elem_rsl_terms, { RDFa_META, a_unknown } },
    { elem_rss, { a_rss_version, a_xmlns, RDFa_META, a_unknown } },
    { elem_rss_author, { RDFa_META, a_unknown } },
    { elem_rss_category, { a_rss_domain, RDFa_META, a_unknown } },
    { elem_rss_channel, { RDFa_META, a_unknown } },
    { elem_rss_cloud, { a_rss_domain, a_rss_path, a_rss_port, a_rss_protocol, a_rss_registerprocedure, RDFa_META, a_unknown } },
    { elem_rss_comments, { RDFa_META, a_unknown } },
    { elem_rss_copyright, { RDFa_META, a_unknown } },
    { elem_rss_description, { RDFa_META, a_unknown } },
    { elem_rss_day, { RDFa_META, a_unknown } },
    { elem_rss_docs, { RDFa_META, a_unknown } },
    { elem_rss_enclosure, { a_rss_length, a_rss_type, a_rss_url, RDFa_META, a_unknown } },
    { elem_rss_generator, { RDFa_META, a_unknown } },
    { elem_rss_guid, { a_rss_ispermalink, RDFa_META, a_unknown } },
    { elem_rss_height, { RDFa_META, a_unknown } },
    { elem_rss_hour, { RDFa_META, a_unknown } },
    { elem_rss_image, { RDFa_META, a_unknown } },
    { elem_rss_item, { RDFa_META, a_unknown } },
    { elem_rss_language, { RDFa_META, a_unknown } },
    { elem_rss_lastbuilddate, { RDFa_META, a_unknown } },
    { elem_rss_link, { RDFa_META, a_unknown } },
    { elem_rss_managingeditor, { RDFa_META, a_unknown } },
    { elem_rss_pubdate, { RDFa_META, a_unknown } },
    { elem_rss_rating, { RDFa_META, a_unknown } },
    { elem_rss_skipdays, { RDFa_META, a_unknown } },
    { elem_rss_skiphours, { RDFa_META, a_unknown } },
    { elem_rss_source, { a_rss_url, RDFa_META, a_unknown } },
    { elem_rss_textinput, { RDFa_META, a_unknown } },
    { elem_rss_title, { RDFa_META, a_unknown } },
    { elem_rss_ttl, { RDFa_META, a_unknown } },
    { elem_rss_webmaster, { RDFa_META, a_unknown } },
    { elem_rss_width, { RDFa_META, a_unknown } },
    ...
    { elem_select, {    a_align, a_autocomplete, a_disabled, a_error, a_form, a_md, a_multiple, a_name, a_required, a_several, a_size, a_units, WIDEHIGH, RESERVED4,
                        METADATA, LIVING_STANDARD, a_unknown } },
    { elem_selectedcontent, { LIVING_STANDARD, a_unknown } },
    ...
    { elem_table, { a_align, a_background, a_bgcolour, a_border, a_cellspacing, a_cellpadding, a_clear, a_cols, a_colspec, a_dp, a_frame, a_noflow, a_nowrap,
                    a_rules, a_sortable, a_summary, a_units, a_valign, a_width, RESERVED4, LIVING_STANDARD_PLUS, a_unknown } },
    ...
    { elem_trackback_about, { a_rdf_resource, a_unknown } },
    { elem_trackback_ping, { a_rdf_resource, a_unknown } },
