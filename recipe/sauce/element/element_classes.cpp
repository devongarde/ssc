...
{   { elem_undefined, { a_unknown } },
    { elem_a, { a_actuate, a_charset, a_command, a_download, a_effect, a_externalresourcesrequired, a_md, a_methods, a_name, a_ping, a_print, a_referrerpolicy,
                a_show, a_size, a_transform, a_type, a_urn, a_xmllink, SVG11GREV, SVG11XLINK, SVG20COND, SVGPRES, COMMON54, a_unknown } },
    ...
    { elem_article, { a_active, a_pubdate, COMMON54, a_unknown } },
    { elem_aside, { a_active, COMMON54, a_unknown } },
    { elem_atop, { a_unknown } },
    { elem_au, { LANGCLASS3, a_unknown } },
    { elem_audio, { a_autobuffer, a_autoplay, a_controls, a_crossorigin, a_currenttime, a_duration, a_end, a_loop, a_loopcount, a_loopend,
                    a_loopstart, a_mediagroup, a_muted, a_preload, a_start, COMMON54, a_unknown } },
    ...
    { elem_blockquote, { a_active, a_align, COMMON54, a_unknown } },
    ...
    { elem_button, {    a_action, a_autocomplete, a_command, a_disabled, a_enctype, a_form, a_formaction, a_formenctype, a_formmethod, a_formnovalidate, a_formtarget,
                        a_menu, a_method, a_name, a_novalidate, a_type, a_value, RESERVED4, COMMON54, a_unknown } },
    ...
    { elem_embed, { a_type, a_align, a_hspace, a_name, a_vspace, WIDEHIGH, COMMON54, a_unknown } },
    ...
    { elem_font, {  a_externalresourcesrequired, a_face, a_horizadvx, a_horizoriginx, a_horizoriginy, a_size, a_vertadvy, a_vertoriginx,
                    a_vertoriginy, SVGPRES, COMMON54, a_unknown } },
    ...
    { elem_html, { a_manifest, a_version, a_urn, a_xsischemaloc, COMMON54, a_unknown } },
    ...
    { elem_iframe, {    a_align, a_allow, a_allowfullscreen, a_allowpaymentrequest, a_allowusermedia, a_csp, a_frameborder, a_importance,
                        ...
                        a_seamless, a_srcdoc, WIDEHIGH, COMMON54, a_unknown } },
    ...
    { elem_menu, { a_align, a_autosubmit, a_clear, a_compact, a_dingbat, a_index, a_label, a_md, a_plain, a_type, a_wrap, COMMON54, a_unknown } },
    ...
    { elem_nav, { a_active, COMMON54, a_unknown } },
    ...
    { elem_option, { a_command, a_disabled, a_error, a_label, a_selected, a_value, COMMON54, a_unknown } },
    ...
    { elem_progress, { a_form, a_max, a_value, COMMON54, a_unknown } },
    ...
    { elem_section, { a_active, COMMON54, a_unknown } },
    ...
    { elem_time, { a_datetime, a_pubdate, COMMON54, a_unknown } },
    ...
    { elem_video, { a_audio, a_autobuffer, a_autopictureinpicture, a_autoplay, a_buffered, a_controls, a_controlslist, a_crossorigin, a_currenttime,
                    a_disablepictureinpicture, a_disableremoteplayback, a_duration, a_end, a_intrinsicsize, a_loop, a_loopcount, a_loopend,
                    a_loopstart, a_mediagroup, a_muted, a_playcount, a_playsinline, a_poster, a_preload, a_start, WIDEHIGH, COMMON54, a_unknown } },
