...
{   if (t <= SSC_TYPES_0_2_MAX) return test_typed_value < SSC_TYPES_0_2, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_3_9_MAX) return test_typed_value < SSC_TYPES_3_9, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_B_MAX) return test_typed_value < SSC_TYPES_B, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_CSS_E_MAX) return test_typed_value < SSC_TYPES_CSS_E, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_CSS_I_MAX) return test_typed_value < SSC_TYPES_CSS_I, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_CSS_J_K_MAX) return test_typed_value < SSC_TYPES_CSS_J_K, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_CSS_L_MAX) return test_typed_value < SSC_TYPES_CSS_L, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_CSS_R_MAX) return test_typed_value < SSC_TYPES_CSS_R, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_D_MAX) return test_typed_value < SSC_TYPES_D, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_G_H_MAX) return test_typed_value < SSC_TYPES_G_H, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_M_N_MAX) return test_typed_value < SSC_TYPES_M_N, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_SVG_2_MAX) return test_typed_value < SSC_TYPES_SVG_2, t_unknown > :: test (nits, v, t, s);
    ...
    if (t <= SSC_TYPES_U_MAX) return test_typed_value < SSC_TYPES_U, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_V_MAX) return test_typed_value < SSC_TYPES_V, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_V_W_MAX) return test_typed_value < SSC_TYPES_V_W, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_X_MAX) return test_typed_value < SSC_TYPES_X, t_unknown > :: test (nits, v, t, s);
    if (t <= SSC_TYPES_X_Z_MAX) return test_typed_value < SSC_TYPES_X_Z, t_unknown > :: test (nits, v, t, s);
    GRACEFUL_CRASH (__FILE__, __LINE__); }
