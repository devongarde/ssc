...
#define XHTML1_STANDARD_ATTRIBUTES(ELEM) \
    RDF_RFA_ATTRIBUTES (ELEM), \
    { { XHTML_1_0, 0, HE_NOT_SVG_10_11_20 }, { HTML_UNDEF }, ELEM, a_role }, \
