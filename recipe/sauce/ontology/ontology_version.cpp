...
{   return ((mjr == 1) && (mnr == 0)); }
template < > ontology_version ontology_detail < s_gs1 > :: to () noexcept { return ontology_version (s_gs1, 1, 16); }
...
template < > int ontology_detail < s_schema > :: count () noexcept { return 90; }
