...
struct sz_bidioverride { constexpr static char const* sz () { return "bidi-override"; } };
...
struct sz_center { constexpr static char const* sz () { return "center"; } };
...
struct sz_fractal_noise { constexpr static char const* sz () { return "fractal-noise"; } };
...
struct sz_stroke_width { constexpr static char const* sz () { return "stroke-width"; } };
