...
template < > struct type_master < t_radial_1 > : type_none_one_two < t_radial_1, sz_space_char, t_radial_start, t_at_pos >
{ using type_none_one_two < t_radial_1, sz_space_char, t_radial_start, t_at_pos > :: type_none_one_two; };
